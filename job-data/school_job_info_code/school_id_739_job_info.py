"""
Job info scraper for school_id 739 - Mission University (US)
ATS platform: own website
Careers link: https://mission.edu/jobs/

Reads posting URLs from school_id_739_job_postings.checkpoint (this
...
Writes school_job_info/school_id_739_job_info.csv. Checkpointed to
school_id_739_job_info.checkpoint next to this script -- kill-and-resume,
