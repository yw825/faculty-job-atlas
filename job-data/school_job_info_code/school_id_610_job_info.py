"""
Job info scraper for school_id 610 - McDaniel College (US)
ATS platform: own website
Careers link: https://mcdaniel.interviewexchange.com/static/clients/561MCM1/index.jsp

Reads posting URLs from school_id_610_job_postings.checkpoint (this
...
Writes school_job_info/school_id_610_job_info.csv. Checkpointed to
school_id_610_job_info.checkpoint next to this script -- kill-and-resume,
