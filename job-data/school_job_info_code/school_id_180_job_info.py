"""
Job info scraper for school_id 180 - Western Connecticut State University (US)
ATS platform: own website
Careers link: http://wcsu.edu/hr/employment/current-opportunities/

Reads posting URLs from school_id_180_job_postings.checkpoint (this
...
Writes school_job_info/school_id_180_job_info.csv. Checkpointed to
school_id_180_job_info.checkpoint next to this script -- kill-and-resume,
