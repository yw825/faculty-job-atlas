"""
Job info scraper for school_id 444 - Saint Mary's College (US)
ATS platform: own website
Careers link: https://www.saintmarys.edu/hr

Reads posting URLs from school_id_444_job_postings.checkpoint (this
...
Writes school_job_info/school_id_444_job_info.csv. Checkpointed to
school_id_444_job_info.checkpoint next to this script -- kill-and-resume,
