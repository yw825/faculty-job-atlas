"""
Job info scraper for school_id 276 - Georgia Institute of Technology-Main Campus (US)
ATS platform: own website
Careers link: https://hr.gatech.edu/employment/careers

Reads posting URLs from school_id_276_job_postings.checkpoint (this
...
Writes school_job_info/school_id_276_job_info.csv. Checkpointed to
school_id_276_job_info.checkpoint next to this script -- kill-and-resume,
