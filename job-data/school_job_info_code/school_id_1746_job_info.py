"""
Job info scraper for school_id 1746 - Universidad Complutense de Madrid (Spain)
ATS platform: own website
Careers link: https://www.ucm.es/empleo-ucm
...
school's job_postings script). Edit it directly if Universidad Complutense de Madrid's posting pages
...
Reads posting URLs from school_id_1746_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1746_job_info.csv. Checkpointed to
school_id_1746_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://www.ucm.es/empleo-ucm'
