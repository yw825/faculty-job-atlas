"""
Job info scraper for school_id 799 - Mars Hill University (US)
ATS platform: own website
Careers link: https://jobs.appone.com/marshilluniversity

Reads posting URLs from school_id_799_job_postings.checkpoint (this
...
Writes school_job_info/school_id_799_job_info.csv. Checkpointed to
school_id_799_job_info.checkpoint next to this script -- kill-and-resume,
