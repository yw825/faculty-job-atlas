"""
Job info scraper for school_id 1702 - University College Cork (Ireland)
ATS platform: CoreHR
...
school's job_postings script). Edit it directly if University College Cork's posting pages
...
Reads posting URLs from school_id_1702_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1702_job_info.csv. Checkpointed to
school_id_1702_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://my.corehr.com/pls/uccrecruit/erq_search_version_4.start_search_with_params'
ATS_PLATFORM = 'CoreHR'
