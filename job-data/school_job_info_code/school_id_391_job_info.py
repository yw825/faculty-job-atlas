"""
Job info scraper for school_id 391 - Northwestern University (US)
ATS platform: own website
Careers link: https://careers.northwestern.edu

Reads posting URLs from school_id_391_job_postings.checkpoint (this
...
Writes school_job_info/school_id_391_job_info.csv. Checkpointed to
school_id_391_job_info.checkpoint next to this script -- kill-and-resume,
