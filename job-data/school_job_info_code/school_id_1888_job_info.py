"""
Job info scraper for school_id 1888 - Radboud University (Netherlands)
ATS platform: own website
Careers link: https://www.ru.nl/werken-bij/vacatures
...
school's job_postings script). Edit it directly if Radboud University's posting pages
...
Reads posting URLs from school_id_1888_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1888_job_info.csv. Checkpointed to
school_id_1888_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1888
SCHOOL_NAME = 'Radboud University'
CAREERS_LINK = 'https://www.ru.nl/werken-bij/vacatures'
