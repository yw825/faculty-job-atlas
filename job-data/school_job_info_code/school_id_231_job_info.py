"""
Job info scraper for school_id 231 - University of Florida (US)
ATS platform: own website
Careers link: https://jobs.ufl.edu/career-growth/professional-development/

Reads posting URLs from school_id_231_job_postings.checkpoint (this
...
Writes school_job_info/school_id_231_job_info.csv. Checkpointed to
school_id_231_job_info.checkpoint next to this script -- kill-and-resume,
