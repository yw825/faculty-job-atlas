"""
Job info scraper for school_id 612 - Husson University (US)
ATS platform: own website
Careers link: https://www.husson.edu/about/human-resources/index.html

Reads posting URLs from school_id_612_job_postings.checkpoint (this
...
Writes school_job_info/school_id_612_job_info.csv. Checkpointed to
school_id_612_job_info.checkpoint next to this script -- kill-and-resume,
