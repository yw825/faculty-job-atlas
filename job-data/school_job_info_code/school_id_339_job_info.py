"""
Job info scraper for school_id 339 - University of Dubuque (US)
ATS platform: own website
Careers link: https://www.dbq.edu/AboutUD/Employment/Jobs/

Reads posting URLs from school_id_339_job_postings.checkpoint (this
...
Writes school_job_info/school_id_339_job_info.csv. Checkpointed to
school_id_339_job_info.checkpoint next to this script -- kill-and-resume,
