"""
Job info scraper for school_id 865 - Stevens Institute of Technology (US)
ATS platform: Workday
Careers link: https://stevens.wd5.myworkdayjobs.com/External

Reads posting URLs from school_id_865_job_postings.checkpoint (this
...
Writes school_job_info/school_id_865_job_info.csv. Checkpointed to
school_id_865_job_info.checkpoint next to this script -- kill-and-resume,
