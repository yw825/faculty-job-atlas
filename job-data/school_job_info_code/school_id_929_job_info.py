"""
Job info scraper for school_id 929 - Villa Maria College (US)
ATS platform: own website
Careers link: https://www.villa.edu/about-us/employment-opportunities/employment-application/

Reads posting URLs from school_id_929_job_postings.checkpoint (this
...
Writes school_job_info/school_id_929_job_info.csv. Checkpointed to
school_id_929_job_info.checkpoint next to this script -- kill-and-resume,
