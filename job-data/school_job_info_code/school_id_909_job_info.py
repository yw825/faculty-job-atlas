"""
Job info scraper for school_id 909 - Daemen University (US)
ATS platform: own website
Careers link: https://www.daemen.edu/about/working-daemen/employment-opportunities

Reads posting URLs from school_id_909_job_postings.checkpoint (this
...
Writes school_job_info/school_id_909_job_info.csv. Checkpointed to
school_id_909_job_info.checkpoint next to this script -- kill-and-resume,
