"""
Job info scraper for school_id 379 - Northeastern Illinois University (US)
ATS platform: own website
Careers link: https://www.neiu.edu/about/working-here/employment-opportunities/faculty-employment-opportunities

Reads posting URLs from school_id_379_job_postings.checkpoint (this
...
Writes school_job_info/school_id_379_job_info.csv. Checkpointed to
school_id_379_job_info.checkpoint next to this script -- kill-and-resume,
