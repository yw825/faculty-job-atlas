"""
Job info scraper for school_id 491 - Georgetown College (US)
ATS platform: own website
Careers link: https://www.georgetowncollege.edu/careers-georgetown-college

Reads posting URLs from school_id_491_job_postings.checkpoint (this
...
Writes school_job_info/school_id_491_job_info.csv. Checkpointed to
school_id_491_job_info.checkpoint next to this script -- kill-and-resume,
