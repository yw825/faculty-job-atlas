"""
Job info scraper for school_id 1727 - Norwegian University of Science and Technology (Norway)
ATS platform: own website
Careers link: https://www.ntnu.edu/vacancies
...
school's job_postings script). Edit it directly if Norwegian University of Science and Technology's posting pages
...
Reads posting URLs from school_id_1727_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1727_job_info.csv. Checkpointed to
school_id_1727_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://www.ntnu.edu/vacancies'
