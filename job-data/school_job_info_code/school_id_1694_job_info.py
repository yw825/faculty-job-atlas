"""
Job info scraper for school_id 1694 - Athens University of Economics and Business (Greece)
...
school's job_postings script). Edit it directly if Athens University of Economics and Business's posting pages
...
Reads posting URLs from school_id_1694_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1694_job_info.csv. Checkpointed to
school_id_1694_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1694
SCHOOL_NAME = 'Athens University of Economics and Business'
