"""
Job info scraper for school_id 1087 - Rogers State University (US)
ATS platform: own website
Careers link: https://my.rsu.edu/ICS/RSU_Jobs/RSU_Employment_Opportunities.jnz

Reads posting URLs from school_id_1087_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1087_job_info.csv. Checkpointed to
school_id_1087_job_info.checkpoint next to this script -- kill-and-resume,
