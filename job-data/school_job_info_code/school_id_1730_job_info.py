"""
Job info scraper for school_id 1730 - University of Warsaw (Poland)
...
school's job_postings script). Edit it directly if University of Warsaw's posting pages
...
Writes school_job_info/school_id_1730_job_info.csv. Checkpointed to
school_id_1730_job_info.checkpoint next to this script -- kill-and-resume,
