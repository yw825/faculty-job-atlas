"""
Job info scraper for school_id 1504 - Saint Michael's College (US)
ATS platform: own website
Careers link: https://www.smcvt.edu/offices-and-services/human-resources/

Reads posting URLs from school_id_1504_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1504_job_info.csv. Checkpointed to
school_id_1504_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://www.smcvt.edu/offices-and-services/human-resources/'
