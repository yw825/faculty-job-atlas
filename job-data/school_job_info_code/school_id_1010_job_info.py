"""
Job info scraper for school_id 1010 - Le Moyne College (US)
ATS platform: Workday
Careers link: https://agilitas.wd503.myworkdayjobs.com/LMC

Reads posting URLs from school_id_1010_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1010_job_info.csv. Checkpointed to
school_id_1010_job_info.checkpoint next to this script -- kill-and-resume,
