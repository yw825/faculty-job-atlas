"""
Job info scraper for school_id 744 - Delta State University (US)
ATS platform: PeopleAdmin
Careers link: https://deltastate.peopleadmin.com/

Reads posting URLs from school_id_744_job_postings.checkpoint (this
...
Writes school_job_info/school_id_744_job_info.csv. Checkpointed to
school_id_744_job_info.checkpoint next to this script -- kill-and-resume,
