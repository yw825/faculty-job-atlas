"""
Job info scraper for school_id 496 - Bellarmine University (US)
ATS platform: own website
Careers link: https://bellarmine.interviewexchange.com/static/clients/459BMM1/index.jsp

Reads posting URLs from school_id_496_job_postings.checkpoint (this
...
Writes school_job_info/school_id_496_job_info.csv. Checkpointed to
school_id_496_job_info.checkpoint next to this script -- kill-and-resume,
