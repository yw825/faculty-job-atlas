"""
Job info scraper for school_id 636 - Wayne State University (US)
ATS platform: Cornerstone OnDemand
Careers link: https://waynetalent.csod.com/ux/ats/careersite/2/home?c=waynetalent

Reads posting URLs from school_id_636_job_postings.checkpoint (this
...
Writes school_job_info/school_id_636_job_info.csv. Checkpointed to
school_id_636_job_info.checkpoint next to this script -- kill-and-resume,
