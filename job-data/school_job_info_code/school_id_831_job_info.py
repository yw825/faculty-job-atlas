"""
Job info scraper for school_id 831 - Doane University (US)
ATS platform: PeopleAdmin
Careers link: https://doane.peopleadmin.com/postings/search

Reads posting URLs from school_id_831_job_postings.checkpoint (this
...
Writes school_job_info/school_id_831_job_info.csv. Checkpointed to
school_id_831_job_info.checkpoint next to this script -- kill-and-resume,
