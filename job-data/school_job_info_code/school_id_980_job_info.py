"""
Job info scraper for school_id 980 - SUNY Old Westbury (US)
ATS platform: own website
Careers link: https://oldwestbury.interviewexchange.com/static/clients/519OWM1/index.jsp

Reads posting URLs from school_id_980_job_postings.checkpoint (this
...
Writes school_job_info/school_id_980_job_info.csv. Checkpointed to
school_id_980_job_info.checkpoint next to this script -- kill-and-resume,
