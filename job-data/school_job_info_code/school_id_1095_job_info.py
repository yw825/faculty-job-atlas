"""
Job info scraper for school_id 1095 - Bacone College (US)
ATS platform: own website
Careers link: https://www.bacone.edu/job-openings/

Reads posting URLs from school_id_1095_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1095_job_info.csv. Checkpointed to
school_id_1095_job_info.checkpoint next to this script -- kill-and-resume,
