"""
Job info scraper for school_id 1667 - University of Copenhagen (Denmark)
...
school's job_postings script). Edit it directly if University of Copenhagen's posting pages
...
Reads posting URLs from school_id_1667_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1667_job_info.csv. Checkpointed to
school_id_1667_job_info.checkpoint next to this script -- kill-and-resume,
