"""
Job info scraper for school_id 1423 - Our Lady of the Lake University (US)
ATS platform: own website
Careers link: https://ollusa.interviewexchange.com/static/clients/485OLM1/index.jsp

Reads posting URLs from school_id_1423_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1423_job_info.csv. Checkpointed to
school_id_1423_job_info.checkpoint next to this script -- kill-and-resume,
