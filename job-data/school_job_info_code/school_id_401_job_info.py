"""
Job info scraper for school_id 401 - Monmouth College (US)
ATS platform: own website
Careers link: https://www.monmouthcollege.edu/offices/hr/employment-opportunities/

Reads posting URLs from school_id_401_job_postings.checkpoint (this
...
Writes school_job_info/school_id_401_job_info.csv. Checkpointed to
school_id_401_job_info.checkpoint next to this script -- kill-and-resume,
