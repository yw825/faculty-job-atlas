"""
Job info scraper for school_id 21 - Amridge University (US)
ATS platform: own website
Careers link: http://www.amridgeuniversity.edu/about/employment/

Reads posting URLs from school_id_21_job_postings.checkpoint (this
...
Writes school_job_info/school_id_21_job_info.csv. Checkpointed to
school_id_21_job_info.checkpoint next to this script -- kill-and-resume,
