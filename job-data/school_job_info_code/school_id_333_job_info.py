"""
Job info scraper for school_id 333 - Saint Ambrose University (US)
ATS platform: own website
Careers link: https://sau.edu/about-sau/employment/

Reads posting URLs from school_id_333_job_postings.checkpoint (this
...
Writes school_job_info/school_id_333_job_info.csv. Checkpointed to
school_id_333_job_info.checkpoint next to this script -- kill-and-resume,
