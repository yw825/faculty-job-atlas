...
school's job_postings script). Edit it directly if LUISS Guido Carli's posting pages
...
Writes school_job_info/school_id_1712_job_info.csv. Checkpointed to
school_id_1712_job_info.checkpoint next to this script -- kill-and-resume,
