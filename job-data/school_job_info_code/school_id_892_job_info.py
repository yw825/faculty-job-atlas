"""
Job info scraper for school_id 892 - Northern New Mexico College (US)
ATS platform: Workday
Careers link: https://chess.wd1.myworkdayjobs.com/nnmcjobs

Reads posting URLs from school_id_892_job_postings.checkpoint (this
...
Writes school_job_info/school_id_892_job_info.csv. Checkpointed to
school_id_892_job_info.checkpoint next to this script -- kill-and-resume,
