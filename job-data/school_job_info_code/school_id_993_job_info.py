"""
Job info scraper for school_id 993 - CUNY Queens College (US)
ATS platform: own website
Careers link: https://cuny.jobs/campus/queens-college/job-category/faculty/jobs/

Reads posting URLs from school_id_993_job_postings.checkpoint (this
...
Writes school_job_info/school_id_993_job_info.csv. Checkpointed to
school_id_993_job_info.checkpoint next to this script -- kill-and-resume,
