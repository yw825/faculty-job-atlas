"""
Job info scraper for school_id 918 - CUNY Medgar Evers College (US)
ATS platform: own website
Careers link: https://cuny.jobs/campus/medgar-evers-college/job-category/faculty/jobs/

Reads posting URLs from school_id_918_job_postings.checkpoint (this
...
Writes school_job_info/school_id_918_job_info.csv. Checkpointed to
school_id_918_job_info.checkpoint next to this script -- kill-and-resume,
