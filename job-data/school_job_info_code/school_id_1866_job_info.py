"""
Job info scraper for school_id 1866 - Singapore Polytechnic (Singapore)
ATS platform: own website
Careers link: https://jobs.careers.gov.sg/?a=Singapore+Polytechnic
...
school's job_postings script). Edit it directly if Singapore Polytechnic's posting pages
...
Reads posting URLs from school_id_1866_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1866_job_info.csv. Checkpointed to
school_id_1866_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1866
SCHOOL_NAME = 'Singapore Polytechnic'
CAREERS_LINK = 'https://jobs.careers.gov.sg/?a=Singapore+Polytechnic'
