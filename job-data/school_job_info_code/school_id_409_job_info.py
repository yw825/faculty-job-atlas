"""
Job info scraper for school_id 409 - Augustana College (US)
ATS platform: own website
Careers link: https://www.augustana.edu/about-us/offices/hr/employment/opportunities

Reads posting URLs from school_id_409_job_postings.checkpoint (this
...
Writes school_job_info/school_id_409_job_info.csv. Checkpointed to
school_id_409_job_info.checkpoint next to this script -- kill-and-resume,
