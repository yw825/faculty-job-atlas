"""
Job info scraper for school_id 804 - University of North Carolina at Pembroke (US)
ATS platform: own website
Careers link: https://jobs.uncp.edu/postings/search

Reads posting URLs from school_id_804_job_postings.checkpoint (this
...
Writes school_job_info/school_id_804_job_info.csv. Checkpointed to
school_id_804_job_info.checkpoint next to this script -- kill-and-resume,
