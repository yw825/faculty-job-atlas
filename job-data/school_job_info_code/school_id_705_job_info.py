"""
Job info scraper for school_id 705 - Columbia College (US)
ATS platform: own website
Careers link: https://www.ccis.edu/careers/jobs

Reads posting URLs from school_id_705_job_postings.checkpoint (this
...
Writes school_job_info/school_id_705_job_info.csv. Checkpointed to
school_id_705_job_info.checkpoint next to this script -- kill-and-resume,
