"""
Job info scraper for school_id 764 - Montana State University-Northern (US)
ATS platform: own website
Careers link: https://jobs.msun.edu/postings/2686

Reads posting URLs from school_id_764_job_postings.checkpoint (this
...
Writes school_job_info/school_id_764_job_info.csv. Checkpointed to
school_id_764_job_info.checkpoint next to this script -- kill-and-resume,
