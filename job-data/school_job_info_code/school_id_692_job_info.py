"""
Job info scraper for school_id 692 - Hamline University (US)
ATS platform: Workday
Careers link: https://hamline.wd5.myworkdayjobs.com/Faculty_Career_Site

Reads posting URLs from school_id_692_job_postings.checkpoint (this
...
Writes school_job_info/school_id_692_job_info.csv. Checkpointed to
school_id_692_job_info.checkpoint next to this script -- kill-and-resume,
