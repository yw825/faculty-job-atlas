"""
Job info scraper for school_id 1369 - Lamar University (US)
...
Reads posting URLs from school_id_1369_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1369_job_info.csv. Checkpointed to
school_id_1369_job_info.checkpoint next to this script -- kill-and-resume,
