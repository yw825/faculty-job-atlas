"""
Job info scraper for school_id 104 - Pacific States University (US)
ATS platform: own website
Careers link: https://psuca.edu/jobs-opportunities/

Reads posting URLs from school_id_104_job_postings.checkpoint (this
...
Writes school_job_info/school_id_104_job_info.csv. Checkpointed to
school_id_104_job_info.checkpoint next to this script -- kill-and-resume,
