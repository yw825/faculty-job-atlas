"""
Job info scraper for school_id 1753 - EPFL (Switzerland)
ATS platform: own website
Careers link: https://www.epfl.ch/about/working/working-at-epfl/job-openings/
...
school's job_postings script). Edit it directly if EPFL's posting pages
...
Reads posting URLs from school_id_1753_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1753_job_info.csv. Checkpointed to
school_id_1753_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1753
SCHOOL_NAME = 'EPFL'
CAREERS_LINK = 'https://www.epfl.ch/about/working/working-at-epfl/job-openings/'
