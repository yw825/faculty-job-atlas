"""
Job info scraper for school_id 1019 - Ohio Northern University (US)
ATS platform: Workday
Careers link: https://onu.wd501.myworkdayjobs.com/ONU

Reads posting URLs from school_id_1019_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1019_job_info.csv. Checkpointed to
school_id_1019_job_info.checkpoint next to this script -- kill-and-resume,
