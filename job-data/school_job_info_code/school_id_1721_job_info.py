"""
Job info scraper for school_id 1721 - Erasmus University Rotterdam (Netherlands)
ATS platform: own website
Careers link: https://www.eur.nl/en/working-at-eur/vacancies/overview
...
school's job_postings script). Edit it directly if Erasmus University Rotterdam's posting pages
...
Reads posting URLs from school_id_1721_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1721_job_info.csv. Checkpointed to
school_id_1721_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1721
SCHOOL_NAME = 'Erasmus University Rotterdam'
CAREERS_LINK = 'https://www.eur.nl/en/working-at-eur/vacancies/overview'
