"""
Job info scraper for school_id 152 - California State University-Monterey Bay (US)
ATS platform: own website
Careers link: https://careers.csumb.edu/en-us/filter/?search-keyword=&job-mail-subscribe-privacy=agree

Reads posting URLs from school_id_152_job_postings.checkpoint (this
...
Writes school_job_info/school_id_152_job_info.csv. Checkpointed to
school_id_152_job_info.checkpoint next to this script -- kill-and-resume,
