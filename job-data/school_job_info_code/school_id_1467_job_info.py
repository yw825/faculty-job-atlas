"""
Job info scraper for school_id 1467 - Ferrum College (US)
ATS platform: own website
Careers link: https://ferrumcollege.applytojob.com/apply

Reads posting URLs from school_id_1467_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1467_job_info.csv. Checkpointed to
school_id_1467_job_info.checkpoint next to this script -- kill-and-resume,
