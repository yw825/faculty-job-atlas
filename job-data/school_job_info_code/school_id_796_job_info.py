"""
Job info scraper for school_id 796 - High Point University (US)
ATS platform: Workday
Careers link: https://highpoint.wd503.myworkdayjobs.com/Highpoint-Faculty

Reads posting URLs from school_id_796_job_postings.checkpoint (this
...
Writes school_job_info/school_id_796_job_info.csv. Checkpointed to
school_id_796_job_info.checkpoint next to this script -- kill-and-resume,
