"""
Job info scraper for school_id 534 - Boston University (US)
ATS platform: own website
Careers link: https://jobs.silkroad.com/BU/External

Reads posting URLs from school_id_534_job_postings.checkpoint (this
...
Writes school_job_info/school_id_534_job_info.csv. Checkpointed to
school_id_534_job_info.checkpoint next to this script -- kill-and-resume,
