"""
Job info scraper for school_id 1079 - Antioch University (US)
ATS platform: own website
Careers link: https://www.antioch.edu/employment/

Reads posting URLs from school_id_1079_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1079_job_info.csv. Checkpointed to
school_id_1079_job_info.checkpoint next to this script -- kill-and-resume,
