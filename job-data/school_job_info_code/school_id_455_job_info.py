"""
Job info scraper for school_id 455 - Purdue University-Main Campus (US)
ATS platform: own website
Careers link: https://careers.purdue.edu/content/Job-Seeker/

Reads posting URLs from school_id_455_job_postings.checkpoint (this
...
Writes school_job_info/school_id_455_job_info.csv. Checkpointed to
school_id_455_job_info.checkpoint next to this script -- kill-and-resume,
