"""
Job info scraper for school_id 72 - California State University-Bakersfield (US)
...
Reads posting URLs from school_id_72_job_postings.checkpoint (this
...
Writes school_job_info/school_id_72_job_info.csv. Checkpointed to
school_id_72_job_info.checkpoint next to this script -- kill-and-resume,
