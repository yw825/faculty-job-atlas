...
school's job_postings script). Edit it directly if Nova School of Business and Economics's posting pages
...
Writes school_job_info/school_id_1732_job_info.csv. Checkpointed to
school_id_1732_job_info.checkpoint next to this script -- kill-and-resume,
