"""
Job info scraper for school_id 110 - California State University-Northridge (US)
ATS platform: PageUp
...
Reads posting URLs from school_id_110_job_postings.checkpoint (this
...
Writes school_job_info/school_id_110_job_info.csv. Checkpointed to
school_id_110_job_info.checkpoint next to this script -- kill-and-resume,
