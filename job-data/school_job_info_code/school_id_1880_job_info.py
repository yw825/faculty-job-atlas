"""
Job info scraper for school_id 1880 - Manchester Metropolitan University (United Kingdom)
ATS platform: own website
Careers link: https://manmetjobs.mmu.ac.uk/jobs/vacancy/find/results/
...
school's job_postings script). Edit it directly if Manchester Metropolitan University's posting pages
...
Reads posting URLs from school_id_1880_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1880_job_info.csv. Checkpointed to
school_id_1880_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1880
SCHOOL_NAME = 'Manchester Metropolitan University'
CAREERS_LINK = 'https://manmetjobs.mmu.ac.uk/jobs/vacancy/find/results/'
