"""
Job info scraper for school_id 1168 - Keystone College (US)
ATS platform: own website
Careers link: https://www.keystone.edu/jobs_at_keystone/

Reads posting URLs from school_id_1168_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1168_job_info.csv. Checkpointed to
school_id_1168_job_info.checkpoint next to this script -- kill-and-resume,
