"""
Job info scraper for school_id 680 - University of Minnesota-Twin Cities (US)
ATS platform: own website
Careers link: https://hr.umn.edu/jobs/Applicant-Support/Veteran-Employment-Guidance

Reads posting URLs from school_id_680_job_postings.checkpoint (this
...
Writes school_job_info/school_id_680_job_info.csv. Checkpointed to
school_id_680_job_info.checkpoint next to this script -- kill-and-resume,
