"""
Job info scraper for school_id 1649 - Université du Québec à Rimouski (Canada)
ATS platform: own website
Careers link: https://www.uqar.ca/en/the-institut-des-sciences-de-la-mer-of-the-universite-du-quebec-a-rimouski-ismer-uqar/opportunities/jobs-at-ismer-uqar/
...
school's job_postings script). Edit it directly if Université du Québec à Rimouski's posting pages
...
Reads posting URLs from school_id_1649_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1649_job_info.csv. Checkpointed to
school_id_1649_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1649
SCHOOL_NAME = 'Université du Québec à Rimouski'
CAREERS_LINK = 'https://www.uqar.ca/en/the-institut-des-sciences-de-la-mer-of-the-universite-du-quebec-a-rimouski-ismer-uqar/opportunities/jobs-at-ismer-uqar/'
