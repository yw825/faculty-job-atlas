"""
Job info scraper for school_id 331 - Coe College (US)
ATS platform: own website
Careers link: https://www.coe.edu/why-coe/discover-coe/human-resources/careers

Reads posting URLs from school_id_331_job_postings.checkpoint (this
...
Writes school_job_info/school_id_331_job_info.csv. Checkpointed to
school_id_331_job_info.checkpoint next to this script -- kill-and-resume,
