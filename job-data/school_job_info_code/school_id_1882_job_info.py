"""
Job info scraper for school_id 1882 - University of Sunderland (United Kingdom)
ATS platform: own website
Careers link: https://jobs.sunderland.ac.uk/vacancies.aspx?cat=all
...
school's job_postings script). Edit it directly if University of Sunderland's posting pages
...
Reads posting URLs from school_id_1882_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1882_job_info.csv. Checkpointed to
school_id_1882_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1882
SCHOOL_NAME = 'University of Sunderland'
CAREERS_LINK = 'https://jobs.sunderland.ac.uk/vacancies.aspx?cat=all'
