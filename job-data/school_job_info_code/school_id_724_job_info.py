"""
Job info scraper for school_id 724 - Park University (US)
ATS platform: Workday
Careers link: https://park.wd1.myworkdayjobs.com/ParkUniversityCareers

Reads posting URLs from school_id_724_job_postings.checkpoint (this
...
Writes school_job_info/school_id_724_job_info.csv. Checkpointed to
school_id_724_job_info.checkpoint next to this script -- kill-and-resume,
