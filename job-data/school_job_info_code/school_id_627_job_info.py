"""
Job info scraper for school_id 627 - Albion College (US)
ATS platform: own website
Careers link: https://apply.interfolio.com/9409/positions

Reads posting URLs from school_id_627_job_postings.checkpoint (this
...
Writes school_job_info/school_id_627_job_info.csv. Checkpointed to
school_id_627_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://apply.interfolio.com/9409/positions'
