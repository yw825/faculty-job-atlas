"""
Job info scraper for school_id 1443 - Utah State University (US)
ATS platform: iCIMS
Careers link: https://careers-usu.icims.com/

Reads posting URLs from school_id_1443_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1443_job_info.csv. Checkpointed to
school_id_1443_job_info.checkpoint next to this script -- kill-and-resume,
