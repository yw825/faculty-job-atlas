"""
Job info scraper for school_id 502 - Brescia University (US)
ATS platform: own website
Careers link: https://www.brescia.edu/employment/

Reads posting URLs from school_id_502_job_postings.checkpoint (this
...
Writes school_job_info/school_id_502_job_info.csv. Checkpointed to
school_id_502_job_info.checkpoint next to this script -- kill-and-resume,
