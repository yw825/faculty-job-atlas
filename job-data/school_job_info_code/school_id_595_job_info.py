"""
Job info scraper for school_id 595 - University of Maryland-Baltimore County (US)
ATS platform: own website
Careers link: https://facultyjobs.umbc.edu/cwfac/en-us/listing/

Reads posting URLs from school_id_595_job_postings.checkpoint (this
...
Writes school_job_info/school_id_595_job_info.csv. Checkpointed to
school_id_595_job_info.checkpoint next to this script -- kill-and-resume,
