"""
Job info scraper for school_id 1549 - Marquette University (US)
ATS platform: own website
Careers link: http://www.marquette.edu/hr/

Reads posting URLs from school_id_1549_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1549_job_info.csv. Checkpointed to
school_id_1549_job_info.checkpoint next to this script -- kill-and-resume,
