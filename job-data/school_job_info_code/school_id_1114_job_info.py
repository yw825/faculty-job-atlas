"""
Job info scraper for school_id 1114 - Western Oregon University (US)
ATS platform: own website
Careers link: https://wou.edu/hr/employment/jobs/

Reads posting URLs from school_id_1114_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1114_job_info.csv. Checkpointed to
school_id_1114_job_info.checkpoint next to this script -- kill-and-resume,
