"""
Job info scraper for school_id 940 - Farmingdale State College (US)
ATS platform: own website
Careers link: https://farmingdale.interviewexchange.com/static/clients/383FAM1/index.jsp

Reads posting URLs from school_id_940_job_postings.checkpoint (this
...
Writes school_job_info/school_id_940_job_info.csv. Checkpointed to
school_id_940_job_info.checkpoint next to this script -- kill-and-resume,
