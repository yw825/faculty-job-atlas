"""
Job info scraper for school_id 1119 - Reed College (US)
ATS platform: own website
Careers link: https://reed-college.breezy.hr/

Reads posting URLs from school_id_1119_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1119_job_info.csv. Checkpointed to
school_id_1119_job_info.checkpoint next to this script -- kill-and-resume,
