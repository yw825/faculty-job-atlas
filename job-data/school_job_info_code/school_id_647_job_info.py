"""
Job info scraper for school_id 647 - Michigan Technological University (US)
ATS platform: own website
Careers link: https://www.mtu.edu/career/on-campus-jobs/index.html

Reads posting URLs from school_id_647_job_postings.checkpoint (this
...
Writes school_job_info/school_id_647_job_info.csv. Checkpointed to
school_id_647_job_info.checkpoint next to this script -- kill-and-resume,
