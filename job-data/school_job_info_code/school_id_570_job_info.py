"""
Job info scraper for school_id 570 - Mount Holyoke College (US)
ATS platform: Workday
Careers link: https://mtholyoke.wd504.myworkdayjobs.com/External

Reads posting URLs from school_id_570_job_postings.checkpoint (this
...
Writes school_job_info/school_id_570_job_info.csv. Checkpointed to
school_id_570_job_info.checkpoint next to this script -- kill-and-resume,
