"""
Job info scraper for school_id 433 - Indiana University-Indianapolis (US)
ATS platform: own website
Careers link: https://indianapolis.iu.edu/academics/hands-on-learning/profiles-of-learning.html

Reads posting URLs from school_id_433_job_postings.checkpoint (this
...
Writes school_job_info/school_id_433_job_info.csv. Checkpointed to
school_id_433_job_info.checkpoint next to this script -- kill-and-resume,
