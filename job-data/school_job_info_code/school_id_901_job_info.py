"""
Job info scraper for school_id 901 - Nevada State University (US)
ATS platform: Workday
Careers link: https://nshe.wd1.myworkdayjobs.com/NSU-external

Reads posting URLs from school_id_901_job_postings.checkpoint (this
...
Writes school_job_info/school_id_901_job_info.csv. Checkpointed to
school_id_901_job_info.checkpoint next to this script -- kill-and-resume,
