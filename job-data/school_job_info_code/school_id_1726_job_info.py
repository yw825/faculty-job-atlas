"""
Job info scraper for school_id 1726 - University of Oslo (Norway)
ATS platform: own website
Careers link: https://www.uio.no/english/about/vacancies/academic/
...
school's job_postings script). Edit it directly if University of Oslo's posting pages
...
Reads posting URLs from school_id_1726_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1726_job_info.csv. Checkpointed to
school_id_1726_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1726
SCHOOL_NAME = 'University of Oslo'
CAREERS_LINK = 'https://www.uio.no/english/about/vacancies/academic/'
