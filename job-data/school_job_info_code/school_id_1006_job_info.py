"""
Job info scraper for school_id 1006 - St. Thomas Aquinas College (US)
ATS platform: own website
Careers link: https://stac.edu/offices/human-resources/employment-opportunities/faculty-positions/

Reads posting URLs from school_id_1006_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1006_job_info.csv. Checkpointed to
school_id_1006_job_info.checkpoint next to this script -- kill-and-resume,
