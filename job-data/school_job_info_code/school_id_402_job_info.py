"""
Job info scraper for school_id 402 - North Central College (US)
ATS platform: own website
Careers link: https://www.northcentralcollege.edu/academic-affairs/staff-openings

Reads posting URLs from school_id_402_job_postings.checkpoint (this
...
Writes school_job_info/school_id_402_job_info.csv. Checkpointed to
school_id_402_job_info.checkpoint next to this script -- kill-and-resume,
