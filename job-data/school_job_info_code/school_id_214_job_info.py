"""
Job info scraper for school_id 214 - University of Delaware (US)
ATS platform: own website
Careers link: https://www.udel.edu/apply/career-outcomes/

Reads posting URLs from school_id_214_job_postings.checkpoint (this
...
Writes school_job_info/school_id_214_job_info.csv. Checkpointed to
school_id_214_job_info.checkpoint next to this script -- kill-and-resume,
