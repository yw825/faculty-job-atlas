"""
Job info scraper for school_id 1835 - Hong Kong Chu Hai College (Hong Kong)
...
school's job_postings script). Edit it directly if Hong Kong Chu Hai College's posting pages
...
Reads posting URLs from school_id_1835_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1835_job_info.csv. Checkpointed to
school_id_1835_job_info.checkpoint next to this script -- kill-and-resume,
