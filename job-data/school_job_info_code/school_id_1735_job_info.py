"""
Job info scraper for school_id 1735 - Universidade do Porto (Portugal)
ATS platform: own website
Careers link: https://sigarra.up.pt/up/en/p/recrutamento
...
school's job_postings script). Edit it directly if Universidade do Porto's posting pages
...
Reads posting URLs from school_id_1735_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1735_job_info.csv. Checkpointed to
school_id_1735_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1735
SCHOOL_NAME = 'Universidade do Porto'
CAREERS_LINK = 'https://sigarra.up.pt/up/en/p/recrutamento'
