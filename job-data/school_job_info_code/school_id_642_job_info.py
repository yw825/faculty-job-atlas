"""
Job info scraper for school_id 642 - Cornerstone University (US)
ATS platform: own website
Careers link: https://www.cornerstone.edu/about/employment/employment-applications/

Reads posting URLs from school_id_642_job_postings.checkpoint (this
...
Writes school_job_info/school_id_642_job_info.csv. Checkpointed to
school_id_642_job_info.checkpoint next to this script -- kill-and-resume,
