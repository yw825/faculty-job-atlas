"""
Job info scraper for school_id 946 - Colgate University (US)
ATS platform: own website
Careers link: https://www.colgate.edu/success-after-colgate

Reads posting URLs from school_id_946_job_postings.checkpoint (this
...
Writes school_job_info/school_id_946_job_info.csv. Checkpointed to
school_id_946_job_info.checkpoint next to this script -- kill-and-resume,
