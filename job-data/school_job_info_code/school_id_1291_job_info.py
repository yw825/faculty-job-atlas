"""
Job info scraper for school_id 1291 - Francis Marion University (US)
ATS platform: own website
Careers link: https://www.fmarion.edu/availablepositions/

Reads posting URLs from school_id_1291_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1291_job_info.csv. Checkpointed to
school_id_1291_job_info.checkpoint next to this script -- kill-and-resume,
