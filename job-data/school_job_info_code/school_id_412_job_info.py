"""
Job info scraper for school_id 412 - University of Illinois Springfield (US)
ATS platform: Cornerstone OnDemand
Careers link: https://uis.csod.com/ux/ats/careersite/1/home?c=uis

Reads posting URLs from school_id_412_job_postings.checkpoint (this
...
Writes school_job_info/school_id_412_job_info.csv. Checkpointed to
school_id_412_job_info.checkpoint next to this script -- kill-and-resume,
