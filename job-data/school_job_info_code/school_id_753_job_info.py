"""
Job info scraper for school_id 753 - Millsaps College (US)
ATS platform: own website
Careers link: https://millsaps.edu/work-at-millsaps/

Reads posting URLs from school_id_753_job_postings.checkpoint (this
...
Writes school_job_info/school_id_753_job_info.csv. Checkpointed to
school_id_753_job_info.checkpoint next to this script -- kill-and-resume,
