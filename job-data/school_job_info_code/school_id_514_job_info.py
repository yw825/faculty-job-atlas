"""
Job info scraper for school_id 514 - University of Louisiana at Lafayette (US)
ATS platform: Cornerstone OnDemand
Careers link: https://louisiana.csod.com/ats/careersite/search.aspx?site=1&c=louisiana

Reads posting URLs from school_id_514_job_postings.checkpoint (this
...
Writes school_job_info/school_id_514_job_info.csv. Checkpointed to
school_id_514_job_info.checkpoint next to this script -- kill-and-resume,
