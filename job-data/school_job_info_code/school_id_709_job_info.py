"""
Job info scraper for school_id 709 - Westminster College (US)
...
Reads posting URLs from school_id_709_job_postings.checkpoint (this
...
Writes school_job_info/school_id_709_job_info.csv. Checkpointed to
school_id_709_job_info.checkpoint next to this script -- kill-and-resume,
