"""
Job info scraper for school_id 1743 - Universitat de Barcelona (Spain)
ATS platform: own website
Careers link: https://www.academicjobs.com/universitat-de-barcelona-jobs
...
school's job_postings script). Edit it directly if Universitat de Barcelona's posting pages
...
Reads posting URLs from school_id_1743_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1743_job_info.csv. Checkpointed to
school_id_1743_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1743
SCHOOL_NAME = 'Universitat de Barcelona'
CAREERS_LINK = 'https://www.academicjobs.com/universitat-de-barcelona-jobs'
