"""
Job info scraper for school_id 195 - University of Connecticut (US)
ATS platform: own website
Careers link: https://jobs.uconn.edu/

Reads posting URLs from school_id_195_job_postings.checkpoint (this
...
Writes school_job_info/school_id_195_job_info.csv. Checkpointed to
school_id_195_job_info.checkpoint next to this script -- kill-and-resume,
