"""
Job info scraper for school_id 1736 - Bucharest University of Economic Studies (Romania)
ATS platform: own website
Careers link: https://resurseumane.ase.ro/
...
school's job_postings script). Edit it directly if Bucharest University of Economic Studies's posting pages
...
Reads posting URLs from school_id_1736_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1736_job_info.csv. Checkpointed to
school_id_1736_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1736
SCHOOL_NAME = 'Bucharest University of Economic Studies'
CAREERS_LINK = 'https://resurseumane.ase.ro/'
