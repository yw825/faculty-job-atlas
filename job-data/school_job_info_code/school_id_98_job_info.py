"""
Job info scraper for school_id 98 - California State University-Long Beach (US)
...
Reads posting URLs from school_id_98_job_postings.checkpoint (this
...
Writes school_job_info/school_id_98_job_info.csv. Checkpointed to
school_id_98_job_info.checkpoint next to this script -- kill-and-resume,
