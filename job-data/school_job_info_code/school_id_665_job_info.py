"""
Job info scraper for school_id 665 - Eastern Michigan University (US)
ATS platform: PageUp
Careers link: https://secure.dc4.pageuppeople.com/apply/1092/aw/applicationForm/default.asp

Reads posting URLs from school_id_665_job_postings.checkpoint (this
...
Writes school_job_info/school_id_665_job_info.csv. Checkpointed to
school_id_665_job_info.checkpoint next to this script -- kill-and-resume,
