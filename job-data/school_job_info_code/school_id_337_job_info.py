"""
Job info scraper for school_id 337 - Clarke University (US)
ATS platform: own website
Careers link: https://clarke.applicantpool.com/jobs/

Reads posting URLs from school_id_337_job_postings.checkpoint (this
...
Writes school_job_info/school_id_337_job_info.csv. Checkpointed to
school_id_337_job_info.checkpoint next to this script -- kill-and-resume,
