"""
Job info scraper for school_id 857 - Franklin Pierce University (US)
ATS platform: own website
Careers link: https://franklinpierce.edu/paths

Reads posting URLs from school_id_857_job_postings.checkpoint (this
...
Writes school_job_info/school_id_857_job_info.csv. Checkpointed to
school_id_857_job_info.checkpoint next to this script -- kill-and-resume,
