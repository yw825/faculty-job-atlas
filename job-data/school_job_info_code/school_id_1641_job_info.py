"""
Job info scraper for school_id 1641 - McGill University (Canada)
ATS platform: Workday
Careers link: https://mcgill.wd3.myworkdayjobs.com/mcgill_careers
...
school's job_postings script). Edit it directly if McGill University's posting pages
...
Reads posting URLs from school_id_1641_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1641_job_info.csv. Checkpointed to
school_id_1641_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://mcgill.wd3.myworkdayjobs.com/mcgill_careers'
