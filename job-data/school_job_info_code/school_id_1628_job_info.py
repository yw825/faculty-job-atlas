"""
Job info scraper for school_id 1628 - Brock University (Canada)
ATS platform: Workday
Careers link: https://brocku.wd3.myworkdayjobs.com/brocku_careers
...
school's job_postings script). Edit it directly if Brock University's posting pages
...
Reads posting URLs from school_id_1628_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1628_job_info.csv. Checkpointed to
school_id_1628_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://brocku.wd3.myworkdayjobs.com/brocku_careers'
