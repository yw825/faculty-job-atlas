"""
Job info scraper for school_id 5 - Auburn University (US)
ATS platform: own website
Careers link: https://jobs.auburn.edu/auburn-careers-home/jobs?tags2=Faculty&page=1

Reads posting URLs from school_id_5_job_postings.checkpoint (this
...
Writes school_job_info/school_id_5_job_info.csv. Checkpointed to
school_id_5_job_info.checkpoint next to this script -- kill-and-resume,
