"""
Job info scraper for school_id 553 - Stonehill College (US)
ATS platform: own website
Careers link: https://jobs.stonehill.edu/hr/sessions/new

Reads posting URLs from school_id_553_job_postings.checkpoint (this
...
Writes school_job_info/school_id_553_job_info.csv. Checkpointed to
school_id_553_job_info.checkpoint next to this script -- kill-and-resume,
