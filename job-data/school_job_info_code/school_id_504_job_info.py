"""
Job info scraper for school_id 504 - University of Pikeville (US)
ATS platform: own website
Careers link: https://www.upike.edu/offices/human-resources/careers/

Reads posting URLs from school_id_504_job_postings.checkpoint (this
...
Writes school_job_info/school_id_504_job_info.csv. Checkpointed to
school_id_504_job_info.checkpoint next to this script -- kill-and-resume,
