...
school's job_postings script). Edit it directly if École des Hautes Études Commerciales (HEC Montréal)'s posting pages
...
Reads posting URLs from school_id_1646_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1646_job_info.csv. Checkpointed to
school_id_1646_job_info.checkpoint next to this script -- kill-and-resume,
