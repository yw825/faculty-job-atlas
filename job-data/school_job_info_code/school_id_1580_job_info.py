"""
Job info scraper for school_id 1580 - Shepherd University (US)
ATS platform: PeopleAdmin
Careers link: https://jobs-shepherd.peopleadmin.com/

Reads posting URLs from school_id_1580_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1580_job_info.csv. Checkpointed to
school_id_1580_job_info.checkpoint next to this script -- kill-and-resume,
