"""
Job info scraper for school_id 1527 - Heritage University (US)
ATS platform: own website
Careers link: https://heritage.edu/faculty-staff/human-resources/

Reads posting URLs from school_id_1527_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1527_job_info.csv. Checkpointed to
school_id_1527_job_info.checkpoint next to this script -- kill-and-resume,
