"""
Job info scraper for school_id 1170 - Cairn University-Langhorne (US)
ATS platform: own website
Careers link: https://cairn.edu/hr/jobs/

Reads posting URLs from school_id_1170_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1170_job_info.csv. Checkpointed to
school_id_1170_job_info.checkpoint next to this script -- kill-and-resume,
