"""
Job info scraper for school_id 832 - Midland University (US)
ATS platform: own website
Careers link: https://www.midlandu.edu/about/careers/

Reads posting URLs from school_id_832_job_postings.checkpoint (this
...
Writes school_job_info/school_id_832_job_info.csv. Checkpointed to
school_id_832_job_info.checkpoint next to this script -- kill-and-resume,
