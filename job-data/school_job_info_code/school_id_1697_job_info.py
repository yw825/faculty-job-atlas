"""
Job info scraper for school_id 1697 - Aristotle University of Thessaloniki (Greece)
...
school's job_postings script). Edit it directly if Aristotle University of Thessaloniki's posting pages
...
Reads posting URLs from school_id_1697_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1697_job_info.csv. Checkpointed to
school_id_1697_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1697
SCHOOL_NAME = 'Aristotle University of Thessaloniki'
