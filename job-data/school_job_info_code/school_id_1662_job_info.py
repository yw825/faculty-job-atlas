"""
Job info scraper for school_id 1662 - Ghent University (Belgium)
ATS platform: own website
Careers link: https://jobs.ugent.be/go/Professoren/8808802/
...
school's job_postings script). Edit it directly if Ghent University's posting pages
...
Reads posting URLs from school_id_1662_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1662_job_info.csv. Checkpointed to
school_id_1662_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1662
SCHOOL_NAME = 'Ghent University'
CAREERS_LINK = 'https://jobs.ugent.be/go/Professoren/8808802/'
