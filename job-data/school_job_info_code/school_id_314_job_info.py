"""
Job info scraper for school_id 314 - Abraham Baldwin Agricultural College (US)
ATS platform: own website
Careers link: https://www.abac.edu/about/administration/human-resources.html

Reads posting URLs from school_id_314_job_postings.checkpoint (this
...
Writes school_job_info/school_id_314_job_info.csv. Checkpointed to
school_id_314_job_info.checkpoint next to this script -- kill-and-resume,
