"""
Job info scraper for school_id 1 - Alaska Pacific University (US)
ATS platform: own website
Careers link: https://www.alaskapacific.edu/about/employment/#openings

Reads posting URLs from school_id_1_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1_job_info.csv. Checkpointed to
school_id_1_job_info.checkpoint next to this script -- kill-and-resume,
