"""
Job info scraper for school_id 1000 - University of Rochester (US)
ATS platform: own website
Careers link: https://www.rochester.edu/human-resources/careers/

Reads posting URLs from school_id_1000_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1000_job_info.csv. Checkpointed to
school_id_1000_job_info.checkpoint next to this script -- kill-and-resume,
