"""
Job info scraper for school_id 224 - Embry-Riddle Aeronautical University-Daytona Beach (US)
ATS platform: Workday
Careers link: https://embryriddle.wd1.myworkdayjobs.com/External

Reads posting URLs from school_id_224_job_postings.checkpoint (this
...
Writes school_job_info/school_id_224_job_info.csv. Checkpointed to
school_id_224_job_info.checkpoint next to this script -- kill-and-resume,
