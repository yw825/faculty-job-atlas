"""
Job info scraper for school_id 272 - University of Georgia (US)
...
Reads posting URLs from school_id_272_job_postings.checkpoint (this
...
Writes school_job_info/school_id_272_job_info.csv. Checkpointed to
school_id_272_job_info.checkpoint next to this script -- kill-and-resume,
