"""
Job info scraper for school_id 1602 - University of Winnipeg (Canada)
ATS platform: Avanti
...
school's job_postings script). Edit it directly if University of Winnipeg's posting pages
...
Reads posting URLs from school_id_1602_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1602_job_info.csv. Checkpointed to
school_id_1602_job_info.checkpoint next to this script -- kill-and-resume,
