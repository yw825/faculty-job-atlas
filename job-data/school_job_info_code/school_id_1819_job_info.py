"""
Job info scraper for school_id 1819 - Curtin University (Australia)
ATS platform: own website
Careers link: https://staff.curtin.edu.au/job-vacancies/
...
school's job_postings script). Edit it directly if Curtin University's posting pages
...
Reads posting URLs from school_id_1819_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1819_job_info.csv. Checkpointed to
school_id_1819_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://staff.curtin.edu.au/job-vacancies/'
