"""
Job info scraper for school_id 1686 - Humboldt University of Berlin (Germany)
...
school's job_postings script). Edit it directly if Humboldt University of Berlin's posting pages
...
Reads posting URLs from school_id_1686_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1686_job_info.csv. Checkpointed to
school_id_1686_job_info.checkpoint next to this script -- kill-and-resume,
