"""
Job info scraper for school_id 332 - Mount Mercy University (US)
ATS platform: own website
Careers link: https://www.mtmercy.edu/careers/index.php

Reads posting URLs from school_id_332_job_postings.checkpoint (this
...
Writes school_job_info/school_id_332_job_info.csv. Checkpointed to
school_id_332_job_info.checkpoint next to this script -- kill-and-resume,
