"""
Job info scraper for school_id 1861 - Singapore University of Social Sciences (Singapore)
ATS platform: own website
Careers link: https://careers.suss.edu.sg/go/Academic-Appointments/4634610/
...
school's job_postings script). Edit it directly if Singapore University of Social Sciences's posting pages
...
Reads posting URLs from school_id_1861_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1861_job_info.csv. Checkpointed to
school_id_1861_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://careers.suss.edu.sg/go/Academic-Appointments/4634610/'
