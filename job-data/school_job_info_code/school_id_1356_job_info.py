"""
Job info scraper for school_id 1356 - Vanderbilt University (US)
ATS platform: own website
Careers link: https://www.vanderbilt.edu/work-at-vanderbilt/

Reads posting URLs from school_id_1356_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1356_job_info.csv. Checkpointed to
school_id_1356_job_info.checkpoint next to this script -- kill-and-resume,
