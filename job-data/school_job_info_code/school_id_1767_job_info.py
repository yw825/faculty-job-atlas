"""
Job info scraper for school_id 1767 - University of Edinburgh (United Kingdom)
ATS platform: own website
Careers link: https://www.jobs.ac.uk/search/?keywords=University%20of%20Edinburgh
...
school's job_postings script). Edit it directly if University of Edinburgh's posting pages
...
Reads posting URLs from school_id_1767_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1767_job_info.csv. Checkpointed to
school_id_1767_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://www.jobs.ac.uk/search/?keywords=University%20of%20Edinburgh'
