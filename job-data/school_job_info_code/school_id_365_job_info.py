"""
Job info scraper for school_id 365 - Illinois Wesleyan University (US)
ATS platform: own website
Careers link: https://www.iwu.edu/human-resources/job-openings/

Reads posting URLs from school_id_365_job_postings.checkpoint (this
...
Writes school_job_info/school_id_365_job_info.csv. Checkpointed to
school_id_365_job_info.checkpoint next to this script -- kill-and-resume,
