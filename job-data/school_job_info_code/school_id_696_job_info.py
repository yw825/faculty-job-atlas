"""
Job info scraper for school_id 696 - University of Northwestern-St Paul (US)
ATS platform: own website
Careers link: https://jobs.unwsp.edu/jobs/search/search-page

Reads posting URLs from school_id_696_job_postings.checkpoint (this
...
Writes school_job_info/school_id_696_job_info.csv. Checkpointed to
school_id_696_job_info.checkpoint next to this script -- kill-and-resume,
