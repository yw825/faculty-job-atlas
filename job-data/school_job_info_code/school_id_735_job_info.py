"""
Job info scraper for school_id 735 - Washington University in St Louis (US)
ATS platform: Workday
Careers link: https://wustl.wd1.myworkdayjobs.com/External

Reads posting URLs from school_id_735_job_postings.checkpoint (this
...
Writes school_job_info/school_id_735_job_info.csv. Checkpointed to
school_id_735_job_info.checkpoint next to this script -- kill-and-resume,
