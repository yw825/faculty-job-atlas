"""
Job info scraper for school_id 1302 - Converse University (US)
ATS platform: own website
Careers link: https://converse.isolvedhire.com/jobs/

Reads posting URLs from school_id_1302_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1302_job_info.csv. Checkpointed to
school_id_1302_job_info.checkpoint next to this script -- kill-and-resume,
