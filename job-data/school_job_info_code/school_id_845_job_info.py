"""
Job info scraper for school_id 845 - York University (US)
ATS platform: own website
Careers link: https://www.york.edu/about/employment.php#faculty

Reads posting URLs from school_id_845_job_postings.checkpoint (this
...
Writes school_job_info/school_id_845_job_info.csv. Checkpointed to
school_id_845_job_info.checkpoint next to this script -- kill-and-resume,
