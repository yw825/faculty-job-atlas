"""
Job info scraper for school_id 338 - Loras College (US)
ATS platform: own website
Careers link: https://loras.applicantpool.com/jobs/

Reads posting URLs from school_id_338_job_postings.checkpoint (this
...
Writes school_job_info/school_id_338_job_info.csv. Checkpointed to
school_id_338_job_info.checkpoint next to this script -- kill-and-resume,
