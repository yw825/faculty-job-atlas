"""
Job info scraper for school_id 493 - Northern Kentucky University (US)
ATS platform: Workday
Careers link: https://nku.wd108.myworkdayjobs.com/NKU_External

Reads posting URLs from school_id_493_job_postings.checkpoint (this
...
Writes school_job_info/school_id_493_job_info.csv. Checkpointed to
school_id_493_job_info.checkpoint next to this script -- kill-and-resume,
