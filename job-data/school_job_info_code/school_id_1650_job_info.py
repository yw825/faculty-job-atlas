"""
Job info scraper for school_id 1650 - Université du Québec en Abitibi-Témiscamingue (Canada)
...
school's job_postings script). Edit it directly if Université du Québec en Abitibi-Témiscamingue's posting pages
...
Reads posting URLs from school_id_1650_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1650_job_info.csv. Checkpointed to
school_id_1650_job_info.checkpoint next to this script -- kill-and-resume,
