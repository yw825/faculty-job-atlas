"""
Job info scraper for school_id 1883 - University of Limerick (Ireland)
ATS platform: CoreHR
Careers link: https://my.corehr.com/pls/esbsheulrecruit/erq_search_version_4.start_search_with_params
...
school's job_postings script). Edit it directly if University of Limerick's posting pages
...
Reads posting URLs from school_id_1883_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1883_job_info.csv. Checkpointed to
school_id_1883_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://my.corehr.com/pls/esbsheulrecruit/erq_search_version_4.start_search_with_params'
ATS_PLATFORM = 'CoreHR'
