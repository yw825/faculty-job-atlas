"""
Job info scraper for school_id 548 - Lesley University (US)
ATS platform: own website
Careers link: https://lesley.edu/my-organizations-goals/recruit-talent/priority-job-matching-program

Reads posting URLs from school_id_548_job_postings.checkpoint (this
...
Writes school_job_info/school_id_548_job_info.csv. Checkpointed to
school_id_548_job_info.checkpoint next to this script -- kill-and-resume,
