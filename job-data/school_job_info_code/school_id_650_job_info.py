"""
Job info scraper for school_id 650 - Western Michigan University (US)
ATS platform: own website
Careers link: https://wmich.edu/career/jobfairprep

Reads posting URLs from school_id_650_job_postings.checkpoint (this
...
Writes school_job_info/school_id_650_job_info.csv. Checkpointed to
school_id_650_job_info.checkpoint next to this script -- kill-and-resume,
