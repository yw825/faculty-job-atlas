"""
Job info scraper for school_id 1899 - Frankfurt School of Finance & Management (Germany)
Careers link: https://jobs.frankfurt-school.de/

Reads posting URLs from school_id_1899_job_postings.checkpoint and writes
school_job_info/school_id_1899_job_info.csv.
"""
import os
import sys
