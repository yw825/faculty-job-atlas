"""
Job info scraper for school_id 82 - Pomona College (US)
ATS platform: own website
Careers link: https://www.pomona.edu/administration/academic-dean/faculty-jobs

Reads posting URLs from school_id_82_job_postings.checkpoint (this
...
Writes school_job_info/school_id_82_job_info.csv. Checkpointed to
school_id_82_job_info.checkpoint next to this script -- kill-and-resume,
