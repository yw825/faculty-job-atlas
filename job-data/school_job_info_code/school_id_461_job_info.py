"""
Job info scraper for school_id 461 - Barclay College (US)
ATS platform: own website
Careers link: https://www.barclaycollege.edu/jobs/

Reads posting URLs from school_id_461_job_postings.checkpoint (this
...
Writes school_job_info/school_id_461_job_info.csv. Checkpointed to
school_id_461_job_info.checkpoint next to this script -- kill-and-resume,
