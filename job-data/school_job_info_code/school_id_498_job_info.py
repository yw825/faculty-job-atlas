"""
Job info scraper for school_id 498 - University of Louisville (US)
ATS platform: own website
Careers link: https://cardinalcareers-csm.symplicity.com/

Reads posting URLs from school_id_498_job_postings.checkpoint (this
...
Writes school_job_info/school_id_498_job_info.csv. Checkpointed to
school_id_498_job_info.checkpoint next to this script -- kill-and-resume,
