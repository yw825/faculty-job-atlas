"""
Job info scraper for school_id 378 - North Park University (US)
ATS platform: own website
Careers link: https://apply.workable.com/north-park-university/

Reads posting URLs from school_id_378_job_postings.checkpoint (this
...
Writes school_job_info/school_id_378_job_info.csv. Checkpointed to
school_id_378_job_info.checkpoint next to this script -- kill-and-resume,
