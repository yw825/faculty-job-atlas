"""
Job info scraper for school_id 954 - State University of New York at New Paltz (US)
ATS platform: own website
Careers link: https://www.newpaltz.edu/hr/displayjobs.php?type=Faculty

Reads posting URLs from school_id_954_job_postings.checkpoint (this
...
Writes school_job_info/school_id_954_job_info.csv. Checkpointed to
school_id_954_job_info.checkpoint next to this script -- kill-and-resume,
