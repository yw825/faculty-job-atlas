"""
Job info scraper for school_id 103 - Occidental College (US)
ATS platform: own website
Careers link: https://www.oxy.edu/working-oxy/faculty-positions

Reads posting URLs from school_id_103_job_postings.checkpoint (this
...
Writes school_job_info/school_id_103_job_info.csv. Checkpointed to
school_id_103_job_info.checkpoint next to this script -- kill-and-resume,
