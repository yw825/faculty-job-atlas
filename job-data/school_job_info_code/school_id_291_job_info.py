"""
Job info scraper for school_id 291 - Agnes Scott College (US)
ATS platform: own website
Careers link: https://www.agnesscott.edu/careers/faculty-openings/index.html

Reads posting URLs from school_id_291_job_postings.checkpoint (this
...
Writes school_job_info/school_id_291_job_info.csv. Checkpointed to
school_id_291_job_info.checkpoint next to this script -- kill-and-resume,
