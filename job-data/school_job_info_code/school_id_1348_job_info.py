"""
Job info scraper for school_id 1348 - University of Memphis (US)
ATS platform: own website
Careers link: https://workforum.memphis.edu/

Reads posting URLs from school_id_1348_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1348_job_info.csv. Checkpointed to
school_id_1348_job_info.checkpoint next to this script -- kill-and-resume,
