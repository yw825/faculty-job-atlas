"""
Job info scraper for school_id 1757 - University of Zurich (Switzerland)
ATS platform: own website
Careers link: https://uzhcareer.ch/de/jobs/
...
school's job_postings script). Edit it directly if University of Zurich's posting pages
...
Reads posting URLs from school_id_1757_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1757_job_info.csv. Checkpointed to
school_id_1757_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://uzhcareer.ch/de/jobs/'
