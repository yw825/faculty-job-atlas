"""
Job info scraper for school_id 1398 - University of Houston-Clear Lake (US)
ATS platform: own website
Careers link: https://careers.uh.edu/jobs/search/uhcl-postings

Reads posting URLs from school_id_1398_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1398_job_info.csv. Checkpointed to
school_id_1398_job_info.checkpoint next to this script -- kill-and-resume,
