"""
Job info scraper for school_id 708 - Central Methodist University-College of Liberal Arts and Sciences (US)
ATS platform: own website
Careers link: https://centralmethodist.edu/about/offices/human-resources/jobs-fayette/index.html

Reads posting URLs from school_id_708_job_postings.checkpoint (this
...
Writes school_job_info/school_id_708_job_info.csv. Checkpointed to
school_id_708_job_info.checkpoint next to this script -- kill-and-resume,
