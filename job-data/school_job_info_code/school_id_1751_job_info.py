"""
Job info scraper for school_id 1751 - Uppsala University (Sweden)
ATS platform: own website
Careers link: https://www.uu.se/en/about-uu/join-us/jobs-and-vacancies
...
school's job_postings script). Edit it directly if Uppsala University's posting pages
...
Reads posting URLs from school_id_1751_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1751_job_info.csv. Checkpointed to
school_id_1751_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1751
SCHOOL_NAME = 'Uppsala University'
CAREERS_LINK = 'https://www.uu.se/en/about-uu/join-us/jobs-and-vacancies'
