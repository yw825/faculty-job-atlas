"""
Job info scraper for school_id 772 - Brevard College (US)
ATS platform: own website
Careers link: https://brevard.edu/employment-opportunities/

Reads posting URLs from school_id_772_job_postings.checkpoint (this
...
Writes school_job_info/school_id_772_job_info.csv. Checkpointed to
school_id_772_job_info.checkpoint next to this script -- kill-and-resume,
