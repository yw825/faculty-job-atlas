"""
Job info scraper for school_id 707 - University of Missouri-Columbia (US)
ATS platform: own website
Careers link: https://www.umsystem.edu/ums/hr/income

Reads posting URLs from school_id_707_job_postings.checkpoint (this
...
Writes school_job_info/school_id_707_job_info.csv. Checkpointed to
school_id_707_job_info.checkpoint next to this script -- kill-and-resume,
