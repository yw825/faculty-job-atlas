"""
Job info scraper for school_id 936 - SUNY College of Technology at Delhi (US)
ATS platform: own website
Careers link: https://delhi.interviewexchange.com/static/clients/409SDM1/index.jsp

Reads posting URLs from school_id_936_job_postings.checkpoint (this
...
Writes school_job_info/school_id_936_job_info.csv. Checkpointed to
school_id_936_job_info.checkpoint next to this script -- kill-and-resume,
