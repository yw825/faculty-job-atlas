"""
Job info scraper for school_id 359 - Lewis-Clark State College (US)
ATS platform: own website
Careers link: https://www.lcsc.edu/career-technical-education

Reads posting URLs from school_id_359_job_postings.checkpoint (this
...
Writes school_job_info/school_id_359_job_info.csv. Checkpointed to
school_id_359_job_info.checkpoint next to this script -- kill-and-resume,
