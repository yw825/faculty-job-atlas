"""
Job info scraper for school_id 579 - Westfield State University (US)
ATS platform: own website
Careers link: https://careers.westfield.ma.edu/labor-market-insights/

Reads posting URLs from school_id_579_job_postings.checkpoint (this
...
Writes school_job_info/school_id_579_job_info.csv. Checkpointed to
school_id_579_job_info.checkpoint next to this script -- kill-and-resume,
