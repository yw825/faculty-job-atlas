"""
Job info scraper for school_id 1047 - Ohio Wesleyan University (US)
ATS platform: own website
Careers link: https://careers.owu.edu/ambassadors/

Reads posting URLs from school_id_1047_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1047_job_info.csv. Checkpointed to
school_id_1047_job_info.checkpoint next to this script -- kill-and-resume,
