"""
Job info scraper for school_id 63 - Arizona State University Campus Immersion (US)
ATS platform: own website
Careers link: https://facultypositions.asu.edu/#/api/Home/_InterfolioPostings

Reads posting URLs from school_id_63_job_postings.checkpoint (this
...
Writes school_job_info/school_id_63_job_info.csv. Checkpointed to
school_id_63_job_info.checkpoint next to this script -- kill-and-resume,
