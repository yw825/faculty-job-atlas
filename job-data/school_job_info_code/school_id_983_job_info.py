"""
Job info scraper for school_id 983 - Dominican University New York (US)
ATS platform: own website
Careers link: https://www.duny.edu/category/employment-opportunities/

Reads posting URLs from school_id_983_job_postings.checkpoint (this
...
Writes school_job_info/school_id_983_job_info.csv. Checkpointed to
school_id_983_job_info.checkpoint next to this script -- kill-and-resume,
