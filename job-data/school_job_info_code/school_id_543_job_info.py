"""
Job info scraper for school_id 543 - Wentworth Institute of Technology (US)
ATS platform: Workday
Careers link: https://wit.wd1.myworkdayjobs.com/en-US/WIT/

Reads posting URLs from school_id_543_job_postings.checkpoint (this
...
Writes school_job_info/school_id_543_job_info.csv. Checkpointed to
school_id_543_job_info.checkpoint next to this script -- kill-and-resume,
