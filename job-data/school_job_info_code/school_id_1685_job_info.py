"""
Job info scraper for school_id 1685 - Free University of Berlin (Germany)
...
school's job_postings script). Edit it directly if Free University of Berlin's posting pages
...
Reads posting URLs from school_id_1685_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1685_job_info.csv. Checkpointed to
school_id_1685_job_info.checkpoint next to this script -- kill-and-resume,
