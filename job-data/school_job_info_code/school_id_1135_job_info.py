"""
Job info scraper for school_id 1135 - Dickinson College (US)
ATS platform: own website
Careers link: https://jobs.dickinson.edu/

Reads posting URLs from school_id_1135_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1135_job_info.csv. Checkpointed to
school_id_1135_job_info.checkpoint next to this script -- kill-and-resume,
