"""
Job info scraper for school_id 1558 - University of Wisconsin-River Falls (US)
...
Reads posting URLs from school_id_1558_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1558_job_info.csv. Checkpointed to
school_id_1558_job_info.checkpoint next to this script -- kill-and-resume,
