"""
Job info scraper for school_id 1217 - Swarthmore College (US)
ATS platform: own website
Careers link: http://careers.swarthmore.edu/cw/en-us/listing/

Reads posting URLs from school_id_1217_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1217_job_info.csv. Checkpointed to
school_id_1217_job_info.checkpoint next to this script -- kill-and-resume,
