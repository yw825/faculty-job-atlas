"""
Job info scraper for school_id 1461 - University of Virginia-Main Campus (US)
ATS platform: own website
Careers link: https://jobs.virginia.edu/us/en/uva-faculty-positions

Reads posting URLs from school_id_1461_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1461_job_info.csv. Checkpointed to
school_id_1461_job_info.checkpoint next to this script -- kill-and-resume,
