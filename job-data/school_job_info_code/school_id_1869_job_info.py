"""
Job info scraper for school_id 1869 - Aston University (United Kingdom)
ATS platform: own website
Careers link: https://jobs.aston.ac.uk/vacancies.aspx?cat=-1
...
school's job_postings script). Edit it directly if Aston University's posting pages
...
Reads posting URLs from school_id_1869_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1869_job_info.csv. Checkpointed to
school_id_1869_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1869
SCHOOL_NAME = 'Aston University'
CAREERS_LINK = 'https://jobs.aston.ac.uk/vacancies.aspx?cat=-1'
