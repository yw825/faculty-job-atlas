"""
Job info scraper for school_id 1780 - University of New England (Australia)
...
school's job_postings script). Edit it directly if University of New England's posting pages
...
Reads posting URLs from school_id_1780_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1780_job_info.csv. Checkpointed to
school_id_1780_job_info.checkpoint next to this script -- kill-and-resume,
