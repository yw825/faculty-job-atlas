"""
Job info scraper for school_id 1849 - University of Macau (Macau)
ATS platform: own website
Careers link: https://career.admo.um.edu.mo/
...
school's job_postings script). Edit it directly if University of Macau's posting pages
...
Reads posting URLs from school_id_1849_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1849_job_info.csv. Checkpointed to
school_id_1849_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1849
SCHOOL_NAME = 'University of Macau'
CAREERS_LINK = 'https://career.admo.um.edu.mo/'
