"""
Job info scraper for school_id 1704 - Trinity College Dublin (Ireland)
ATS platform: CoreHR
Careers link: https://my.corehr.com/pls/trrecruit/erq_search_version_4.start_search_with_params
...
school's job_postings script). Edit it directly if Trinity College Dublin's posting pages
...
Reads posting URLs from school_id_1704_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1704_job_info.csv. Checkpointed to
school_id_1704_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1704
SCHOOL_NAME = 'Trinity College Dublin'
CAREERS_LINK = 'https://my.corehr.com/pls/trrecruit/erq_search_version_4.start_search_with_params'
ATS_PLATFORM = 'CoreHR'
