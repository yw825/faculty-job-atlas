"""
Job info scraper for school_id 1798 - University of Queensland (Australia)
ATS platform: Workday
Careers link: https://uq.wd3.myworkdayjobs.com/uqcareers
...
school's job_postings script). Edit it directly if University of Queensland's posting pages
...
Reads posting URLs from school_id_1798_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1798_job_info.csv. Checkpointed to
school_id_1798_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://uq.wd3.myworkdayjobs.com/uqcareers'
