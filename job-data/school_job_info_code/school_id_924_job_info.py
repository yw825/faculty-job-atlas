"""
Job info scraper for school_id 924 - Canisius University (US)
ATS platform: iCIMS
Careers link: https://canisiusuniversity-puzzlehr.icims.com/

Reads posting URLs from school_id_924_job_postings.checkpoint (this
...
Writes school_job_info/school_id_924_job_info.csv. Checkpointed to
school_id_924_job_info.checkpoint next to this script -- kill-and-resume,
