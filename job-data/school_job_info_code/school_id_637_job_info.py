"""
Job info scraper for school_id 637 - Michigan State University (US)
ATS platform: own website
Careers link: https://careers.msu.edu/homepage

Reads posting URLs from school_id_637_job_postings.checkpoint (this
...
Writes school_job_info/school_id_637_job_info.csv. Checkpointed to
school_id_637_job_info.checkpoint next to this script -- kill-and-resume,
