"""
Job info scraper for school_id 1840 - Saint Francis University (Hong Kong)
ATS platform: own website
Careers link: https://www.sfu.edu.hk/en/career/academic-teaching-positions/index.html
...
school's job_postings script). Edit it directly if Saint Francis University's posting pages
...
Reads posting URLs from school_id_1840_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1840_job_info.csv. Checkpointed to
school_id_1840_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1840
SCHOOL_NAME = 'Saint Francis University'
CAREERS_LINK = 'https://www.sfu.edu.hk/en/career/academic-teaching-positions/index.html'
