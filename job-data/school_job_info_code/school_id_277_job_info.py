"""
Job info scraper for school_id 277 - Georgia State University (US)
ATS platform: Taleo
Careers link: https://gsu.taleo.net/

Reads posting URLs from school_id_277_job_postings.checkpoint (this
...
Writes school_job_info/school_id_277_job_info.csv. Checkpointed to
school_id_277_job_info.checkpoint next to this script -- kill-and-resume,
