"""
Job info scraper for school_id 400 - Western Illinois University (US)
ATS platform: own website
Careers link: https://sso.interviewexchange.com/wiu/sso.jsp

Reads posting URLs from school_id_400_job_postings.checkpoint (this
...
Writes school_job_info/school_id_400_job_info.csv. Checkpointed to
school_id_400_job_info.checkpoint next to this script -- kill-and-resume,
