"""
Job info scraper for school_id 1812 - La Trobe University (Australia)
ATS platform: own website
Careers link: https://jobs.latrobe.edu.au/en/listing/
...
school's job_postings script). Edit it directly if La Trobe University's posting pages
...
Reads posting URLs from school_id_1812_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1812_job_info.csv. Checkpointed to
school_id_1812_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://jobs.latrobe.edu.au/en/listing/'
