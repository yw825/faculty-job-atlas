"""
Job info scraper for school_id 1005 - Union College (US)
ATS platform: Workday
Careers link: https://unioncollege.wd5.myworkdayjobs.com/UnionCollegeCareers

Reads posting URLs from school_id_1005_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1005_job_info.csv. Checkpointed to
school_id_1005_job_info.checkpoint next to this script -- kill-and-resume,
