"""
Job info scraper for school_id 482 - Southwestern College (US)
ATS platform: own website
Careers link: https://www.sckans.edu/about/employment/

Reads posting URLs from school_id_482_job_postings.checkpoint (this
...
Writes school_job_info/school_id_482_job_info.csv. Checkpointed to
school_id_482_job_info.checkpoint next to this script -- kill-and-resume,
