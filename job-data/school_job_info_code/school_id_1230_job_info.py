"""
Job info scraper for school_id 1230 - University of Puerto Rico-Aguadilla (US)
ATS platform: own website
Careers link: https://www.uprag.edu/convocatorias/

Reads posting URLs from school_id_1230_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1230_job_info.csv. Checkpointed to
school_id_1230_job_info.checkpoint next to this script -- kill-and-resume,
