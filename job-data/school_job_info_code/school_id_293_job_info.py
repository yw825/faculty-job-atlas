"""
Job info scraper for school_id 293 - Piedmont University (US)
ATS platform: own website
Careers link: https://www.piedmont.edu/employment/

Reads posting URLs from school_id_293_job_postings.checkpoint (this
...
Writes school_job_info/school_id_293_job_info.csv. Checkpointed to
school_id_293_job_info.checkpoint next to this script -- kill-and-resume,
