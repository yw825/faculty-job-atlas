"""
Job info scraper for school_id 209 - Trinity Washington University (US)
ATS platform: own website
Careers link: https://www2.trinitydc.edu/hr/employment-openings/

Reads posting URLs from school_id_209_job_postings.checkpoint (this
...
Writes school_job_info/school_id_209_job_info.csv. Checkpointed to
school_id_209_job_info.checkpoint next to this script -- kill-and-resume,
