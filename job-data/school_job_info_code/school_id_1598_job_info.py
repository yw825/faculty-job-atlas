"""
Job info scraper for school_id 1598 - University of Victoria (Canada)
...
school's job_postings script). Edit it directly if University of Victoria's posting pages
...
Reads posting URLs from school_id_1598_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1598_job_info.csv. Checkpointed to
school_id_1598_job_info.checkpoint next to this script -- kill-and-resume,
