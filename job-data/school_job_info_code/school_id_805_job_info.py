"""
Job info scraper for school_id 805 - Meredith College (US)
ATS platform: own website
Careers link: https://meredith.career-pages.com/jobs/search

Reads posting URLs from school_id_805_job_postings.checkpoint (this
...
Writes school_job_info/school_id_805_job_info.csv. Checkpointed to
school_id_805_job_info.checkpoint next to this script -- kill-and-resume,
