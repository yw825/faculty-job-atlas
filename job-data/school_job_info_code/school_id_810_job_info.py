"""
Job info scraper for school_id 810 - North Carolina Wesleyan University (US)
ATS platform: own website
Careers link: https://ncwu.edu/community/careers/current-openings/faculty-teaching-positions/

Reads posting URLs from school_id_810_job_postings.checkpoint (this
...
Writes school_job_info/school_id_810_job_info.csv. Checkpointed to
school_id_810_job_info.checkpoint next to this script -- kill-and-resume,
