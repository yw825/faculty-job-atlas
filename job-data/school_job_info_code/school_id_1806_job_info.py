"""
Job info scraper for school_id 1806 - Torrens University Australia (Australia)
ATS platform: Workday
Careers link: https://strayer.wd1.myworkdayjobs.com/en-US/ANZ_TUA_External1
...
school's job_postings script). Edit it directly if Torrens University Australia's posting pages
...
Reads posting URLs from school_id_1806_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1806_job_info.csv. Checkpointed to
school_id_1806_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://strayer.wd1.myworkdayjobs.com/en-US/ANZ_TUA_External1'
