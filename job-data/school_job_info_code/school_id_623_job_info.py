"""
Job info scraper for school_id 623 - Colby College (US)
ATS platform: own website
Careers link: https://www.colby.edu/people/offices-directory/human-resources/employment/academic-positions-available/

Reads posting URLs from school_id_623_job_postings.checkpoint (this
...
Writes school_job_info/school_id_623_job_info.csv. Checkpointed to
school_id_623_job_info.checkpoint next to this script -- kill-and-resume,
