"""
Job info scraper for school_id 1063 - Miami University-Oxford (US)
ATS platform: Workday
Careers link: https://miamioh.wd5.myworkdayjobs.com/miamioh-faculty

Reads posting URLs from school_id_1063_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1063_job_info.csv. Checkpointed to
school_id_1063_job_info.checkpoint next to this script -- kill-and-resume,
