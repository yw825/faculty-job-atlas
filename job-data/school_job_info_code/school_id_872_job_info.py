"""
Job info scraper for school_id 872 - Drew University (US)
ATS platform: own website
Careers link: https://drew.edu/about/human-resources/employment-opportunities/

Reads posting URLs from school_id_872_job_postings.checkpoint (this
...
Writes school_job_info/school_id_872_job_info.csv. Checkpointed to
school_id_872_job_info.checkpoint next to this script -- kill-and-resume,
