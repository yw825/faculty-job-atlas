"""
Job info scraper for school_id 1894 - University of Oulu (Finland)
ATS platform: own website
Careers link: https://oulunyliopisto.varbi.com/en/
...
school's job_postings script). Edit it directly if University of Oulu's posting pages
...
Reads posting URLs from school_id_1894_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1894_job_info.csv. Checkpointed to
school_id_1894_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1894
SCHOOL_NAME = 'University of Oulu'
CAREERS_LINK = 'https://oulunyliopisto.varbi.com/en/'
