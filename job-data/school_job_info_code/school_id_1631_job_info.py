"""
Job info scraper for school_id 1631 - OCAD University (Canada)
ATS platform: Taleo
Careers link: https://tre.tbe.taleo.net/tre01/ats/careers/v2/searchResults?org=OCADU&cws=37
...
school's job_postings script). Edit it directly if OCAD University's posting pages
...
Reads posting URLs from school_id_1631_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1631_job_info.csv. Checkpointed to
school_id_1631_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1631
SCHOOL_NAME = 'OCAD University'
CAREERS_LINK = 'https://tre.tbe.taleo.net/tre01/ats/careers/v2/searchResults?org=OCADU&cws=37'
ATS_PLATFORM = 'Taleo'
