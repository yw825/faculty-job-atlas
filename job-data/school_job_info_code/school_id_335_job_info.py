"""
Job info scraper for school_id 335 - Drake University (US)
ATS platform: own website
Careers link: https://jobs.drake.edu/jobs/search

Reads posting URLs from school_id_335_job_postings.checkpoint (this
...
Writes school_job_info/school_id_335_job_info.csv. Checkpointed to
school_id_335_job_info.checkpoint next to this script -- kill-and-resume,
