"""
Job info scraper for school_id 168 - University of Colorado Denver/Anschutz Medical Campus (US)
ATS platform: Taleo
Careers link: https://cu.taleo.net/careersection/2/moresearch.ftl?lang=en

Reads posting URLs from school_id_168_job_postings.checkpoint (this
...
Writes school_job_info/school_id_168_job_info.csv. Checkpointed to
school_id_168_job_info.checkpoint next to this script -- kill-and-resume,
