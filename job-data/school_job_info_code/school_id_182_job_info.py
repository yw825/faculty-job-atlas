"""
Job info scraper for school_id 182 - Sacred Heart University (US)
ATS platform: own website
Careers link: https://jobs.dayforcehcm.com/shu/CANDIDATEPORTAL

Reads posting URLs from school_id_182_job_postings.checkpoint (this
...
Writes school_job_info/school_id_182_job_info.csv. Checkpointed to
school_id_182_job_info.checkpoint next to this script -- kill-and-resume,
