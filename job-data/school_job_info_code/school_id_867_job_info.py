"""
Job info scraper for school_id 867 - New Jersey City University (US)
ATS platform: Workday
Careers link: https://kean.wd503.myworkdayjobs.com/Kean

Reads posting URLs from school_id_867_job_postings.checkpoint (this
...
Writes school_job_info/school_id_867_job_info.csv. Checkpointed to
school_id_867_job_info.checkpoint next to this script -- kill-and-resume,
