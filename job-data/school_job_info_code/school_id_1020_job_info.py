"""
Job info scraper for school_id 1020 - University of Akron Main Campus (US)
ATS platform: Workday
Careers link: https://uakron.wd1.myworkdayjobs.com/en-US/UACareers

Reads posting URLs from school_id_1020_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1020_job_info.csv. Checkpointed to
school_id_1020_job_info.checkpoint next to this script -- kill-and-resume,
