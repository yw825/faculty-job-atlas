"""
Job info scraper for school_id 362 - Idaho State University (US)
ATS platform: Cornerstone OnDemand
Careers link: https://isu.csod.com/ux/ats/careersite/5/home?c=isu

Reads posting URLs from school_id_362_job_postings.checkpoint (this
...
Writes school_job_info/school_id_362_job_info.csv. Checkpointed to
school_id_362_job_info.checkpoint next to this script -- kill-and-resume,
