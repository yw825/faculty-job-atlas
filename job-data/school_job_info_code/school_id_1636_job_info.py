"""
Job info scraper for school_id 1636 - Wilfrid Laurier University (Canada)
...
school's job_postings script). Edit it directly if Wilfrid Laurier University's posting pages
...
Reads posting URLs from school_id_1636_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1636_job_info.csv. Checkpointed to
school_id_1636_job_info.checkpoint next to this script -- kill-and-resume,
