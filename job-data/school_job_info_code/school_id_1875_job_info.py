"""
Job info scraper for school_id 1875 - De Montfort University (United Kingdom)
ATS platform: own website
Careers link: https://www.jobs.ac.uk/search/?keywords=De%20Montfort%20University
...
school's job_postings script). Edit it directly if De Montfort University's posting pages
...
Reads posting URLs from school_id_1875_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1875_job_info.csv. Checkpointed to
school_id_1875_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1875
SCHOOL_NAME = 'De Montfort University'
CAREERS_LINK = 'https://www.jobs.ac.uk/search/?keywords=De%20Montfort%20University'
