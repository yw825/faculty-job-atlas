"""
Job info scraper for school_id 1817 - Victoria University (Australia)
ATS platform: Oracle Cloud HCM (detected: oracle)
Careers link: https://fa-ercy-saasfaprod1.fa.ocs.oraclecloud.com/hcmUI/CandidateExperience/en/sites/CX_2001/jobs

Victoria University runs on a shared ATS platform with a bulk info adapter --
...
Reads posting URLs from school_id_1817_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1817_job_info.csv. Checkpointed to
school_id_1817_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://fa-ercy-saasfaprod1.fa.ocs.oraclecloud.com/hcmUI/CandidateExperience/en/sites/CX_2001/jobs'
