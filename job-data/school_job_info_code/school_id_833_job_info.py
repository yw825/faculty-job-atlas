"""
Job info scraper for school_id 833 - Hastings College (US)
ATS platform: own website
Careers link: https://www.hastings.edu/academics/academic-opportunities/

Reads posting URLs from school_id_833_job_postings.checkpoint (this
...
Writes school_job_info/school_id_833_job_info.csv. Checkpointed to
school_id_833_job_info.checkpoint next to this script -- kill-and-resume,
