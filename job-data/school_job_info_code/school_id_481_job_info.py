"""
Job info scraper for school_id 481 - Wichita State University (US)
ATS platform: own website
Careers link: https://wichita-state-university-careers.career-pages.com/jobs/search?query=

Reads posting URLs from school_id_481_job_postings.checkpoint (this
...
Writes school_job_info/school_id_481_job_info.csv. Checkpointed to
school_id_481_job_info.checkpoint next to this script -- kill-and-resume,
