"""
Job info scraper for school_id 1403 - University of Dallas (US)
ATS platform: own website
Careers link: https://udallas.edu/offices-services/human-resources/open-positions.php

Reads posting URLs from school_id_1403_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1403_job_info.csv. Checkpointed to
school_id_1403_job_info.checkpoint next to this script -- kill-and-resume,
