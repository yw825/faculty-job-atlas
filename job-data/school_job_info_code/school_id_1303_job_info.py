"""
Job info scraper for school_id 1303 - University of South Carolina-Upstate (US)
ATS platform: own website
Careers link: https://uscupstate.edu/employment/faculty-positions/

Reads posting URLs from school_id_1303_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1303_job_info.csv. Checkpointed to
school_id_1303_job_info.checkpoint next to this script -- kill-and-resume,
