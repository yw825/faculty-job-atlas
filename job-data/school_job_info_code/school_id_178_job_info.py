"""
Job info scraper for school_id 178 - Colorado State University Pueblo (US)
...
Reads posting URLs from school_id_178_job_postings.checkpoint (this
...
Writes school_job_info/school_id_178_job_info.csv. Checkpointed to
school_id_178_job_info.checkpoint next to this script -- kill-and-resume,
