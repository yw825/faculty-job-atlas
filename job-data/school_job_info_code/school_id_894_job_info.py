"""
Job info scraper for school_id 894 - New Mexico State University-Main Campus (US)
ATS platform: own website
Careers link: https://careers.nmsu.edu/

Reads posting URLs from school_id_894_job_postings.checkpoint (this
...
Writes school_job_info/school_id_894_job_info.csv. Checkpointed to
school_id_894_job_info.checkpoint next to this script -- kill-and-resume,
