"""
Job info scraper for school_id 1319 - University of South Dakota (US)
ATS platform: own website
Careers link: https://yourfuture.sdbor.edu/postings/search

Reads posting URLs from school_id_1319_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1319_job_info.csv. Checkpointed to
school_id_1319_job_info.checkpoint next to this script -- kill-and-resume,
