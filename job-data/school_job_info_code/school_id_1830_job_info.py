"""
Job info scraper for school_id 1830 - Victoria University of Wellington (New Zealand)
ATS platform: Oracle Cloud HCM (detected: oracle)
Careers link: https://ejye.fa.ap1.oraclecloud.com/hcmUI/CandidateExperience/en/sites/CX_1/jobs?lastSelectedFacet=CATEGORIES&selectedCategoriesFacet=300000002931158

Victoria University of Wellington runs on a shared ATS platform with a bulk info adapter --
...
Reads posting URLs from school_id_1830_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1830_job_info.csv. Checkpointed to
school_id_1830_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1830
SCHOOL_NAME = 'Victoria University of Wellington'
CAREERS_LINK = 'https://ejye.fa.ap1.oraclecloud.com/hcmUI/CandidateExperience/en/sites/CX_1/jobs?lastSelectedFacet=CATEGORIES&selectedCategoriesFacet=300000002931158'
