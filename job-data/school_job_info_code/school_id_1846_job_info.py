"""
Job info scraper for school_id 1846 - The University of Hong Kong (Hong Kong)
ATS platform: own website
Careers link: https://jobs.hku.hk/
...
school's job_postings script). Edit it directly if The University of Hong Kong's posting pages
...
Reads posting URLs from school_id_1846_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1846_job_info.csv. Checkpointed to
school_id_1846_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://jobs.hku.hk/'
