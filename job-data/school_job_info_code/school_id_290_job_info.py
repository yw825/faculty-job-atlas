"""
Job info scraper for school_id 290 - Dalton State College (US)
ATS platform: own website
Careers link: https://www.daltonstate.edu/about/marketing-communications-workforce/career-and-professional-development/

Reads posting URLs from school_id_290_job_postings.checkpoint (this
...
Writes school_job_info/school_id_290_job_info.csv. Checkpointed to
school_id_290_job_info.checkpoint next to this script -- kill-and-resume,
