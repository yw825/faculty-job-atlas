"""
Job info scraper for school_id 815 - Barton College (US)
ATS platform: own website
Careers link: https://www.barton.edu/academics/academic-career-planning/

Reads posting URLs from school_id_815_job_postings.checkpoint (this
...
Writes school_job_info/school_id_815_job_info.csv. Checkpointed to
school_id_815_job_info.checkpoint next to this script -- kill-and-resume,
