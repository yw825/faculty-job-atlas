"""
Job info scraper for school_id 930 - SUNY College of Technology at Canton (US)
ATS platform: own website
Careers link: https://canton-accommodate.symplicity.com/

Reads posting URLs from school_id_930_job_postings.checkpoint (this
...
Writes school_job_info/school_id_930_job_info.csv. Checkpointed to
school_id_930_job_info.checkpoint next to this script -- kill-and-resume,
