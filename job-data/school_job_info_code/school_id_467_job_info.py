"""
Job info scraper for school_id 467 - Kansas State University (US)
ATS platform: own website
Careers link: https://www.k-state.edu/employment/

Reads posting URLs from school_id_467_job_postings.checkpoint (this
...
Writes school_job_info/school_id_467_job_info.csv. Checkpointed to
school_id_467_job_info.checkpoint next to this script -- kill-and-resume,
