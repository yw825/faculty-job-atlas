"""
Job info scraper for school_id 477 - Sterling College (US)
ATS platform: own website
Careers link: https://www.sterling.edu/about/employment

Reads posting URLs from school_id_477_job_postings.checkpoint (this
...
Writes school_job_info/school_id_477_job_info.csv. Checkpointed to
school_id_477_job_info.checkpoint next to this script -- kill-and-resume,
