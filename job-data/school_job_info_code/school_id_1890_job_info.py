"""
Job info scraper for school_id 1890 - University of Gothenburg (Sweden)
ATS platform: own website
Careers link: https://www.gu.se/en/work-at-the-university-of-gothenburg/vacancies
...
school's job_postings script). Edit it directly if University of Gothenburg's posting pages
...
Reads posting URLs from school_id_1890_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1890_job_info.csv. Checkpointed to
school_id_1890_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1890
SCHOOL_NAME = 'University of Gothenburg'
CAREERS_LINK = 'https://www.gu.se/en/work-at-the-university-of-gothenburg/vacancies'
