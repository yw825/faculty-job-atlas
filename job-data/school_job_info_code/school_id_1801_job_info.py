"""
Job info scraper for school_id 1801 - University of the Sunshine Coast (Australia)
ATS platform: own website
Careers link: https://careers.usc.edu.au/jobs/search
...
school's job_postings script). Edit it directly if University of the Sunshine Coast's posting pages
...
Reads posting URLs from school_id_1801_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1801_job_info.csv. Checkpointed to
school_id_1801_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://careers.usc.edu.au/jobs/search'
