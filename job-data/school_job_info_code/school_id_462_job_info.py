"""
Job info scraper for school_id 462 - Fort Hays State University (US)
ATS platform: own website
Careers link: https://www.fhsu.edu/humanresourceoffice/positions

Reads posting URLs from school_id_462_job_postings.checkpoint (this
...
Writes school_job_info/school_id_462_job_info.csv. Checkpointed to
school_id_462_job_info.checkpoint next to this script -- kill-and-resume,
