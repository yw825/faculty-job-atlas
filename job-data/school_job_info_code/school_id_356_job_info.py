"""
Job info scraper for school_id 356 - Wartburg College (US)
ATS platform: own website
Careers link: https://www.wartburg.edu/carson-research-opportunities-focused-my-career-goals/

Reads posting URLs from school_id_356_job_postings.checkpoint (this
...
Writes school_job_info/school_id_356_job_info.csv. Checkpointed to
school_id_356_job_info.checkpoint next to this script -- kill-and-resume,
