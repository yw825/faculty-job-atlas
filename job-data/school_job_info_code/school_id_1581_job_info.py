"""
Job info scraper for school_id 1581 - West Liberty University (US)
ATS platform: own website
Careers link: https://westliberty.edu/human-resources/search/

Reads posting URLs from school_id_1581_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1581_job_info.csv. Checkpointed to
school_id_1581_job_info.checkpoint next to this script -- kill-and-resume,
