"""
Job info scraper for school_id 483 - Union College (US)
ATS platform: own website
Careers link: https://www.unionky.edu/about/human-resources/employment-opportunities/faculty-positions

Reads posting URLs from school_id_483_job_postings.checkpoint (this
...
Writes school_job_info/school_id_483_job_info.csv. Checkpointed to
school_id_483_job_info.checkpoint next to this script -- kill-and-resume,
