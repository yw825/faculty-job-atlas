"""
Job info scraper for school_id 1094 - Randall University (US)
ATS platform: own website
Careers link: https://ru.edu/about-randall/jobs/

Reads posting URLs from school_id_1094_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1094_job_info.csv. Checkpointed to
school_id_1094_job_info.checkpoint next to this script -- kill-and-resume,
