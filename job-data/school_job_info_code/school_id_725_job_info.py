"""
Job info scraper for school_id 725 - College of the Ozarks (US)
ATS platform: own website
Careers link: https://www.cofo.edu/jobs

Reads posting URLs from school_id_725_job_postings.checkpoint (this
...
Writes school_job_info/school_id_725_job_info.csv. Checkpointed to
school_id_725_job_info.checkpoint next to this script -- kill-and-resume,
