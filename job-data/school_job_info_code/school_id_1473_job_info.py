"""
Job info scraper for school_id 1473 - James Madison University (US)
ATS platform: own website
Careers link: https://jobs.jmu.edu/

Reads posting URLs from school_id_1473_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1473_job_info.csv. Checkpointed to
school_id_1473_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://jobs.jmu.edu/'
