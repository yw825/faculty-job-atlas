"""
Job info scraper for school_id 873 - Fairleigh Dickinson University-Florham Campus (US)
ATS platform: own website
Careers link: https://www.instagram.com/reel/Db53N_YDMHp/

Reads posting URLs from school_id_873_job_postings.checkpoint (this
...
Writes school_job_info/school_id_873_job_info.csv. Checkpointed to
school_id_873_job_info.checkpoint next to this script -- kill-and-resume,
