"""
Job info scraper for school_id 174 - University of Northern Colorado (US)
ATS platform: Cornerstone OnDemand
Careers link: https://unco.csod.com/ux/ats/careersite/1/home?c=unco

Reads posting URLs from school_id_174_job_postings.checkpoint (this
...
Writes school_job_info/school_id_174_job_info.csv. Checkpointed to
school_id_174_job_info.checkpoint next to this script -- kill-and-resume,
