"""
Job info scraper for school_id 1857 - National University of Singapore (Singapore)
ATS platform: own website
Careers link: https://careers.nus.edu.sg/Acadpositions/go/Academic-Positions-Tenure-Track/732844/
...
school's job_postings script). Edit it directly if National University of Singapore's posting pages
...
Reads posting URLs from school_id_1857_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1857_job_info.csv. Checkpointed to
school_id_1857_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://careers.nus.edu.sg/Acadpositions/go/Academic-Positions-Tenure-Track/732844/'
