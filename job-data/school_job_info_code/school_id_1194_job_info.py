"""
Job info scraper for school_id 1194 - University of Pennsylvania (US)
ATS platform: own website
Careers link: https://facultyjobs.upenn.edu/

Reads posting URLs from school_id_1194_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1194_job_info.csv. Checkpointed to
school_id_1194_job_info.checkpoint next to this script -- kill-and-resume,
