"""
Job info scraper for school_id 928 - University at Buffalo (US)
ATS platform: own website
Careers link: https://www.buffalo.edu/administrative-services/careers-at-ub/ny-helps-program.html

Reads posting URLs from school_id_928_job_postings.checkpoint (this
...
Writes school_job_info/school_id_928_job_info.csv. Checkpointed to
school_id_928_job_info.checkpoint next to this script -- kill-and-resume,
