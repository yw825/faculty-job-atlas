"""
Job info scraper for school_id 1851 - Macao University of Tourism (Macau)
ATS platform: own website
Careers link: https://www.utm.edu.mo/visitors/job-vacancies
...
school's job_postings script). Edit it directly if Macao University of Tourism's posting pages
...
Reads posting URLs from school_id_1851_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1851_job_info.csv. Checkpointed to
school_id_1851_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1851
SCHOOL_NAME = 'Macao University of Tourism'
CAREERS_LINK = 'https://www.utm.edu.mo/visitors/job-vacancies'
