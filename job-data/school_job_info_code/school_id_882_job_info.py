"""
Job info scraper for school_id 882 - Princeton University (US)
ATS platform: own website
Careers link: http://dof.princeton.edu/academicjobs

Reads posting URLs from school_id_882_job_postings.checkpoint (this
...
Writes school_job_info/school_id_882_job_info.csv. Checkpointed to
school_id_882_job_info.checkpoint next to this script -- kill-and-resume,
