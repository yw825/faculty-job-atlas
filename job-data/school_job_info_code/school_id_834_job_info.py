"""
Job info scraper for school_id 834 - University of Nebraska at Kearney (US)
ATS platform: own website
Careers link: https://unknews.unk.edu/2026/08/25/vail-ziolkowski-beissel-heath-selected-for-endowed-faculty-positions-at-unk/

Reads posting URLs from school_id_834_job_postings.checkpoint (this
...
Writes school_job_info/school_id_834_job_info.csv. Checkpointed to
school_id_834_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://unknews.unk.edu/2026/08/25/vail-ziolkowski-beissel-heath-selected-for-endowed-faculty-positions-at-unk/'
