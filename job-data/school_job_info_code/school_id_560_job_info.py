"""
Job info scraper for school_id 560 - Curry College (US)
ATS platform: own website
Careers link: https://www.curry.edu/about-us/community-resources/human-resources-and-employment/job-opportunities

Reads posting URLs from school_id_560_job_postings.checkpoint (this
...
Writes school_job_info/school_id_560_job_info.csv. Checkpointed to
school_id_560_job_info.checkpoint next to this script -- kill-and-resume,
