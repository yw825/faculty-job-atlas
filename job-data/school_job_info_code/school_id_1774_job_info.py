"""
Job info scraper for school_id 1774 - University College London (United Kingdom)
ATS platform: own website
Careers link: https://www.ucl.ac.uk/work-at-ucl/search-ucl-jobs
...
school's job_postings script). Edit it directly if University College London's posting pages
...
Reads posting URLs from school_id_1774_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1774_job_info.csv. Checkpointed to
school_id_1774_job_info.checkpoint next to this script -- kill-and-resume,
