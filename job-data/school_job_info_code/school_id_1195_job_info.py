"""
Job info scraper for school_id 1195 - University of Valley Forge (US)
ATS platform: own website
Careers link: https://valleyforge.edu/careers-at-uvf/adjunct-instructor-in-person-masters-of-business-administration/

Reads posting URLs from school_id_1195_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1195_job_info.csv. Checkpointed to
school_id_1195_job_info.checkpoint next to this script -- kill-and-resume,
