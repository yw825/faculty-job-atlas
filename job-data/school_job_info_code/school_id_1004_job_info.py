"""
Job info scraper for school_id 1004 - Skidmore College (US)
ATS platform: own website
Careers link: https://www.skidmore.edu/advancement/giving-opportunities/index.php

Reads posting URLs from school_id_1004_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1004_job_info.csv. Checkpointed to
school_id_1004_job_info.checkpoint next to this script -- kill-and-resume,
