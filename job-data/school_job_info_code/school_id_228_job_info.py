"""
Job info scraper for school_id 228 - Nova Southeastern University (US)
ATS platform: own website
Careers link: https://www.nova.edu/resources/employment.html

Reads posting URLs from school_id_228_job_postings.checkpoint (this
...
Writes school_job_info/school_id_228_job_info.csv. Checkpointed to
school_id_228_job_info.checkpoint next to this script -- kill-and-resume,
