"""
Job info scraper for school_id 503 - Kentucky Wesleyan College (US)
ATS platform: own website
Careers link: https://kwc.edu/about-wesleyan/employment-opportunities/

Reads posting URLs from school_id_503_job_postings.checkpoint (this
...
Writes school_job_info/school_id_503_job_info.csv. Checkpointed to
school_id_503_job_info.checkpoint next to this script -- kill-and-resume,
