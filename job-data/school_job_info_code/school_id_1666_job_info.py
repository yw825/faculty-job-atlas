"""
Job info scraper for school_id 1666 - Aarhus University (Denmark)
ATS platform: own website
Careers link: https://international.au.dk/about/profile/vacant-positions
...
school's job_postings script). Edit it directly if Aarhus University's posting pages
...
Reads posting URLs from school_id_1666_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1666_job_info.csv. Checkpointed to
school_id_1666_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1666
SCHOOL_NAME = 'Aarhus University'
CAREERS_LINK = 'https://international.au.dk/about/profile/vacant-positions'
