"""
Job info scraper for school_id 574 - Bentley University (US)
ATS platform: Workday
Careers link: https://bentley.wd503.myworkdayjobs.com/faculty

Reads posting URLs from school_id_574_job_postings.checkpoint (this
...
Writes school_job_info/school_id_574_job_info.csv. Checkpointed to
school_id_574_job_info.checkpoint next to this script -- kill-and-resume,
