"""
Job info scraper for school_id 1825 - University of Canterbury (New Zealand)
ATS platform: own website
Careers link: https://jobs.canterbury.ac.nz/search
...
school's job_postings script). Edit it directly if University of Canterbury's posting pages
...
Reads posting URLs from school_id_1825_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1825_job_info.csv. Checkpointed to
school_id_1825_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1825
SCHOOL_NAME = 'University of Canterbury'
CAREERS_LINK = 'https://jobs.canterbury.ac.nz/search'
