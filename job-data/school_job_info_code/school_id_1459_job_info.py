"""
Job info scraper for school_id 1459 - Bridgewater College (US)
ATS platform: own website
Careers link: https://www.bridgewater.edu/careers/

Reads posting URLs from school_id_1459_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1459_job_info.csv. Checkpointed to
school_id_1459_job_info.checkpoint next to this script -- kill-and-resume,
