"""
Job info scraper for school_id 583 - Clark University (US)
ATS platform: own website
Careers link: https://clarku.interviewexchange.com/static/clients/569CUM1/index.jsp

Reads posting URLs from school_id_583_job_postings.checkpoint (this
...
Writes school_job_info/school_id_583_job_info.csv. Checkpointed to
school_id_583_job_info.checkpoint next to this script -- kill-and-resume,
