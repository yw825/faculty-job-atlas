"""
Job info scraper for school_id 1341 - The University of Tennessee-Martin (US)
ATS platform: own website
Careers link: https://www.utm.edu/offices-and-services/human-resources/employment-opportunities.php

Reads posting URLs from school_id_1341_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1341_job_info.csv. Checkpointed to
school_id_1341_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://www.utm.edu/offices-and-services/human-resources/employment-opportunities.php'
