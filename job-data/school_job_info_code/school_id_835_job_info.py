"""
Job info scraper for school_id 835 - Nebraska Wesleyan University (US)
ATS platform: own website
Careers link: https://www.nebrwesleyan.edu/about-nwu/employment/business-office-hr-associate

Reads posting URLs from school_id_835_job_postings.checkpoint (this
...
Writes school_job_info/school_id_835_job_info.csv. Checkpointed to
school_id_835_job_info.checkpoint next to this script -- kill-and-resume,
