"""
Job info scraper for school_id 1577 - Alderson Broaddus University (US)
ATS platform: own website
Careers link: https://ab.edu/employment/

Reads posting URLs from school_id_1577_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1577_job_info.csv. Checkpointed to
school_id_1577_job_info.checkpoint next to this script -- kill-and-resume,
