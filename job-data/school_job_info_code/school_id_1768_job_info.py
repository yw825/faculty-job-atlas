"""
Job info scraper for school_id 1768 - University of Glasgow (United Kingdom)
ATS platform: own website
Careers link: https://www.jobs.gla.ac.uk/jobs?source=google.com
...
school's job_postings script). Edit it directly if University of Glasgow's posting pages
...
Reads posting URLs from school_id_1768_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1768_job_info.csv. Checkpointed to
school_id_1768_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://www.jobs.gla.ac.uk/jobs?source=google.com'
