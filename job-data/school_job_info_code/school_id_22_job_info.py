"""
Job info scraper for school_id 22 - Auburn University at Montgomery (US)
ATS platform: own website
Careers link: https://jobs.aum.edu/aum-careers-home/jobs?tags2=Faculty

Reads posting URLs from school_id_22_job_postings.checkpoint (this
...
Writes school_job_info/school_id_22_job_info.csv. Checkpointed to
school_id_22_job_info.checkpoint next to this script -- kill-and-resume,
