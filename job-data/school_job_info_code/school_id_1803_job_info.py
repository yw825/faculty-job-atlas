"""
Job info scraper for school_id 1803 - James Cook University (Australia)
ATS platform: own website
Careers link: https://careers.jcu.edu.au/jobs/search
...
school's job_postings script). Edit it directly if James Cook University's posting pages
...
Reads posting URLs from school_id_1803_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1803_job_info.csv. Checkpointed to
school_id_1803_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://careers.jcu.edu.au/jobs/search'
