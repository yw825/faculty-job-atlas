"""
Job info scraper for school_id 279 - Oglethorpe University (US)
ATS platform: own website
Careers link: https://oglethorpe.edu/about/offices-departments/human-resources/jobs/

Reads posting URLs from school_id_279_job_postings.checkpoint (this
...
Writes school_job_info/school_id_279_job_info.csv. Checkpointed to
school_id_279_job_info.checkpoint next to this script -- kill-and-resume,
