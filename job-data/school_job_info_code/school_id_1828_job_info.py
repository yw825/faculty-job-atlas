"""
Job info scraper for school_id 1828 - Lincoln University (New Zealand)
ATS platform: own website
Careers link: https://careers.lincoln.ac.nz/search
...
school's job_postings script). Edit it directly if Lincoln University's posting pages
...
Reads posting URLs from school_id_1828_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1828_job_info.csv. Checkpointed to
school_id_1828_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1828
SCHOOL_NAME = 'Lincoln University'
CAREERS_LINK = 'https://careers.lincoln.ac.nz/search'
