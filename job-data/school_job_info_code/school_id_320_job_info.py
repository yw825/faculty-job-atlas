"""
Job info scraper for school_id 320 - University of Guam (US)
ATS platform: PeopleAdmin
Careers link: https://uog.peopleadmin.com/

Reads posting URLs from school_id_320_job_postings.checkpoint (this
...
Writes school_job_info/school_id_320_job_info.csv. Checkpointed to
school_id_320_job_info.checkpoint next to this script -- kill-and-resume,
