"""
Job info scraper for school_id 1279 - College of Charleston (US)
ATS platform: own website
Careers link: https://charleston.edu/academic-affairs/faculty-careers.php

Reads posting URLs from school_id_1279_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1279_job_info.csv. Checkpointed to
school_id_1279_job_info.checkpoint next to this script -- kill-and-resume,
