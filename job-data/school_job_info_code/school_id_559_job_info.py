"""
Job info scraper for school_id 559 - Tufts University (US)
ATS platform: own website
Careers link: https://jobs.tufts.edu/jobs

Reads posting URLs from school_id_559_job_postings.checkpoint (this
...
Writes school_job_info/school_id_559_job_info.csv. Checkpointed to
school_id_559_job_info.checkpoint next to this script -- kill-and-resume,
