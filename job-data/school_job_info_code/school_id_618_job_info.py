"""
Job info scraper for school_id 618 - Bates College (US)
ATS platform: own website
Careers link: https://www.bates.edu/career/

Reads posting URLs from school_id_618_job_postings.checkpoint (this
...
Writes school_job_info/school_id_618_job_info.csv. Checkpointed to
school_id_618_job_info.checkpoint next to this script -- kill-and-resume,
