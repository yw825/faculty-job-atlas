"""
Job info scraper for school_id 1779 - University of Canberra (Australia)
ATS platform: own website
Careers link: https://uctalent.canberra.edu.au/cw/en/listing.html
...
school's job_postings script). Edit it directly if University of Canberra's posting pages
...
Reads posting URLs from school_id_1779_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1779_job_info.csv. Checkpointed to
school_id_1779_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://uctalent.canberra.edu.au/cw/en/listing.html'
