"""
Job info scraper for school_id 125 - California State University-Sacramento (US)
...
Reads posting URLs from school_id_125_job_postings.checkpoint (this
...
Writes school_job_info/school_id_125_job_info.csv. Checkpointed to
school_id_125_job_info.checkpoint next to this script -- kill-and-resume,
