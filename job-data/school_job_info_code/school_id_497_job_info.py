"""
Job info scraper for school_id 497 - Spalding University (US)
ATS platform: own website
Careers link: https://spalding.edu/careers/

Reads posting URLs from school_id_497_job_postings.checkpoint (this
...
Writes school_job_info/school_id_497_job_info.csv. Checkpointed to
school_id_497_job_info.checkpoint next to this script -- kill-and-resume,
