"""
Job info scraper for school_id 1284 - Columbia College (US)
ATS platform: own website
Careers link: https://www.columbiasc.edu/academics/academic-career-support

Reads posting URLs from school_id_1284_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1284_job_info.csv. Checkpointed to
school_id_1284_job_info.checkpoint next to this script -- kill-and-resume,
