"""
Job info scraper for school_id 1632 - Toronto Metropolitan University (Canada)
ATS platform: own website
Careers link: https://careers.torontomu.ca/psc/hrcgprd/EMPLOYEE/HRMS/c/HRS_HRAM_FL.HRS_CG_SEARCH_FL.GBL?Page=HRS_APP_SCHJOB_FL&Action=U
...
school's job_postings script). Edit it directly if Toronto Metropolitan University's posting pages
...
Reads posting URLs from school_id_1632_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1632_job_info.csv. Checkpointed to
school_id_1632_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://careers.torontomu.ca/psc/hrcgprd/EMPLOYEE/HRMS/c/HRS_HRAM_FL.HRS_CG_SEARCH_FL.GBL?Page=HRS_APP_SCHJOB_FL&Action=U&SiteId=1'
