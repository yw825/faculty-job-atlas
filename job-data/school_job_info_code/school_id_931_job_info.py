"""
Job info scraper for school_id 931 - St Lawrence University (US)
ATS platform: iCIMS
...
Reads posting URLs from school_id_931_job_postings.checkpoint (this
...
Writes school_job_info/school_id_931_job_info.csv. Checkpointed to
school_id_931_job_info.checkpoint next to this script -- kill-and-resume,
