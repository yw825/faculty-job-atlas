"""
Job info scraper for school_id 1886 - University of Groningen (Netherlands)
ATS platform: own website
Careers link: https://werkenbij.rug.nl/en/all-vacancies/
...
school's job_postings script). Edit it directly if University of Groningen's posting pages
...
Reads posting URLs from school_id_1886_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1886_job_info.csv. Checkpointed to
school_id_1886_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://werkenbij.rug.nl/en/all-vacancies/'
