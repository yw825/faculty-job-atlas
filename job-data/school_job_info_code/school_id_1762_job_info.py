"""
Job info scraper for school_id 1762 - Sabancı University (Turkey)
ATS platform: own website
Careers link: https://www.sabanciuniv.edu/en/academic-positions
...
school's job_postings script). Edit it directly if Sabancı University's posting pages
...
Reads posting URLs from school_id_1762_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1762_job_info.csv. Checkpointed to
school_id_1762_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1762
SCHOOL_NAME = 'Sabancı University'
CAREERS_LINK = 'https://www.sabanciuniv.edu/en/academic-positions'
