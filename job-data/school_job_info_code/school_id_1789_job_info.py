"""
Job info scraper for school_id 1789 - University of New South Wales (Australia)
...
school's job_postings script). Edit it directly if University of New South Wales's posting pages
...
Reads posting URLs from school_id_1789_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1789_job_info.csv. Checkpointed to
school_id_1789_job_info.checkpoint next to this script -- kill-and-resume,
