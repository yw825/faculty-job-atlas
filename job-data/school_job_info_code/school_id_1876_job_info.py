"""
Job info scraper for school_id 1876 - Oxford Brookes University (United Kingdom)
ATS platform: CoreHR
Careers link: https://my.corehr.com/pls/oburecruit/erq_search_version_4.start_search_with_params
...
school's job_postings script). Edit it directly if Oxford Brookes University's posting pages
...
Reads posting URLs from school_id_1876_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1876_job_info.csv. Checkpointed to
school_id_1876_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1876
SCHOOL_NAME = 'Oxford Brookes University'
CAREERS_LINK = 'https://my.corehr.com/pls/oburecruit/erq_search_version_4.start_search_with_params'
ATS_PLATFORM = 'CoreHR'
