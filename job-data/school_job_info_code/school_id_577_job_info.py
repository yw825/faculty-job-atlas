"""
Job info scraper for school_id 577 - Wellesley College (US)
ATS platform: own website
Careers link: https://careereducation.wellesley.edu/career_exploration

Reads posting URLs from school_id_577_job_postings.checkpoint (this
...
Writes school_job_info/school_id_577_job_info.csv. Checkpointed to
school_id_577_job_info.checkpoint next to this script -- kill-and-resume,
