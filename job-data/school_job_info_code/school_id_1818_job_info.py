"""
Job info scraper for school_id 1818 - University of Notre Dame Australia (Australia)
ATS platform: own website
Careers link: https://search.nd.edu.au/s/search.html?collection=und~sp-jobs&profile=jobs
...
school's job_postings script). Edit it directly if University of Notre Dame Australia's posting pages
...
Reads posting URLs from school_id_1818_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1818_job_info.csv. Checkpointed to
school_id_1818_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1818
SCHOOL_NAME = 'University of Notre Dame Australia'
CAREERS_LINK = 'https://search.nd.edu.au/s/search.html?collection=und~sp-jobs&profile=jobs'
