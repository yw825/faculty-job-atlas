"""
Job info scraper for school_id 908 - Alfred University (US)
ATS platform: own website
Careers link: https://www.alfred.edu/jobs-at-alfred/index.cfm

Reads posting URLs from school_id_908_job_postings.checkpoint (this
...
Writes school_job_info/school_id_908_job_info.csv. Checkpointed to
school_id_908_job_info.checkpoint next to this script -- kill-and-resume,
