"""
Job info scraper for school_id 1805 - Flinders University (Australia)
ATS platform: Workday
Careers link: https://flinders.wd3.myworkdayjobs.com/flinders_employment
...
school's job_postings script). Edit it directly if Flinders University's posting pages
...
Reads posting URLs from school_id_1805_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1805_job_info.csv. Checkpointed to
school_id_1805_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://flinders.wd3.myworkdayjobs.com/flinders_employment'
