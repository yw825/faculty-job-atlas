"""
Job info scraper for school_id 935 - State University of New York at Cortland (US)
ATS platform: own website
Careers link: https://www2.cortland.edu/offices/hr/jobs

Reads posting URLs from school_id_935_job_postings.checkpoint (this
...
Writes school_job_info/school_id_935_job_info.csv. Checkpointed to
school_id_935_job_info.checkpoint next to this script -- kill-and-resume,
