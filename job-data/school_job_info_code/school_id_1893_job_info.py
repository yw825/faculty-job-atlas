"""
Job info scraper for school_id 1893 - University of Vaasa (Finland)
...
school's job_postings script). Edit it directly if University of Vaasa's posting pages
...
Reads posting URLs from school_id_1893_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1893_job_info.csv. Checkpointed to
school_id_1893_job_info.checkpoint next to this script -- kill-and-resume,
