"""
Job info scraper for school_id 1588 - Burman University (Canada)
ATS platform: own website
Careers link: https://www.burmanu.ca/careers
...
school's job_postings script). Edit it directly if Burman University's posting pages
...
Reads posting URLs from school_id_1588_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1588_job_info.csv. Checkpointed to
school_id_1588_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1588
SCHOOL_NAME = 'Burman University'
CAREERS_LINK = 'https://www.burmanu.ca/careers'
