"""
Job info scraper for school_id 1129 - Neumann University (US)
ATS platform: own website
Careers link: https://www.neumann.edu/about/humanresources/employment#Faculty

Reads posting URLs from school_id_1129_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1129_job_info.csv. Checkpointed to
school_id_1129_job_info.checkpoint next to this script -- kill-and-resume,
