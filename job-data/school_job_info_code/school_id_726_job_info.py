"""
Job info scraper for school_id 726 - Missouri University of Science and Technology (US)
ATS platform: own website
Careers link: https://jobs.mst.edu/

Reads posting URLs from school_id_726_job_postings.checkpoint (this
...
Writes school_job_info/school_id_726_job_info.csv. Checkpointed to
school_id_726_job_info.checkpoint next to this script -- kill-and-resume,
