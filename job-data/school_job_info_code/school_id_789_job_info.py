"""
Job info scraper for school_id 789 - Greensboro College (US)
ATS platform: own website
Careers link: https://www.greensboro.edu/employment/

Reads posting URLs from school_id_789_job_postings.checkpoint (this
...
Writes school_job_info/school_id_789_job_info.csv. Checkpointed to
school_id_789_job_info.checkpoint next to this script -- kill-and-resume,
