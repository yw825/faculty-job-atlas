"""
Job info scraper for school_id 1759 - Middle East Technical University (Turkey)
ATS platform: own website
Careers link: https://www.academicjobs.com/employers/middle-east-technical-university/8994/jobs
...
school's job_postings script). Edit it directly if Middle East Technical University's posting pages
...
Reads posting URLs from school_id_1759_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1759_job_info.csv. Checkpointed to
school_id_1759_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://www.academicjobs.com/employers/middle-east-technical-university/8994/jobs'
