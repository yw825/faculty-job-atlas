"""
Job info scraper for school_id 896 - Eastern New Mexico University-Main Campus (US)
ATS platform: own website
Careers link: https://www.schooljobs.com/careers/enmu?jobType[0]=Faculty&sort=PositionTitle%7CAscending

Reads posting URLs from school_id_896_job_postings.checkpoint (this
...
Writes school_job_info/school_id_896_job_info.csv. Checkpointed to
school_id_896_job_info.checkpoint next to this script -- kill-and-resume,
