"""
Job info scraper for school_id 1045 - Wright State University-Main Campus (US)
ATS platform: own website
Careers link: #VALUE!

Reads posting URLs from school_id_1045_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1045_job_info.csv. Checkpointed to
school_id_1045_job_info.checkpoint next to this script -- kill-and-resume,
