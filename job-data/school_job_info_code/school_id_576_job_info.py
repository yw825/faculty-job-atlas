"""
Job info scraper for school_id 576 - Babson College (US)
ATS platform: own website
Careers link: https://entrepreneurship.babson.edu/career-outcomes-mba-class-2025/?share=linkedin

Reads posting URLs from school_id_576_job_postings.checkpoint (this
...
Writes school_job_info/school_id_576_job_info.csv. Checkpointed to
school_id_576_job_info.checkpoint next to this script -- kill-and-resume,
