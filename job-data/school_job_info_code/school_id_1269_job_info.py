"""
Job info scraper for school_id 1269 - Johnson & Wales University-Providence (US)
ATS platform: own website
Careers link: https://jobs.jwu.edu/en-us/listing/

Reads posting URLs from school_id_1269_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1269_job_info.csv. Checkpointed to
school_id_1269_job_info.checkpoint next to this script -- kill-and-resume,
