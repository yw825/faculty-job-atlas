"""
Job info scraper for school_id 813 - Warren Wilson College (US)
ATS platform: own website
Careers link: https://www.warren-wilson.edu/about/employment/

Reads posting URLs from school_id_813_job_postings.checkpoint (this
...
Writes school_job_info/school_id_813_job_info.csv. Checkpointed to
school_id_813_job_info.checkpoint next to this script -- kill-and-resume,
