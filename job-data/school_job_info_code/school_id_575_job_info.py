"""
Job info scraper for school_id 575 - Brandeis University (US)
ATS platform: own website
Careers link: https://www.brandeis.edu/human-resources/careers/faculty-positions.html

Reads posting URLs from school_id_575_job_postings.checkpoint (this
...
Writes school_job_info/school_id_575_job_info.csv. Checkpointed to
school_id_575_job_info.checkpoint next to this script -- kill-and-resume,
