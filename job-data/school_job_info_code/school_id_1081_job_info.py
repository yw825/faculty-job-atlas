"""
Job info scraper for school_id 1081 - East Central University (US)
ATS platform: own website
Careers link: https://ecokedu.bamboohr.com/careers

Reads posting URLs from school_id_1081_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1081_job_info.csv. Checkpointed to
school_id_1081_job_info.checkpoint next to this script -- kill-and-resume,
