"""
Job info scraper for school_id 322 - Chaminade University of Honolulu (US)
ATS platform: ADP
...
Reads posting URLs from school_id_322_job_postings.checkpoint (this
...
Writes school_job_info/school_id_322_job_info.csv. Checkpointed to
school_id_322_job_info.checkpoint next to this script -- kill-and-resume,
