"""
Job info scraper for school_id 670 - University of Minnesota-Crookston (US)
ATS platform: own website
Careers link: https://crk.umn.edu/human-resources/employment

Reads posting URLs from school_id_670_job_postings.checkpoint (this
...
Writes school_job_info/school_id_670_job_info.csv. Checkpointed to
school_id_670_job_info.checkpoint next to this script -- kill-and-resume,
