"""
Job info scraper for school_id 1346 - Rhodes College (US)
ATS platform: Workday
Careers link: https://rhodes.wd5.myworkdayjobs.com/Rhodes_Careers

Reads posting URLs from school_id_1346_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1346_job_info.csv. Checkpointed to
school_id_1346_job_info.checkpoint next to this script -- kill-and-resume,
