"""
Job info scraper for school_id 1591 - Simon Fraser University (Canada)
...
school's job_postings script). Edit it directly if Simon Fraser University's posting pages
...
Reads posting URLs from school_id_1591_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1591_job_info.csv. Checkpointed to
school_id_1591_job_info.checkpoint next to this script -- kill-and-resume,
