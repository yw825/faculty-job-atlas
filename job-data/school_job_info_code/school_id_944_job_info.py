"""
Job info scraper for school_id 944 - Hobart William Smith Colleges (US)
ATS platform: own website
Careers link: https://www.hws.edu/offices/hr/employment-opportunities/faculty.aspx

Reads posting URLs from school_id_944_job_postings.checkpoint (this
...
Writes school_job_info/school_id_944_job_info.csv. Checkpointed to
school_id_944_job_info.checkpoint next to this script -- kill-and-resume,
