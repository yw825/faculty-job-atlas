"""
Job info scraper for school_id 416 - Trine University (US)
ATS platform: own website
Careers link: https://www.trine.edu/human-resources/careers/

Reads posting URLs from school_id_416_job_postings.checkpoint (this
...
Writes school_job_info/school_id_416_job_info.csv. Checkpointed to
school_id_416_job_info.checkpoint next to this script -- kill-and-resume,
