"""
Job info scraper for school_id 1080 - Youngstown State University (US)
ATS platform: own website
Careers link: http://www.governmentjobs.com/careers/ysu/Faculty?jobType[0]=Faculty&sort=PositionTitle%7CAscending

Reads posting URLs from school_id_1080_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1080_job_info.csv. Checkpointed to
school_id_1080_job_info.checkpoint next to this script -- kill-and-resume,
