"""
Job info scraper for school_id 436 - University of Indianapolis (US)
ATS platform: own website
Careers link: https://hrjobs.uindy.edu

Reads posting URLs from school_id_436_job_postings.checkpoint (this
...
Writes school_job_info/school_id_436_job_info.csv. Checkpointed to
school_id_436_job_info.checkpoint next to this script -- kill-and-resume,
