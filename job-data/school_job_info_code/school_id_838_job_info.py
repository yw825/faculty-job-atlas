"""
Job info scraper for school_id 838 - Clarkson College (US)
ATS platform: Workday
Careers link: https://nebraskamed.wd5.myworkdayjobs.com/en-US/Clarkson

Reads posting URLs from school_id_838_job_postings.checkpoint (this
...
Writes school_job_info/school_id_838_job_info.csv. Checkpointed to
school_id_838_job_info.checkpoint next to this script -- kill-and-resume,
