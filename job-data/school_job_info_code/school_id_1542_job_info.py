"""
Job info scraper for school_id 1542 - Viterbo University (US)
ATS platform: own website
Careers link: https://www.viterbo.edu/human-resources/job-announcements

Reads posting URLs from school_id_1542_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1542_job_info.csv. Checkpointed to
school_id_1542_job_info.checkpoint next to this script -- kill-and-resume,
