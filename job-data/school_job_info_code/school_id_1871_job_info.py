"""
Job info scraper for school_id 1871 - Nottingham Trent University (United Kingdom)
ATS platform: own website
Careers link: https://www.jobs.ac.uk/search/?keywords=Nottingham%20Trent%20University
...
school's job_postings script). Edit it directly if Nottingham Trent University's posting pages
...
Reads posting URLs from school_id_1871_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1871_job_info.csv. Checkpointed to
school_id_1871_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1871
SCHOOL_NAME = 'Nottingham Trent University'
CAREERS_LINK = 'https://www.jobs.ac.uk/search/?keywords=Nottingham%20Trent%20University'
