"""
Job info scraper for school_id 962 - CUNY Graduate School and University Center (US)
ATS platform: own website
Careers link: https://cuny.jobs/campus/graduate-center/job-category/faculty/jobs/

Reads posting URLs from school_id_962_job_postings.checkpoint (this
...
Writes school_job_info/school_id_962_job_info.csv. Checkpointed to
school_id_962_job_info.checkpoint next to this script -- kill-and-resume,
