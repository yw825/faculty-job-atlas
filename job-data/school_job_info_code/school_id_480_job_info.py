"""
Job info scraper for school_id 480 - Newman University (US)
ATS platform: own website
Careers link: https://newmanu.edu/administration/human-resources/job-openings

Reads posting URLs from school_id_480_job_postings.checkpoint (this
...
Writes school_job_info/school_id_480_job_info.csv. Checkpointed to
school_id_480_job_info.checkpoint next to this script -- kill-and-resume,
