"""
Job info scraper for school_id 555 - Framingham State University (US)
ATS platform: own website
Careers link: https://www.framingham.edu/about-fsu/careers-fsu

Reads posting URLs from school_id_555_job_postings.checkpoint (this
...
Writes school_job_info/school_id_555_job_info.csv. Checkpointed to
school_id_555_job_info.checkpoint next to this script -- kill-and-resume,
