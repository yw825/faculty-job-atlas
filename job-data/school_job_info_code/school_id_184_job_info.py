"""
Job info scraper for school_id 184 - Quinnipiac University (US)
ATS platform: own website
Careers link: https://career.qu.edu/en-us/filter/?job-mail-subscribe-privacy=agree&search-keyword=&category=faculty

Reads posting URLs from school_id_184_job_postings.checkpoint (this
...
Writes school_job_info/school_id_184_job_info.csv. Checkpointed to
school_id_184_job_info.checkpoint next to this script -- kill-and-resume,
