"""
Job info scraper for school_id 1696 - National and Kapodistrian University of Athens (Greece)
ATS platform: APELLA (Greece)
...
school's job_postings script). Edit it directly if National and Kapodistrian University of Athens's posting pages
...
Reads posting URLs from school_id_1696_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1696_job_info.csv. Checkpointed to
school_id_1696_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1696
SCHOOL_NAME = 'National and Kapodistrian University of Athens'
