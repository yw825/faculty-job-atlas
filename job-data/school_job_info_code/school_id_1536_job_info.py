"""
Job info scraper for school_id 1536 - Marian University (US)
ATS platform: own website
Careers link: https://www.marianuniversity.edu/about-marian/employment/

Reads posting URLs from school_id_1536_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1536_job_info.csv. Checkpointed to
school_id_1536_job_info.checkpoint next to this script -- kill-and-resume,
