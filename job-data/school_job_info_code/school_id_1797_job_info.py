"""
Job info scraper for school_id 1797 - Queensland University of Technology (Australia)
ATS platform: PageUp/NGA
Careers link: https://qut.nga.net.au/cp/index.cfm?event=jobs.listJobs&jobListid=73e3bb51-1aa7-db29-2ea3-52af99b4f747
...
school's job_postings script). Edit it directly if Queensland University of Technology's posting pages
...
Reads posting URLs from school_id_1797_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1797_job_info.csv. Checkpointed to
school_id_1797_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://qut.nga.net.au/cp/index.cfm?event=jobs.listJobs&jobListid=73e3bb51-1aa7-db29-2ea3-52af99b4f747'
