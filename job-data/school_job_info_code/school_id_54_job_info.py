"""
Job info scraper for school_id 54 - Northern Arizona University (US)
ATS platform: own website
Careers link: https://careers.nau.edu/jobs/search?page=1&category_uids%5B%5D=16877518cdbd46262a1b4a995c2a65c2&query=

Reads posting URLs from school_id_54_job_postings.checkpoint (this
...
Writes school_job_info/school_id_54_job_info.csv. Checkpointed to
school_id_54_job_info.checkpoint next to this script -- kill-and-resume,
