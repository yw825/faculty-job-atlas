"""
Job info scraper for school_id 1534 - Saint Norbert College (US)
ATS platform: own website
Careers link: https://snc.edu/search/careers

Reads posting URLs from school_id_1534_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1534_job_info.csv. Checkpointed to
school_id_1534_job_info.checkpoint next to this script -- kill-and-resume,
