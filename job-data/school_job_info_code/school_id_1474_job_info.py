"""
Job info scraper for school_id 1474 - Virginia Military Institute (US)
ATS platform: own website
Careers link: https://www.vmi.edu/job-openings/

Reads posting URLs from school_id_1474_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1474_job_info.csv. Checkpointed to
school_id_1474_job_info.checkpoint next to this script -- kill-and-resume,
