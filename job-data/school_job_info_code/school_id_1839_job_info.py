"""
Job info scraper for school_id 1839 - Lingnan University (Hong Kong)
ATS platform: Cornerstone OnDemand
Careers link: https://lingnan.csod.com/ux/ats/careersite/4/home?c=lingnan&cfdd[0][id]=151&cfdd[0][options][0]=101
...
school's job_postings script). Edit it directly if Lingnan University's posting pages
...
Reads posting URLs from school_id_1839_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1839_job_info.csv. Checkpointed to
school_id_1839_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1839
SCHOOL_NAME = 'Lingnan University'
CAREERS_LINK = 'https://lingnan.csod.com/ux/ats/careersite/4/home?c=lingnan&cfdd[0][id]=151&cfdd[0][options][0]=101'
