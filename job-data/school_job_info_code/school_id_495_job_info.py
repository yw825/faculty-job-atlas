"""
Job info scraper for school_id 495 - University of Kentucky (US)
ATS platform: own website
Careers link: https://careers.uky.edu/careers/hr

Reads posting URLs from school_id_495_job_postings.checkpoint (this
...
Writes school_job_info/school_id_495_job_info.csv. Checkpointed to
school_id_495_job_info.checkpoint next to this script -- kill-and-resume,
