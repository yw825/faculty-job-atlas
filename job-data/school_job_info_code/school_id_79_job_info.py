"""
Job info scraper for school_id 79 - Claremont McKenna College (US)
ATS platform: own website
Careers link: https://webapps.cmc.edu/jobs/faculty/faculty_opening.php

Reads posting URLs from school_id_79_job_postings.checkpoint (this
...
Writes school_job_info/school_id_79_job_info.csv. Checkpointed to
school_id_79_job_info.checkpoint next to this script -- kill-and-resume,
