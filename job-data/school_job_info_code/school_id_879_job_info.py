"""
Job info scraper for school_id 879 - Pillar College (US)
ATS platform: own website
Careers link: https://www.pillar.edu/careers

Reads posting URLs from school_id_879_job_postings.checkpoint (this
...
Writes school_job_info/school_id_879_job_info.csv. Checkpointed to
school_id_879_job_info.checkpoint next to this script -- kill-and-resume,
