"""
Job info scraper for school_id 147 - Westmont College (US)
ATS platform: own website
Careers link: https://www.westmont.edu/office-provost/open-positions

Reads posting URLs from school_id_147_job_postings.checkpoint (this
...
Writes school_job_info/school_id_147_job_info.csv. Checkpointed to
school_id_147_job_info.checkpoint next to this script -- kill-and-resume,
