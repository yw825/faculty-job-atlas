"""
Job info scraper for school_id 536 - Emerson College (US)
ATS platform: Workday
Careers link: https://emerson.wd5.myworkdayjobs.com/en-US/Emerson_College_ft_faculty

Reads posting URLs from school_id_536_job_postings.checkpoint (this
...
Writes school_job_info/school_id_536_job_info.csv. Checkpointed to
school_id_536_job_info.checkpoint next to this script -- kill-and-resume,
