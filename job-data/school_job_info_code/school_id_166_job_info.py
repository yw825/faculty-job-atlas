"""
Job info scraper for school_id 166 - Metropolitan State University of Denver (US)
...
Reads posting URLs from school_id_166_job_postings.checkpoint (this
...
Writes school_job_info/school_id_166_job_info.csv. Checkpointed to
school_id_166_job_info.checkpoint next to this script -- kill-and-resume,
