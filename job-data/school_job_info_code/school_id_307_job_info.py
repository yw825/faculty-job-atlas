"""
Job info scraper for school_id 307 - Berry College (US)
ATS platform: own website
Careers link: https://www.berry.edu/employment/

Reads posting URLs from school_id_307_job_postings.checkpoint (this
...
Writes school_job_info/school_id_307_job_info.csv. Checkpointed to
school_id_307_job_info.checkpoint next to this script -- kill-and-resume,
