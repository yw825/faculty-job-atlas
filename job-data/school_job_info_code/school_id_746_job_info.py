"""
Job info scraper for school_id 746 - Mississippi University for Women (US)
ATS platform: PeopleAdmin
Careers link: https://muw.peopleadmin.com/

Reads posting URLs from school_id_746_job_postings.checkpoint (this
...
Writes school_job_info/school_id_746_job_info.csv. Checkpointed to
school_id_746_job_info.checkpoint next to this script -- kill-and-resume,
