"""
Job info scraper for school_id 1737 - University of Bucharest (Romania)
ATS platform: own website
Careers link: https://unibuc.ro/despre-ub/cariere/personal-didactic/posturi-vacante/
...
school's job_postings script). Edit it directly if University of Bucharest's posting pages
...
Reads posting URLs from school_id_1737_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1737_job_info.csv. Checkpointed to
school_id_1737_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1737
SCHOOL_NAME = 'University of Bucharest'
CAREERS_LINK = 'https://unibuc.ro/despre-ub/cariere/personal-didactic/posturi-vacante/'
