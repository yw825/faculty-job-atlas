"""
Job info scraper for school_id 1586 - University of Calgary (Canada)
ATS platform: own website
Careers link: https://careers.ucalgary.ca/search/academic-staff/jobs/in
...
school's job_postings script). Edit it directly if University of Calgary's posting pages
...
Reads posting URLs from school_id_1586_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1586_job_info.csv. Checkpointed to
school_id_1586_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://careers.ucalgary.ca/search/academic-staff/jobs/in'
