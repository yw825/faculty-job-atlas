"""
Job info scraper for school_id 229 - Florida Gulf Coast University (US)
ATS platform: own website
Careers link: https://jobs.fgcu.edu/jobs/search/search-page-faculty

Reads posting URLs from school_id_229_job_postings.checkpoint (this
...
Writes school_job_info/school_id_229_job_info.csv. Checkpointed to
school_id_229_job_info.checkpoint next to this script -- kill-and-resume,
