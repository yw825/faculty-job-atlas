"""
Job info scraper for school_id 424 - University of Saint Francis-Fort Wayne (US)
ATS platform: own website
Careers link: https://www.sf.edu/about/offices-and-departments/careers/

Reads posting URLs from school_id_424_job_postings.checkpoint (this
...
Writes school_job_info/school_id_424_job_info.csv. Checkpointed to
school_id_424_job_info.checkpoint next to this script -- kill-and-resume,
