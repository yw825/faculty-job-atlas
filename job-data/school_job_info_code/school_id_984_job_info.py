"""
Job info scraper for school_id 984 - State University of New York at Oswego (US)
ATS platform: own website
Careers link: https://oswego.interviewexchange.com/static/clients/313OSM1/index.jsp

Reads posting URLs from school_id_984_job_postings.checkpoint (this
...
Writes school_job_info/school_id_984_job_info.csv. Checkpointed to
school_id_984_job_info.checkpoint next to this script -- kill-and-resume,
