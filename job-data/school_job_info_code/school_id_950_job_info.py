"""
Job info scraper for school_id 950 - Ithaca College (US)
ATS platform: own website
Careers link: https://www.ithaca.edu/center-career-exploration-and-development

Reads posting URLs from school_id_950_job_postings.checkpoint (this
...
Writes school_job_info/school_id_950_job_info.csv. Checkpointed to
school_id_950_job_info.checkpoint next to this script -- kill-and-resume,
