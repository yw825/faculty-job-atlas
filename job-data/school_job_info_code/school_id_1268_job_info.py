"""
Job info scraper for school_id 1268 - Brown University (US)
ATS platform: Workday
Careers link: https://brown.wd5.myworkdayjobs.com/staff-careers-brown/jobs

Reads posting URLs from school_id_1268_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1268_job_info.csv. Checkpointed to
school_id_1268_job_info.checkpoint next to this script -- kill-and-resume,
