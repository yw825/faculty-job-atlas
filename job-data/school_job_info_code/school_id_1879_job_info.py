"""
Job info scraper for school_id 1879 - University of Greenwich (United Kingdom)
ATS platform: own website
Careers link: https://jobs.gre.ac.uk/vacancies.aspx?cat=407
...
school's job_postings script). Edit it directly if University of Greenwich's posting pages
...
Reads posting URLs from school_id_1879_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1879_job_info.csv. Checkpointed to
school_id_1879_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://jobs.gre.ac.uk/vacancies.aspx?cat=407'
