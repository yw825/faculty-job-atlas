"""
Job info scraper for school_id 213 - Wilmington University (US)
ATS platform: Taleo
Careers link: https://phh.tbe.taleo.net/phh02/ats/careers/v2/searchResults?org=WILMU&cws=60

Reads posting URLs from school_id_213_job_postings.checkpoint (this
...
Writes school_job_info/school_id_213_job_info.csv. Checkpointed to
school_id_213_job_info.checkpoint next to this script -- kill-and-resume,
