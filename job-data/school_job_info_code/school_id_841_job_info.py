"""
Job info scraper for school_id 841 - University of Nebraska at Omaha (US)
ATS platform: PeopleAdmin
Careers link: https://unomaha.peopleadmin.com/

Reads posting URLs from school_id_841_job_postings.checkpoint (this
...
Writes school_job_info/school_id_841_job_info.csv. Checkpointed to
school_id_841_job_info.checkpoint next to this script -- kill-and-resume,
