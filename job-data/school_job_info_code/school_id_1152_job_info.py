"""
Job info scraper for school_id 1152 - Mercyhurst University (US)
ATS platform: own website
Careers link: https://www.mercyhurst.edu/human-resources/jobs

Reads posting URLs from school_id_1152_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1152_job_info.csv. Checkpointed to
school_id_1152_job_info.checkpoint next to this script -- kill-and-resume,
