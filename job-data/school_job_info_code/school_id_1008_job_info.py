"""
Job info scraper for school_id 1008 - Wagner College (US)
ATS platform: own website
Careers link: https://wagner.edu/hr/hr_openings/

Reads posting URLs from school_id_1008_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1008_job_info.csv. Checkpointed to
school_id_1008_job_info.checkpoint next to this script -- kill-and-resume,
