"""
Job info scraper for school_id 1595 - University Canada West (Canada)
ATS platform: ADP
...
school's job_postings script). Edit it directly if University Canada West's posting pages
...
Reads posting URLs from school_id_1595_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1595_job_info.csv. Checkpointed to
school_id_1595_job_info.checkpoint next to this script -- kill-and-resume,
