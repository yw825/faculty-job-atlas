"""
Job info scraper for school_id 544 - Bridgewater State University (US)
ATS platform: own website
Careers link: https://careers.bridgew.edu/blog/2024/02/16/how-transparency-in-job-postings-improves-recruiting-outcomes/

Reads posting URLs from school_id_544_job_postings.checkpoint (this
...
Writes school_job_info/school_id_544_job_info.csv. Checkpointed to
school_id_544_job_info.checkpoint next to this script -- kill-and-resume,
