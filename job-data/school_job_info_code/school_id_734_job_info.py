"""
Job info scraper for school_id 734 - University of Missouri-St Louis (US)
ATS platform: own website
Careers link: https://www.umsl.edu/services/hrs/careers/index.html

Reads posting URLs from school_id_734_job_postings.checkpoint (this
...
Writes school_job_info/school_id_734_job_info.csv. Checkpointed to
school_id_734_job_info.checkpoint next to this script -- kill-and-resume,
