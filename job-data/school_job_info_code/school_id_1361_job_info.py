"""
Job info scraper for school_id 1361 - McMurry University (US)
ATS platform: own website
Careers link: https://oncampusdining.com/mcm/job-opportunities/

Reads posting URLs from school_id_1361_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1361_job_info.csv. Checkpointed to
school_id_1361_job_info.checkpoint next to this script -- kill-and-resume,
