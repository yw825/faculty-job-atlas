"""
Job info scraper for school_id 1776 - University of Oxford (United Kingdom)
ATS platform: CoreHR
...
school's job_postings script). Edit it directly if University of Oxford's posting pages
...
Reads posting URLs from school_id_1776_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1776_job_info.csv. Checkpointed to
school_id_1776_job_info.checkpoint next to this script -- kill-and-resume,
