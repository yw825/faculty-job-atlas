"""
Job info scraper for school_id 697 - University of St Thomas (US)
ATS platform: iCIMS
Careers link: https://staffemployment-stthomas.icims.com/

Reads posting URLs from school_id_697_job_postings.checkpoint (this
...
Writes school_job_info/school_id_697_job_info.csv. Checkpointed to
school_id_697_job_info.checkpoint next to this script -- kill-and-resume,
