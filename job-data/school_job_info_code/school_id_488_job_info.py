"""
Job info scraper for school_id 488 - Thomas More University (US)
ATS platform: ADP
...
Reads posting URLs from school_id_488_job_postings.checkpoint (this
...
Writes school_job_info/school_id_488_job_info.csv. Checkpointed to
school_id_488_job_info.checkpoint next to this script -- kill-and-resume,
