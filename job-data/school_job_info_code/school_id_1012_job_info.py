"""
Job info scraper for school_id 1012 - Syracuse University (US)
ATS platform: own website
Careers link: https://www.syracuse.edu/academics/career-paths/

Reads posting URLs from school_id_1012_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1012_job_info.csv. Checkpointed to
school_id_1012_job_info.checkpoint next to this script -- kill-and-resume,
