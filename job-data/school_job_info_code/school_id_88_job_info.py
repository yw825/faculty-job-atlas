"""
Job info scraper for school_id 88 - Fresno Pacific University (US)
ATS platform: own website
Careers link: https://www.schooljobs.com/careers/fresnoedu

Reads posting URLs from school_id_88_job_postings.checkpoint (this
...
Writes school_job_info/school_id_88_job_info.csv. Checkpointed to
school_id_88_job_info.checkpoint next to this script -- kill-and-resume,
