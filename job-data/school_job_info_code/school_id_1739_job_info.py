"""
Job info scraper for school_id 1739 - ESADE Business School (Spain)
ATS platform: own website
Careers link: https://esadefaculty.teamtailor.com/jobs
...
school's job_postings script). Edit it directly if ESADE Business School's posting pages
...
Reads posting URLs from school_id_1739_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1739_job_info.csv. Checkpointed to
school_id_1739_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1739
SCHOOL_NAME = 'ESADE Business School'
CAREERS_LINK = 'https://esadefaculty.teamtailor.com/jobs'
