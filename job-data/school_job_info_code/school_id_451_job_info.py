"""
Job info scraper for school_id 451 - Indiana State University (US)
ATS platform: own website
Careers link: https://jobs.indstate.edu/

Reads posting URLs from school_id_451_job_postings.checkpoint (this
...
Writes school_job_info/school_id_451_job_info.csv. Checkpointed to
school_id_451_job_info.checkpoint next to this script -- kill-and-resume,
