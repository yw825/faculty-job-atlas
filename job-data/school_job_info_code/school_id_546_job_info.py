"""
Job info scraper for school_id 546 - Massachusetts Maritime Academy (US)
ATS platform: own website
Careers link: https://www.maritime.edu/human-resources/employment-opportunities

Reads posting URLs from school_id_546_job_postings.checkpoint (this
...
Writes school_job_info/school_id_546_job_info.csv. Checkpointed to
school_id_546_job_info.checkpoint next to this script -- kill-and-resume,
