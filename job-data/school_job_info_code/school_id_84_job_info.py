"""
Job info scraper for school_id 84 - Vanguard University of Southern California (US)
ATS platform: own website
Careers link: https://www.vanguard.edu/resources/human-resources/vu-careers?post_category_id=165

Reads posting URLs from school_id_84_job_postings.checkpoint (this
...
Writes school_job_info/school_id_84_job_info.csv. Checkpointed to
school_id_84_job_info.checkpoint next to this script -- kill-and-resume,
