"""
Job info scraper for school_id 825 - University of Jamestown (US)
ATS platform: own website
Careers link: https://www.uj.edu/about/job-opportunities/

Reads posting URLs from school_id_825_job_postings.checkpoint (this
...
Writes school_job_info/school_id_825_job_info.csv. Checkpointed to
school_id_825_job_info.checkpoint next to this script -- kill-and-resume,
