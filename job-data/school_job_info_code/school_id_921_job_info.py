"""
Job info scraper for school_id 921 - St. Francis College (US)
ATS platform: own website
Careers link: https://www.sfc.edu/why-sfc/careers-at-sfc

Reads posting URLs from school_id_921_job_postings.checkpoint (this
...
Writes school_job_info/school_id_921_job_info.csv. Checkpointed to
school_id_921_job_info.checkpoint next to this script -- kill-and-resume,
