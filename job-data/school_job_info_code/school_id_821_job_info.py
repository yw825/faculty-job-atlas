"""
Job info scraper for school_id 821 - Dickinson State University (US)
ATS platform: own website
Careers link: https://dickinsonstate.edu/about/employment/open-positions/index.html

Reads posting URLs from school_id_821_job_postings.checkpoint (this
...
Writes school_job_info/school_id_821_job_info.csv. Checkpointed to
school_id_821_job_info.checkpoint next to this script -- kill-and-resume,
