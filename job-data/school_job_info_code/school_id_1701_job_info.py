"""
Job info scraper for school_id 1701 - University of Iceland (Iceland)
...
school's job_postings script). Edit it directly if University of Iceland's posting pages
...
Reads posting URLs from school_id_1701_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1701_job_info.csv. Checkpointed to
school_id_1701_job_info.checkpoint next to this script -- kill-and-resume,
