"""
Job info scraper for school_id 1223 - West Chester University of Pennsylvania (US)
ATS platform: own website
Careers link: https://www.wcupa.edu/hr/

Reads posting URLs from school_id_1223_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1223_job_info.csv. Checkpointed to
school_id_1223_job_info.checkpoint next to this script -- kill-and-resume,
