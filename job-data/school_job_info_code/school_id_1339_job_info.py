"""
Job info scraper for school_id 1339 - The University of Tennessee-Knoxville (US)
ATS platform: own website
Careers link: https://hr.utk.edu/faculty-positions/

Reads posting URLs from school_id_1339_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1339_job_info.csv. Checkpointed to
school_id_1339_job_info.checkpoint next to this script -- kill-and-resume,
