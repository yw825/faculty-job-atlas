"""
Job info scraper for school_id 923 - Long Island University (US)
ATS platform: own website
Careers link: https://jobs.liu.edu/job_details/4967

Reads posting URLs from school_id_923_job_postings.checkpoint (this
...
Writes school_job_info/school_id_923_job_info.csv. Checkpointed to
school_id_923_job_info.checkpoint next to this script -- kill-and-resume,
