"""
Job info scraper for school_id 1855 - Macau Institute of Management (Macau)
ATS platform: own website
Careers link: https://www.mim.edu.mo/?list_102/
...
school's job_postings script). Edit it directly if Macau Institute of Management's posting pages
...
Reads posting URLs from school_id_1855_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1855_job_info.csv. Checkpointed to
school_id_1855_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1855
SCHOOL_NAME = 'Macau Institute of Management'
CAREERS_LINK = 'https://www.mim.edu.mo/?list_102/'
