"""
Job info scraper for school_id 1242 - University of Puerto Rico-Carolina (US)
ATS platform: own website
Careers link: https://carolina-upr-csm.symplicity.com/

Reads posting URLs from school_id_1242_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1242_job_info.csv. Checkpointed to
school_id_1242_job_info.checkpoint next to this script -- kill-and-resume,
