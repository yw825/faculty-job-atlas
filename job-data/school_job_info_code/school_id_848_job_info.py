"""
Job info scraper for school_id 848 - New England College (US)
ATS platform: PeopleAdmin
Careers link: https://nec.peopleadmin.com

Reads posting URLs from school_id_848_job_postings.checkpoint (this
...
Writes school_job_info/school_id_848_job_info.csv. Checkpointed to
school_id_848_job_info.checkpoint next to this script -- kill-and-resume,
