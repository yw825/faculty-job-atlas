"""
Job info scraper for school_id 1247 - Universidad Ana G. Mendez-Gurabo Campus (US)
ATS platform: own website
Careers link: https://jobs.uagm.edu/Home?lang=es

Reads posting URLs from school_id_1247_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1247_job_info.csv. Checkpointed to
school_id_1247_job_info.checkpoint next to this script -- kill-and-resume,
