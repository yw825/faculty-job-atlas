"""
Job info scraper for school_id 844 - Wayne State College (US)
ATS platform: own website
Careers link: https://www.wsc.edu/directory/16/employment-opportunities/category/300

Reads posting URLs from school_id_844_job_postings.checkpoint (this
...
Writes school_job_info/school_id_844_job_info.csv. Checkpointed to
school_id_844_job_info.checkpoint next to this script -- kill-and-resume,
