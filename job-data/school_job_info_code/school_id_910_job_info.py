"""
Job info scraper for school_id 910 - Bard College (US)
ATS platform: own website
Careers link: https://www.bard.edu/humanresources/employment/

Reads posting URLs from school_id_910_job_postings.checkpoint (this
...
Writes school_job_info/school_id_910_job_info.csv. Checkpointed to
school_id_910_job_info.checkpoint next to this script -- kill-and-resume,
