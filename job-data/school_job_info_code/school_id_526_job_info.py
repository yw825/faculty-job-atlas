"""
Job info scraper for school_id 526 - Louisiana Tech University (US)
ATS platform: Workday
Careers link: https://ulsltu.wd1.myworkdayjobs.com/LATECHCareers

Reads posting URLs from school_id_526_job_postings.checkpoint (this
...
Writes school_job_info/school_id_526_job_info.csv. Checkpointed to
school_id_526_job_info.checkpoint next to this script -- kill-and-resume,
