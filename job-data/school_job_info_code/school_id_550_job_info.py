"""
Job info scraper for school_id 550 - Boston College (US)
ATS platform: own website
Careers link: https://www.bc.edu/jobs

Reads posting URLs from school_id_550_job_postings.checkpoint (this
...
Writes school_job_info/school_id_550_job_info.csv. Checkpointed to
school_id_550_job_info.checkpoint next to this script -- kill-and-resume,
