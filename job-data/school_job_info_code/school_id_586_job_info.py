"""
Job info scraper for school_id 586 - Worcester State University (US)
ATS platform: own website
Careers link: https://worcester.interviewexchange.com/

Reads posting URLs from school_id_586_job_postings.checkpoint (this
...
Writes school_job_info/school_id_586_job_info.csv. Checkpointed to
school_id_586_job_info.checkpoint next to this script -- kill-and-resume,
