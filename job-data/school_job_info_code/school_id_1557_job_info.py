"""
Job info scraper for school_id 1557 - Ripon College (US)
ATS platform: own website
Careers link: https://ripon.edu/career-discovery-tour/

Reads posting URLs from school_id_1557_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1557_job_info.csv. Checkpointed to
school_id_1557_job_info.checkpoint next to this script -- kill-and-resume,
