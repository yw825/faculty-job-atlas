"""
Job info scraper for school_id 1833 - HKCT Institute of Higher Education (Hong Kong)
...
school's job_postings script). Edit it directly if HKCT Institute of Higher Education's posting pages
...
Reads posting URLs from school_id_1833_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1833_job_info.csv. Checkpointed to
school_id_1833_job_info.checkpoint next to this script -- kill-and-resume,
