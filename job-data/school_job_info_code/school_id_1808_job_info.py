"""
Job info scraper for school_id 1808 - Adelaide University (Australia)
ATS platform: own website
Careers link: https://jobs.adelaide.edu.au/jobs/search
...
school's job_postings script). Edit it directly if Adelaide University's posting pages
...
Reads posting URLs from school_id_1808_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1808_job_info.csv. Checkpointed to
school_id_1808_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1808
SCHOOL_NAME = 'Adelaide University'
CAREERS_LINK = 'https://jobs.adelaide.edu.au/jobs/search'
