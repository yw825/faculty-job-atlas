"""
Job info scraper for school_id 769 - Belmont Abbey College (US)
ATS platform: own website
Careers link: https://belmontabbeycollege.edu/about-us/employment

Reads posting URLs from school_id_769_job_postings.checkpoint (this
...
Writes school_job_info/school_id_769_job_info.csv. Checkpointed to
school_id_769_job_info.checkpoint next to this script -- kill-and-resume,
