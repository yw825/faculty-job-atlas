"""
Job info scraper for school_id 501 - Murray State University (US)
ATS platform: own website
Careers link: https://www.murraystatejobs.com/postings/search

Reads posting URLs from school_id_501_job_postings.checkpoint (this
...
Writes school_job_info/school_id_501_job_info.csv. Checkpointed to
school_id_501_job_info.checkpoint next to this script -- kill-and-resume,
