"""
Job info scraper for school_id 316 - Valdosta State University (US)
ATS platform: own website
Careers link: http://www.valdosta.edu/administration/finance-admin/human-resources/employment-opportunities.php

Reads posting URLs from school_id_316_job_postings.checkpoint (this
...
Writes school_job_info/school_id_316_job_info.csv. Checkpointed to
school_id_316_job_info.checkpoint next to this script -- kill-and-resume,
