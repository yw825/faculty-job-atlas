"""
Job info scraper for school_id 679 - North Central University (US)
ATS platform: own website
Careers link: https://www.northcentral.edu/about/employment/current-job-openings/

Reads posting URLs from school_id_679_job_postings.checkpoint (this
...
Writes school_job_info/school_id_679_job_info.csv. Checkpointed to
school_id_679_job_info.checkpoint next to this script -- kill-and-resume,
