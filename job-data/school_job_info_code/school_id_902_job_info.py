"""
Job info scraper for school_id 902 - University of Nevada-Las Vegas (US)
ATS platform: Workday
Careers link: https://nshe.wd1.myworkdayjobs.com/UNLV-External

Reads posting URLs from school_id_902_job_postings.checkpoint (this
...
Writes school_job_info/school_id_902_job_info.csv. Checkpointed to
school_id_902_job_info.checkpoint next to this script -- kill-and-resume,
