"""
Job info scraper for school_id 355 - Buena Vista University (US)
ATS platform: own website
Careers link: https://www.bvu.edu/en/undergraduate-on-campus/careers--outcomes/

Reads posting URLs from school_id_355_job_postings.checkpoint (this
...
Writes school_job_info/school_id_355_job_info.csv. Checkpointed to
school_id_355_job_info.checkpoint next to this script -- kill-and-resume,
