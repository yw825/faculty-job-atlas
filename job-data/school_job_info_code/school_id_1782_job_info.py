"""
Job info scraper for school_id 1782 - Avondale University (Australia)
ATS platform: own website
Careers link: https://www.avondale.edu.au/jobs/
...
school's job_postings script). Edit it directly if Avondale University's posting pages
...
Reads posting URLs from school_id_1782_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1782_job_info.csv. Checkpointed to
school_id_1782_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1782
SCHOOL_NAME = 'Avondale University'
CAREERS_LINK = 'https://www.avondale.edu.au/jobs/'
