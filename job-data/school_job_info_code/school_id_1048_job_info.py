"""
Job info scraper for school_id 1048 - The University of Findlay (US)
ATS platform: Workday
Careers link: https://findlay.wd5.myworkdayjobs.com/careers

Reads posting URLs from school_id_1048_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1048_job_info.csv. Checkpointed to
school_id_1048_job_info.checkpoint next to this script -- kill-and-resume,
