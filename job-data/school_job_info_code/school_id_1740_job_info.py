"""
Job info scraper for school_id 1740 - IESE Business School (Spain)
ATS platform: own website
Careers link: https://jobs.iese.edu/
...
school's job_postings script). Edit it directly if IESE Business School's posting pages
...
Reads posting URLs from school_id_1740_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1740_job_info.csv. Checkpointed to
school_id_1740_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1740
SCHOOL_NAME = 'IESE Business School'
CAREERS_LINK = 'https://jobs.iese.edu/'
