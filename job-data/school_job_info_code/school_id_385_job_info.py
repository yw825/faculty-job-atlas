"""
Job info scraper for school_id 385 - Trinity International University-Illinois (US)
ATS platform: own website
Careers link: https://www.tiu.edu/human-resources/

Reads posting URLs from school_id_385_job_postings.checkpoint (this
...
Writes school_job_info/school_id_385_job_info.csv. Checkpointed to
school_id_385_job_info.checkpoint next to this script -- kill-and-resume,
