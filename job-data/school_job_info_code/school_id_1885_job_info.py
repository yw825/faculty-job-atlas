...
school's job_postings script). Edit it directly if Munster Technological University's posting pages
...
Reads posting URLs from school_id_1885_job_postings.checkpoint (this
