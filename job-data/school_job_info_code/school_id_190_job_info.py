"""
Job info scraper for school_id 190 - Southern Connecticut State University (US)
ATS platform: own website
Careers link: https://inside.southernct.edu/human-resources/jobs

Reads posting URLs from school_id_190_job_postings.checkpoint (this
...
Writes school_job_info/school_id_190_job_info.csv. Checkpointed to
school_id_190_job_info.checkpoint next to this script -- kill-and-resume,
