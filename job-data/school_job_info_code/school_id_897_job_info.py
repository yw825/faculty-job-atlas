"""
Job info scraper for school_id 897 - Institute of American Indian and Alaska Native Culture and Arts Development (US)
ATS platform: own website
Careers link: https://iaia.edu/about/employment/

Reads posting URLs from school_id_897_job_postings.checkpoint (this
...
Writes school_job_info/school_id_897_job_info.csv. Checkpointed to
school_id_897_job_info.checkpoint next to this script -- kill-and-resume,
