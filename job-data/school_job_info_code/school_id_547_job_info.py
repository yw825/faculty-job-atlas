"""
Job info scraper for school_id 547 - Harvard University (US)
ATS platform: own website
Careers link: https://hr.harvard.edu/careers

Reads posting URLs from school_id_547_job_postings.checkpoint (this
...
Writes school_job_info/school_id_547_job_info.csv. Checkpointed to
school_id_547_job_info.checkpoint next to this script -- kill-and-resume,
