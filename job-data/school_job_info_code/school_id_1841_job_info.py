"""
Job info scraper for school_id 1841 - Technological and Higher Education Institute of Hong Kong (Hong Kong)
ATS platform: own website
Careers link: https://www.thei.edu.hk/about-thei/career-opportunities
...
school's job_postings script). Edit it directly if Technological and Higher Education Institute of Hong Kong's posting pages
...
Reads posting URLs from school_id_1841_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1841_job_info.csv. Checkpointed to
school_id_1841_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1841
SCHOOL_NAME = 'Technological and Higher Education Institute of Hong Kong'
CAREERS_LINK = 'https://www.thei.edu.hk/about-thei/career-opportunities'
