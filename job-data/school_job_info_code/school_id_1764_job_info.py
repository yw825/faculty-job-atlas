"""
Job info scraper for school_id 1764 - University of Bristol (United Kingdom)
ATS platform: own website
Careers link: https://www.bristol.ac.uk/jobs/find/
...
school's job_postings script). Edit it directly if University of Bristol's posting pages
...
Reads posting URLs from school_id_1764_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1764_job_info.csv. Checkpointed to
school_id_1764_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1764
SCHOOL_NAME = 'University of Bristol'
CAREERS_LINK = 'https://www.bristol.ac.uk/jobs/find/'
