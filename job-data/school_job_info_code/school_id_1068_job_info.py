"""
Job info scraper for school_id 1068 - Franciscan University of Steubenville (US)
ATS platform: own website
Careers link: http://franciscan.edu/faculty-openings/

Reads posting URLs from school_id_1068_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1068_job_info.csv. Checkpointed to
school_id_1068_job_info.checkpoint next to this script -- kill-and-resume,
