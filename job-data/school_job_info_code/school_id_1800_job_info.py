"""
Job info scraper for school_id 1800 - CQUniversity (Australia)
ATS platform: own website
Careers link: https://careers.cqu.edu.au/go/Academic-&-ELICOS-Jobs/7956910/
...
school's job_postings script). Edit it directly if CQUniversity's posting pages
...
Reads posting URLs from school_id_1800_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1800_job_info.csv. Checkpointed to
school_id_1800_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://careers.cqu.edu.au/go/Academic-&-ELICOS-Jobs/7956910/'
