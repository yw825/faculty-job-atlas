"""
Job info scraper for school_id 1836 - Hong Kong Metropolitan University (Hong Kong)
ATS platform: Taleo
Careers link: https://hkmu.taleo.net/careersection/ex_full_time/jobsearch.ftl?lang=en&portal=101430233
...
school's job_postings script). Edit it directly if Hong Kong Metropolitan University's posting pages
...
Reads posting URLs from school_id_1836_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1836_job_info.csv. Checkpointed to
school_id_1836_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://hkmu.taleo.net/careersection/ex_full_time/jobsearch.ftl?lang=en&portal=101430233'
ATS_PLATFORM = 'Taleo'
