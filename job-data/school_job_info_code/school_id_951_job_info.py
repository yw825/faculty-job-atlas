"""
Job info scraper for school_id 951 - CUNY York College (US)
ATS platform: own website
Careers link: https://cuny.jobs/campus/york-college/job-category/faculty/jobs/

Reads posting URLs from school_id_951_job_postings.checkpoint (this
...
Writes school_job_info/school_id_951_job_info.csv. Checkpointed to
school_id_951_job_info.checkpoint next to this script -- kill-and-resume,
