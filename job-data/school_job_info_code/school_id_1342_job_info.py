"""
Job info scraper for school_id 1342 - Maryville College (US)
ATS platform: own website
Careers link: https://www.maryvillecollege.edu/about/inside/human-resources/careers/

Reads posting URLs from school_id_1342_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1342_job_info.csv. Checkpointed to
school_id_1342_job_info.checkpoint next to this script -- kill-and-resume,
