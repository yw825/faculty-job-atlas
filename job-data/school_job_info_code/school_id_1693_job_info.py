"""
Job info scraper for school_id 1693 - Technical University of Munich (Germany)
ATS platform: own website
Careers link: https://portal.mytum.de/jobs/professuren
...
school's job_postings script). Edit it directly if Technical University of Munich's posting pages
...
Reads posting URLs from school_id_1693_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1693_job_info.csv. Checkpointed to
school_id_1693_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1693
SCHOOL_NAME = 'Technical University of Munich'
CAREERS_LINK = 'https://portal.mytum.de/jobs/professuren'
