"""
Job info scraper for school_id 126 - California State University-San Bernardino (US)
...
Reads posting URLs from school_id_126_job_postings.checkpoint (this
...
Writes school_job_info/school_id_126_job_info.csv. Checkpointed to
school_id_126_job_info.checkpoint next to this script -- kill-and-resume,
