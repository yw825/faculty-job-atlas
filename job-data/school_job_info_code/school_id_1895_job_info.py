"""
Job info scraper for school_id 1895 - MacEwan University (Canada)
ATS platform: own website
Careers link: https://www.macewan.ca/about-macewan/careers/opportunities/
...
school's job_postings script). Edit it directly if MacEwan University's posting pages
...
Reads posting URLs from school_id_1895_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1895_job_info.csv. Checkpointed to
school_id_1895_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1895
SCHOOL_NAME = 'MacEwan University'
CAREERS_LINK = 'https://www.macewan.ca/about-macewan/careers/opportunities/'
