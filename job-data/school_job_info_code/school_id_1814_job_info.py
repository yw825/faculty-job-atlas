"""
Job info scraper for school_id 1814 - RMIT University (Australia)
ATS platform: Workday
Careers link: https://rmit.wd3.myworkdayjobs.com/RMIT_Careers
...
school's job_postings script). Edit it directly if RMIT University's posting pages
...
Reads posting URLs from school_id_1814_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1814_job_info.csv. Checkpointed to
school_id_1814_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://rmit.wd3.myworkdayjobs.com/RMIT_Careers'
