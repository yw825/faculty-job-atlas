"""
Job info scraper for school_id 1887 - University of Twente (Netherlands)
...
school's job_postings script). Edit it directly if University of Twente's posting pages
...
Reads posting URLs from school_id_1887_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1887_job_info.csv. Checkpointed to
school_id_1887_job_info.checkpoint next to this script -- kill-and-resume,
