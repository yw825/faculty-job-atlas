"""
Job info scraper for school_id 1307 - Northern State University (US)
ATS platform: own website
Careers link: https://northern.edu/about/departments/human-resources

Reads posting URLs from school_id_1307_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1307_job_info.csv. Checkpointed to
school_id_1307_job_info.checkpoint next to this script -- kill-and-resume,
