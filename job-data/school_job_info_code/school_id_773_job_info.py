"""
Job info scraper for school_id 773 - Campbell University (US)
ATS platform: Taleo
Careers link: https://phg.tbe.taleo.net/phg01/ats/careers/v2/jobSearch?act=redirectCwsV2&cws=37&org=CAMPUNIV

Reads posting URLs from school_id_773_job_postings.checkpoint (this
...
Writes school_job_info/school_id_773_job_info.csv. Checkpointed to
school_id_773_job_info.checkpoint next to this script -- kill-and-resume,
