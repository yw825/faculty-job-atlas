"""
Job info scraper for school_id 589 - Goucher College (US)
ATS platform: Workday
Careers link: https://goucher.wd1.myworkdayjobs.com/Goucher_Careers

Reads posting URLs from school_id_589_job_postings.checkpoint (this
...
Writes school_job_info/school_id_589_job_info.csv. Checkpointed to
school_id_589_job_info.checkpoint next to this script -- kill-and-resume,
