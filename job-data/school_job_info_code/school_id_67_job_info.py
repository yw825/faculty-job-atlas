"""
Job info scraper for school_id 67 - Pacific Union College (US)
ATS platform: own website
Careers link: https://www.puc.edu/campus-services/human-resources/faculty-job-postings

Reads posting URLs from school_id_67_job_postings.checkpoint (this
...
Writes school_job_info/school_id_67_job_info.csv. Checkpointed to
school_id_67_job_info.checkpoint next to this script -- kill-and-resume,
