"""
Job info scraper for school_id 615 - Maine Maritime Academy (US)
ATS platform: own website
Careers link: https://mainemaritime.edu/employment-at-mma/faculty-positions/

Reads posting URLs from school_id_615_job_postings.checkpoint (this
...
Writes school_job_info/school_id_615_job_info.csv. Checkpointed to
school_id_615_job_info.checkpoint next to this script -- kill-and-resume,
