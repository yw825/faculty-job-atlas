"""
Job info scraper for school_id 828 - Valley City State University (US)
ATS platform: own website
Careers link: https://www.vcsu.edu/jobs/

Reads posting URLs from school_id_828_job_postings.checkpoint (this
...
Writes school_job_info/school_id_828_job_info.csv. Checkpointed to
school_id_828_job_info.checkpoint next to this script -- kill-and-resume,
