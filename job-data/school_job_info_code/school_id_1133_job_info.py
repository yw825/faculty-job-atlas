"""
Job info scraper for school_id 1133 - University of Pittsburgh-Bradford (US)
ATS platform: Taleo
...
Reads posting URLs from school_id_1133_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1133_job_info.csv. Checkpointed to
school_id_1133_job_info.checkpoint next to this script -- kill-and-resume,
