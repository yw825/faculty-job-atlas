"""
Job info scraper for school_id 1105 - Southern Oregon University (US)
ATS platform: own website
Careers link: https://hrs.sou.edu/working-at-sou/search-jobs/

Reads posting URLs from school_id_1105_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1105_job_info.csv. Checkpointed to
school_id_1105_job_info.checkpoint next to this script -- kill-and-resume,
