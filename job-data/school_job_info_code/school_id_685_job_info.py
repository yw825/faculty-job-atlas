"""
Job info scraper for school_id 685 - Carleton College (US)
ATS platform: own website
Careers link: https://www.myworkday.com/carleton/d/home.htmld

Reads posting URLs from school_id_685_job_postings.checkpoint (this
...
Writes school_job_info/school_id_685_job_info.csv. Checkpointed to
school_id_685_job_info.checkpoint next to this script -- kill-and-resume,
