"""
Job info scraper for school_id 649 - Kalamazoo College (US)
...
Reads posting URLs from school_id_649_job_postings.checkpoint (this
...
Writes school_job_info/school_id_649_job_info.csv. Checkpointed to
school_id_649_job_info.checkpoint next to this script -- kill-and-resume,
