"""
Job info scraper for school_id 569 - Salem State University (US)
ATS platform: own website
Careers link: https://salem-state-university.career-pages.com/jobs/search

Reads posting URLs from school_id_569_job_postings.checkpoint (this
...
Writes school_job_info/school_id_569_job_info.csv. Checkpointed to
school_id_569_job_info.checkpoint next to this script -- kill-and-resume,
