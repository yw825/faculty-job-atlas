"""
Job info scraper for school_id 818 - Wake Forest University (US)
ATS platform: Workday
Careers link: https://wfu.wd1.myworkdayjobs.com/Faculty_Career_Website_live

Reads posting URLs from school_id_818_job_postings.checkpoint (this
...
Writes school_job_info/school_id_818_job_info.csv. Checkpointed to
school_id_818_job_info.checkpoint next to this script -- kill-and-resume,
