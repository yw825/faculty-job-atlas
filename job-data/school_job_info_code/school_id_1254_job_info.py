"""
Job info scraper for school_id 1254 - Inter American University of Puerto Rico-Ponce (US)
ATS platform: own website
Careers link: https://ponce.inter.edu/recursos-humanos-2/

Reads posting URLs from school_id_1254_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1254_job_info.csv. Checkpointed to
school_id_1254_job_info.checkpoint next to this script -- kill-and-resume,
