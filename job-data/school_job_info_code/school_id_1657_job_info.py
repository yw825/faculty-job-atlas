"""
Job info scraper for school_id 1657 - University of Innsbruck (Austria)
ATS platform: own website
Careers link: https://lfuonline.uibk.ac.at/public/karriereportal.home?lang=de
...
school's job_postings script). Edit it directly if University of Innsbruck's posting pages
...
Reads posting URLs from school_id_1657_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1657_job_info.csv. Checkpointed to
school_id_1657_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1657
SCHOOL_NAME = 'University of Innsbruck'
CAREERS_LINK = 'https://lfuonline.uibk.ac.at/public/karriereportal.home?lang=de'
