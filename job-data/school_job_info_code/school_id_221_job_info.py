"""
Job info scraper for school_id 221 - Lynn University (US)
ATS platform: own website
Careers link: https://www.lynn.edu/employment

Reads posting URLs from school_id_221_job_postings.checkpoint (this
...
Writes school_job_info/school_id_221_job_info.csv. Checkpointed to
school_id_221_job_info.checkpoint next to this script -- kill-and-resume,
