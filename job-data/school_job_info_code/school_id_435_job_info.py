"""
Job info scraper for school_id 435 - Martin University (US)
ATS platform: own website
Careers link: https://www.martin.edu/jobreadyindy

Reads posting URLs from school_id_435_job_postings.checkpoint (this
...
Writes school_job_info/school_id_435_job_info.csv. Checkpointed to
school_id_435_job_info.checkpoint next to this script -- kill-and-resume,
