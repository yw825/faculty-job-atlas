"""
Job info scraper for school_id 446 - Oakland City University (US)
ATS platform: own website
Careers link: https://www.oak.edu/academics/career-pathways-program/

Reads posting URLs from school_id_446_job_postings.checkpoint (this
...
Writes school_job_info/school_id_446_job_info.csv. Checkpointed to
school_id_446_job_info.checkpoint next to this script -- kill-and-resume,
