"""
Job info scraper for school_id 489 - Centre College (US)
ATS platform: own website
Careers link: https://careers.centre.edu/channels/search-for-a-job/

Reads posting URLs from school_id_489_job_postings.checkpoint (this
...
Writes school_job_info/school_id_489_job_info.csv. Checkpointed to
school_id_489_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://careers.centre.edu/channels/search-for-a-job/'
