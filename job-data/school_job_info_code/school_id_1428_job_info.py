"""
Job info scraper for school_id 1428 - Trinity University (US)
ATS platform: own website
Careers link: https://trinity.edu/hr/careers

Reads posting URLs from school_id_1428_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1428_job_info.csv. Checkpointed to
school_id_1428_job_info.checkpoint next to this script -- kill-and-resume,
