"""
Job info scraper for school_id 1052 - Hiram College (US)
ATS platform: own website
Careers link: https://www.hiram.edu/about-hiram-college/human-resources/careers-at-hiram/

Reads posting URLs from school_id_1052_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1052_job_info.csv. Checkpointed to
school_id_1052_job_info.checkpoint next to this script -- kill-and-resume,
