"""
Job info scraper for school_id 661 - Spring Arbor University (US)
ATS platform: own website
Careers link: https://springarbor.edu/about/offices-and-schools/human-resources/careers.php

Reads posting URLs from school_id_661_job_postings.checkpoint (this
...
Writes school_job_info/school_id_661_job_info.csv. Checkpointed to
school_id_661_job_info.checkpoint next to this script -- kill-and-resume,
