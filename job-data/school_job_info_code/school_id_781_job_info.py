"""
Job info scraper for school_id 781 - Duke University (US)
ATS platform: own website
Careers link: https://hr.duke.edu/careers/new-duke/

Reads posting URLs from school_id_781_job_postings.checkpoint (this
...
Writes school_job_info/school_id_781_job_info.csv. Checkpointed to
school_id_781_job_info.checkpoint next to this script -- kill-and-resume,
