"""
Job info scraper for school_id 505 - Alice Lloyd College (US)
ATS platform: own website
Careers link: https://alc.edu/special-learning-opportunities/

Reads posting URLs from school_id_505_job_postings.checkpoint (this
...
Writes school_job_info/school_id_505_job_info.csv. Checkpointed to
school_id_505_job_info.checkpoint next to this script -- kill-and-resume,
