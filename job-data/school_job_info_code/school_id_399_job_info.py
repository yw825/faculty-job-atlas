"""
Job info scraper for school_id 399 - Benedictine University (US)
ATS platform: Cornerstone OnDemand
Careers link: https://benu.csod.com/ux/ats/careersite/5/home?c=benu

Reads posting URLs from school_id_399_job_postings.checkpoint (this
...
Writes school_job_info/school_id_399_job_info.csv. Checkpointed to
school_id_399_job_info.checkpoint next to this script -- kill-and-resume,
