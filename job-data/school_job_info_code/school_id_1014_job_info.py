"""
Job info scraper for school_id 1014 - Rensselaer Polytechnic Institute (US)
ATS platform: PageUp
Careers link: https://rpi.dc4.pageuppeople.com/dashboard

Reads posting URLs from school_id_1014_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1014_job_info.csv. Checkpointed to
school_id_1014_job_info.checkpoint next to this script -- kill-and-resume,
