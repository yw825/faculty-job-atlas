"""
Job info scraper for school_id 625 - Adrian College (US)
ATS platform: own website
Careers link: https://www.adrian.edu/academics/academics/career-planning/job-search

Reads posting URLs from school_id_625_job_postings.checkpoint (this
...
Writes school_job_info/school_id_625_job_info.csv. Checkpointed to
school_id_625_job_info.checkpoint next to this script -- kill-and-resume,
