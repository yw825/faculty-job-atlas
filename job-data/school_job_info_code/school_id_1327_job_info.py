"""
Job info scraper for school_id 1327 - Tennessee Technological University (US)
ATS platform: own website
Careers link: https://jobs.tntech.edu/

Reads posting URLs from school_id_1327_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1327_job_info.csv. Checkpointed to
school_id_1327_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://jobs.tntech.edu/'
