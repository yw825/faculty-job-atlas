"""
Job info scraper for school_id 165 - University of Colorado Colorado Springs (US)
ATS platform: Taleo
...
Reads posting URLs from school_id_165_job_postings.checkpoint (this
...
Writes school_job_info/school_id_165_job_info.csv. Checkpointed to
school_id_165_job_info.checkpoint next to this script -- kill-and-resume,
