"""
Job info scraper for school_id 859 - Caldwell University (US)
ATS platform: own website
Careers link: https://www.caldwell.edu/hr/employment-opportunities/faculty-full-time/

Reads posting URLs from school_id_859_job_postings.checkpoint (this
...
Writes school_job_info/school_id_859_job_info.csv. Checkpointed to
school_id_859_job_info.checkpoint next to this script -- kill-and-resume,
