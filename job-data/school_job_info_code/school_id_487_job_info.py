"""
Job info scraper for school_id 487 - Lindsey Wilson College (US)
ATS platform: own website
Careers link: https://lindsey.elluciancrmrecruit.com/Apply/Account/Create

Reads posting URLs from school_id_487_job_postings.checkpoint (this
...
Writes school_job_info/school_id_487_job_info.csv. Checkpointed to
school_id_487_job_info.checkpoint next to this script -- kill-and-resume,
