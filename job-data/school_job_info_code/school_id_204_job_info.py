"""
Job info scraper for school_id 204 - George Washington University (US)
ATS platform: own website
Careers link: https://careers.gwu.edu/

Reads posting URLs from school_id_204_job_postings.checkpoint (this
...
Writes school_job_info/school_id_204_job_info.csv. Checkpointed to
school_id_204_job_info.checkpoint next to this script -- kill-and-resume,
