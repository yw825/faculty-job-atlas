"""
Job info scraper for school_id 1304 - Wofford College (US)
ATS platform: Workday
Careers link: https://wofford.wd5.myworkdayjobs.com/Wofford

Reads posting URLs from school_id_1304_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1304_job_info.csv. Checkpointed to
school_id_1304_job_info.checkpoint next to this script -- kill-and-resume,
