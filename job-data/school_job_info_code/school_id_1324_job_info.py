"""
Job info scraper for school_id 1324 - Austin Peay State University (US)
ATS platform: own website
Careers link: https://www.apsu.edu/human-resources/govs-suite.php

Reads posting URLs from school_id_1324_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1324_job_info.csv. Checkpointed to
school_id_1324_job_info.checkpoint next to this script -- kill-and-resume,
