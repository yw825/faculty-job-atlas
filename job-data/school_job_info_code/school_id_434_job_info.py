"""
Job info scraper for school_id 434 - Marian University (US)
...
Reads posting URLs from school_id_434_job_postings.checkpoint (this
...
Writes school_job_info/school_id_434_job_info.csv. Checkpointed to
school_id_434_job_info.checkpoint next to this script -- kill-and-resume,
