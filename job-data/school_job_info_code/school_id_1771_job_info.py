"""
Job info scraper for school_id 1771 - King's College London (United Kingdom)
ATS platform: own website
Careers link: https://www.kcl.ac.uk/jobs/search?term=
...
school's job_postings script). Edit it directly if King's College London's posting pages
...
Reads posting URLs from school_id_1771_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1771_job_info.csv. Checkpointed to
school_id_1771_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://www.kcl.ac.uk/jobs/search?term='
