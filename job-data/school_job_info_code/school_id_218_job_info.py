"""
Job info scraper for school_id 218 - Webber International University (US)
ATS platform: own website
Careers link: https://www.webber.edu/jobs-at-webber/

Reads posting URLs from school_id_218_job_postings.checkpoint (this
...
Writes school_job_info/school_id_218_job_info.csv. Checkpointed to
school_id_218_job_info.checkpoint next to this script -- kill-and-resume,
