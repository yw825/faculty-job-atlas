"""
Job info scraper for school_id 965 - Columbia University in the City of New York (US)
ATS platform: own website
Careers link: https://academic.careers.columbia.edu/

Reads posting URLs from school_id_965_job_postings.checkpoint (this
...
Writes school_job_info/school_id_965_job_info.csv. Checkpointed to
school_id_965_job_info.checkpoint next to this script -- kill-and-resume,
