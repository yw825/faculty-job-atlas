"""
Job info scraper for school_id 646 - Hope College (US)
ATS platform: own website
Careers link: https://hope.edu/offices/boerigter-center/

Reads posting URLs from school_id_646_job_postings.checkpoint (this
...
Writes school_job_info/school_id_646_job_info.csv. Checkpointed to
school_id_646_job_info.checkpoint next to this script -- kill-and-resume,
