"""
Job info scraper for school_id 533 - Endicott College (US)
ATS platform: Workday
Careers link: https://endicott.wd1.myworkdayjobs.com/Endicott

Reads posting URLs from school_id_533_job_postings.checkpoint (this
...
Writes school_job_info/school_id_533_job_info.csv. Checkpointed to
school_id_533_job_info.checkpoint next to this script -- kill-and-resume,
