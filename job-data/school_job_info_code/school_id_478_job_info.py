"""
Job info scraper for school_id 478 - Washburn University (US)
ATS platform: own website
Careers link: https://careers.washburn.edu/jobs/search

Reads posting URLs from school_id_478_job_postings.checkpoint (this
...
Writes school_job_info/school_id_478_job_info.csv. Checkpointed to
school_id_478_job_info.checkpoint next to this script -- kill-and-resume,
