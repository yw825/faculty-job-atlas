"""
Job info scraper for school_id 1441 - Midwestern State University (US)
ATS platform: own website
Careers link: https://msutexas.edu/human-resources/jobs/index.php

Reads posting URLs from school_id_1441_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1441_job_info.csv. Checkpointed to
school_id_1441_job_info.checkpoint next to this script -- kill-and-resume,
