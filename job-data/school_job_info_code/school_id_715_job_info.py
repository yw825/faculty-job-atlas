"""
Job info scraper for school_id 715 - Calvary University (US)
ATS platform: own website
Careers link: https://www.calvary.edu/employment/work-at-calvary/

Reads posting URLs from school_id_715_job_postings.checkpoint (this
...
Writes school_job_info/school_id_715_job_info.csv. Checkpointed to
school_id_715_job_info.checkpoint next to this script -- kill-and-resume,
