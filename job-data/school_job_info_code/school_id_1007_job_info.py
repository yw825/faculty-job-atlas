"""
Job info scraper for school_id 1007 - College of Staten Island CUNY (US)
ATS platform: own website
Careers link: https://cuny.jobs/campus/college-of-staten-island/job-category/faculty/jobs/

Reads posting URLs from school_id_1007_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1007_job_info.csv. Checkpointed to
school_id_1007_job_info.checkpoint next to this script -- kill-and-resume,
