"""
Job info scraper for school_id 306 - Clayton  State University (US)
ATS platform: own website
Careers link: https://www.clayton.edu/human-resources/employment-opportunities

Reads posting URLs from school_id_306_job_postings.checkpoint (this
...
Writes school_job_info/school_id_306_job_info.csv. Checkpointed to
school_id_306_job_info.checkpoint next to this script -- kill-and-resume,
