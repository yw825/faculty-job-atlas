"""
Job info scraper for school_id 558 - University of Massachusetts-Lowell (US)
ATS platform: own website
Careers link: https://www.uml.edu/academics/programs/?career=undergraduate&utm_source=home

Reads posting URLs from school_id_558_job_postings.checkpoint (this
...
Writes school_job_info/school_id_558_job_info.csv. Checkpointed to
school_id_558_job_info.checkpoint next to this script -- kill-and-resume,
