"""
Job info scraper for school_id 528 - Louisiana State University-Shreveport (US)
ATS platform: own website
Careers link: https://lsus.edu2.com/topic/programsteps

Reads posting URLs from school_id_528_job_postings.checkpoint (this
...
Writes school_job_info/school_id_528_job_info.csv. Checkpointed to
school_id_528_job_info.checkpoint next to this script -- kill-and-resume,
