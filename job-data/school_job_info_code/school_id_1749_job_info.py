"""
Job info scraper for school_id 1749 - KTH Royal Institute of Technology (Sweden)
ATS platform: own website
Careers link: https://www.kth.se/lediga-jobb?l=en
...
school's job_postings script). Edit it directly if KTH Royal Institute of Technology's posting pages
...
Reads posting URLs from school_id_1749_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1749_job_info.csv. Checkpointed to
school_id_1749_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1749
SCHOOL_NAME = 'KTH Royal Institute of Technology'
CAREERS_LINK = 'https://www.kth.se/lediga-jobb?l=en'
