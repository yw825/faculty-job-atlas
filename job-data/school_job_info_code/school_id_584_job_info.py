"""
Job info scraper for school_id 584 - College of the Holy Cross (US)
ATS platform: Workday
Careers link: https://holycross.wd12.myworkdayjobs.com/en-US/Careers/

Reads posting URLs from school_id_584_job_postings.checkpoint (this
...
Writes school_job_info/school_id_584_job_info.csv. Checkpointed to
school_id_584_job_info.checkpoint next to this script -- kill-and-resume,
