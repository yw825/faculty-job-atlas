"""
Job info scraper for school_id 1128 - Lebanon Valley College (US)
ATS platform: own website
Careers link: https://www.lvc.edu/breen-center/

Reads posting URLs from school_id_1128_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1128_job_info.csv. Checkpointed to
school_id_1128_job_info.checkpoint next to this script -- kill-and-resume,
