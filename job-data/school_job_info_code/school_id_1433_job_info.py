"""
Job info scraper for school_id 1433 - North American University (US)
ATS platform: own website
Careers link: https://www.na.edu/faculty-staff/human-resources/employment-opportunities/

Reads posting URLs from school_id_1433_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1433_job_info.csv. Checkpointed to
school_id_1433_job_info.checkpoint next to this script -- kill-and-resume,
