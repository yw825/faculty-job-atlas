"""
Job info scraper for school_id 242 - Florida Institute of Technology (US)
ATS platform: Workday
Careers link: https://floridatech.wd5.myworkdayjobs.com/FloridaTechCareers

Reads posting URLs from school_id_242_job_postings.checkpoint (this
...
Writes school_job_info/school_id_242_job_info.csv. Checkpointed to
school_id_242_job_info.checkpoint next to this script -- kill-and-resume,
