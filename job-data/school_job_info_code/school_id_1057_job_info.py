"""
Job info scraper for school_id 1057 - Ohio State University-Marion Campus (US)
ATS platform: own website
Careers link: https://osumarion.osu.edu/engineering/career-opportunities-engineering

Reads posting URLs from school_id_1057_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1057_job_info.csv. Checkpointed to
school_id_1057_job_info.checkpoint next to this script -- kill-and-resume,
