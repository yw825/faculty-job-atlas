"""
Job info scraper for school_id 1244 - Inter American University of Puerto Rico-Fajardo (US)
ATS platform: own website
Careers link: https://fajardo.inter.edu/empleos/

Reads posting URLs from school_id_1244_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1244_job_info.csv. Checkpointed to
school_id_1244_job_info.checkpoint next to this script -- kill-and-resume,
