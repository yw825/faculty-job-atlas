"""
Job info scraper for school_id 862 - Stockton University (US)
ATS platform: own website
Careers link: https://employment.stockton.edu/jobs/search

Reads posting URLs from school_id_862_job_postings.checkpoint (this
...
Writes school_job_info/school_id_862_job_info.csv. Checkpointed to
school_id_862_job_info.checkpoint next to this script -- kill-and-resume,
