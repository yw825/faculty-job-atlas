"""
Job info scraper for school_id 1450 - Western Governors University (US)
ATS platform: own website
Careers link: https://jobs.wgu.edu/academic-careers

Reads posting URLs from school_id_1450_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1450_job_info.csv. Checkpointed to
school_id_1450_job_info.checkpoint next to this script -- kill-and-resume,
