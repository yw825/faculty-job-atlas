"""
Job info scraper for school_id 1568 - West Virginia Wesleyan College (US)
ATS platform: own website
Careers link: https://www.wvwc.edu/jobs/?faculty

Reads posting URLs from school_id_1568_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1568_job_info.csv. Checkpointed to
school_id_1568_job_info.checkpoint next to this script -- kill-and-resume,
