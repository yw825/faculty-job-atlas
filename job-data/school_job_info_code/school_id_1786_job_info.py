"""
Job info scraper for school_id 1786 - Australian Catholic University (Australia)
ATS platform: own website
Careers link: https://www.acu.edu.au/about-acu/careers-at-acu/how-to-apply/job-vacancies
...
school's job_postings script). Edit it directly if Australian Catholic University's posting pages
...
Reads posting URLs from school_id_1786_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1786_job_info.csv. Checkpointed to
school_id_1786_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://www.acu.edu.au/about-acu/careers-at-acu/how-to-apply/job-vacancies'
