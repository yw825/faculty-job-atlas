"""
Job info scraper for school_id 540 - Simmons University (US)
ATS platform: Workday
Careers link: https://simmons.wd504.myworkdayjobs.com/Simmons-Careers

Reads posting URLs from school_id_540_job_postings.checkpoint (this
...
Writes school_job_info/school_id_540_job_info.csv. Checkpointed to
school_id_540_job_info.checkpoint next to this script -- kill-and-resume,
