"""
Job info scraper for school_id 1266 - University of Rhode Island (US)
ATS platform: own website
Careers link: https://jobs.uri.edu/postings/search

Reads posting URLs from school_id_1266_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1266_job_info.csv. Checkpointed to
school_id_1266_job_info.checkpoint next to this script -- kill-and-resume,
