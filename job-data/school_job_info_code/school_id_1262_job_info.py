"""
Job info scraper for school_id 1262 - University of Puerto Rico-Rio Piedras (US)
ATS platform: own website
Careers link: https://recursoshumanos.uprrp.edu/

Reads posting URLs from school_id_1262_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1262_job_info.csv. Checkpointed to
school_id_1262_job_info.checkpoint next to this script -- kill-and-resume,
