"""
Job info scraper for school_id 1112 - Eastern Oregon University (US)
ATS platform: PeopleAdmin
Careers link: http://eou.peopleadmin.com

Reads posting URLs from school_id_1112_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1112_job_info.csv. Checkpointed to
school_id_1112_job_info.checkpoint next to this script -- kill-and-resume,
