"""
Job info scraper for school_id 1625 - University of Ottawa (Canada)
ATS platform: Workday
Careers link: https://uottawa.wd3.myworkdayjobs.com/en-US/uOttawa_External_Career_Site
...
school's job_postings script). Edit it directly if University of Ottawa's posting pages
...
Reads posting URLs from school_id_1625_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1625_job_info.csv. Checkpointed to
school_id_1625_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://uottawa.wd3.myworkdayjobs.com/en-US/uOttawa_External_Career_Site'
