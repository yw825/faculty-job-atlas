"""
Job info scraper for school_id 598 - University of Maryland-College Park (US)
ATS platform: Workday
Careers link: https://umd.wd1.myworkdayjobs.com/UMCP

Reads posting URLs from school_id_598_job_postings.checkpoint (this
...
Writes school_job_info/school_id_598_job_info.csv. Checkpointed to
school_id_598_job_info.checkpoint next to this script -- kill-and-resume,
