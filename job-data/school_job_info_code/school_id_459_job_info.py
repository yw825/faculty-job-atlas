"""
Job info scraper for school_id 459 - Baker University (US)
ATS platform: own website
Careers link: https://www.bakeru.edu/about-baker/careers-baker

Reads posting URLs from school_id_459_job_postings.checkpoint (this
...
Writes school_job_info/school_id_459_job_info.csv. Checkpointed to
school_id_459_job_info.checkpoint next to this script -- kill-and-resume,
