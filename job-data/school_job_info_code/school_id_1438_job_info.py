"""
Job info scraper for school_id 1438 - University of Houston-Victoria (US)
ATS platform: Workday
Careers link: https://tamus.wd1.myworkdayjobs.com/TAMUV_External

Reads posting URLs from school_id_1438_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1438_job_info.csv. Checkpointed to
school_id_1438_job_info.checkpoint next to this script -- kill-and-resume,
