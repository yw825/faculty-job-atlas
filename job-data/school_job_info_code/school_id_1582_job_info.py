"""
Job info scraper for school_id 1582 - Wheeling University (US)
ATS platform: own website
Careers link: https://wheeling.edu/about/employment/

Reads posting URLs from school_id_1582_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1582_job_info.csv. Checkpointed to
school_id_1582_job_info.checkpoint next to this script -- kill-and-resume,
