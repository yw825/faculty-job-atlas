"""
Job info scraper for school_id 1091 - Oklahoma Panhandle State University (US)
ATS platform: own website
Careers link: https://opsu.edu/job-opportunities/

Reads posting URLs from school_id_1091_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1091_job_info.csv. Checkpointed to
school_id_1091_job_info.checkpoint next to this script -- kill-and-resume,
