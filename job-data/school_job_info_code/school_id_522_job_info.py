"""
Job info scraper for school_id 522 - University of Holy Cross (US)
ATS platform: own website
Careers link: https://uhcno.edu/hr/jobs/index.php

Reads posting URLs from school_id_522_job_postings.checkpoint (this
...
Writes school_job_info/school_id_522_job_info.csv. Checkpointed to
school_id_522_job_info.checkpoint next to this script -- kill-and-resume,
