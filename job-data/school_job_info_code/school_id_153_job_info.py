"""
Job info scraper for school_id 153 - Stanford University (US)
ATS platform: own website
Careers link: https://facultypositions.stanford.edu/jobs/search?page=1&query=

Reads posting URLs from school_id_153_job_postings.checkpoint (this
...
Writes school_job_info/school_id_153_job_info.csv. Checkpointed to
school_id_153_job_info.checkpoint next to this script -- kill-and-resume,
