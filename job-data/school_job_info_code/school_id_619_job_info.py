"""
Job info scraper for school_id 619 - University of Maine (US)
...
Reads posting URLs from school_id_619_job_postings.checkpoint (this
...
Writes school_job_info/school_id_619_job_info.csv. Checkpointed to
school_id_619_job_info.checkpoint next to this script -- kill-and-resume,
