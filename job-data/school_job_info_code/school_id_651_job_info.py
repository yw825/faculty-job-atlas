"""
Job info scraper for school_id 651 - Madonna University (US)
ATS platform: own website
Careers link: https://www.madonna.edu/resources/human-resources/

Reads posting URLs from school_id_651_job_postings.checkpoint (this
...
Writes school_job_info/school_id_651_job_info.csv. Checkpointed to
school_id_651_job_info.checkpoint next to this script -- kill-and-resume,
