"""
Job info scraper for school_id 777 - Queens University of Charlotte (US)
ATS platform: own website
Careers link: https://www.queens.edu/careers/why-work-at-queens/career-opportunities-at-queens/

Reads posting URLs from school_id_777_job_postings.checkpoint (this
...
Writes school_job_info/school_id_777_job_info.csv. Checkpointed to
school_id_777_job_info.checkpoint next to this script -- kill-and-resume,
