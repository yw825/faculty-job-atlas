"""
Job info scraper for school_id 199 - University of Saint Joseph (US)
ATS platform: own website
Careers link: https://www.usj.edu/academics/health-care-careers/

Reads posting URLs from school_id_199_job_postings.checkpoint (this
...
Writes school_job_info/school_id_199_job_info.csv. Checkpointed to
school_id_199_job_info.checkpoint next to this script -- kill-and-resume,
