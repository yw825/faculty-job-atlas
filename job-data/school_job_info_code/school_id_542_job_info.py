"""
Job info scraper for school_id 542 - University of Massachusetts-Boston (US)
ATS platform: own website
Careers link: https://hr.umb.edu/employees/payroll/job-aids/

Reads posting URLs from school_id_542_job_postings.checkpoint (this
...
Writes school_job_info/school_id_542_job_info.csv. Checkpointed to
school_id_542_job_info.checkpoint next to this script -- kill-and-resume,
