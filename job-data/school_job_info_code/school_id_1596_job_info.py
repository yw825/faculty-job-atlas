"""
Job info scraper for school_id 1596 - University of British Columbia (Canada)
ATS platform: Workday
Careers link: https://ubc.wd10.myworkdayjobs.com/ubcfacultyjobs
...
school's job_postings script). Edit it directly if University of British Columbia's posting pages
...
Reads posting URLs from school_id_1596_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1596_job_info.csv. Checkpointed to
school_id_1596_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://ubc.wd10.myworkdayjobs.com/ubcfacultyjobs'
