"""
Job info scraper for school_id 7 - Samford University (US)
ATS platform: own website
Careers link: https://www.samford.edu/employee/faculty-employment-opportunities/default

Reads posting URLs from school_id_7_job_postings.checkpoint (this
...
Writes school_job_info/school_id_7_job_info.csv. Checkpointed to
school_id_7_job_info.checkpoint next to this script -- kill-and-resume,
