"""
Job info scraper for school_id 1025 - Bluffton University (US)
ATS platform: own website
Careers link: https://www.bluffton.edu/academiclife/career/index.aspx

Reads posting URLs from school_id_1025_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1025_job_info.csv. Checkpointed to
school_id_1025_job_info.checkpoint next to this script -- kill-and-resume,
