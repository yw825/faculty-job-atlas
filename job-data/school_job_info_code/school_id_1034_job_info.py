"""
Job info scraper for school_id 1034 - Xavier University (US)
ATS platform: Workday
Careers link: https://xavier.wd108.myworkdayjobs.com/XavierCareers

Reads posting URLs from school_id_1034_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1034_job_info.csv. Checkpointed to
school_id_1034_job_info.checkpoint next to this script -- kill-and-resume,
