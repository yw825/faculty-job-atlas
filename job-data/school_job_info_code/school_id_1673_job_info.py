"""
Job info scraper for school_id 1673 - University of Turku (Finland)
ATS platform: own website
Careers link: https://www.utu.fi/en/university/come-work-with-us/open-vacancies
...
school's job_postings script). Edit it directly if University of Turku's posting pages
...
Reads posting URLs from school_id_1673_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1673_job_info.csv. Checkpointed to
school_id_1673_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1673
SCHOOL_NAME = 'University of Turku'
CAREERS_LINK = 'https://www.utu.fi/en/university/come-work-with-us/open-vacancies'
