"""
Job info scraper for school_id 687 - Crown College (US)
ATS platform: own website
Careers link: https://secure5.entertimeonline.com/ta/CBIZ20706.careers?CareersSearch

Reads posting URLs from school_id_687_job_postings.checkpoint (this
...
Writes school_job_info/school_id_687_job_info.csv. Checkpointed to
school_id_687_job_info.checkpoint next to this script -- kill-and-resume,
