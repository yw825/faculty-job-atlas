"""
Job info scraper for school_id 887 - William Paterson University of New Jersey (US)
ATS platform: own website
Careers link: https://www.wpunj.edu/human-resources/jobs-careers-comp/employment-opportunities

Reads posting URLs from school_id_887_job_postings.checkpoint (this
...
Writes school_job_info/school_id_887_job_info.csv. Checkpointed to
school_id_887_job_info.checkpoint next to this script -- kill-and-resume,
