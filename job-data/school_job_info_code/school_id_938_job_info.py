"""
Job info scraper for school_id 938 - Mercy University (US)
ATS platform: own website
Careers link: https://www.mercy.edu/about/human-resources/employment-mercy

Reads posting URLs from school_id_938_job_postings.checkpoint (this
...
Writes school_job_info/school_id_938_job_info.csv. Checkpointed to
school_id_938_job_info.checkpoint next to this script -- kill-and-resume,
