"""
Job info scraper for school_id 535 - Cambridge College (US)
ATS platform: own website
Careers link: https://www.cambridgecollege.edu/es/life-at-cc/career-life-planning-center

Reads posting URLs from school_id_535_job_postings.checkpoint (this
...
Writes school_job_info/school_id_535_job_info.csv. Checkpointed to
school_id_535_job_info.checkpoint next to this script -- kill-and-resume,
