"""
Job info scraper for school_id 14 - Jacksonville State University (US)
ATS platform: own website
Careers link: https://careers.jsu.edu/jobs/search?page=1&category_uids%5B%5D=6221c7f16b88a1e8462b2d492ce7977f&query=

Reads posting URLs from school_id_14_job_postings.checkpoint (this
...
Writes school_job_info/school_id_14_job_info.csv. Checkpointed to
school_id_14_job_info.checkpoint next to this script -- kill-and-resume,
