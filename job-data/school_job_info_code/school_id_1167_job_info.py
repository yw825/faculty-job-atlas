"""
Job info scraper for school_id 1167 - Kutztown University of Pennsylvania (US)
...
Reads posting URLs from school_id_1167_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1167_job_info.csv. Checkpointed to
school_id_1167_job_info.checkpoint next to this script -- kill-and-resume,
