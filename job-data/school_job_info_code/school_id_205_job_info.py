"""
Job info scraper for school_id 205 - Georgetown University (US)
ATS platform: Workday
Careers link: https://georgetown.wd1.myworkdayjobs.com/Georgetown_Admin_Careers

Reads posting URLs from school_id_205_job_postings.checkpoint (this
...
Writes school_job_info/school_id_205_job_info.csv. Checkpointed to
school_id_205_job_info.checkpoint next to this script -- kill-and-resume,
