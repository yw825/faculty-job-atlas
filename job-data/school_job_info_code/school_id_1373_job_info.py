"""
Job info scraper for school_id 1373 - Texas A & M University-College Station (US)
ATS platform: own website
Careers link: https://faculty.tamu.edu/

Reads posting URLs from school_id_1373_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1373_job_info.csv. Checkpointed to
school_id_1373_job_info.checkpoint next to this script -- kill-and-resume,
