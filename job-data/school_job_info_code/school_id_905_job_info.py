"""
Job info scraper for school_id 905 - Excelsior University (US)
ATS platform: own website
Careers link: https://www.excelsior.edu/career-training

Reads posting URLs from school_id_905_job_postings.checkpoint (this
...
Writes school_job_info/school_id_905_job_info.csv. Checkpointed to
school_id_905_job_info.checkpoint next to this script -- kill-and-resume,
