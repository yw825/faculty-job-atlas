"""
Job info scraper for school_id 13 - University of Alabama in Huntsville (US)
ATS platform: own website
Careers link: https://www.uah.edu/hr/careers/faculty-careers

Reads posting URLs from school_id_13_job_postings.checkpoint (this
...
Writes school_job_info/school_id_13_job_info.csv. Checkpointed to
school_id_13_job_info.checkpoint next to this script -- kill-and-resume,
