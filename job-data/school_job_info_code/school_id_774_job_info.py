"""
Job info scraper for school_id 774 - University of North Carolina at Chapel Hill (US)
ATS platform: PeopleAdmin
Careers link: https://unc.peopleadmin.com/postings/search

Reads posting URLs from school_id_774_job_postings.checkpoint (this
...
Writes school_job_info/school_id_774_job_info.csv. Checkpointed to
school_id_774_job_info.checkpoint next to this script -- kill-and-resume,
