"""
Job info scraper for school_id 703 - Culver-Stockton College (US)
ATS platform: own website
Careers link: https://culver.edu/gps-core/

Reads posting URLs from school_id_703_job_postings.checkpoint (this
...
Writes school_job_info/school_id_703_job_info.csv. Checkpointed to
school_id_703_job_info.checkpoint next to this script -- kill-and-resume,
