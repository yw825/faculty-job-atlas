"""
Job info scraper for school_id 585 - Worcester Polytechnic Institute (US)
ATS platform: Workday
Careers link: https://wpi.wd5.myworkdayjobs.com/WPI_External_Career_Site

Reads posting URLs from school_id_585_job_postings.checkpoint (this
...
Writes school_job_info/school_id_585_job_info.csv. Checkpointed to
school_id_585_job_info.checkpoint next to this script -- kill-and-resume,
