"""
Job info scraper for school_id 785 - Elon University (US)
ATS platform: own website
Careers link: https://jobs.elon.edu/jobs/search

Reads posting URLs from school_id_785_job_postings.checkpoint (this
...
Writes school_job_info/school_id_785_job_info.csv. Checkpointed to
school_id_785_job_info.checkpoint next to this script -- kill-and-resume,
