"""
Job info scraper for school_id 1765 - University of Cambridge (United Kingdom)
ATS platform: own website
Careers link: https://www.cam.ac.uk/jobs/search
...
school's job_postings script). Edit it directly if University of Cambridge's posting pages
...
Reads posting URLs from school_id_1765_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1765_job_info.csv. Checkpointed to
school_id_1765_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://www.cam.ac.uk/jobs/search'
