"""
Job info scraper for school_id 779 - Western Carolina University (US)
ATS platform: own website
Careers link: https://jobs.wcu.edu/postings/search

Reads posting URLs from school_id_779_job_postings.checkpoint (this
...
Writes school_job_info/school_id_779_job_info.csv. Checkpointed to
school_id_779_job_info.checkpoint next to this script -- kill-and-resume,
