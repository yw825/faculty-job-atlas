"""
Job info scraper for school_id 638 - Kettering University (US)
ATS platform: own website
Careers link: https://www.kettering.edu/co-op-career-design

Reads posting URLs from school_id_638_job_postings.checkpoint (this
...
Writes school_job_info/school_id_638_job_info.csv. Checkpointed to
school_id_638_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://www.kettering.edu/co-op-career-design'
