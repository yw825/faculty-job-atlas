"""
Job info scraper for school_id 562 - Massachusetts College of Liberal Arts (US)
ATS platform: own website
Careers link: http://mcla.interviewexchange.com/

Reads posting URLs from school_id_562_job_postings.checkpoint (this
...
Writes school_job_info/school_id_562_job_info.csv. Checkpointed to
school_id_562_job_info.checkpoint next to this script -- kill-and-resume,
