"""
Job info scraper for school_id 144 - California State University-San Marcos (US)
ATS platform: PageUp
...
Reads posting URLs from school_id_144_job_postings.checkpoint (this
...
Writes school_job_info/school_id_144_job_info.csv. Checkpointed to
school_id_144_job_info.checkpoint next to this script -- kill-and-resume,
