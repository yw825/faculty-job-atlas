"""
Job info scraper for school_id 1273 - University of South Carolina Aiken (US)
ATS platform: own website
Careers link: https://www.usca.edu/departments/human-resources/employment/internal-job-postings/

Reads posting URLs from school_id_1273_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1273_job_info.csv. Checkpointed to
school_id_1273_job_info.checkpoint next to this script -- kill-and-resume,
