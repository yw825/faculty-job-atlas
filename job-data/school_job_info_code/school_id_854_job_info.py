"""
Job info scraper for school_id 854 - Rivier University (US)
ATS platform: own website
Careers link: https://www.schooljobs.com/careers/rivieredu?jobType[0]=Faculty&sort=PositionTitle%7CAscending

Reads posting URLs from school_id_854_job_postings.checkpoint (this
...
Writes school_job_info/school_id_854_job_info.csv. Checkpointed to
school_id_854_job_info.checkpoint next to this script -- kill-and-resume,
