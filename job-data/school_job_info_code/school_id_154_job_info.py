"""
Job info scraper for school_id 154 - Humphreys University-Stockton and Modesto Campuses (US)
ATS platform: own website
Careers link: https://www.humphreys.edu/career-opportunities/

Reads posting URLs from school_id_154_job_postings.checkpoint (this
...
Writes school_job_info/school_id_154_job_info.csv. Checkpointed to
school_id_154_job_info.checkpoint next to this script -- kill-and-resume,
