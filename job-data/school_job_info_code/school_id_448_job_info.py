"""
Job info scraper for school_id 448 - Indiana University-East (US)
ATS platform: own website
Careers link: https://east.iu.edu/red-wolf-central/academic-career/index.html

Reads posting URLs from school_id_448_job_postings.checkpoint (this
...
Writes school_job_info/school_id_448_job_info.csv. Checkpointed to
school_id_448_job_info.checkpoint next to this script -- kill-and-resume,
