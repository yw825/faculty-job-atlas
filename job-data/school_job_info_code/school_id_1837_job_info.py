"""
Job info scraper for school_id 1837 - Hong Kong Nang Yan College of Higher Education (Hong Kong)
ATS platform: 
Careers link: 
...
school's job_postings script). Edit it directly if Hong Kong Nang Yan College of Higher Education's posting pages
...
Reads posting URLs from school_id_1837_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1837_job_info.csv. Checkpointed to
school_id_1837_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1837
SCHOOL_NAME = 'Hong Kong Nang Yan College of Higher Education'
CAREERS_LINK = ''
ATS_PLATFORM = ''
