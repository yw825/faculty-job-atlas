"""
Job info scraper for school_id 820 - University of Mary (US)
ATS platform: own website
Careers link: https://universityofmary.applytojob.com/apply

Reads posting URLs from school_id_820_job_postings.checkpoint (this
...
Writes school_job_info/school_id_820_job_info.csv. Checkpointed to
school_id_820_job_info.checkpoint next to this script -- kill-and-resume,
