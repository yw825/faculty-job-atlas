"""
Job info scraper for school_id 790 - Guilford College (US)
ATS platform: Workday
Careers link: https://guilford.wd1.myworkdayjobs.com/Guilford_Careers

Reads posting URLs from school_id_790_job_postings.checkpoint (this
...
Writes school_job_info/school_id_790_job_info.csv. Checkpointed to
school_id_790_job_info.checkpoint next to this script -- kill-and-resume,
