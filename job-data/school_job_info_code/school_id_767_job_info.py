"""
Job info scraper for school_id 767 - University of North Carolina Asheville (US)
ATS platform: PeopleAdmin
Careers link: https://uncash-sb.peopleadmin.com/

Reads posting URLs from school_id_767_job_postings.checkpoint (this
...
Writes school_job_info/school_id_767_job_info.csv. Checkpointed to
school_id_767_job_info.checkpoint next to this script -- kill-and-resume,
