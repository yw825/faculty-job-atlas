"""
Job info scraper for school_id 599 - Mount St. Mary's University (US)
ATS platform: own website
Careers link: https://inside.msmary.edu/more/human-resources/employment-opportunities/index.html#faculty-jobs

Reads posting URLs from school_id_599_job_postings.checkpoint (this
...
Writes school_job_info/school_id_599_job_info.csv. Checkpointed to
school_id_599_job_info.checkpoint next to this script -- kill-and-resume,
