"""
Job info scraper for school_id 1750 - Stockholm School of Economics (Sweden)
ATS platform: own website
Careers link: https://jobs.hhs.se/job-vacancies
...
school's job_postings script). Edit it directly if Stockholm School of Economics's posting pages
...
Reads posting URLs from school_id_1750_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1750_job_info.csv. Checkpointed to
school_id_1750_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1750
SCHOOL_NAME = 'Stockholm School of Economics'
CAREERS_LINK = 'https://jobs.hhs.se/job-vacancies'
