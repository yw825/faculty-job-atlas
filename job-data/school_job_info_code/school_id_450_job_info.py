"""
Job info scraper for school_id 450 - Indiana University-South Bend (US)
ATS platform: PeopleAdmin
Careers link: https://indiana.peopleadmin.com/postings/search

Reads posting URLs from school_id_450_job_postings.checkpoint (this
...
Writes school_job_info/school_id_450_job_info.csv. Checkpointed to
school_id_450_job_info.checkpoint next to this script -- kill-and-resume,
