"""
Job info scraper for school_id 1824 - University of Auckland (New Zealand)
...
school's job_postings script). Edit it directly if University of Auckland's posting pages
...
Reads posting URLs from school_id_1824_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1824_job_info.csv. Checkpointed to
school_id_1824_job_info.checkpoint next to this script -- kill-and-resume,
