"""
Job info scraper for school_id 330 - University of Northern Iowa (US)
ATS platform: Workday
Careers link: https://uni.wd5.myworkdayjobs.com/UNI

Reads posting URLs from school_id_330_job_postings.checkpoint (this
...
Writes school_job_info/school_id_330_job_info.csv. Checkpointed to
school_id_330_job_info.checkpoint next to this script -- kill-and-resume,
