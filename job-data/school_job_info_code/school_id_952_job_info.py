"""
Job info scraper for school_id 952 - Keuka College (US)
ATS platform: own website
Careers link: https://www.keuka.edu/hr/employment-opportunities

Reads posting URLs from school_id_952_job_postings.checkpoint (this
...
Writes school_job_info/school_id_952_job_info.csv. Checkpointed to
school_id_952_job_info.checkpoint next to this script -- kill-and-resume,
