"""
Job info scraper for school_id 35 - University of the Ozarks (US)
ATS platform: own website
Careers link: https://ozarks.edu/about/employment/

Reads posting URLs from school_id_35_job_postings.checkpoint (this
...
Writes school_job_info/school_id_35_job_info.csv. Checkpointed to
school_id_35_job_info.checkpoint next to this script -- kill-and-resume,
