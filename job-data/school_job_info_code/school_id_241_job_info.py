"""
Job info scraper for school_id 241 - Beacon College (US)
ATS platform: own website
Careers link: https://www.beaconcollege.edu/career-opportunities/

Reads posting URLs from school_id_241_job_postings.checkpoint (this
...
Writes school_job_info/school_id_241_job_info.csv. Checkpointed to
school_id_241_job_info.checkpoint next to this script -- kill-and-resume,
