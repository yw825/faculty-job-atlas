"""
Job info scraper for school_id 1544 - University of Wisconsin-Madison (US)
ATS platform: own website
Careers link: https://jobs.wisc.edu/

Reads posting URLs from school_id_1544_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1544_job_info.csv. Checkpointed to
school_id_1544_job_info.checkpoint next to this script -- kill-and-resume,
