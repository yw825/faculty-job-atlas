"""
Job info scraper for school_id 886 - Kean University (US)
ATS platform: Workday
Careers link: https://kean.wd503.myworkdayjobs.com/Kean

Reads posting URLs from school_id_886_job_postings.checkpoint (this
...
Writes school_job_info/school_id_886_job_info.csv. Checkpointed to
school_id_886_job_info.checkpoint next to this script -- kill-and-resume,
