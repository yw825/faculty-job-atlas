"""
Job info scraper for school_id 1884 - Technological University Dublin (Ireland)
ATS platform: CoreHR
Careers link: https://my.corehr.com/pls/tudrecruit/erq_search_version_4.start_search_with_params
...
school's job_postings script). Edit it directly if Technological University Dublin's posting pages
...
Reads posting URLs from school_id_1884_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1884_job_info.csv. Checkpointed to
school_id_1884_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://my.corehr.com/pls/tudrecruit/erq_search_version_4.start_search_with_params'
ATS_PLATFORM = 'CoreHR'
