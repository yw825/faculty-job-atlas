"""
Job info scraper for school_id 1453 - Marymount University (US)
ATS platform: Workday
Careers link: https://marymount.wd5.myworkdayjobs.com/Careers

Reads posting URLs from school_id_1453_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1453_job_info.csv. Checkpointed to
school_id_1453_job_info.checkpoint next to this script -- kill-and-resume,
