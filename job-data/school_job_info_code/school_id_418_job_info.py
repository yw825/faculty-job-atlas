"""
Job info scraper for school_id 418 - Indiana University-Bloomington (US)
ATS platform: own website
Careers link: https://bloomington.iu.edu/academics/experiential-learning/research-opportunities/

Reads posting URLs from school_id_418_job_postings.checkpoint (this
...
Writes school_job_info/school_id_418_job_info.csv. Checkpointed to
school_id_418_job_info.checkpoint next to this script -- kill-and-resume,
