"""
Job info scraper for school_id 1622 - Nipissing University (Canada)
ATS platform: own website
Careers link: https://www.nipissingu.ca/careers/employment-postings/faculty
...
school's job_postings script). Edit it directly if Nipissing University's posting pages
...
Reads posting URLs from school_id_1622_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1622_job_info.csv. Checkpointed to
school_id_1622_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://www.nipissingu.ca/careers/employment-postings/faculty'
