"""
Job info scraper for school_id 982 - SUNY Oneonta (US)
ATS platform: own website
Careers link: https://oneonta.interviewexchange.com/static/clients/336ONM1/index.jsp

Reads posting URLs from school_id_982_job_postings.checkpoint (this
...
Writes school_job_info/school_id_982_job_info.csv. Checkpointed to
school_id_982_job_info.checkpoint next to this script -- kill-and-resume,
