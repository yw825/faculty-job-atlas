"""
Job info scraper for school_id 1858 - Nanyang Technological University (Singapore)
ATS platform: Workday
Careers link: https://ntu.wd3.myworkdayjobs.com/Careers
...
school's job_postings script). Edit it directly if Nanyang Technological University's posting pages
...
Reads posting URLs from school_id_1858_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1858_job_info.csv. Checkpointed to
school_id_1858_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://ntu.wd3.myworkdayjobs.com/Careers'
