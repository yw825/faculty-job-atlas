"""
Job info scraper for school_id 351 - Central College (US)
ATS platform: own website
Careers link: https://central.edu/job-seekers/

Reads posting URLs from school_id_351_job_postings.checkpoint (this
...
Writes school_job_info/school_id_351_job_info.csv. Checkpointed to
school_id_351_job_info.checkpoint next to this script -- kill-and-resume,
