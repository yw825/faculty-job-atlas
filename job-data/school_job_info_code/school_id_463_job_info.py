"""
Job info scraper for school_id 463 - Tabor College (US)
ATS platform: own website
Careers link: https://tabor.edu/about/employment/

Reads posting URLs from school_id_463_job_postings.checkpoint (this
...
Writes school_job_info/school_id_463_job_info.csv. Checkpointed to
school_id_463_job_info.checkpoint next to this script -- kill-and-resume,
