"""
Job info scraper for school_id 1770 - Imperial College London (United Kingdom)
ATS platform: own website
Careers link: https://www.imperial.ac.uk/jobs/search-jobs/?
...
school's job_postings script). Edit it directly if Imperial College London's posting pages
...
Reads posting URLs from school_id_1770_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1770_job_info.csv. Checkpointed to
school_id_1770_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://www.imperial.ac.uk/jobs/search-jobs/?'
