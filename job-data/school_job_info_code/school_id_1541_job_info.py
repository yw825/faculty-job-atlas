"""
Job info scraper for school_id 1541 - University of Wisconsin-La Crosse (US)
...
Reads posting URLs from school_id_1541_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1541_job_info.csv. Checkpointed to
school_id_1541_job_info.checkpoint next to this script -- kill-and-resume,
