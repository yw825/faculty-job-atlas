"""
Job info scraper for school_id 1528 - Whitman College (US)
ATS platform: own website
Careers link: https://whitman-advocate.symplicity.com/public_report/index.php

Reads posting URLs from school_id_1528_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1528_job_info.csv. Checkpointed to
school_id_1528_job_info.checkpoint next to this script -- kill-and-resume,
