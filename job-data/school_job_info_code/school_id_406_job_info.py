"""
Job info scraper for school_id 406 - Quincy University (US)
ATS platform: own website
Careers link: https://www.quincy.edu/about/work-at-qu/job-openings/

Reads posting URLs from school_id_406_job_postings.checkpoint (this
...
Writes school_job_info/school_id_406_job_info.csv. Checkpointed to
school_id_406_job_info.checkpoint next to this script -- kill-and-resume,
