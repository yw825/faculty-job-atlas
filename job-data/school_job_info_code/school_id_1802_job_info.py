"""
Job info scraper for school_id 1802 - University of Southern Queensland (Australia)
ATS platform: PageUp/NGA
Careers link: https://usq.nga.net.au/cp/index.cfm?audiencetypecode=ext
...
school's job_postings script). Edit it directly if University of Southern Queensland's posting pages
...
Reads posting URLs from school_id_1802_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1802_job_info.csv. Checkpointed to
school_id_1802_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://usq.nga.net.au/cp/index.cfm?audiencetypecode=ext'
