"""
Job info scraper for school_id 973 - The King's College (US)
ATS platform: own website
Careers link: https://www.tkc.edu/?page_id=1006

Reads posting URLs from school_id_973_job_postings.checkpoint (this
...
Writes school_job_info/school_id_973_job_info.csv. Checkpointed to
school_id_973_job_info.checkpoint next to this script -- kill-and-resume,
