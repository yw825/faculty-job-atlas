"""
Job info scraper for school_id 1769 - University of Leeds (United Kingdom)
ATS platform: own website
Careers link: https://jobs.leeds.ac.uk/vacancies.aspx?cat=200
...
school's job_postings script). Edit it directly if University of Leeds's posting pages
...
Reads posting URLs from school_id_1769_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1769_job_info.csv. Checkpointed to
school_id_1769_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://jobs.leeds.ac.uk/vacancies.aspx?cat=200'
