"""
Job info scraper for school_id 1078 - The College of Wooster (US)
ATS platform: own website
Careers link: https://wooster.edu/employment/jobs

Reads posting URLs from school_id_1078_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1078_job_info.csv. Checkpointed to
school_id_1078_job_info.checkpoint next to this script -- kill-and-resume,
