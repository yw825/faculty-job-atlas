"""
Job info scraper for school_id 1651 - Université du Québec à Chicoutimi (Canada)
ATS platform: own website
Careers link: https://www.uqac.ca/emploi/
...
school's job_postings script). Edit it directly if Université du Québec à Chicoutimi's posting pages
...
Reads posting URLs from school_id_1651_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1651_job_info.csv. Checkpointed to
school_id_1651_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1651
SCHOOL_NAME = 'Université du Québec à Chicoutimi'
CAREERS_LINK = 'https://www.uqac.ca/emploi/'
