"""
Job info scraper for school_id 37 - Hendrix College (US)
ATS platform: own website
Careers link: https://www.hendrix.edu/humanresources/jobs.aspx

Reads posting URLs from school_id_37_job_postings.checkpoint (this
...
Writes school_job_info/school_id_37_job_info.csv. Checkpointed to
school_id_37_job_info.checkpoint next to this script -- kill-and-resume,
