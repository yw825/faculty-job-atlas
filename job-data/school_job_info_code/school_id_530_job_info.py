"""
Job info scraper for school_id 530 - Amherst College (US)
ATS platform: own website
Careers link: https://wd5.myworkday.com/amherst/d/home.htmld

Reads posting URLs from school_id_530_job_postings.checkpoint (this
...
Writes school_job_info/school_id_530_job_info.csv. Checkpointed to
school_id_530_job_info.checkpoint next to this script -- kill-and-resume,
