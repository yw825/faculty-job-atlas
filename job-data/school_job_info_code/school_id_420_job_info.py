"""
Job info scraper for school_id 420 - University of Evansville (US)
ATS platform: own website
Careers link: https://www.altogethergreat.com/careers/job-opportunities-compassgroupusa/

Reads posting URLs from school_id_420_job_postings.checkpoint (this
...
Writes school_job_info/school_id_420_job_info.csv. Checkpointed to
school_id_420_job_info.checkpoint next to this script -- kill-and-resume,
