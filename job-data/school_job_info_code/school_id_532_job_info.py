"""
Job info scraper for school_id 532 - University of Massachusetts-Amherst (US)
ATS platform: PageUp
Careers link: https://umassamherst.dc4.pageuppeople.com/

Reads posting URLs from school_id_532_job_postings.checkpoint (this
...
Writes school_job_info/school_id_532_job_info.csv. Checkpointed to
school_id_532_job_info.checkpoint next to this script -- kill-and-resume,
