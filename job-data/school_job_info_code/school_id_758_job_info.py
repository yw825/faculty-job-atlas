"""
Job info scraper for school_id 758 - Montana State University Billings (US)
ATS platform: own website
Careers link: http://www.mus.edu/hr/jobs.asp

Reads posting URLs from school_id_758_job_postings.checkpoint (this
...
Writes school_job_info/school_id_758_job_info.csv. Checkpointed to
school_id_758_job_info.checkpoint next to this script -- kill-and-resume,
