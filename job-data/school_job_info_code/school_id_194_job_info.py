"""
Job info scraper for school_id 194 - University of Connecticut-Stamford (US)
ATS platform: own website
Careers link: https://jobs.hr.uconn.edu/mob/en-us/listing/

Reads posting URLs from school_id_194_job_postings.checkpoint (this
...
Writes school_job_info/school_id_194_job_info.csv. Checkpointed to
school_id_194_job_info.checkpoint next to this script -- kill-and-resume,
