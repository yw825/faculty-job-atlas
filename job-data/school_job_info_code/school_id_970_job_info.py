"""
Job info scraper for school_id 970 - New York University (US)
ATS platform: own website
Careers link: https://www.nyu.edu/about/university-initiatives/nyu-irl.html

Reads posting URLs from school_id_970_job_postings.checkpoint (this
...
Writes school_job_info/school_id_970_job_info.csv. Checkpointed to
school_id_970_job_info.checkpoint next to this script -- kill-and-resume,
