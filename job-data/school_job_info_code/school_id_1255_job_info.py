"""
Job info scraper for school_id 1255 - Caribbean University-Ponce (US)
ATS platform: SmartRecruiters
Careers link: https://careers.smartrecruiters.com/CaribbeanUniversity

Reads posting URLs from school_id_1255_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1255_job_info.csv. Checkpointed to
school_id_1255_job_info.checkpoint next to this script -- kill-and-resume,
