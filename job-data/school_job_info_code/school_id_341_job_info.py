"""
Job info scraper for school_id 341 - Upper Iowa University (US)
ATS platform: own website
Careers link: https://my.uiu.edu/ICS/Employment_Opportunities.jnz

Reads posting URLs from school_id_341_job_postings.checkpoint (this
...
Writes school_job_info/school_id_341_job_info.csv. Checkpointed to
school_id_341_job_info.checkpoint next to this script -- kill-and-resume,
