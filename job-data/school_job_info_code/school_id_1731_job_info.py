"""
Job info scraper for school_id 1731 - Warsaw School of Economics (Poland)
ATS platform: Poland national portal
...
school's job_postings script). Edit it directly if Warsaw School of Economics's posting pages
...
Reads posting URLs from school_id_1731_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1731_job_info.csv. Checkpointed to
school_id_1731_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1731
SCHOOL_NAME = 'Warsaw School of Economics'
