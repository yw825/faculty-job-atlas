"""
Job info scraper for school_id 653 - Northwood University (US)
ATS platform: own website
Careers link: https://www.schooljobs.com/careers/northwoodu?jobType[0]=Faculty&sort=PositionTitle%7CAscending

Reads posting URLs from school_id_653_job_postings.checkpoint (this
...
Writes school_job_info/school_id_653_job_info.csv. Checkpointed to
school_id_653_job_info.checkpoint next to this script -- kill-and-resume,
