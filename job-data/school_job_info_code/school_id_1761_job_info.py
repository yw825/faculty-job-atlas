"""
Job info scraper for school_id 1761 - Koç University (Turkey)
ATS platform: own website
Careers link: https://jobs.ku.edu.tr/
...
school's job_postings script). Edit it directly if Koç University's posting pages
...
Reads posting URLs from school_id_1761_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1761_job_info.csv. Checkpointed to
school_id_1761_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1761
SCHOOL_NAME = 'Koç University'
CAREERS_LINK = 'https://jobs.ku.edu.tr/'
