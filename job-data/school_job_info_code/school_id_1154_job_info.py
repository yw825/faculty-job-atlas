"""
Job info scraper for school_id 1154 - Gettysburg College (US)
ATS platform: own website
Careers link: https://www.gettysburg.edu/offices/provost/academic-positions/

Reads posting URLs from school_id_1154_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1154_job_info.csv. Checkpointed to
school_id_1154_job_info.checkpoint next to this script -- kill-and-resume,
