"""
Job info scraper for school_id 1564 - Concord University (US)
ATS platform: own website
Careers link: https://jobs.concord.edu/

Reads posting URLs from school_id_1564_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1564_job_info.csv. Checkpointed to
school_id_1564_job_info.checkpoint next to this script -- kill-and-resume,
