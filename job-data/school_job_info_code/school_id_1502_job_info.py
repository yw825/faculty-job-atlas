"""
Job info scraper for school_id 1502 - University of Vermont (US)
ATS platform: own website
Careers link: https://www.uvm.edu/human-resources/careers

Reads posting URLs from school_id_1502_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1502_job_info.csv. Checkpointed to
school_id_1502_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://www.uvm.edu/human-resources/careers'
