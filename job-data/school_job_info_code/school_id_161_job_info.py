"""
Job info scraper for school_id 161 - Colorado State University Global (US)
ATS platform: iCIMS
Careers link: https://faculty-csuglobal.icims.com/

Reads posting URLs from school_id_161_job_postings.checkpoint (this
...
Writes school_job_info/school_id_161_job_info.csv. Checkpointed to
school_id_161_job_info.checkpoint next to this script -- kill-and-resume,
