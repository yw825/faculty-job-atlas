"""
Job info scraper for school_id 410 - Rockford University (US)
ATS platform: own website
Careers link: https://www.rockford.edu/community/humanresources/faculty/

Reads posting URLs from school_id_410_job_postings.checkpoint (this
...
Writes school_job_info/school_id_410_job_info.csv. Checkpointed to
school_id_410_job_info.checkpoint next to this script -- kill-and-resume,
