"""
Job info scraper for school_id 1788 - Macquarie University (Australia)
ATS platform: Workday
Careers link: https://mq.wd3.myworkdayjobs.com/CareersatMQ
...
school's job_postings script). Edit it directly if Macquarie University's posting pages
...
Reads posting URLs from school_id_1788_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1788_job_info.csv. Checkpointed to
school_id_1788_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://mq.wd3.myworkdayjobs.com/CareersatMQ'
