"""
Job info scraper for school_id 816 - Wingate University (US)
ATS platform: Workday
Careers link: https://wingate.wd5.myworkdayjobs.com/WU

Reads posting URLs from school_id_816_job_postings.checkpoint (this
...
Writes school_job_info/school_id_816_job_info.csv. Checkpointed to
school_id_816_job_info.checkpoint next to this script -- kill-and-resume,
