"""
Job info scraper for school_id 170 - Fort Lewis College (US)
ATS platform: Workday
Careers link: https://fortlewiscollege.wd1.myworkdayjobs.com/FLC

Reads posting URLs from school_id_170_job_postings.checkpoint (this
...
Writes school_job_info/school_id_170_job_info.csv. Checkpointed to
school_id_170_job_info.checkpoint next to this script -- kill-and-resume,
