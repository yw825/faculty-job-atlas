"""
Job info scraper for school_id 427 - Goshen College (US)
ATS platform: own website
Careers link: https://www.goshen.edu/employment/director-of-human-resources/

Reads posting URLs from school_id_427_job_postings.checkpoint (this
...
Writes school_job_info/school_id_427_job_info.csv. Checkpointed to
school_id_427_job_info.checkpoint next to this script -- kill-and-resume,
