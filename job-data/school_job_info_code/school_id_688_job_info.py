"""
Job info scraper for school_id 688 - Saint Cloud State University (US)
ATS platform: Workday
Careers link: https://minnstate.wd115.myworkdayjobs.com/Minnesota_State_Careers

Reads posting URLs from school_id_688_job_postings.checkpoint (this
...
Writes school_job_info/school_id_688_job_info.csv. Checkpointed to
school_id_688_job_info.checkpoint next to this script -- kill-and-resume,
