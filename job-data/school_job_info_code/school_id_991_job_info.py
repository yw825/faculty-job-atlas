"""
Job info scraper for school_id 991 - Manhattanville College (US)
ATS platform: own website
Careers link: https://mville.exacthire.com/All_Open_Jobs_at_All_Locations?jobs=[]

Reads posting URLs from school_id_991_job_postings.checkpoint (this
...
Writes school_job_info/school_id_991_job_info.csv. Checkpointed to
school_id_991_job_info.checkpoint next to this script -- kill-and-resume,
