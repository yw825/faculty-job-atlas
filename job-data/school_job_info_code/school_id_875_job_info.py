"""
Job info scraper for school_id 875 - Montclair State University (US)
ATS platform: Workday
Careers link: https://montclair.wd1.myworkdayjobs.com/JobOpportunities

Reads posting URLs from school_id_875_job_postings.checkpoint (this
...
Writes school_job_info/school_id_875_job_info.csv. Checkpointed to
school_id_875_job_info.checkpoint next to this script -- kill-and-resume,
