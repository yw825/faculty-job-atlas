"""
Job info scraper for school_id 441 - Indiana University-Southeast (US)
ATS platform: own website
Careers link: https://southeast.iu.edu/academics/explore-careers/index.html

Reads posting URLs from school_id_441_job_postings.checkpoint (this
...
Writes school_job_info/school_id_441_job_info.csv. Checkpointed to
school_id_441_job_info.checkpoint next to this script -- kill-and-resume,
