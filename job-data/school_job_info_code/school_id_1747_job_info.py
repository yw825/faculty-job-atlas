"""
Job info scraper for school_id 1747 - Chalmers University of Technology (Sweden)
ATS platform: own website
Careers link: https://www.chalmers.se/en/about-chalmers/work-with-us/assistant-professor-positions/
...
school's job_postings script). Edit it directly if Chalmers University of Technology's posting pages
...
Reads posting URLs from school_id_1747_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1747_job_info.csv. Checkpointed to
school_id_1747_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1747
SCHOOL_NAME = 'Chalmers University of Technology'
CAREERS_LINK = 'https://www.chalmers.se/en/about-chalmers/work-with-us/assistant-professor-positions/'
