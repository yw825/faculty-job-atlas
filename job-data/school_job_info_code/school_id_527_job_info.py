"""
Job info scraper for school_id 527 - Centenary College of Louisiana (US)
ATS platform: own website
Careers link: https://www.centenary.edu/directories/offices-services-directory/human-resources/job-opportunities/

Reads posting URLs from school_id_527_job_postings.checkpoint (this
...
Writes school_job_info/school_id_527_job_info.csv. Checkpointed to
school_id_527_job_info.checkpoint next to this script -- kill-and-resume,
