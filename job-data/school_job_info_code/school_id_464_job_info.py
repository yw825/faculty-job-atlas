"""
Job info scraper for school_id 464 - University of Kansas (US)
ATS platform: own website
Careers link: https://employment.ku.edu

Reads posting URLs from school_id_464_job_postings.checkpoint (this
...
Writes school_job_info/school_id_464_job_info.csv. Checkpointed to
school_id_464_job_info.checkpoint next to this script -- kill-and-resume,
