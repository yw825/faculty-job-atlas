"""
Job info scraper for school_id 716 - City Vision University (US)
ATS platform: own website
Careers link: https://cityvisionuniversity.applytojob.com

Reads posting URLs from school_id_716_job_postings.checkpoint (this
...
Writes school_job_info/school_id_716_job_info.csv. Checkpointed to
school_id_716_job_info.checkpoint next to this script -- kill-and-resume,
