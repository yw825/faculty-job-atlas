"""
Job info scraper for school_id 30 - The University of Alabama (US)
ATS platform: own website
Careers link: https://careers.ua.edu/faculty

Reads posting URLs from school_id_30_job_postings.checkpoint (this
...
Writes school_job_info/school_id_30_job_info.csv. Checkpointed to
school_id_30_job_info.checkpoint next to this script -- kill-and-resume,
