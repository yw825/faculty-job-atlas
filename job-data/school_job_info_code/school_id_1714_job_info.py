"""
Job info scraper for school_id 1714 - Politecnico di Torino (Italy)
...
school's job_postings script). Edit it directly if Politecnico di Torino's posting pages
...
Reads posting URLs from school_id_1714_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1714_job_info.csv. Checkpointed to
school_id_1714_job_info.checkpoint next to this script -- kill-and-resume,
