"""
Job info scraper for school_id 1742 - Universitat Pompeu Fabra (Spain)
ATS platform: own website
Careers link: https://www.academicjobs.com/universitat-pompeu-fabra-jobs
...
school's job_postings script). Edit it directly if Universitat Pompeu Fabra's posting pages
...
Reads posting URLs from school_id_1742_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1742_job_info.csv. Checkpointed to
school_id_1742_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1742
SCHOOL_NAME = 'Universitat Pompeu Fabra'
CAREERS_LINK = 'https://www.academicjobs.com/universitat-pompeu-fabra-jobs'
