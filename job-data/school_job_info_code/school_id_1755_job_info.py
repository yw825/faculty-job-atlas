"""
Job info scraper for school_id 1755 - University of St. Gallen (Switzerland)
ATS platform: own website
Careers link: https://www.unisg.ch/en/university/working-at-hsg/jobs/
...
school's job_postings script). Edit it directly if University of St. Gallen's posting pages
...
Reads posting URLs from school_id_1755_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1755_job_info.csv. Checkpointed to
school_id_1755_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1755
SCHOOL_NAME = 'University of St. Gallen'
CAREERS_LINK = 'https://www.unisg.ch/en/university/working-at-hsg/jobs/'
