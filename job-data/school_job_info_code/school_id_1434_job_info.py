"""
Job info scraper for school_id 1434 - Tarleton State University (US)
ATS platform: Workday
Careers link: https://tamus.wd1.myworkdayjobs.com/TARLETON_External

Reads posting URLs from school_id_1434_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1434_job_info.csv. Checkpointed to
school_id_1434_job_info.checkpoint next to this script -- kill-and-resume,
