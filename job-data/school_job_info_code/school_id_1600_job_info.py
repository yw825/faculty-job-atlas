"""
Job info scraper for school_id 1600 - Booth University College (Canada)
ATS platform: own website
Careers link: https://boothuc.ca/about/our-people/careers/
...
school's job_postings script). Edit it directly if Booth University College's posting pages
...
Reads posting URLs from school_id_1600_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1600_job_info.csv. Checkpointed to
school_id_1600_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1600
SCHOOL_NAME = 'Booth University College'
CAREERS_LINK = 'https://boothuc.ca/about/our-people/careers/'
