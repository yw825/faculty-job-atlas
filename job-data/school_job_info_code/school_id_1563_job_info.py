"""
Job info scraper for school_id 1563 - University of Wisconsin-Whitewater (US)
ATS platform: Workday
Careers link: https://wisconsin.wd1.myworkdayjobs.com/en-US/UW_Comprehensives

Reads posting URLs from school_id_1563_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1563_job_info.csv. Checkpointed to
school_id_1563_job_info.checkpoint next to this script -- kill-and-resume,
