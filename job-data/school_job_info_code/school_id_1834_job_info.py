"""
Job info scraper for school_id 1834 - Hong Kong Baptist University (Hong Kong)
...
Hong Kong Baptist University runs on a shared ATS platform with a bulk info adapter --
...
Reads posting URLs from school_id_1834_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1834_job_info.csv. Checkpointed to
school_id_1834_job_info.checkpoint next to this script -- kill-and-resume,
