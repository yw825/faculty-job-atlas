"""
Job info scraper for school_id 768 - Lees-McRae College (US)
ATS platform: PeopleAdmin
Careers link: https://leesmcrae.peopleadmin.com/

Reads posting URLs from school_id_768_job_postings.checkpoint (this
...
Writes school_job_info/school_id_768_job_info.csv. Checkpointed to
school_id_768_job_info.checkpoint next to this script -- kill-and-resume,
