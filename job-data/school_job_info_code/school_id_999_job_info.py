"""
Job info scraper for school_id 999 - St. John Fisher University (US)
ATS platform: own website
Careers link: https://www.sjf.edu/services/human-resources/career-experience/

Reads posting URLs from school_id_999_job_postings.checkpoint (this
...
Writes school_job_info/school_id_999_job_info.csv. Checkpointed to
school_id_999_job_info.checkpoint next to this script -- kill-and-resume,
