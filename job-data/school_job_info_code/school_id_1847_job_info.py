"""
Job info scraper for school_id 1847 - Tung Wah College (Hong Kong)
ATS platform: own website
Careers link: https://careers.twc.edu.hk/search/?createNewAlert=false&q=&optionsFacetsDD_department=Academic+Staff&optionsFacetsDD_dept=
...
school's job_postings script). Edit it directly if Tung Wah College's posting pages
...
Reads posting URLs from school_id_1847_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1847_job_info.csv. Checkpointed to
school_id_1847_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1847
SCHOOL_NAME = 'Tung Wah College'
CAREERS_LINK = 'https://careers.twc.edu.hk/search/?createNewAlert=false&q=&optionsFacetsDD_department=Academic+Staff&optionsFacetsDD_dept='
