"""
Job info scraper for school_id 853 - University of New Hampshire at Manchester (US)
ATS platform: own website
Careers link: https://manchester.unh.edu/careers

Reads posting URLs from school_id_853_job_postings.checkpoint (this
...
Writes school_job_info/school_id_853_job_info.csv. Checkpointed to
school_id_853_job_info.checkpoint next to this script -- kill-and-resume,
