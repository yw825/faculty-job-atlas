"""
Job info scraper for school_id 1310 - South Dakota State University (US)
ATS platform: own website
Careers link: https://www.sdstate.edu/human-resources/sdsu-employment

Reads posting URLs from school_id_1310_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1310_job_info.csv. Checkpointed to
school_id_1310_job_info.checkpoint next to this script -- kill-and-resume,
