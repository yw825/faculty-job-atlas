"""
Job info scraper for school_id 634 - University of Michigan-Dearborn (US)
ATS platform: own website
Careers link: https://careers.umich.edu/search-jobs

Reads posting URLs from school_id_634_job_postings.checkpoint (this
...
Writes school_job_info/school_id_634_job_info.csv. Checkpointed to
school_id_634_job_info.checkpoint next to this script -- kill-and-resume,
