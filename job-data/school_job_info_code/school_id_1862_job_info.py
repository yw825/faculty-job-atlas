"""
Job info scraper for school_id 1862 - Singapore University of Technology and Design (Singapore)
ATS platform: own website
Careers link: https://careers.sutd.edu.sg/search/?createNewAlert=false&q=&optionsFacetsDD_facility=&optionsFacetsDD_department=
...
school's job_postings script). Edit it directly if Singapore University of Technology and Design's posting pages
...
Reads posting URLs from school_id_1862_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1862_job_info.csv. Checkpointed to
school_id_1862_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://careers.sutd.edu.sg/search/?createNewAlert=false&q=&optionsFacetsDD_facility=&optionsFacetsDD_department='
