"""
Job info scraper for school_id 635 - University of Detroit Mercy (US)
ATS platform: own website
Careers link: https://www.udmercy.edu/faculty-staff/hr/jobs.php

Reads posting URLs from school_id_635_job_postings.checkpoint (this
...
Writes school_job_info/school_id_635_job_info.csv. Checkpointed to
school_id_635_job_info.checkpoint next to this script -- kill-and-resume,
