"""
Job info scraper for school_id 611 - University of Maine at Augusta (US)
ATS platform: own website
Careers link: https://uma.careers.maine.edu/

Reads posting URLs from school_id_611_job_postings.checkpoint (this
...
Writes school_job_info/school_id_611_job_info.csv. Checkpointed to
school_id_611_job_info.checkpoint next to this script -- kill-and-resume,
