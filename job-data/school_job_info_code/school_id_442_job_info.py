"""
Job info scraper for school_id 442 - Manchester University (US)
ATS platform: own website
Careers link: https://www.manchester.edu/employment-opportunities/

Reads posting URLs from school_id_442_job_postings.checkpoint (this
...
Writes school_job_info/school_id_442_job_info.csv. Checkpointed to
school_id_442_job_info.checkpoint next to this script -- kill-and-resume,
