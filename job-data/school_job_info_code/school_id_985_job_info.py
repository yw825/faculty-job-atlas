"""
Job info scraper for school_id 985 - Paul Smiths College of Arts and Science (US)
ATS platform: own website
Careers link: https://www.paulsmiths.edu/careers/

Reads posting URLs from school_id_985_job_postings.checkpoint (this
...
Writes school_job_info/school_id_985_job_info.csv. Checkpointed to
school_id_985_job_info.checkpoint next to this script -- kill-and-resume,
