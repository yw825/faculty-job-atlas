"""
Job info scraper for school_id 1791 - University of Technology Sydney (Australia)
ATS platform: own website
Careers link: https://recruitment.uts.edu.au/OA_HTML/OA.jsp?OAFunc=IRC_VIS_HOME_NEW_JOBS&_ti=620357091&oapc=2&oas=1N5G4mzcqWkf6lkmKhbEMw..
...
school's job_postings script). Edit it directly if University of Technology Sydney's posting pages
...
Reads posting URLs from school_id_1791_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1791_job_info.csv. Checkpointed to
school_id_1791_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://recruitment.uts.edu.au/OA_HTML/OA.jsp?OAFunc=IRC_VIS_HOME_NEW_JOBS&_ti=620357091&oapc=2&oas=1N5G4mzcqWkf6lkmKhbEMw..'
