"""
Job info scraper for school_id 1815 - Swinburne University of Technology (Australia)
ATS platform: PageUp/NGA
Careers link: https://swinjobs.nga.net.au/cp/index.cfm?event=jobs.listJobs&jobListid=1e31354d-ae80-9f9a-6321-5b3e8846b9e0&AudienceTypeCode=EXT&unpersistVars=CurATC,CurBID,jobListid&rmuh=A703045E85CF1618241426410433C711F3C4108C
...
school's job_postings script). Edit it directly if Swinburne University of Technology's posting pages
...
Reads posting URLs from school_id_1815_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1815_job_info.csv. Checkpointed to
school_id_1815_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://swinjobs.nga.net.au/cp/index.cfm?event=jobs.listJobs&jobListid=1e31354d-ae80-9f9a-6321-5b3e8846b9e0&AudienceTypeCode=EXT&unpersistVars=CurATC,CurBID,jobListid&rmuh=A703045E85CF1618241426410433C711F3C4108C'
