"""
Job info scraper for school_id 1692 - Ludwig Maximilian University of Munich (Germany)
...
school's job_postings script). Edit it directly if Ludwig Maximilian University of Munich's posting pages
...
Reads posting URLs from school_id_1692_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1692_job_info.csv. Checkpointed to
school_id_1692_job_info.checkpoint next to this script -- kill-and-resume,
