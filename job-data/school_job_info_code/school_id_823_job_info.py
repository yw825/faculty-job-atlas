"""
Job info scraper for school_id 823 - North Dakota State University-Main Campus (US)
ATS platform: own website
Careers link: https://www.ndsu.edu/employment

Reads posting URLs from school_id_823_job_postings.checkpoint (this
...
Writes school_job_info/school_id_823_job_info.csv. Checkpointed to
school_id_823_job_info.checkpoint next to this script -- kill-and-resume,
