"""
Job info scraper for school_id 253 - Polytechnic University of Puerto Rico-Orlando (US)
ATS platform: ADP
...
Reads posting URLs from school_id_253_job_postings.checkpoint (this
...
Writes school_job_info/school_id_253_job_info.csv. Checkpointed to
school_id_253_job_info.checkpoint next to this script -- kill-and-resume,
