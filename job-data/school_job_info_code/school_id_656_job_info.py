"""
Job info scraper for school_id 656 - Baker College (US)
ATS platform: own website
Careers link: https://www.baker.edu/about/get-to-know-us/careers/

Reads posting URLs from school_id_656_job_postings.checkpoint (this
...
Writes school_job_info/school_id_656_job_info.csv. Checkpointed to
school_id_656_job_info.checkpoint next to this script -- kill-and-resume,
