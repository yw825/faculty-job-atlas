"""
Job info scraper for school_id 18 - University of South Alabama (US)
ATS platform: own website
Careers link: https://www.southalabama.edu/departments/academicaffairs/facultyposition.html

Reads posting URLs from school_id_18_job_postings.checkpoint (this
...
Writes school_job_info/school_id_18_job_info.csv. Checkpointed to
school_id_18_job_info.checkpoint next to this script -- kill-and-resume,
