"""
Job info scraper for school_id 249 - Trinity International University-Florida (US)
ATS platform: own website
Careers link: https://www.tiu.edu/human-resources/

Reads posting URLs from school_id_249_job_postings.checkpoint (this
...
Writes school_job_info/school_id_249_job_info.csv. Checkpointed to
school_id_249_job_info.checkpoint next to this script -- kill-and-resume,
