"""
Job info scraper for school_id 1775 - University of Manchester (United Kingdom)
ATS platform: own website
Careers link: https://www.jobs.manchester.ac.uk/Home/Job
...
school's job_postings script). Edit it directly if University of Manchester's posting pages
...
Reads posting URLs from school_id_1775_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1775_job_info.csv. Checkpointed to
school_id_1775_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://www.jobs.manchester.ac.uk/Home/Job'
