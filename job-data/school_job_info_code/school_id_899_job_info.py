"""
Job info scraper for school_id 899 - New Mexico Institute of Mining and Technology (US)
ATS platform: own website
Careers link: https://www.nmt.edu/hr/employment.php

Reads posting URLs from school_id_899_job_postings.checkpoint (this
...
Writes school_job_info/school_id_899_job_info.csv. Checkpointed to
school_id_899_job_info.checkpoint next to this script -- kill-and-resume,
