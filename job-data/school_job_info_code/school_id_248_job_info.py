"""
Job info scraper for school_id 248 - Polytechnic University of Puerto Rico-Miami (US)
ATS platform: own website
Careers link: https://pupr.edu/hr/

Reads posting URLs from school_id_248_job_postings.checkpoint (this
...
Writes school_job_info/school_id_248_job_info.csv. Checkpointed to
school_id_248_job_info.checkpoint next to this script -- kill-and-resume,
