"""
Job info scraper for school_id 672 - University of Minnesota-Duluth (US)
ATS platform: own website
Careers link: https://hr.umn.edu/jobs/Applicant-Support/Veteran-Employment-Guidance

Reads posting URLs from school_id_672_job_postings.checkpoint (this
...
Writes school_job_info/school_id_672_job_info.csv. Checkpointed to
school_id_672_job_info.checkpoint next to this script -- kill-and-resume,
