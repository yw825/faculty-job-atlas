"""
Job info scraper for school_id 943 - SUNY College at Geneseo (US)
ATS platform: own website
Careers link: https://www.geneseo.edu/provost/applying-for-faculty-positions

Reads posting URLs from school_id_943_job_postings.checkpoint (this
...
Writes school_job_info/school_id_943_job_info.csv. Checkpointed to
school_id_943_job_info.checkpoint next to this script -- kill-and-resume,
