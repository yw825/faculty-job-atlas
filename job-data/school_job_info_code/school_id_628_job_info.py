"""
Job info scraper for school_id 628 - Grand Valley State University (US)
ATS platform: Workday
Careers link: https://gvsu.wd1.myworkdayjobs.com/careers

Reads posting URLs from school_id_628_job_postings.checkpoint (this
...
Writes school_job_info/school_id_628_job_info.csv. Checkpointed to
school_id_628_job_info.checkpoint next to this script -- kill-and-resume,
