"""
Job info scraper for school_id 1234 - Inter American University of Puerto Rico-Barranquitas (US)
ATS platform: own website
Careers link: https://iaupr.elluciancrmrecruit.com/Apply

Reads posting URLs from school_id_1234_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1234_job_info.csv. Checkpointed to
school_id_1234_job_info.checkpoint next to this script -- kill-and-resume,
