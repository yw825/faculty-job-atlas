"""
Job info scraper for school_id 188 - Charter Oak State College (US)
ATS platform: own website
Careers link: https://www.charteroak.edu/aboutus/employment.php

Reads posting URLs from school_id_188_job_postings.checkpoint (this
...
Writes school_job_info/school_id_188_job_info.csv. Checkpointed to
school_id_188_job_info.checkpoint next to this script -- kill-and-resume,
