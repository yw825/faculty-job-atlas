"""
Job info scraper for school_id 1249 - University of Puerto Rico-Humacao (US)
ATS platform: own website
Careers link: https://www.uprh.edu/empleos/

Reads posting URLs from school_id_1249_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1249_job_info.csv. Checkpointed to
school_id_1249_job_info.checkpoint next to this script -- kill-and-resume,
