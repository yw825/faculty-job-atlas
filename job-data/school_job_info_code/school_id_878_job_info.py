"""
Job info scraper for school_id 878 - New Jersey Institute of Technology (US)
ATS platform: own website
Careers link: https://jobs.njit.edu

Reads posting URLs from school_id_878_job_postings.checkpoint (this
...
Writes school_job_info/school_id_878_job_info.csv. Checkpointed to
school_id_878_job_info.checkpoint next to this script -- kill-and-resume,
