"""
Job info scraper for school_id 1015 - Russell Sage College (US)
ATS platform: own website
Careers link: https://sage.interviewexchange.com/

Reads posting URLs from school_id_1015_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1015_job_info.csv. Checkpointed to
school_id_1015_job_info.checkpoint next to this script -- kill-and-resume,
