"""
Job info scraper for school_id 1807 - University of Adelaide (Australia)
ATS platform: own website
Careers link: https://careers.adelaide.edu.au/
...
school's job_postings script). Edit it directly if University of Adelaide's posting pages
...
Reads posting URLs from school_id_1807_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1807_job_info.csv. Checkpointed to
school_id_1807_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://careers.adelaide.edu.au/'
