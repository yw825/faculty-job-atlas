"""
Job info scraper for school_id 1711 - University of Padua (Italy)
ATS platform: own website
Careers link: https://protocollo.unipd.it/albo/viewer
...
school's job_postings script). Edit it directly if University of Padua's posting pages
...
Reads posting URLs from school_id_1711_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1711_job_info.csv. Checkpointed to
school_id_1711_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1711
SCHOOL_NAME = 'University of Padua'
CAREERS_LINK = 'https://protocollo.unipd.it/albo/viewer'
