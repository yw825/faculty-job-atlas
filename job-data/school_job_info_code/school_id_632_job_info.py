"""
Job info scraper for school_id 632 - Andrews University (US)
ATS platform: own website
Careers link: https://andrewsu-advocate.symplicity.com/care_report/index.php/pid627169

Reads posting URLs from school_id_632_job_postings.checkpoint (this
...
Writes school_job_info/school_id_632_job_info.csv. Checkpointed to
school_id_632_job_info.checkpoint next to this script -- kill-and-resume,
