"""
Job info scraper for school_id 317 - Reinhardt University (US)
ATS platform: own website
Careers link: https://www.reinhardt.edu/careers/

Reads posting URLs from school_id_317_job_postings.checkpoint (this
...
Writes school_job_info/school_id_317_job_info.csv. Checkpointed to
school_id_317_job_info.checkpoint next to this script -- kill-and-resume,
