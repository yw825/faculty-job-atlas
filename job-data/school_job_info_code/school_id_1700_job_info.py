"""
Job info scraper for school_id 1700 - Central European University (Hungary)
ATS platform: own website
Careers link: https://careers.ceu.edu/go/Academic-Career-Opportunities/9273755/
...
school's job_postings script). Edit it directly if Central European University's posting pages
...
Reads posting URLs from school_id_1700_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1700_job_info.csv. Checkpointed to
school_id_1700_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1700
SCHOOL_NAME = 'Central European University'
CAREERS_LINK = 'https://careers.ceu.edu/go/Academic-Career-Opportunities/9273755/'
