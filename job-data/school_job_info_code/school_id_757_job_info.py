"""
Job info scraper for school_id 757 - University of Mississippi (US)
ATS platform: Workday
Careers link: https://olemiss.wd12.myworkdayjobs.com/External__Faculty

Reads posting URLs from school_id_757_job_postings.checkpoint (this
...
Writes school_job_info/school_id_757_job_info.csv. Checkpointed to
school_id_757_job_info.checkpoint next to this script -- kill-and-resume,
