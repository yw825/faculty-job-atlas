"""
Job info scraper for school_id 876 - Saint Elizabeth University (US)
ATS platform: ADP
Careers link: https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=08c27dfd-4a66-473e-ac0f-70b2d10bc070&ccId=19000101_000001&source=CC2&lang=en_US&selectedMenuKey=CurrentOpenings

Reads posting URLs from school_id_876_job_postings.checkpoint (this
...
Every posting's title, department and description come back from ONE adp API call (BULK_ADAPTERS), not a visit per posting.
...
Writes school_job_info/school_id_876_job_info.csv. Checkpointed to
school_id_876_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 876
SCHOOL_NAME = 'Saint Elizabeth University'
CAREERS_LINK = 'https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=08c27dfd-4a66-473e-ac0f-70b2d10bc070&ccId=19000101_000001&source=CC2&lang=en_US&selectedMenuKey=CurrentOpenings'
ATS_PLATFORM = 'ADP'
USE_LLM = False
