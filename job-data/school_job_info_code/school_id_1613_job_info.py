"""
Job info scraper for school_id 1613 - Mount Saint Vincent University (Canada)
...
school's job_postings script). Edit it directly if Mount Saint Vincent University's posting pages
...
Reads posting URLs from school_id_1613_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1613_job_info.csv. Checkpointed to
school_id_1613_job_info.checkpoint next to this script -- kill-and-resume,
