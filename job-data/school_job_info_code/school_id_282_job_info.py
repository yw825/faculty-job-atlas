"""
Job info scraper for school_id 282 - Augusta University (US)
ATS platform: own website
Careers link: https://www.augusta.edu/hr/jobs/university/index.php

Reads posting URLs from school_id_282_job_postings.checkpoint (this
...
Writes school_job_info/school_id_282_job_info.csv. Checkpointed to
school_id_282_job_info.checkpoint next to this script -- kill-and-resume,
