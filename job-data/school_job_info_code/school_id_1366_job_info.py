"""
Job info scraper for school_id 1366 - Saint Edward's University (US)
ATS platform: own website
Careers link: http://stedwards.applicantpro.com/jobs/

Reads posting URLs from school_id_1366_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1366_job_info.csv. Checkpointed to
school_id_1366_job_info.checkpoint next to this script -- kill-and-resume,
