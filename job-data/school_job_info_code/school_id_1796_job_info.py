"""
Job info scraper for school_id 1796 - Griffith University (Australia)
ATS platform: own website
Careers link: https://www.griffith.edu.au/jobs/search-jobs
...
school's job_postings script). Edit it directly if Griffith University's posting pages
...
Reads posting URLs from school_id_1796_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1796_job_info.csv. Checkpointed to
school_id_1796_job_info.checkpoint next to this script -- kill-and-resume,
