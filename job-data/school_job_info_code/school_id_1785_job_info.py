"""
Job info scraper for school_id 1785 - Alphacrucis University College (Australia)
ATS platform: own website
Careers link: https://www.ac.edu.au/job-opportunities/
...
school's job_postings script). Edit it directly if Alphacrucis University College's posting pages
...
Reads posting URLs from school_id_1785_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1785_job_info.csv. Checkpointed to
school_id_1785_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1785
SCHOOL_NAME = 'Alphacrucis University College'
CAREERS_LINK = 'https://www.ac.edu.au/job-opportunities/'
