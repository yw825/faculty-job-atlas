"""
Job info scraper for school_id 515 - McNeese State University (US)
ATS platform: own website
Careers link: https://www.mcneese.edu/financial-aid/gainful-employment-disclosure-information/

Reads posting URLs from school_id_515_job_postings.checkpoint (this
...
Writes school_job_info/school_id_515_job_info.csv. Checkpointed to
school_id_515_job_info.checkpoint next to this script -- kill-and-resume,
