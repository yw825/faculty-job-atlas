"""
Job info scraper for school_id 552 - Nichols College (US)
ATS platform: own website
Careers link: https://www.nichols.edu/offices/human-resources/

Reads posting URLs from school_id_552_job_postings.checkpoint (this
...
Writes school_job_info/school_id_552_job_info.csv. Checkpointed to
school_id_552_job_info.checkpoint next to this script -- kill-and-resume,
