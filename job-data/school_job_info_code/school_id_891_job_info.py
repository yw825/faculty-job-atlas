"""
Job info scraper for school_id 891 - University of New Mexico-Main Campus (US)
ATS platform: own website
Careers link: https://unmjobs.unm.edu/

Reads posting URLs from school_id_891_job_postings.checkpoint (this
...
Writes school_job_info/school_id_891_job_info.csv. Checkpointed to
school_id_891_job_info.checkpoint next to this script -- kill-and-resume,
