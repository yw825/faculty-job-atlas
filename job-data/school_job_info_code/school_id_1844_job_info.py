...
school's job_postings script). Edit it directly if The Hong Kong Polytechnic University's posting pages
...
Reads posting URLs from school_id_1844_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1844_job_info.csv. Checkpointed to
school_id_1844_job_info.checkpoint next to this script -- kill-and-resume,
