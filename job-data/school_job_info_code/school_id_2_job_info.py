"""
Job info scraper for school_id 2 - University of Alaska Anchorage (US)
ATS platform: own website
Careers link: https://careers.alaska.edu/jobs/search/faculty-jobs?page=1&cities%5B%5D=Anchorage&query=

Reads posting URLs from school_id_2_job_postings.checkpoint (this
...
Writes school_job_info/school_id_2_job_info.csv. Checkpointed to
school_id_2_job_info.checkpoint next to this script -- kill-and-resume,
