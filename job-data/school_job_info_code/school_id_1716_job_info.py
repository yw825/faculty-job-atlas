"""
Job info scraper for school_id 1716 - University of Amsterdam (Netherlands)
ATS platform: own website
Careers link: https://werkenbij.uva.nl/vacatures
...
school's job_postings script). Edit it directly if University of Amsterdam's posting pages
...
Reads posting URLs from school_id_1716_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1716_job_info.csv. Checkpointed to
school_id_1716_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1716
SCHOOL_NAME = 'University of Amsterdam'
CAREERS_LINK = 'https://werkenbij.uva.nl/vacatures'
