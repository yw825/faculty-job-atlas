"""
Job info scraper for school_id 80 - Harvey Mudd College (US)
ATS platform: own website
Careers link: https://www.hmc.edu/dean-of-faculty/available-faculty-positions/

Reads posting URLs from school_id_80_job_postings.checkpoint (this
...
Writes school_job_info/school_id_80_job_info.csv. Checkpointed to
school_id_80_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://www.hmc.edu/dean-of-faculty/available-faculty-positions/'
