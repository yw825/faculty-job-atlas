"""
Job info scraper for school_id 1745 - Universidad Autónoma de Madrid (Spain)
ATS platform: own website
Careers link: https://www.uam.es/uam/en/investigacion/ofertas-empleo
...
school's job_postings script). Edit it directly if Universidad Autónoma de Madrid's posting pages
...
Reads posting URLs from school_id_1745_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1745_job_info.csv. Checkpointed to
school_id_1745_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1745
SCHOOL_NAME = 'Universidad Autónoma de Madrid'
CAREERS_LINK = 'https://www.uam.es/uam/en/investigacion/ofertas-empleo'
