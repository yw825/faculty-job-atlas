"""
Job info scraper for school_id 539 - Northeastern University (US)
ATS platform: own website
Careers link: https://hr.northeastern.edu/careers/job-listings/

Reads posting URLs from school_id_539_job_postings.checkpoint (this
...
Writes school_job_info/school_id_539_job_info.csv. Checkpointed to
school_id_539_job_info.checkpoint next to this script -- kill-and-resume,
