"""
Job info scraper for school_id 622 - Saint Joseph's College of Maine (US)
ATS platform: ADP
...
Reads posting URLs from school_id_622_job_postings.checkpoint (this
...
Writes school_job_info/school_id_622_job_info.csv. Checkpointed to
school_id_622_job_info.checkpoint next to this script -- kill-and-resume,
