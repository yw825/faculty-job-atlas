"""
Job info scraper for school_id 336 - Grand View University (US)
ATS platform: own website
Careers link: https://www.grandview.edu/about/directory/careers-at-gv

Reads posting URLs from school_id_336_job_postings.checkpoint (this
...
Writes school_job_info/school_id_336_job_info.csv. Checkpointed to
school_id_336_job_info.checkpoint next to this script -- kill-and-resume,
