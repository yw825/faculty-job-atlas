"""
Job info scraper for school_id 695 - St Catherine University (US)
ATS platform: PeopleAdmin
Careers link: https://stcatherine.peopleadmin.com/

Reads posting URLs from school_id_695_job_postings.checkpoint (this
...
Writes school_job_info/school_id_695_job_info.csv. Checkpointed to
school_id_695_job_info.checkpoint next to this script -- kill-and-resume,
