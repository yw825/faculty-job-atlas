"""
Job info scraper for school_id 561 - Lasell University (US)
ATS platform: own website
Careers link: https://www.lasell.edu/discover-lasell/employment/about-human-resources.html#nav

Reads posting URLs from school_id_561_job_postings.checkpoint (this
...
Writes school_job_info/school_id_561_job_info.csv. Checkpointed to
school_id_561_job_info.checkpoint next to this script -- kill-and-resume,
