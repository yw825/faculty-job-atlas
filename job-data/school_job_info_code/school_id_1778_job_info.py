"""
Job info scraper for school_id 1778 - Australian National University (Australia)
ATS platform: own website
Careers link: https://jobs.anu.edu.au/jobs/search?page=1&category_uids%5B%5D=37694d529bb555c68f1e76ddc653d496&query=
...
school's job_postings script). Edit it directly if Australian National University's posting pages
...
Reads posting URLs from school_id_1778_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1778_job_info.csv. Checkpointed to
school_id_1778_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://jobs.anu.edu.au/jobs/search?page=1&category_uids%5B%5D=37694d529bb555c68f1e76ddc653d496&query='
