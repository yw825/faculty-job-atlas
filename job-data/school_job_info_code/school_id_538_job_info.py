"""
Job info scraper for school_id 538 - Fisher College (US)
ATS platform: own website
Careers link: https://www.fisher.edu/careers

Reads posting URLs from school_id_538_job_postings.checkpoint (this
...
Writes school_job_info/school_id_538_job_info.csv. Checkpointed to
school_id_538_job_info.checkpoint next to this script -- kill-and-resume,
