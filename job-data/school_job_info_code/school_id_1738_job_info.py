"""
Job info scraper for school_id 1738 - Babeș-Bolyai University (Romania)
ATS platform: own website
Careers link: https://www.ubbcluj.ro/ro/infoubb/posturi_vacante/posturi_didactice_perioada_nedeterminata
...
school's job_postings script). Edit it directly if Babeș-Bolyai University's posting pages
...
Reads posting URLs from school_id_1738_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1738_job_info.csv. Checkpointed to
school_id_1738_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1738
SCHOOL_NAME = 'Babeș-Bolyai University'
CAREERS_LINK = 'https://www.ubbcluj.ro/ro/infoubb/posturi_vacante/posturi_didactice_perioada_nedeterminata'
