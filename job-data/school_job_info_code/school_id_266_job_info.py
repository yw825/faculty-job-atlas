"""
Job info scraper for school_id 266 - University of South Florida (US)
ATS platform: own website
Careers link: https://jobs.usf.edu/

Reads posting URLs from school_id_266_job_postings.checkpoint (this
...
Writes school_job_info/school_id_266_job_info.csv. Checkpointed to
school_id_266_job_info.checkpoint next to this script -- kill-and-resume,
