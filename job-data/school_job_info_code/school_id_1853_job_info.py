"""
Job info scraper for school_id 1853 - City University of Macau (Macau)
...
school's job_postings script). Edit it directly if City University of Macau's posting pages
...
Reads posting URLs from school_id_1853_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1853_job_info.csv. Checkpointed to
school_id_1853_job_info.checkpoint next to this script -- kill-and-resume,
