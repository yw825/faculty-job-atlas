"""
Job info scraper for school_id 1633 - University of Toronto (Canada)
ATS platform: own website
Careers link: https://jobs.utoronto.ca/go/All-Opportunities/2607117/
...
school's job_postings script). Edit it directly if University of Toronto's posting pages
...
Reads posting URLs from school_id_1633_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1633_job_info.csv. Checkpointed to
school_id_1633_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://jobs.utoronto.ca/go/All-Opportunities/2607117/'
