"""
Job info scraper for school_id 304 - Life University (US)
ATS platform: own website
Careers link: https://life-csm.symplicity.com/employers/?signin_tab=0

Reads posting URLs from school_id_304_job_postings.checkpoint (this
...
Writes school_job_info/school_id_304_job_info.csv. Checkpointed to
school_id_304_job_info.checkpoint next to this script -- kill-and-resume,
