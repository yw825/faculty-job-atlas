"""
Job info scraper for school_id 941 - SUNY at Fredonia (US)
ATS platform: own website
Careers link: https://www.fredonia.edu/about/offices/human-resources/jobs

Reads posting URLs from school_id_941_job_postings.checkpoint (this
...
Writes school_job_info/school_id_941_job_info.csv. Checkpointed to
school_id_941_job_info.checkpoint next to this script -- kill-and-resume,
