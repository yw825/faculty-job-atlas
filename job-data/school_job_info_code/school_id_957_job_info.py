"""
Job info scraper for school_id 957 - Barnard College (US)
ATS platform: Workday
Careers link: https://barnard.wd1.myworkdayjobs.com/Faculty

Reads posting URLs from school_id_957_job_postings.checkpoint (this
...
Writes school_job_info/school_id_957_job_info.csv. Checkpointed to
school_id_957_job_info.checkpoint next to this script -- kill-and-resume,
