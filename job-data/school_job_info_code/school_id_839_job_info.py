"""
Job info scraper for school_id 839 - College of Saint Mary (US)
ATS platform: own website
Careers link: https://www.csm.edu/academics/career-pathways/

Reads posting URLs from school_id_839_job_postings.checkpoint (this
...
Writes school_job_info/school_id_839_job_info.csv. Checkpointed to
school_id_839_job_info.checkpoint next to this script -- kill-and-resume,
