"""
Job info scraper for school_id 1720 - Maastricht University (Netherlands)
ATS platform: own website
Careers link: https://vacancies.maastrichtuniversity.nl/go/Vacatures/8841902/
...
school's job_postings script). Edit it directly if Maastricht University's posting pages
...
Reads posting URLs from school_id_1720_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1720_job_info.csv. Checkpointed to
school_id_1720_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1720
SCHOOL_NAME = 'Maastricht University'
CAREERS_LINK = 'https://vacancies.maastrichtuniversity.nl/go/Vacatures/8841902/'
