"""
Job info scraper for school_id 1878 - Middlesex University (United Kingdom)
ATS platform: own website
Careers link: https://jobs.mdx.ac.uk/vacancies.aspx?cat=200
...
school's job_postings script). Edit it directly if Middlesex University's posting pages
...
Reads posting URLs from school_id_1878_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1878_job_info.csv. Checkpointed to
school_id_1878_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1878
SCHOOL_NAME = 'Middlesex University'
CAREERS_LINK = 'https://jobs.mdx.ac.uk/vacancies.aspx?cat=200'
