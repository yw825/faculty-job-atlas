"""
Job info scraper for school_id 1787 - Excelsia College (Australia)
ATS platform: own website
Careers link: https://employmenthero.com/jobs/organisations/excelsia-university-college/
...
school's job_postings script). Edit it directly if Excelsia College's posting pages
...
Reads posting URLs from school_id_1787_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1787_job_info.csv. Checkpointed to
school_id_1787_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1787
SCHOOL_NAME = 'Excelsia College'
CAREERS_LINK = 'https://employmenthero.com/jobs/organisations/excelsia-university-college/'
