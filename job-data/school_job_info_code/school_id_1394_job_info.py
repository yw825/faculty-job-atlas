"""
Job info scraper for school_id 1394 - Rice University (US)
ATS platform: own website
Careers link: https://vpaa.rice.edu/faculty/open-positions

Reads posting URLs from school_id_1394_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1394_job_info.csv. Checkpointed to
school_id_1394_job_info.checkpoint next to this script -- kill-and-resume,
