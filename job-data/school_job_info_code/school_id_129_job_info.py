"""
Job info scraper for school_id 129 - National University (US)
ATS platform: Workday
Careers link: https://nus.wd1.myworkdayjobs.com/en-US/Careers

Reads posting URLs from school_id_129_job_postings.checkpoint (this
...
Writes school_job_info/school_id_129_job_info.csv. Checkpointed to
school_id_129_job_info.checkpoint next to this script -- kill-and-resume,
