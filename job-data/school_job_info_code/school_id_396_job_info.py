"""
Job info scraper for school_id 396 - Lake Forest College (US)
ATS platform: own website
Careers link: https://www.lakeforest.edu/offices-and-departments/human-resources/lake-forest-college-employment

Reads posting URLs from school_id_396_job_postings.checkpoint (this
...
Writes school_job_info/school_id_396_job_info.csv. Checkpointed to
school_id_396_job_info.checkpoint next to this script -- kill-and-resume,
