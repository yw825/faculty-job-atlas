"""
Job info scraper for school_id 1414 - Stephen F Austin State University (US)
ATS platform: own website
Careers link: https://www.sfasu.edu/hr

Reads posting URLs from school_id_1414_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1414_job_info.csv. Checkpointed to
school_id_1414_job_info.checkpoint next to this script -- kill-and-resume,
