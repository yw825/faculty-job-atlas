"""
Job info scraper for school_id 1400 - University of St Thomas (US)
ATS platform: own website
Careers link: https://stthom.applicantpro.com/jobs/

Reads posting URLs from school_id_1400_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1400_job_info.csv. Checkpointed to
school_id_1400_job_info.checkpoint next to this script -- kill-and-resume,
