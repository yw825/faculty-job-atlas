"""
Job info scraper for school_id 676 - Augsburg University (US)
ATS platform: SmartRecruiters
Careers link: https://careers.smartrecruiters.com/AugsburgUniversity-MinneapolisMN/faculty

Reads posting URLs from school_id_676_job_postings.checkpoint (this
...
Writes school_job_info/school_id_676_job_info.csv. Checkpointed to
school_id_676_job_info.checkpoint next to this script -- kill-and-resume,
