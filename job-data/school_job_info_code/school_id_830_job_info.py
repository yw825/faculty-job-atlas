"""
Job info scraper for school_id 830 - Chadron State College (US)
ATS platform: PeopleAdmin
Careers link: https://nscs.peopleadmin.com/postings/13006

Reads posting URLs from school_id_830_job_postings.checkpoint (this
...
Writes school_job_info/school_id_830_job_info.csv. Checkpointed to
school_id_830_job_info.checkpoint next to this script -- kill-and-resume,
