"""
Job info scraper for school_id 1211 - University of Scranton (US)
ATS platform: own website
Careers link: https://www.follett.com/careerportal/find-career.cfm

Reads posting URLs from school_id_1211_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1211_job_info.csv. Checkpointed to
school_id_1211_job_info.checkpoint next to this script -- kill-and-resume,
