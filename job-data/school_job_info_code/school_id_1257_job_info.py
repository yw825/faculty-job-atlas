"""
Job info scraper for school_id 1257 - University of Puerto Rico at Ponce (US)
ATS platform: own website
Careers link: https://www.uprp.edu/en/articulos/administracion/recursos-humanos/

Reads posting URLs from school_id_1257_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1257_job_info.csv. Checkpointed to
school_id_1257_job_info.checkpoint next to this script -- kill-and-resume,
