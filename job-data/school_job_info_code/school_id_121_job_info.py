"""
Job info scraper for school_id 121 - University of California-Riverside (US)
ATS platform: own website
Careers link: https://aprecruit.ucr.edu/apply

Reads posting URLs from school_id_121_job_postings.checkpoint (this
...
Writes school_job_info/school_id_121_job_info.csv. Checkpointed to
school_id_121_job_info.checkpoint next to this script -- kill-and-resume,
