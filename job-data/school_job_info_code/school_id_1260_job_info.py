"""
Job info scraper for school_id 1260 - Inter American University of Puerto Rico-Metro (US)
ATS platform: own website
Careers link: https://iaupr.elluciancrmrecruit.com/Apply/Account/Create?returnUrl=%2FApply

Reads posting URLs from school_id_1260_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1260_job_info.csv. Checkpointed to
school_id_1260_job_info.checkpoint next to this script -- kill-and-resume,
