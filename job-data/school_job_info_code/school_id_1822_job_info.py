"""
Job info scraper for school_id 1822 - University of Western Australia (Australia)
ATS platform: own website
Careers link: https://external.jobs.uwa.edu.au/jobs/search
...
school's job_postings script). Edit it directly if University of Western Australia's posting pages
...
Reads posting URLs from school_id_1822_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1822_job_info.csv. Checkpointed to
school_id_1822_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1822
SCHOOL_NAME = 'University of Western Australia'
CAREERS_LINK = 'https://external.jobs.uwa.edu.au/jobs/search'
