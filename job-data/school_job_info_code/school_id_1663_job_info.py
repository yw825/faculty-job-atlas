"""
Job info scraper for school_id 1663 - Vlerick Business School (Belgium)
ATS platform: own website
Careers link: https://www.vlerick.com/en/working-vlerick/join-the-faculty-team/
...
school's job_postings script). Edit it directly if Vlerick Business School's posting pages
...
Reads posting URLs from school_id_1663_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1663_job_info.csv. Checkpointed to
school_id_1663_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1663
SCHOOL_NAME = 'Vlerick Business School'
CAREERS_LINK = 'https://www.vlerick.com/en/working-vlerick/join-the-faculty-team/'
