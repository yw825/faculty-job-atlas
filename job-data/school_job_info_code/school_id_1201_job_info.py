"""
Job info scraper for school_id 1201 - Point Park University (US)
ATS platform: own website
Careers link: https://www.pointpark.edu/careerready/index

Reads posting URLs from school_id_1201_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1201_job_info.csv. Checkpointed to
school_id_1201_job_info.checkpoint next to this script -- kill-and-resume,
