"""
Job info scraper for school_id 460 - Emporia State University (US)
ATS platform: own website
Careers link: https://hr.hornet365.com/open-positions

Reads posting URLs from school_id_460_job_postings.checkpoint (this
...
Writes school_job_info/school_id_460_job_info.csv. Checkpointed to
school_id_460_job_info.checkpoint next to this script -- kill-and-resume,
