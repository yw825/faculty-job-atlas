"""
Job info scraper for school_id 1728 - AGH University of Krakow (Poland)
...
school's job_postings script). Edit it directly if AGH University of Krakow's posting pages
...
Reads posting URLs from school_id_1728_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1728_job_info.csv. Checkpointed to
school_id_1728_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1728
SCHOOL_NAME = 'AGH University of Krakow'
