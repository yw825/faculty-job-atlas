"""
Job info scraper for school_id 1116 - Lewis & Clark College (US)
ATS platform: own website
Careers link: https://www.lclark.edu/offices/human_resources/jobs/

Reads posting URLs from school_id_1116_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1116_job_info.csv. Checkpointed to
school_id_1116_job_info.checkpoint next to this script -- kill-and-resume,
