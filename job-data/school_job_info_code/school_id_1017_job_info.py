"""
Job info scraper for school_id 1017 - Utica University (US)
ATS platform: own website
Careers link: https://www.utica.edu/hr/employment.cfm

Reads posting URLs from school_id_1017_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1017_job_info.csv. Checkpointed to
school_id_1017_job_info.checkpoint next to this script -- kill-and-resume,
