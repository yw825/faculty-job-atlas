"""
Job info scraper for school_id 1661 - Université Libre de Bruxelles (Belgium)
...
school's job_postings script). Edit it directly if Université Libre de Bruxelles's posting pages
...
Reads posting URLs from school_id_1661_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1661_job_info.csv. Checkpointed to
school_id_1661_job_info.checkpoint next to this script -- kill-and-resume,
