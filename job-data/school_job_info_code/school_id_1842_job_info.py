"""
Job info scraper for school_id 1842 - The Chinese University of Hong Kong (Hong Kong)
ATS platform: Taleo
Careers link: https://cuhk.taleo.net/careersection/cu_career_teach/jobsearch.ftl?lang=en&portal=10115020119
...
school's job_postings script). Edit it directly if The Chinese University of Hong Kong's posting pages
...
Reads posting URLs from school_id_1842_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1842_job_info.csv. Checkpointed to
school_id_1842_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://cuhk.taleo.net/careersection/cu_career_teach/jobsearch.ftl?lang=en&portal=10115020119'
ATS_PLATFORM = 'Taleo'
