"""
Job info scraper for school_id 728 - Missouri Western State University (US)
ATS platform: PeopleAdmin
Careers link: https://mwsu.peopleadmin.com/

Reads posting URLs from school_id_728_job_postings.checkpoint (this
...
Writes school_job_info/school_id_728_job_info.csv. Checkpointed to
school_id_728_job_info.checkpoint next to this script -- kill-and-resume,
