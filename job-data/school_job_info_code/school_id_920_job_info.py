"""
Job info scraper for school_id 920 - Pratt Institute-Main (US)
ATS platform: own website
Careers link: https://www.pratt.edu/administrative-departments/human-resources/open-positions/faculty-positions/

Reads posting URLs from school_id_920_job_postings.checkpoint (this
...
Writes school_job_info/school_id_920_job_info.csv. Checkpointed to
school_id_920_job_info.checkpoint next to this script -- kill-and-resume,
