"""
Job info scraper for school_id 265 - The University of Tampa (US)
ATS platform: Workday
Careers link: https://utampa.wd1.myworkdayjobs.com/Faculty

Reads posting URLs from school_id_265_job_postings.checkpoint (this
...
Writes school_job_info/school_id_265_job_info.csv. Checkpointed to
school_id_265_job_info.checkpoint next to this script -- kill-and-resume,
