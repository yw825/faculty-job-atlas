"""
Job info scraper for school_id 1505 - Northern Vermont University (US)
ATS platform: Workday
Careers link: https://vsc.wd108.myworkdayjobs.com/VTSU

Reads posting URLs from school_id_1505_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1505_job_info.csv. Checkpointed to
school_id_1505_job_info.checkpoint next to this script -- kill-and-resume,
