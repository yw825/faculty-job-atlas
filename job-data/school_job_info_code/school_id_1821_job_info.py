"""
Job info scraper for school_id 1821 - Murdoch University (Australia)
ATS platform: Workday
Careers link: https://murdoch.wd3.myworkdayjobs.com/MurdochCareers
...
school's job_postings script). Edit it directly if Murdoch University's posting pages
...
Reads posting URLs from school_id_1821_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1821_job_info.csv. Checkpointed to
school_id_1821_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://murdoch.wd3.myworkdayjobs.com/MurdochCareers'
