"""
Job info scraper for school_id 431 - Butler University (US)
...
Reads posting URLs from school_id_431_job_postings.checkpoint (this
...
Writes school_job_info/school_id_431_job_info.csv. Checkpointed to
school_id_431_job_info.checkpoint next to this script -- kill-and-resume,
