"""
Job info scraper for school_id 1233 - University of Puerto Rico-Arecibo (US)
ATS platform: own website
Careers link: https://upra.edu/recursos-humanos/convocatorias/

Reads posting URLs from school_id_1233_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1233_job_info.csv. Checkpointed to
school_id_1233_job_info.checkpoint next to this script -- kill-and-resume,
