"""
Job info scraper for school_id 1318 - Black Hills State University (US)
ATS platform: own website
Careers link: https://yourfuture.sdbor.edu/postings/search

Reads posting URLs from school_id_1318_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1318_job_info.csv. Checkpointed to
school_id_1318_job_info.checkpoint next to this script -- kill-and-resume,
