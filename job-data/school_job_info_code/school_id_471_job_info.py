"""
Job info scraper for school_id 471 - Bethel College-North Newton (US)
ATS platform: own website
Careers link: https://jobs.bethelks.edu/

Reads posting URLs from school_id_471_job_postings.checkpoint (this
...
Writes school_job_info/school_id_471_job_info.csv. Checkpointed to
school_id_471_job_info.checkpoint next to this script -- kill-and-resume,
