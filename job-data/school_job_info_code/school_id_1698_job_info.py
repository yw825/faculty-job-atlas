"""
Job info scraper for school_id 1698 - Corvinus University of Budapest (Hungary)
...
school's job_postings script). Edit it directly if Corvinus University of Budapest's posting pages
...
Reads posting URLs from school_id_1698_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1698_job_info.csv. Checkpointed to
school_id_1698_job_info.checkpoint next to this script -- kill-and-resume,
