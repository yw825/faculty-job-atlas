"""
Job info scraper for school_id 1717 - Vrije Universiteit Amsterdam (Netherlands)
ATS platform: own website
Careers link: https://werkenbij.vu.nl/vacatures
...
school's job_postings script). Edit it directly if Vrije Universiteit Amsterdam's posting pages
...
Reads posting URLs from school_id_1717_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1717_job_info.csv. Checkpointed to
school_id_1717_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1717
SCHOOL_NAME = 'Vrije Universiteit Amsterdam'
CAREERS_LINK = 'https://werkenbij.vu.nl/vacatures'
