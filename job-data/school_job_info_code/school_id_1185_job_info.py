"""
Job info scraper for school_id 1185 - Pennsylvania State University-Penn State New Kensington (US)
ATS platform: Workday
Careers link: https://psu.wd1.myworkdayjobs.com/PSU_Academic

Reads posting URLs from school_id_1185_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1185_job_info.csv. Checkpointed to
school_id_1185_job_info.checkpoint next to this script -- kill-and-resume,
