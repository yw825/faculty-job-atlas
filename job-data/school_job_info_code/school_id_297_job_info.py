"""
Job info scraper for school_id 297 - Kennesaw State University (US)
ATS platform: own website
Careers link: https://campus.kennesaw.edu/offices-services/careers/campus-community/faculty-career-champions.php

Reads posting URLs from school_id_297_job_postings.checkpoint (this
...
Writes school_job_info/school_id_297_job_info.csv. Checkpointed to
school_id_297_job_info.checkpoint next to this script -- kill-and-resume,
