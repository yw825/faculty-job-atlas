"""
Job info scraper for school_id 1889 - Eindhoven University of Technology (Netherlands)
...
school's job_postings script). Edit it directly if Eindhoven University of Technology's posting pages
...
Reads posting URLs from school_id_1889_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1889_job_info.csv. Checkpointed to
school_id_1889_job_info.checkpoint next to this script -- kill-and-resume,
