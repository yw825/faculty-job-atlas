"""
Job info scraper for school_id 871 - Felician University (US)
ATS platform: own website
Careers link: https://felician.edu/about-felician-university/careers-at-felician/

Reads posting URLs from school_id_871_job_postings.checkpoint (this
...
Writes school_job_info/school_id_871_job_info.csv. Checkpointed to
school_id_871_job_info.checkpoint next to this script -- kill-and-resume,
