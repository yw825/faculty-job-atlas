"""
Job info scraper for school_id 1675 - INSEAD (France)
ATS platform: Oracle Cloud HCM (detected: oracle)
Careers link: https://iablgs.fa.ocs.oraclecloud.com/hcmUI/CandidateExperience/en/sites/CX_1?utm_medium=direct

INSEAD runs on a shared ATS platform with a bulk info adapter --
...
Reads posting URLs from school_id_1675_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1675_job_info.csv. Checkpointed to
school_id_1675_job_info.checkpoint next to this script -- kill-and-resume,
