"""
Job info scraper for school_id 135 - University of San Diego (US)
ATS platform: own website
Careers link: https://www.sandiego.edu/outcomes/careers/

Reads posting URLs from school_id_135_job_postings.checkpoint (this
...
Writes school_job_info/school_id_135_job_info.csv. Checkpointed to
school_id_135_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://www.sandiego.edu/outcomes/careers/'
