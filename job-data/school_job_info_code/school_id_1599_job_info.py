"""
Job info scraper for school_id 1599 - Brandon University (Canada)
ATS platform: own website
Careers link: https://www.brandonu.ca/jobs/
...
school's job_postings script). Edit it directly if Brandon University's posting pages
...
Reads posting URLs from school_id_1599_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1599_job_info.csv. Checkpointed to
school_id_1599_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1599
SCHOOL_NAME = 'Brandon University'
CAREERS_LINK = 'https://www.brandonu.ca/jobs/'
