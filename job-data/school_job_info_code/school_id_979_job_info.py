"""
Job info scraper for school_id 979 - New York Institute of Technology (US)
ATS platform: own website
Careers link: https://www.nyit.edu/human_resources/careers

Reads posting URLs from school_id_979_job_postings.checkpoint (this
...
Writes school_job_info/school_id_979_job_info.csv. Checkpointed to
school_id_979_job_info.checkpoint next to this script -- kill-and-resume,
