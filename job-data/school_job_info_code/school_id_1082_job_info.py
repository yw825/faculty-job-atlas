"""
Job info scraper for school_id 1082 - Northwestern Oklahoma State University (US)
ATS platform: own website
Careers link: https://nwosu.jotform.com/form/app-for-employment-non-exemt

Reads posting URLs from school_id_1082_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1082_job_info.csv. Checkpointed to
school_id_1082_job_info.checkpoint next to this script -- kill-and-resume,
