"""
Job info scraper for school_id 1713 - Sapienza University of Rome (Italy)
ATS platform: own website
Careers link: https://www.academicjobs.com/sapienza-university-of-rome-jobs
...
school's job_postings script). Edit it directly if Sapienza University of Rome's posting pages
...
Reads posting URLs from school_id_1713_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1713_job_info.csv. Checkpointed to
school_id_1713_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1713
SCHOOL_NAME = 'Sapienza University of Rome'
CAREERS_LINK = 'https://www.academicjobs.com/sapienza-university-of-rome-jobs'
