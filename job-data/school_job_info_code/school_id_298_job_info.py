"""
Job info scraper for school_id 298 - LaGrange College (US)
ATS platform: own website
Careers link: https://lagrangecollege.applicantstack.com/x/openings

Reads posting URLs from school_id_298_job_postings.checkpoint (this
...
Writes school_job_info/school_id_298_job_info.csv. Checkpointed to
school_id_298_job_info.checkpoint next to this script -- kill-and-resume,
