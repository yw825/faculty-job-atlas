"""
Job info scraper for school_id 1652 - Bishop's University (Canada)
ATS platform: own website
Careers link: https://working.ubishops.ca/
...
school's job_postings script). Edit it directly if Bishop's University's posting pages
...
Reads posting URLs from school_id_1652_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1652_job_info.csv. Checkpointed to
school_id_1652_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1652
SCHOOL_NAME = "Bishop's University"
CAREERS_LINK = 'https://working.ubishops.ca/'
