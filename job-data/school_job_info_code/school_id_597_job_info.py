"""
Job info scraper for school_id 597 - Washington College (US)
ATS platform: own website
Careers link: https://www.washcoll.edu/people_departments/offices/human-resources/employment/index.php

Reads posting URLs from school_id_597_job_postings.checkpoint (this
...
Writes school_job_info/school_id_597_job_info.csv. Checkpointed to
school_id_597_job_info.checkpoint next to this script -- kill-and-resume,
