"""
Job info scraper for school_id 1823 - Auckland University of Technology (New Zealand)
ATS platform: own website
Careers link: https://careers.aut.ac.nz/jobs
...
school's job_postings script). Edit it directly if Auckland University of Technology's posting pages
...
Reads posting URLs from school_id_1823_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1823_job_info.csv. Checkpointed to
school_id_1823_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1823
SCHOOL_NAME = 'Auckland University of Technology'
CAREERS_LINK = 'https://careers.aut.ac.nz/jobs'
