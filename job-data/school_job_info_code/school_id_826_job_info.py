"""
Job info scraper for school_id 826 - Mayville State University (US)
ATS platform: own website
Careers link: https://www.mayvillestate.edu/campus-life/campus-employment/

Reads posting URLs from school_id_826_job_postings.checkpoint (this
...
Writes school_job_info/school_id_826_job_info.csv. Checkpointed to
school_id_826_job_info.checkpoint next to this script -- kill-and-resume,
