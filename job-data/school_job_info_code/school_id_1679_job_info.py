"""
Job info scraper for school_id 1679 - Institut Polytechnique de Paris (France)
...
school's job_postings script). Edit it directly if Institut Polytechnique de Paris's posting pages
...
Reads posting URLs from school_id_1679_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1679_job_info.csv. Checkpointed to
school_id_1679_job_info.checkpoint next to this script -- kill-and-resume,
