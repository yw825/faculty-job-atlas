"""
Job info scraper for school_id 89 - California State University-Fullerton (US)
ATS platform: PageUp
...
Reads posting URLs from school_id_89_job_postings.checkpoint (this
...
Writes school_job_info/school_id_89_job_info.csv. Checkpointed to
school_id_89_job_info.checkpoint next to this script -- kill-and-resume,
