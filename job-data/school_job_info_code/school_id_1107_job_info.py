"""
Job info scraper for school_id 1107 - Oregon State University (US)
ATS platform: Workday
Careers link: https://oregonstate.wd501.myworkdayjobs.com/OSU_Careers_Site

Reads posting URLs from school_id_1107_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1107_job_info.csv. Checkpointed to
school_id_1107_job_info.checkpoint next to this script -- kill-and-resume,
