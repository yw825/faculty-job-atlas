"""
Job info scraper for school_id 140 - University of San Francisco (US)
ATS platform: Workday
Careers link: https://usfca.wd5.myworkdayjobs.com/USF_Full-Time_Faculty

Reads posting URLs from school_id_140_job_postings.checkpoint (this
...
Writes school_job_info/school_id_140_job_info.csv. Checkpointed to
school_id_140_job_info.checkpoint next to this script -- kill-and-resume,
