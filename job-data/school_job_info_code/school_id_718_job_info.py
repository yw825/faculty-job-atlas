"""
Job info scraper for school_id 718 - University of Missouri-Kansas City (US)
ATS platform: own website
Careers link: https://www.umkc.edu/hr/careers/index.html

Reads posting URLs from school_id_718_job_postings.checkpoint (this
...
Writes school_job_info/school_id_718_job_info.csv. Checkpointed to
school_id_718_job_info.checkpoint next to this script -- kill-and-resume,
