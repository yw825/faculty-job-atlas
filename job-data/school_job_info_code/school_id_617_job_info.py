"""
Job info scraper for school_id 617 - University of Maine at Fort Kent (US)
ATS platform: own website
Careers link: https://www.maine.edu/careers/

Reads posting URLs from school_id_617_job_postings.checkpoint (this
...
Writes school_job_info/school_id_617_job_info.csv. Checkpointed to
school_id_617_job_info.checkpoint next to this script -- kill-and-resume,
