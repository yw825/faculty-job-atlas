"""
Job info scraper for school_id 737 - Drury University (US)
ATS platform: own website
Careers link: https://www.drury.edu/hr/drury-university-jobs/

Reads posting URLs from school_id_737_job_postings.checkpoint (this
...
Writes school_job_info/school_id_737_job_info.csv. Checkpointed to
school_id_737_job_info.checkpoint next to this script -- kill-and-resume,
