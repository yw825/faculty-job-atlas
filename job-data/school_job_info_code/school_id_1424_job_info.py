"""
Job info scraper for school_id 1424 - St. Mary's University (US)
ATS platform: own website
Careers link: https://www.stmarytx.edu/about/jobs/

Reads posting URLs from school_id_1424_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1424_job_info.csv. Checkpointed to
school_id_1424_job_info.checkpoint next to this script -- kill-and-resume,
