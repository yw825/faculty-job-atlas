"""
Job info scraper for school_id 1813 - Monash University (Australia)
ATS platform: PageUp
Careers link: https://careers.pageuppeople.com/513/cw/en/listing
...
school's job_postings script). Edit it directly if Monash University's posting pages
...
Reads posting URLs from school_id_1813_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1813_job_info.csv. Checkpointed to
school_id_1813_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://careers.pageuppeople.com/513/cw/en/listing'
ATS_PLATFORM = 'PageUp'
