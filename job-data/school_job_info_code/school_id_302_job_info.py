"""
Job info scraper for school_id 302 - Middle Georgia State University (US)
ATS platform: own website
Careers link: https://www.mga.edu/human-resources/jobs/index.php

Reads posting URLs from school_id_302_job_postings.checkpoint (this
...
Writes school_job_info/school_id_302_job_info.csv. Checkpointed to
school_id_302_job_info.checkpoint next to this script -- kill-and-resume,
