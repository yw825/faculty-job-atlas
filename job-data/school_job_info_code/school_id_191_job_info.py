"""
Job info scraper for school_id 191 - Yale University (US)
ATS platform: own website
Careers link: https://academicpositions.yale.edu/

Reads posting URLs from school_id_191_job_postings.checkpoint (this
...
Writes school_job_info/school_id_191_job_info.csv. Checkpointed to
school_id_191_job_info.checkpoint next to this script -- kill-and-resume,
