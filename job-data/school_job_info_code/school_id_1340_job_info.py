"""
Job info scraper for school_id 1340 - Cumberland University (US)
ATS platform: own website
Careers link: https://www.cumberland.edu/about/employment/

Reads posting URLs from school_id_1340_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1340_job_info.csv. Checkpointed to
school_id_1340_job_info.checkpoint next to this script -- kill-and-resume,
