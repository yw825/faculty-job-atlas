"""
Job info scraper for school_id 1804 - Australian Institute of Business (Australia)
ATS platform: own website
Careers link: https://www.aib.edu.au/about-us/positions-available/
...
school's job_postings script). Edit it directly if Australian Institute of Business's posting pages
...
Reads posting URLs from school_id_1804_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1804_job_info.csv. Checkpointed to
school_id_1804_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1804
SCHOOL_NAME = 'Australian Institute of Business'
CAREERS_LINK = 'https://www.aib.edu.au/about-us/positions-available/'
