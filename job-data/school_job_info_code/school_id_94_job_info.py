"""
Job info scraper for school_id 94 - University of Massachusetts Global (US)
ATS platform: Workday
Careers link: https://umassglobal.wd5.myworkdayjobs.com/UMassGlobalCareers

Reads posting URLs from school_id_94_job_postings.checkpoint (this
...
Writes school_job_info/school_id_94_job_info.csv. Checkpointed to
school_id_94_job_info.checkpoint next to this script -- kill-and-resume,
