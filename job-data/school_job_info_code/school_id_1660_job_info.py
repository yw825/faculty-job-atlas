"""
Job info scraper for school_id 1660 - Vienna University of Economics and Business (Austria)
ATS platform: own website
Careers link: https://jobs.wu.ac.at/eng
...
school's job_postings script). Edit it directly if Vienna University of Economics and Business's posting pages
...
Reads posting URLs from school_id_1660_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1660_job_info.csv. Checkpointed to
school_id_1660_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1660
SCHOOL_NAME = 'Vienna University of Economics and Business'
CAREERS_LINK = 'https://jobs.wu.ac.at/eng'
