"""
Job info scraper for school_id 717 - Rockhurst University (US)
ATS platform: own website
Careers link: https://www.rockhurst.edu/about/human-resources/equal-employment-opportunity

Reads posting URLs from school_id_717_job_postings.checkpoint (this
...
Writes school_job_info/school_id_717_job_info.csv. Checkpointed to
school_id_717_job_info.checkpoint next to this script -- kill-and-resume,
