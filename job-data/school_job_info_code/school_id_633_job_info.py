"""
Job info scraper for school_id 633 - Ferris State University (US)
ATS platform: own website
Careers link: https://jobs.ferris.edu/en-us/listing/

Reads posting URLs from school_id_633_job_postings.checkpoint (this
...
Writes school_job_info/school_id_633_job_info.csv. Checkpointed to
school_id_633_job_info.checkpoint next to this script -- kill-and-resume,
