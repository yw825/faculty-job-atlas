"""
Job info scraper for school_id 1556 - Lakeland University (US)
ATS platform: own website
Careers link: https://lakeland.applicantpro.com/jobs/

Reads posting URLs from school_id_1556_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1556_job_info.csv. Checkpointed to
school_id_1556_job_info.checkpoint next to this script -- kill-and-resume,
