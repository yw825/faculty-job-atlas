"""
Job info scraper for school_id 1695 - National Technical University of Athens (Greece)
...
school's job_postings script). Edit it directly if National Technical University of Athens's posting pages
...
Reads posting URLs from school_id_1695_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1695_job_info.csv. Checkpointed to
school_id_1695_job_info.checkpoint next to this script -- kill-and-resume,
