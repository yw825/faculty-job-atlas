"""
Job info scraper for school_id 1519 - Seattle University (US)
ATS platform: Workday
Careers link: https://seattleu.wd108.myworkdayjobs.com/SeattleUJobs

Reads posting URLs from school_id_1519_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1519_job_info.csv. Checkpointed to
school_id_1519_job_info.checkpoint next to this script -- kill-and-resume,
