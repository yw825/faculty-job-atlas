"""
Job info scraper for school_id 643 - Davenport University (US)
ATS platform: own website
Careers link: https://post.davenport.edu/category/careers/

Reads posting URLs from school_id_643_job_postings.checkpoint (this
...
Writes school_job_info/school_id_643_job_info.csv. Checkpointed to
school_id_643_job_info.checkpoint next to this script -- kill-and-resume,
