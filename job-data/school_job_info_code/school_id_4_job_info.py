"""
Job info scraper for school_id 4 - Athens State University (US)
ATS platform: own website
Careers link: https://www.athens.edu/about/offices/human-resources/employment-opportunities/

Reads posting URLs from school_id_4_job_postings.checkpoint (this
...
Writes school_job_info/school_id_4_job_info.csv. Checkpointed to
school_id_4_job_info.checkpoint next to this script -- kill-and-resume,
