"""
Job info scraper for school_id 571 - American International College (US)
ATS platform: ADP
...
Reads posting URLs from school_id_571_job_postings.checkpoint (this
...
Writes school_job_info/school_id_571_job_info.csv. Checkpointed to
school_id_571_job_info.checkpoint next to this script -- kill-and-resume,
