"""
Job info scraper for school_id 760 - Montana State University (US)
ATS platform: own website
Careers link: https://jobs.montana.edu/postings/search

Reads posting URLs from school_id_760_job_postings.checkpoint (this
...
Writes school_job_info/school_id_760_job_info.csv. Checkpointed to
school_id_760_job_info.checkpoint next to this script -- kill-and-resume,
