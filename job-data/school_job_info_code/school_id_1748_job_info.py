"""
Job info scraper for school_id 1748 - Lund University (Sweden)
ATS platform: own website
Careers link: https://www.lunduniversity.lu.se/vacancies
...
school's job_postings script). Edit it directly if Lund University's posting pages
...
Reads posting URLs from school_id_1748_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1748_job_info.csv. Checkpointed to
school_id_1748_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1748
SCHOOL_NAME = 'Lund University'
CAREERS_LINK = 'https://www.lunduniversity.lu.se/vacancies'
