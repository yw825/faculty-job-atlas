"""
Job info scraper for school_id 916 - University of Mount Saint Vincent (US)
ATS platform: own website
Careers link: https://mountsaintvincent.edu/employment-opportunities/

Reads posting URLs from school_id_916_job_postings.checkpoint (this
...
Writes school_job_info/school_id_916_job_info.csv. Checkpointed to
school_id_916_job_info.checkpoint next to this script -- kill-and-resume,
