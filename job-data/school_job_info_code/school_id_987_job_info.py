"""
Job info scraper for school_id 987 - Clarkson University (US)
ATS platform: iCIMS
Careers link: https://careerhub-clarkson.icims.com

Reads posting URLs from school_id_987_job_postings.checkpoint (this
...
Writes school_job_info/school_id_987_job_info.csv. Checkpointed to
school_id_987_job_info.checkpoint next to this script -- kill-and-resume,
