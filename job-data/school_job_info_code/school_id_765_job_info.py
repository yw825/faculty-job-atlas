"""
Job info scraper for school_id 765 - Carroll College (US)
ATS platform: own website
Careers link: https://www.carroll.edu/about/work-carroll

Reads posting URLs from school_id_765_job_postings.checkpoint (this
...
Writes school_job_info/school_id_765_job_info.csv. Checkpointed to
school_id_765_job_info.checkpoint next to this script -- kill-and-resume,
