"""
Job info scraper for school_id 425 - Franklin College (US)
ATS platform: own website
Careers link: https://franklincollege.edu/about/key-offices/office-of-human-resources/employment-opportunities/

Reads posting URLs from school_id_425_job_postings.checkpoint (this
...
Writes school_job_info/school_id_425_job_info.csv. Checkpointed to
school_id_425_job_info.checkpoint next to this script -- kill-and-resume,
