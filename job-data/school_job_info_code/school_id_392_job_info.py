"""
Job info scraper for school_id 392 - Knox College (US)
ATS platform: own website
Careers link: https://www.knox.edu/employment-at-knox/faculty

Reads posting URLs from school_id_392_job_postings.checkpoint (this
...
Writes school_job_info/school_id_392_job_info.csv. Checkpointed to
school_id_392_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://www.knox.edu/employment-at-knox/faculty'
