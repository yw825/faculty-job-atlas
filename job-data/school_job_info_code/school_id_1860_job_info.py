"""
Job info scraper for school_id 1860 - Singapore Institute of Technology (Singapore)
ATS platform: own website
Careers link: https://careers.singaporetech.edu.sg/search/?q=&searchResultView=LIST
...
school's job_postings script). Edit it directly if Singapore Institute of Technology's posting pages
...
Reads posting URLs from school_id_1860_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1860_job_info.csv. Checkpointed to
school_id_1860_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://careers.singaporetech.edu.sg/search/?q=&searchResultView=LIST'
