"""
Job info scraper for school_id 1827 - University of Waikato (New Zealand)
ATS platform: Oracle Cloud HCM (detected: oracle)
Careers link: https://elhs.fa.ap1.oraclecloud.com/hcmUI/CandidateExperience/en/sites/CX/jobs?lastSelectedFacet=TITLES&mode=location&selectedTitlesFacet=UOW_ACADEMIC

University of Waikato runs on a shared ATS platform with a bulk info adapter --
...
Reads posting URLs from school_id_1827_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1827_job_info.csv. Checkpointed to
school_id_1827_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1827
SCHOOL_NAME = 'University of Waikato'
CAREERS_LINK = 'https://elhs.fa.ap1.oraclecloud.com/hcmUI/CandidateExperience/en/sites/CX/jobs?lastSelectedFacet=TITLES&mode=location&selectedTitlesFacet=UOW_ACADEMIC'
