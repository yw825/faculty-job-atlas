"""
Job info scraper for school_id 523 - University of New Orleans (US)
ATS platform: own website
Careers link: https://www.uno.edu/careers

Reads posting URLs from school_id_523_job_postings.checkpoint (this
...
Writes school_job_info/school_id_523_job_info.csv. Checkpointed to
school_id_523_job_info.checkpoint next to this script -- kill-and-resume,
