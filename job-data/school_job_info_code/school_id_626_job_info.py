"""
Job info scraper for school_id 626 - Siena Heights University (US)
ATS platform: own website
Careers link: https://www.sienaheights.edu/past-syllabi-employment-and-financial-aid/

Reads posting URLs from school_id_626_job_postings.checkpoint (this
...
Writes school_job_info/school_id_626_job_info.csv. Checkpointed to
school_id_626_job_info.checkpoint next to this script -- kill-and-resume,
