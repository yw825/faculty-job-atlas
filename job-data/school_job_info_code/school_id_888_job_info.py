"""
Job info scraper for school_id 888 - Monmouth University (US)
ATS platform: own website
Careers link: https://jobs.monmouth.edu/

Reads posting URLs from school_id_888_job_postings.checkpoint (this
...
Writes school_job_info/school_id_888_job_info.csv. Checkpointed to
school_id_888_job_info.checkpoint next to this script -- kill-and-resume,
