"""
Job info scraper for school_id 395 - University of St Francis (US)
ATS platform: own website
Careers link: https://stfrancis.edu/career-success-center/

Reads posting URLs from school_id_395_job_postings.checkpoint (this
...
Writes school_job_info/school_id_395_job_info.csv. Checkpointed to
school_id_395_job_info.checkpoint next to this script -- kill-and-resume,
