"""
Job info scraper for school_id 219 - Everglades University (US)
ATS platform: own website
Careers link: https://www.evergladesuniversity.edu/employment-opportunities/

Reads posting URLs from school_id_219_job_postings.checkpoint (this
...
Writes school_job_info/school_id_219_job_info.csv. Checkpointed to
school_id_219_job_info.checkpoint next to this script -- kill-and-resume,
