"""
Job info scraper for school_id 621 - University of Maine at Presque Isle (US)
ATS platform: own website
Careers link: https://www.umpi.edu/human-resources/jobs-at-umpi/

Reads posting URLs from school_id_621_job_postings.checkpoint (this
...
Writes school_job_info/school_id_621_job_info.csv. Checkpointed to
school_id_621_job_info.checkpoint next to this script -- kill-and-resume,
