"""
Job info scraper for school_id 68 - California State Polytechnic University-Humboldt (US)
ATS platform: own website
Careers link: https://careers.humboldt.edu/hm/en-us/filter/?work-type=faculty

Reads posting URLs from school_id_68_job_postings.checkpoint (this
...
Writes school_job_info/school_id_68_job_info.csv. Checkpointed to
school_id_68_job_info.checkpoint next to this script -- kill-and-resume,
