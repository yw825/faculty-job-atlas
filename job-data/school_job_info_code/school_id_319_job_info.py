"""
Job info scraper for school_id 319 - Young Harris College (US)
ATS platform: own website
Careers link: https://www.yhc.edu/careers/

Reads posting URLs from school_id_319_job_postings.checkpoint (this
...
Writes school_job_info/school_id_319_job_info.csv. Checkpointed to
school_id_319_job_info.checkpoint next to this script -- kill-and-resume,
