"""
Job info scraper for school_id 1690 - Karlsruhe Institute of Technology (Germany)
...
school's job_postings script). Edit it directly if Karlsruhe Institute of Technology's posting pages
...
Reads posting URLs from school_id_1690_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1690_job_info.csv. Checkpointed to
school_id_1690_job_info.checkpoint next to this script -- kill-and-resume,
