"""
Job info scraper for school_id 275 - Emory University (US)
ATS platform: own website
Careers link: http://www.hr.emory.edu/careers/index.html

Reads posting URLs from school_id_275_job_postings.checkpoint (this
...
Writes school_job_info/school_id_275_job_info.csv. Checkpointed to
school_id_275_job_info.checkpoint next to this script -- kill-and-resume,
