"""
Job info scraper for school_id 787 - Methodist University (US)
ATS platform: own website
Careers link: https://www.methodist.edu/offices-services/human-resources/

Reads posting URLs from school_id_787_job_postings.checkpoint (this
...
Writes school_job_info/school_id_787_job_info.csv. Checkpointed to
school_id_787_job_info.checkpoint next to this script -- kill-and-resume,
