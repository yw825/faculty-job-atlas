"""
Job info scraper for school_id 47 - Southern Arkansas University Main Campus (US)
ATS platform: own website
Careers link: https://www.saumag.edu/human-resources/category/employment-opportunities/faculty-positions/

Reads posting URLs from school_id_47_job_postings.checkpoint (this
...
Writes school_job_info/school_id_47_job_info.csv. Checkpointed to
school_id_47_job_info.checkpoint next to this script -- kill-and-resume,
