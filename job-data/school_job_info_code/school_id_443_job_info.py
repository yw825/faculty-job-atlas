"""
Job info scraper for school_id 443 - Holy Cross College (US)
ATS platform: own website
Careers link: https://www.hcc-nd.edu/career-opportunities/

Reads posting URLs from school_id_443_job_postings.checkpoint (this
...
Writes school_job_info/school_id_443_job_info.csv. Checkpointed to
school_id_443_job_info.checkpoint next to this script -- kill-and-resume,
