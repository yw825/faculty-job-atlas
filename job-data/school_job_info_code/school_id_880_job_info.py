"""
Job info scraper for school_id 880 - Rutgers University-Newark (US)
ATS platform: own website
Careers link: https://careers.newark.rutgers.edu/channels/detecting-fraudulent-job-postings/

Reads posting URLs from school_id_880_job_postings.checkpoint (this
...
Writes school_job_info/school_id_880_job_info.csv. Checkpointed to
school_id_880_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://careers.newark.rutgers.edu/channels/detecting-fraudulent-job-postings/'
