"""
Job info scraper for school_id 594 - University of Baltimore (US)
ATS platform: Workday
Careers link: https://marylandconnect.wd1.myworkdayjobs.com/UBaltCareers

Reads posting URLs from school_id_594_job_postings.checkpoint (this
...
Writes school_job_info/school_id_594_job_info.csv. Checkpointed to
school_id_594_job_info.checkpoint next to this script -- kill-and-resume,
