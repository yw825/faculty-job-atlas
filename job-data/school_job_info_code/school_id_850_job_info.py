"""
Job info scraper for school_id 850 - Saint Anselm College (US)
ATS platform: Workday
Careers link: https://anselm.wd1.myworkdayjobs.com/Anselm

Reads posting URLs from school_id_850_job_postings.checkpoint (this
...
Writes school_job_info/school_id_850_job_info.csv. Checkpointed to
school_id_850_job_info.checkpoint next to this script -- kill-and-resume,
