"""
Job info scraper for school_id 847 - Dartmouth College (US)
ATS platform: own website
Careers link: https://www.buzzfeed.com/about/jobs

Reads posting URLs from school_id_847_job_postings.checkpoint (this
...
Writes school_job_info/school_id_847_job_info.csv. Checkpointed to
school_id_847_job_info.checkpoint next to this script -- kill-and-resume,
