"""
Job info scraper for school_id 549 - Massachusetts Institute of Technology (US)
ATS platform: own website
Careers link: https://hr.mit.edu/jobs

Reads posting URLs from school_id_549_job_postings.checkpoint (this
...
Writes school_job_info/school_id_549_job_info.csv. Checkpointed to
school_id_549_job_info.checkpoint next to this script -- kill-and-resume,
