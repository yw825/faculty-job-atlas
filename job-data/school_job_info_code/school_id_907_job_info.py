"""
Job info scraper for school_id 907 - University at Albany (US)
ATS platform: own website
Careers link: https://albany.interviewexchange.com/jobsearchfrm.jsp

Reads posting URLs from school_id_907_job_postings.checkpoint (this
...
Writes school_job_info/school_id_907_job_info.csv. Checkpointed to
school_id_907_job_info.checkpoint next to this script -- kill-and-resume,
