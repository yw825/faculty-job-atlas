"""
Job info scraper for school_id 1843 - The Hang Seng University of Hong Kong (Hong Kong)
ATS platform: own website
Careers link: https://www.hsu.edu.hk/en/job-opportunities/
...
school's job_postings script). Edit it directly if The Hang Seng University of Hong Kong's posting pages
...
Reads posting URLs from school_id_1843_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1843_job_info.csv. Checkpointed to
school_id_1843_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1843
SCHOOL_NAME = 'The Hang Seng University of Hong Kong'
CAREERS_LINK = 'https://www.hsu.edu.hk/en/job-opportunities/'
