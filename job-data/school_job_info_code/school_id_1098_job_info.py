"""
Job info scraper for school_id 1098 - Oklahoma City University (US)
ATS platform: own website
Careers link: https://careers.okcu.edu/jobs/search

Reads posting URLs from school_id_1098_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1098_job_info.csv. Checkpointed to
school_id_1098_job_info.checkpoint next to this script -- kill-and-resume,
