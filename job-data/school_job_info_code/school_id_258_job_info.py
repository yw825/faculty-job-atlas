"""
Job info scraper for school_id 258 - Saint Leo University (US)
ATS platform: Workday
Careers link: https://saintleo.wd503.myworkdayjobs.com/en-US/SLU

Reads posting URLs from school_id_258_job_postings.checkpoint (this
...
Writes school_job_info/school_id_258_job_info.csv. Checkpointed to
school_id_258_job_info.checkpoint next to this script -- kill-and-resume,
