"""
Job info scraper for school_id 722 - Northwest Missouri State University (US)
ATS platform: Workday
Careers link: https://nwmissouri.wd108.myworkdayjobs.com/External

Reads posting URLs from school_id_722_job_postings.checkpoint (this
...
Writes school_job_info/school_id_722_job_info.csv. Checkpointed to
school_id_722_job_info.checkpoint next to this script -- kill-and-resume,
