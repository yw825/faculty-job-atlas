"""
Job info scraper for school_id 884 - Fairleigh Dickinson University-Metropolitan Campus (US)
ATS platform: own website
Careers link: https://www.instagram.com/reel/Db53N_YDMHp/

Reads posting URLs from school_id_884_job_postings.checkpoint (this
...
Writes school_job_info/school_id_884_job_info.csv. Checkpointed to
school_id_884_job_info.checkpoint next to this script -- kill-and-resume,
