"""
Job info scraper for school_id 1594 - University of Northern British Columbia (Canada)
ATS platform: Njoyn
...
school's job_postings script). Edit it directly if University of Northern British Columbia's posting pages
...
Reads posting URLs from school_id_1594_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1594_job_info.csv. Checkpointed to
school_id_1594_job_info.checkpoint next to this script -- kill-and-resume,
