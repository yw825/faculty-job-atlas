"""
Job info scraper for school_id 817 - Salem College (US)
ATS platform: own website
Careers link: https://www.salem.edu/about/employment/limitedtermcustodian/

Reads posting URLs from school_id_817_job_postings.checkpoint (this
...
Writes school_job_info/school_id_817_job_info.csv. Checkpointed to
school_id_817_job_info.checkpoint next to this script -- kill-and-resume,
