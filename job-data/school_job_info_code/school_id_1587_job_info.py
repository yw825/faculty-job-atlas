"""
Job info scraper for school_id 1587 - University of Alberta (Canada)
...
University of Alberta runs on a shared ATS platform with a bulk info adapter --
...
Reads posting URLs from school_id_1587_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1587_job_info.csv. Checkpointed to
school_id_1587_job_info.checkpoint next to this script -- kill-and-resume,
