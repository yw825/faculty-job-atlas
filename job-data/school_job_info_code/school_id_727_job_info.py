"""
Job info scraper for school_id 727 - Lindenwood University (US)
ATS platform: Workday
Careers link: https://lindenwood.wd1.myworkdayjobs.com/CareerOpportunities

Reads posting URLs from school_id_727_job_postings.checkpoint (this
...
Writes school_job_info/school_id_727_job_info.csv. Checkpointed to
school_id_727_job_info.checkpoint next to this script -- kill-and-resume,
