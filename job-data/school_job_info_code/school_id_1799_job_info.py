"""
Job info scraper for school_id 1799 - Bond University (Australia)
ATS platform: own website
Careers link: https://bond.edu.au/our-university/careers-at-bond/jobs-at-bond
...
school's job_postings script). Edit it directly if Bond University's posting pages
...
Reads posting URLs from school_id_1799_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1799_job_info.csv. Checkpointed to
school_id_1799_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://bond.edu.au/our-university/careers-at-bond/jobs-at-bond'
