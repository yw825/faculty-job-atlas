"""
Job info scraper for school_id 1848 - UOW College Hong Kong (Hong Kong)
...
school's job_postings script). Edit it directly if UOW College Hong Kong's posting pages
...
Reads posting URLs from school_id_1848_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1848_job_info.csv. Checkpointed to
school_id_1848_job_info.checkpoint next to this script -- kill-and-resume,
