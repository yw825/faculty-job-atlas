"""
Job info scraper for school_id 733 - Saint Louis University (US)
ATS platform: Workday
Careers link: https://slu.wd5.myworkdayjobs.com/Careers

Reads posting URLs from school_id_733_job_postings.checkpoint (this
...
Writes school_job_info/school_id_733_job_info.csv. Checkpointed to
school_id_733_job_info.checkpoint next to this script -- kill-and-resume,
