"""
Job info scraper for school_id 1043 - Ohio State University-Main Campus (US)
ATS platform: Workday
Careers link: https://osu.wd1.myworkdayjobs.com/OSUCareers

Reads posting URLs from school_id_1043_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1043_job_info.csv. Checkpointed to
school_id_1043_job_info.checkpoint next to this script -- kill-and-resume,
