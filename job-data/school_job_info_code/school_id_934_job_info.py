"""
Job info scraper for school_id 934 - SUNY College of Agriculture and Technology at Cobleskill (US)
ATS platform: own website
Careers link: https://cobleskill.interviewexchange.com/static/clients/474SCM1/index.jsp

Reads posting URLs from school_id_934_job_postings.checkpoint (this
...
Writes school_job_info/school_id_934_job_info.csv. Checkpointed to
school_id_934_job_info.checkpoint next to this script -- kill-and-resume,
