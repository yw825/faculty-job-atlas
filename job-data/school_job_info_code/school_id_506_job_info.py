"""
Job info scraper for school_id 506 - Eastern Kentucky University (US)
ATS platform: own website
Careers link: https://careers.eku.edu/jobs/search

Reads posting URLs from school_id_506_job_postings.checkpoint (this
...
Writes school_job_info/school_id_506_job_info.csv. Checkpointed to
school_id_506_job_info.checkpoint next to this script -- kill-and-resume,
