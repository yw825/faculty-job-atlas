"""
Job info scraper for school_id 1239 - Universidad Central de Bayamon (US)
ATS platform: own website
Careers link: https://ucb.edu.pr/oficina-de-recursos-humanos/

Reads posting URLs from school_id_1239_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1239_job_info.csv. Checkpointed to
school_id_1239_job_info.checkpoint next to this script -- kill-and-resume,
