"""
Job info scraper for school_id 942 - Adelphi University (US)
ATS platform: Taleo
Careers link: https://phf.tbe.taleo.net/phf02/ats/careers/v2/searchResults?org=ADELPHI&cws=43

Reads posting URLs from school_id_942_job_postings.checkpoint (this
...
Writes school_job_info/school_id_942_job_info.csv. Checkpointed to
school_id_942_job_info.checkpoint next to this script -- kill-and-resume,
