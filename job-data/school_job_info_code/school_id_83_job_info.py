"""
Job info scraper for school_id 83 - Scripps College (US)
ATS platform: own website
Careers link: http://www.scrippscollege.edu/hr/faculty

Reads posting URLs from school_id_83_job_postings.checkpoint (this
...
Writes school_job_info/school_id_83_job_info.csv. Checkpointed to
school_id_83_job_info.checkpoint next to this script -- kill-and-resume,
