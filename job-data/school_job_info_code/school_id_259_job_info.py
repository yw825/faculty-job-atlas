"""
Job info scraper for school_id 259 - Eckerd College (US)
ATS platform: own website
Careers link: https://eckerd.exacthire.com/

Reads posting URLs from school_id_259_job_postings.checkpoint (this
...
Writes school_job_info/school_id_259_job_info.csv. Checkpointed to
school_id_259_job_info.checkpoint next to this script -- kill-and-resume,
