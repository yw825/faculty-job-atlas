"""
Job info scraper for school_id 328 - Iowa State University (US)
ATS platform: Workday
Careers link: https://isu.wd1.myworkdayjobs.com/IowaStateJobs

Reads posting URLs from school_id_328_job_postings.checkpoint (this
...
Writes school_job_info/school_id_328_job_info.csv. Checkpointed to
school_id_328_job_info.checkpoint next to this script -- kill-and-resume,
