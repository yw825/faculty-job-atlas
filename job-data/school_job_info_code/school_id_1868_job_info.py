"""
Job info scraper for school_id 1868 - Wrexham University (United Kingdom)
ATS platform: own website
Careers link: https://jobs.wrexham.ac.uk/vacancies.aspx
...
school's job_postings script). Edit it directly if Wrexham University's posting pages
...
Reads posting URLs from school_id_1868_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1868_job_info.csv. Checkpointed to
school_id_1868_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1868
SCHOOL_NAME = 'Wrexham University'
CAREERS_LINK = 'https://jobs.wrexham.ac.uk/vacancies.aspx'
