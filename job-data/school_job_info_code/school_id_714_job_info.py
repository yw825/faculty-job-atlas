"""
Job info scraper for school_id 714 - Avila University (US)
ATS platform: own website
Careers link: https://www.avila.edu/about/administrative-offices/human-resources/careers/

Reads posting URLs from school_id_714_job_postings.checkpoint (this
...
Writes school_job_info/school_id_714_job_info.csv. Checkpointed to
school_id_714_job_info.checkpoint next to this script -- kill-and-resume,
