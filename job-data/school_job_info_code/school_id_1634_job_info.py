"""
Job info scraper for school_id 1634 - York University (Canada)
...
school's job_postings script). Edit it directly if York University's posting pages
...
Reads posting URLs from school_id_1634_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1634_job_info.csv. Checkpointed to
school_id_1634_job_info.checkpoint next to this script -- kill-and-resume,
