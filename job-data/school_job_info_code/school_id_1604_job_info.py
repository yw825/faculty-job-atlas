"""
Job info scraper for school_id 1604 - University of New Brunswick (Canada)
ATS platform: own website
Careers link: https://www.unb.ca/hr/careers/academic.php
...
school's job_postings script). Edit it directly if University of New Brunswick's posting pages
...
Reads posting URLs from school_id_1604_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1604_job_info.csv. Checkpointed to
school_id_1604_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1604
SCHOOL_NAME = 'University of New Brunswick'
CAREERS_LINK = 'https://www.unb.ca/hr/careers/academic.php'
