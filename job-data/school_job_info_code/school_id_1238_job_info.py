"""
Job info scraper for school_id 1238 - University of Puerto Rico-Bayamon (US)
ATS platform: own website
Careers link: https://www.upr.edu/ac/oficinas-adscritas/recursos-humanos/oficina-de-recursos-humanos-convocatorias/

Reads posting URLs from school_id_1238_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1238_job_info.csv. Checkpointed to
school_id_1238_job_info.checkpoint next to this script -- kill-and-resume,
