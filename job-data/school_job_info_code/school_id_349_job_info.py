"""
Job info scraper for school_id 349 - Northwestern College (US)
ATS platform: own website
Careers link: https://www.nwciowa.edu/employment

Reads posting URLs from school_id_349_job_postings.checkpoint (this
...
Writes school_job_info/school_id_349_job_info.csv. Checkpointed to
school_id_349_job_info.checkpoint next to this script -- kill-and-resume,
