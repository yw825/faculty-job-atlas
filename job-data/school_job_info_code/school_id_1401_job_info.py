"""
Job info scraper for school_id 1401 - Sam Houston State University (US)
ATS platform: own website
Careers link: https://www.shsu.edu/offices-departments/career-success-center/index.php

Reads posting URLs from school_id_1401_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1401_job_info.csv. Checkpointed to
school_id_1401_job_info.checkpoint next to this script -- kill-and-resume,
