"""
Job info scraper for school_id 893 - University of the Southwest (US)
ATS platform: own website
Careers link: https://www.usw.edu/faculty-openings

Reads posting URLs from school_id_893_job_postings.checkpoint (this
...
Writes school_job_info/school_id_893_job_info.csv. Checkpointed to
school_id_893_job_info.checkpoint next to this script -- kill-and-resume,
