"""
Job info scraper for school_id 1593 - Vancouver Island University (Canada)
ATS platform: own website
Careers link: https://careers.viu.ca/vacancies.html
...
school's job_postings script). Edit it directly if Vancouver Island University's posting pages
...
Reads posting URLs from school_id_1593_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1593_job_info.csv. Checkpointed to
school_id_1593_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1593
SCHOOL_NAME = 'Vancouver Island University'
CAREERS_LINK = 'https://careers.viu.ca/vacancies.html'
