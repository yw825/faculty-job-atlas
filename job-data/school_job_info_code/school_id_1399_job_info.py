"""
Job info scraper for school_id 1399 - University of Houston-Downtown (US)
ATS platform: own website
Careers link: https://www.uhd.edu/hr/careers/temporary-employment.aspx

Reads posting URLs from school_id_1399_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1399_job_info.csv. Checkpointed to
school_id_1399_job_info.checkpoint next to this script -- kill-and-resume,
