"""
Job info scraper for school_id 1684 - RWTH Aachen University (Germany)
ATS platform: own website
Careers link: https://www.rwth-aachen.de/cms/root/wir/Karriere/RWTH-Jobportal/~crfe/Stellenangebote-fuer-Professuren/lidx/1/
...
school's job_postings script). Edit it directly if RWTH Aachen University's posting pages
...
Reads posting URLs from school_id_1684_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1684_job_info.csv. Checkpointed to
school_id_1684_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1684
SCHOOL_NAME = 'RWTH Aachen University'
CAREERS_LINK = 'https://www.rwth-aachen.de/cms/root/wir/Karriere/RWTH-Jobportal/~crfe/Stellenangebote-fuer-Professuren/lidx/1/'
