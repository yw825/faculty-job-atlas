"""
Job info scraper for school_id 602 - Capitol Technology University (US)
ATS platform: own website
Careers link: https://captechu-csm.symplicity.com/

Reads posting URLs from school_id_602_job_postings.checkpoint (this
...
Writes school_job_info/school_id_602_job_info.csv. Checkpointed to
school_id_602_job_info.checkpoint next to this script -- kill-and-resume,
