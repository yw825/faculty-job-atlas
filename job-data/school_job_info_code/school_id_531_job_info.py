"""
Job info scraper for school_id 531 - Hampshire College (US)
ATS platform: own website
Careers link: https://www.hampshire.edu/offices/human-resources/employment-opportunities

Reads posting URLs from school_id_531_job_postings.checkpoint (this
...
Writes school_job_info/school_id_531_job_info.csv. Checkpointed to
school_id_531_job_info.checkpoint next to this script -- kill-and-resume,
