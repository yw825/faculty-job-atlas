"""
Job info scraper for school_id 1809 - University of Tasmania (Australia)
ATS platform: own website
Careers link: https://careers.utas.edu.au/en/listing/
...
school's job_postings script). Edit it directly if University of Tasmania's posting pages
...
Reads posting URLs from school_id_1809_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1809_job_info.csv. Checkpointed to
school_id_1809_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://careers.utas.edu.au/en/listing/'
