"""
Job info scraper for school_id 447 - Earlham College (US)
ATS platform: own website
Careers link: https://hr.earlham.edu/careers

Reads posting URLs from school_id_447_job_postings.checkpoint (this
...
Writes school_job_info/school_id_447_job_info.csv. Checkpointed to
school_id_447_job_info.checkpoint next to this script -- kill-and-resume,
