"""
Job info scraper for school_id 1475 - Washington and Lee University (US)
ATS platform: own website
Careers link: https://www.wlu.edu/employment-opportunities/faculty-positions

Reads posting URLs from school_id_1475_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1475_job_info.csv. Checkpointed to
school_id_1475_job_info.checkpoint next to this script -- kill-and-resume,
