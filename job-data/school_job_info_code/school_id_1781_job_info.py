"""
Job info scraper for school_id 1781 - Charles Sturt University (Australia)
ATS platform: own website
Careers link: https://external-jobs.csu.edu.au/cw/en/listing
...
school's job_postings script). Edit it directly if Charles Sturt University's posting pages
...
Reads posting URLs from school_id_1781_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1781_job_info.csv. Checkpointed to
school_id_1781_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://external-jobs.csu.edu.au/cw/en/listing'
