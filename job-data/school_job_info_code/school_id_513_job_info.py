"""
Job info scraper for school_id 513 - Southeastern Louisiana University (US)
ATS platform: own website
Careers link: https://wd503.myworkday.com/ulsselu/

Reads posting URLs from school_id_513_job_postings.checkpoint (this
...
Writes school_job_info/school_id_513_job_info.csv. Checkpointed to
school_id_513_job_info.checkpoint next to this script -- kill-and-resume,
