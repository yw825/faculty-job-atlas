"""
Job info scraper for school_id 1709 - Politecnico di Milano (Italy)
ATS platform: own website
Careers link: https://www.polimi.it/en/staff/lavora-con-noi/bandi-e-concorsi
...
school's job_postings script). Edit it directly if Politecnico di Milano's posting pages
...
Reads posting URLs from school_id_1709_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1709_job_info.csv. Checkpointed to
school_id_1709_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1709
SCHOOL_NAME = 'Politecnico di Milano'
CAREERS_LINK = 'https://www.polimi.it/en/staff/lavora-con-noi/bandi-e-concorsi'
