"""
Job info scraper for school_id 1845 - The Hong Kong University of Science and Technology (Hong Kong)
ATS platform: own website
Careers link: https://hkustcareers.hkust.edu.hk/join-us/current-opening/academic-careers
...
school's job_postings script). Edit it directly if The Hong Kong University of Science and Technology's posting pages
...
Reads posting URLs from school_id_1845_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1845_job_info.csv. Checkpointed to
school_id_1845_job_info.checkpoint next to this script -- kill-and-resume,
...
CAREERS_LINK = 'https://hkustcareers.hkust.edu.hk/join-us/current-opening/academic-careers'
