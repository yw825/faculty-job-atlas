"""
Job info scraper for school_id 990 - Vassar College (US)
ATS platform: own website
Careers link: https://www.ey.com/en_us/careers/how-to-join-us

Reads posting URLs from school_id_990_job_postings.checkpoint (this
...
Writes school_job_info/school_id_990_job_info.csv. Checkpointed to
school_id_990_job_info.checkpoint next to this script -- kill-and-resume,
