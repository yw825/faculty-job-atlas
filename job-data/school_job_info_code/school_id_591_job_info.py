"""
Job info scraper for school_id 591 - Loyola University Maryland (US)
ATS platform: Workday
Careers link: https://loyola.wd5.myworkdayjobs.com/External

Reads posting URLs from school_id_591_job_postings.checkpoint (this
...
Writes school_job_info/school_id_591_job_info.csv. Checkpointed to
school_id_591_job_info.checkpoint next to this script -- kill-and-resume,
