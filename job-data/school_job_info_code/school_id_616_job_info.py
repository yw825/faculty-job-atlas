"""
Job info scraper for school_id 616 - University of Maine at Farmington (US)
ATS platform: own website
Careers link: #VALUE!

Reads posting URLs from school_id_616_job_postings.checkpoint (this
...
Writes school_job_info/school_id_616_job_info.csv. Checkpointed to
school_id_616_job_info.checkpoint next to this script -- kill-and-resume,
