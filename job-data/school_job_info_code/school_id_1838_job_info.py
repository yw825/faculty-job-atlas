"""
Job info scraper for school_id 1838 - Hong Kong Shue Yan University (Hong Kong)
ATS platform: own website
Careers link: https://www.hksyu.edu/en/snippets/external-vacancy
...
school's job_postings script). Edit it directly if Hong Kong Shue Yan University's posting pages
...
Reads posting URLs from school_id_1838_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1838_job_info.csv. Checkpointed to
school_id_1838_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1838
SCHOOL_NAME = 'Hong Kong Shue Yan University'
CAREERS_LINK = 'https://www.hksyu.edu/en/snippets/external-vacancy'
