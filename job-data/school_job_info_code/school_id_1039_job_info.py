"""
Job info scraper for school_id 1039 - Capital University (US)
ATS platform: own website
Careers link: https://capital.applicantpro.com/jobs/

Reads posting URLs from school_id_1039_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1039_job_info.csv. Checkpointed to
school_id_1039_job_info.checkpoint next to this script -- kill-and-resume,
