"""
Job info scraper for school_id 1741 - Universitat Politècnica de Catalunya (Spain)
ATS platform: own website
Careers link: https://www.upc.edu/en/the-upc/the-institution/jobs-at-the-upc
...
school's job_postings script). Edit it directly if Universitat Politècnica de Catalunya's posting pages
...
Reads posting URLs from school_id_1741_job_postings.checkpoint (this
...
Writes school_job_info/school_id_1741_job_info.csv. Checkpointed to
school_id_1741_job_info.checkpoint next to this script -- kill-and-resume,
...
SCHOOL_ID = 1741
SCHOOL_NAME = 'Universitat Politècnica de Catalunya'
CAREERS_LINK = 'https://www.upc.edu/en/the-upc/the-institution/jobs-at-the-upc'
