"""
Job info scraper for school_id 660 - Lawrence Technological University (US)
ATS platform: own website
Careers link: https://ltu.edu/about/human-resources/job-openings/

Reads posting URLs from school_id_660_job_postings.checkpoint (this
...
Writes school_job_info/school_id_660_job_info.csv. Checkpointed to
school_id_660_job_info.checkpoint next to this script -- kill-and-resume,
