"""
Job postings scraper for school_id 1068 - Franciscan University of Steubenville (US)
ATS platform: own website
Careers link: http://franciscan.edu/faculty-openings/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Franciscan University of Steubenville; nothing here affects any
...
Writes school_job_posts/school_id_1068_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1068_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1068
SCHOOL_NAME = 'Franciscan University of Steubenville'
CAREERS_LINK = 'http://franciscan.edu/faculty-openings/'
