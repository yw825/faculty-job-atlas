"""
Job postings scraper for school_id 1729 - Jagiellonian University (Poland)
...
Jagiellonian University runs on a shared ATS platform -- every school on poland_nauka uses the
...
Writes school_job_posts/school_id_1729_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1729_job_postings.checkpoint next to this script.
"""
import os
import sys
