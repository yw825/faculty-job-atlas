"""
Job postings scraper for school_id 699 - Herzing University-Minneapolis (US)
...
Herzing University-Minneapolis runs on a shared ATS platform -- every school on ultipro uses the
...
NOTE: 3 schools list against this same URL, so this listing carries every one of their postings, not just this school's: Herzing University-Brookfield, Herzing University-Kenosha.

Writes school_job_posts/school_id_699_job_posts.csv (school_id, post_link).
Checkpointed to school_id_699_job_postings.checkpoint next to this script.
"""
import os
import sys
...
SCHOOL_ID = 699
SCHOOL_NAME = 'Herzing University-Minneapolis'
