"""
Job postings scraper for school_id 1267 - Salve Regina University (US)
ATS platform: own website
Careers link: https://salve.interviewexchange.com/static/clients/288SRM1/administrative.jsp

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Salve Regina University; nothing here affects any
...
Writes school_job_posts/school_id_1267_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1267_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1267
SCHOOL_NAME = 'Salve Regina University'
CAREERS_LINK = 'https://salve.interviewexchange.com/static/clients/288SRM1/administrative.jsp'
