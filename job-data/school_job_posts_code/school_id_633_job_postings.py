"""
Job postings scraper for school_id 633 - Ferris State University (US)
ATS platform: own website
Careers link: https://jobs.ferris.edu/en-us/listing/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Ferris State University; nothing here affects any
...
Writes school_job_posts/school_id_633_job_posts.csv (school_id, post_link).
Checkpointed to school_id_633_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 633
SCHOOL_NAME = 'Ferris State University'
CAREERS_LINK = 'https://jobs.ferris.edu/en-us/listing/'
