"""
Job postings scraper for school_id 1344 - Christian Brothers University (US)
ATS platform: own website
Careers link: http://cbu.interviewexchange.com/jobofferdetails.jsp?JOBID=200928

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Christian Brothers University; nothing here affects any
...
Writes school_job_posts/school_id_1344_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1344_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1344
SCHOOL_NAME = 'Christian Brothers University'
CAREERS_LINK = 'http://cbu.interviewexchange.com/jobofferdetails.jsp?JOBID=200928'
