"""
Job postings scraper for school_id 1625 - University of Ottawa (Canada)
ATS platform: Workday (detected: workday)
Careers link: https://uottawa.wd3.myworkdayjobs.com/en-US/uOttawa_External_Career_Site

University of Ottawa runs on a shared ATS platform -- every school on workday uses the
...
Writes school_job_posts/school_id_1625_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1625_job_postings.checkpoint next to this script.
"""
import os
import sys
