"""
Job postings scraper for school_id 626 - Siena Heights University (US)
ATS platform: own website
Careers link: https://www.sienaheights.edu/past-syllabi-employment-and-financial-aid/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Siena Heights University; nothing here affects any
...
Writes school_job_posts/school_id_626_job_posts.csv (school_id, post_link).
Checkpointed to school_id_626_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 626
SCHOOL_NAME = 'Siena Heights University'
CAREERS_LINK = 'https://www.sienaheights.edu/past-syllabi-employment-and-financial-aid/'
