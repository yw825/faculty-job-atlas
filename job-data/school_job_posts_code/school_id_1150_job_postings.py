"""
Job postings scraper for school_id 1150 - Elizabethtown College (US)
ATS platform: own website
Careers link: https://www.etown.edu/offices/human-resources/careers.aspx

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Elizabethtown College; nothing here affects any
...
Writes school_job_posts/school_id_1150_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1150_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1150
SCHOOL_NAME = 'Elizabethtown College'
CAREERS_LINK = 'https://www.etown.edu/offices/human-resources/careers.aspx'
