"""
Job postings scraper for school_id 1540 - University of Wisconsin-Parkside (US)
ATS platform: Workday (detected: workday)
Careers link: https://wisconsin.wd1.myworkdayjobs.com/UW_Comprehensives?Institution=5adf054562b610142325bf73eae20000

University of Wisconsin-Parkside runs on a shared ATS platform -- every
...
institution id in the careers link is all that is needed: Parkside returns
10 of the 361 -- a small number because the campus is small, not because
the scrape is truncated.

Writes school_job_posts/school_id_1540_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1540_job_postings.checkpoint next to this script.
"""
import os
import sys
...
SCHOOL_ID = 1540
SCHOOL_NAME = 'University of Wisconsin-Parkside'
CAREERS_LINK = ('https://wisconsin.wd1.myworkdayjobs.com/UW_Comprehensives'
                '?Institution=5adf054562b610142325bf73eae20000')
