"""
Job postings scraper for school_id 603 - Stevenson University (US)
ATS platform: PeopleAdmin (detected: peopleadmin)
Careers link: https://stevenson.peopleadmin.com/

Stevenson University runs on a shared ATS platform -- every school on peopleadmin uses the
...
Writes school_job_posts/school_id_603_job_posts.csv (school_id, post_link).
Checkpointed to school_id_603_job_postings.checkpoint next to this script.
"""
import os
import sys
...
SCHOOL_ID = 603
SCHOOL_NAME = 'Stevenson University'
CAREERS_LINK = 'https://stevenson.peopleadmin.com/'
