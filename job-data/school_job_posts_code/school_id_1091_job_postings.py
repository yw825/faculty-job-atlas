"""
Job postings scraper for school_id 1091 - Oklahoma Panhandle State University (US)
ATS platform: own website
Careers link: https://opsu.edu/job-opportunities/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Oklahoma Panhandle State University; nothing here affects any
...
Writes school_job_posts/school_id_1091_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1091_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1091
SCHOOL_NAME = 'Oklahoma Panhandle State University'
CAREERS_LINK = 'https://opsu.edu/job-opportunities/'
