"""
Job postings scraper for school_id 1694 - Athens University of Economics and Business (Greece)
ATS platform: APELLA (Greece) (detected: apella)
Careers link: https://apella.minedu.gov.gr/en/positions

Athens University of Economics and Business runs on a shared ATS platform -- every school on apella uses the
...
Writes school_job_posts/school_id_1694_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1694_job_postings.checkpoint next to this script.
"""
import os
import sys
