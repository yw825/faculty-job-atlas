"""
Job postings scraper for school_id 1033 - University of Cincinnati-Main Campus (US)
ATS platform: own website
Careers link: https://jobs.uc.edu/go/Faculty/7912200/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of Cincinnati-Main Campus; nothing here affects any
...
Writes school_job_posts/school_id_1033_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1033_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1033
SCHOOL_NAME = 'University of Cincinnati-Main Campus'
CAREERS_LINK = 'https://jobs.uc.edu/go/Faculty/7912200/'
