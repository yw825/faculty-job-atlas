"""
Job postings scraper for school_id 215 - Goldey-Beacom College (US)
ATS platform: own website
Careers link: https://www.paycomonline.net/v4/ats/web.php/portal/019DF7F6E271614BAB2785B88C6A379F/career-page

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Goldey-Beacom College; nothing here affects any
...
Writes school_job_posts/school_id_215_job_posts.csv (school_id, post_link).
Checkpointed to school_id_215_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 215
SCHOOL_NAME = 'Goldey-Beacom College'
CAREERS_LINK = 'https://www.paycomonline.net/v4/ats/web.php/portal/019DF7F6E271614BAB2785B88C6A379F/career-page'
