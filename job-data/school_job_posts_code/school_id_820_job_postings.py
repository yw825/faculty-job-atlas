"""
Job postings scraper for school_id 820 - University of Mary (US)
ATS platform: own website
Careers link: https://universityofmary.applytojob.com/apply

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of Mary; nothing here affects any
...
Writes school_job_posts/school_id_820_job_posts.csv (school_id, post_link).
Checkpointed to school_id_820_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 820
SCHOOL_NAME = 'University of Mary'
CAREERS_LINK = 'https://universityofmary.applytojob.com/apply'
