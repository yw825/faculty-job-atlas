"""
Job postings scraper for school_id 969 - Metropolitan College of New York (US)
ATS platform: own website
Careers link: https://www.paycomonline.net/v4/ats/web.php/portal/0AFB6B93B59D609A2037FAB5547D9B02/career-page

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Metropolitan College of New York; nothing here affects any
...
Writes school_job_posts/school_id_969_job_posts.csv (school_id, post_link).
Checkpointed to school_id_969_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://www.paycomonline.net/v4/ats/web.php/portal/0AFB6B93B59D609A2037FAB5547D9B02/career-page'
