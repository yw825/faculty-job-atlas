"""
Job postings scraper for school_id 319 - Young Harris College (US)
ATS platform: own website
Careers link: https://www.yhc.edu/careers/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Young Harris College; nothing here affects any
...
Writes school_job_posts/school_id_319_job_posts.csv (school_id, post_link).
Checkpointed to school_id_319_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://www.yhc.edu/careers/'
