"""
Job postings scraper for school_id 1731 - Warsaw School of Economics (Poland)
...
Warsaw School of Economics runs on a shared ATS platform -- every school on poland_nauka uses the
...
Writes school_job_posts/school_id_1731_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1731_job_postings.checkpoint next to this script.
"""
import os
import sys
