"""
Job postings scraper for school_id 1312 - Dakota Wesleyan University (US)
ATS platform: own website
Careers link: https://www.dwu.edu/employment

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Dakota Wesleyan University; nothing here affects any
...
Writes school_job_posts/school_id_1312_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1312_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1312
SCHOOL_NAME = 'Dakota Wesleyan University'
CAREERS_LINK = 'https://www.dwu.edu/employment'
ATS_PLATFORM = 'own website'

CHECKPOINT_PATH = os.path.join(HERE, f'school_id_{SCHOOL_ID}_job_postings.checkpoint')


POSTING_PATTERN = 'www.dwu.edu/<*>'
...
def find_links():
    ...
    (title_role=0 degree=0 furniture=0 len=13586; title_role=0 degree=0 furniture=2 len=21491).

        www.dwu.edu/<*>

    The generic job-word filter returned 3 link(s) here against 40
