"""
Job postings scraper for school_id 282 - Augusta University (US)
ATS platform: own website
Careers link: https://www.augusta.edu/hr/jobs/university/index.php

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Augusta University; nothing here affects any
...
Writes school_job_posts/school_id_282_job_posts.csv (school_id, post_link).
Checkpointed to school_id_282_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 282
SCHOOL_NAME = 'Augusta University'
CAREERS_LINK = 'https://www.augusta.edu/hr/jobs/university/index.php'
