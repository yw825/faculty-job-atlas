"""
Job postings scraper for school_id 760 - Montana State University (US)
ATS platform: own website
Careers link: https://jobs.montana.edu/postings/search

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Montana State University; nothing here affects any
other school's script.

Link check (ok): 74 posting-shaped links found.
...
Writes school_job_posts/school_id_760_job_posts.csv (school_id, post_link).
Checkpointed to school_id_760_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://jobs.montana.edu/postings/search'
