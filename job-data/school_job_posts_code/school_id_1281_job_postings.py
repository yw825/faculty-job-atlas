"""
Job postings scraper for school_id 1281 - Presbyterian College (US)
ATS platform: own website
Careers link: https://www.presby.edu/about/offices-and-services/human-resources/job-opportunities/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Presbyterian College; nothing here affects any
...
Writes school_job_posts/school_id_1281_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1281_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://www.presby.edu/about/offices-and-services/human-resources/job-opportunities/'
ATS_PLATFORM = 'own website'

CHECKPOINT_PATH = os.path.join(HERE, f'school_id_{SCHOOL_ID}_job_postings.checkpoint')


POSTING_PATTERN = 'www.presby.edu/about/offices-and-services/human-resources/employment/<*>'
...
def find_links():
    ...
    (title_role=1 degree=0 furniture=1 len=5211; title_role=1 degree=0 furniture=5 len=6444).

        www.presby.edu/about/offices-and-services/human-resources/employment/<*>

    The generic job-word filter returned 4 link(s) here against 8
