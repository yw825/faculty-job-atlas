"""
Job postings scraper for school_id 1119 - Reed College (US)
ATS platform: own website
Careers link: https://reed-college.breezy.hr/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Reed College; nothing here affects any
...
Writes school_job_posts/school_id_1119_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1119_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://reed-college.breezy.hr/'
ATS_PLATFORM = 'own website'

CHECKPOINT_PATH = os.path.join(HERE, f'school_id_{SCHOOL_ID}_job_postings.checkpoint')


POSTING_PATTERN = 'reed-college.breezy.hr/p/<*>'
...
def find_links():
    ...
    (title_role=0 degree=0 furniture=1 len=5045; title_role=1 degree=1 furniture=2 len=5676).

        reed-college.breezy.hr/p/<*>

    The generic job-word filter returned 1 link(s) here against 6
