"""
Job postings scraper for school_id 497 - Spalding University (US)
ATS platform: own website
Careers link: https://spalding.edu/careers/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Spalding University; nothing here affects any
...
CAREERS_LINK = 'https://spalding.edu/careers/'
