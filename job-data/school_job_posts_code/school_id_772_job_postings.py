"""
Job postings scraper for school_id 772 - Brevard College (US)
ATS platform: own website
Careers link: https://brevard.edu/employment-opportunities/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Brevard College; nothing here affects any
...
Writes school_job_posts/school_id_772_job_posts.csv (school_id, post_link).
Checkpointed to school_id_772_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 772
SCHOOL_NAME = 'Brevard College'
CAREERS_LINK = 'https://brevard.edu/employment-opportunities/'
