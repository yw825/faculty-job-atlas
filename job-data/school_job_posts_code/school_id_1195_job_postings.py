"""
Job postings scraper for school_id 1195 - University of Valley Forge (US)
ATS platform: own website
Careers link: https://valleyforge.edu/careers-at-uvf/adjunct-instructor-in-person-masters-of-business-administration/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of Valley Forge; nothing here affects any
...
Writes school_job_posts/school_id_1195_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1195_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1195
SCHOOL_NAME = 'University of Valley Forge'
CAREERS_LINK = 'https://valleyforge.edu/careers-at-uvf/adjunct-instructor-in-person-masters-of-business-administration/'
