"""
Job postings scraper for school_id 537 - Emmanuel College (US)
ATS platform: own website
Careers link: https://emmanuel.interviewexchange.com/static/clients/13EM1/listJobs.jsp;jsessionid=47B469F5FF02B2ECA11624165C411A0F

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Emmanuel College; nothing here affects any
...
Writes school_job_posts/school_id_537_job_posts.csv (school_id, post_link).
Checkpointed to school_id_537_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 537
SCHOOL_NAME = 'Emmanuel College'
CAREERS_LINK = 'https://emmanuel.interviewexchange.com/static/clients/13EM1/listJobs.jsp;jsessionid=47B469F5FF02B2ECA11624165C411A0F'
