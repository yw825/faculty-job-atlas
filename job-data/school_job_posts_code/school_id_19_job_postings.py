"""
Job postings scraper for school_id 19 - University of Montevallo (US)
...
directly to fix or improve results for University of Montevallo; nothing here affects any
...
Writes school_job_posts/school_id_19_job_posts.csv (school_id, post_link).
Checkpointed to school_id_19_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
