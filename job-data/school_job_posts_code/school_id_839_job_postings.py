"""
Job postings scraper for school_id 839 - College of Saint Mary (US)
ATS platform: own website
Careers link: https://www.csm.edu/academics/career-pathways/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for College of Saint Mary; nothing here affects any
...
Writes school_job_posts/school_id_839_job_posts.csv (school_id, post_link).
Checkpointed to school_id_839_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 839
SCHOOL_NAME = 'College of Saint Mary'
CAREERS_LINK = 'https://www.csm.edu/academics/career-pathways/'
