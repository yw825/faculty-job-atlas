"""
Job postings scraper for school_id 1222 - Waynesburg University (US)
ATS platform: own website
Careers link: http://www.facebook.com/share.php?u=https://www.waynesburg.edu/careers&title=Careers

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Waynesburg University; nothing here affects any
...
Writes school_job_posts/school_id_1222_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1222_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
