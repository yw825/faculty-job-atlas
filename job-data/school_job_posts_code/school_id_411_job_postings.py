"""
Job postings scraper for school_id 411 - Lewis University (US)
ATS platform: PeopleAdmin (detected: peopleadmin)
Careers link: https://jobs.lewisu.edu

Lewis University runs on a shared ATS platform -- every school on peopleadmin uses the
...
Writes school_job_posts/school_id_411_job_posts.csv (school_id, post_link).
Checkpointed to school_id_411_job_postings.checkpoint next to this script.
"""
import os
import sys
...
CAREERS_LINK = 'https://jobs.lewisu.edu'
