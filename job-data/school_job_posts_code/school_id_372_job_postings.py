"""
Job postings scraper for school_id 372 - Columbia College Chicago (US)
ATS platform: own website
Careers link: https://about.colum.edu/provost/faculty-careers/index

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Columbia College Chicago; nothing here affects any
...
Writes school_job_posts/school_id_372_job_posts.csv (school_id, post_link).
Checkpointed to school_id_372_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 372
SCHOOL_NAME = 'Columbia College Chicago'
CAREERS_LINK = 'https://about.colum.edu/provost/faculty-careers/index'
