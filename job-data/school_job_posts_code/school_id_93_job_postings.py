"""
Job postings scraper for school_id 93 - University of California-Irvine (US)
ATS platform: UC Recruit (detected: ucrecruit)
Careers link: https://recruit.ap.uci.edu/apply

University of California-Irvine runs on a shared ATS platform -- every school on ucrecruit uses the
...
Writes school_job_posts/school_id_93_job_posts.csv (school_id, post_link).
Checkpointed to school_id_93_job_postings.checkpoint next to this script.
"""
import os
import sys
