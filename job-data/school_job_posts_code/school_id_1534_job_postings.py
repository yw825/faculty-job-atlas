"""
Job postings scraper for school_id 1534 - Saint Norbert College (US)
ATS platform: own website
Careers link: https://snc.edu/search/careers

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Saint Norbert College; nothing here affects any
...
Writes school_job_posts/school_id_1534_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1534_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1534
SCHOOL_NAME = 'Saint Norbert College'
CAREERS_LINK = 'https://snc.edu/search/careers'
