"""
Job postings scraper for school_id 1245 - Inter American University of Puerto Rico-Guayama (US)
ATS platform: own website
Careers link: https://iaupr.elluciancrmrecruit.com/Apply

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Inter American University of Puerto Rico-Guayama; nothing here affects any
other school's script.

Link check (review): 0 posting-shaped links found -- rendered no job-shaped links found [shared URL].

NOTE: 3 schools list against this same URL, so this listing carries every one of their postings, not just this school's: Inter American University of Puerto Rico-Barranquitas, Inter American University of Puerto Rico-San German.
...
Writes school_job_posts/school_id_1245_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1245_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
