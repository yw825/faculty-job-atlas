"""
Job postings scraper for school_id 1693 - Technical University of Munich (Germany)
ATS platform: own website
Careers link: https://portal.mytum.de/jobs/professuren

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Technical University of Munich; nothing here affects any
...
Writes school_job_posts/school_id_1693_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1693_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
