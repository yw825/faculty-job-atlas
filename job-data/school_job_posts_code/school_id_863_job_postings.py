"""
Job postings scraper for school_id 863 - Rowan University (US)
ATS platform: own website
Careers link: https://jobs.rowan.edu/en-us/listing/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Rowan University; nothing here affects any
...
Writes school_job_posts/school_id_863_job_posts.csv (school_id, post_link).
Checkpointed to school_id_863_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 863
SCHOOL_NAME = 'Rowan University'
CAREERS_LINK = 'https://jobs.rowan.edu/en-us/listing/'
