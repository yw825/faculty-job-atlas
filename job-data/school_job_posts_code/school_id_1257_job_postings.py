"""
Job postings scraper for school_id 1257 - University of Puerto Rico at Ponce (US)
ATS platform: own website
Careers link: https://www.uprp.edu/en/articulos/administracion/recursos-humanos/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of Puerto Rico at Ponce; nothing here affects any
...
Writes school_job_posts/school_id_1257_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1257_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1257
SCHOOL_NAME = 'University of Puerto Rico at Ponce'
CAREERS_LINK = 'https://www.uprp.edu/en/articulos/administracion/recursos-humanos/'
