"""
Job postings scraper for school_id 1577 - Alderson Broaddus University (US)
ATS platform: own website
Careers link: https://ab.edu/employment/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Alderson Broaddus University; nothing here affects any
...
Writes school_job_posts/school_id_1577_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1577_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1577
SCHOOL_NAME = 'Alderson Broaddus University'
CAREERS_LINK = 'https://ab.edu/employment/'
