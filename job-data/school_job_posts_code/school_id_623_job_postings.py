"""
Job postings scraper for school_id 623 - Colby College (US)
ATS platform: own website
Careers link: https://www.colby.edu/people/offices-directory/human-resources/employment/academic-positions-available/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Colby College; nothing here affects any
...
Writes school_job_posts/school_id_623_job_posts.csv (school_id, post_link).
Checkpointed to school_id_623_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://www.colby.edu/people/offices-directory/human-resources/employment/academic-positions-available/'
