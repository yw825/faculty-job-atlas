"""
Job postings scraper for school_id 1521 - Gonzaga University (US)
ATS platform: own website
Careers link: https://employment.gonzaga.edu/jobs/search?page=1&category_uids%5B%5D=ccb5730a856e3e50b7226edb37c1facb&query=

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Gonzaga University; nothing here affects any
...
Writes school_job_posts/school_id_1521_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1521_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://employment.gonzaga.edu/jobs/search?page=1&category_uids%5B%5D=ccb5730a856e3e50b7226edb37c1facb&query='
