"""
Job postings scraper for school_id 54 - Northern Arizona University (US)
ATS platform: own website
Careers link: https://careers.nau.edu/jobs/search?page=1&category_uids%5B%5D=16877518cdbd46262a1b4a995c2a65c2&query=

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Northern Arizona University; nothing here affects any
...
Writes school_job_posts/school_id_54_job_posts.csv (school_id, post_link).
Checkpointed to school_id_54_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://careers.nau.edu/jobs/search?page=1&category_uids%5B%5D=16877518cdbd46262a1b4a995c2a65c2&query='
