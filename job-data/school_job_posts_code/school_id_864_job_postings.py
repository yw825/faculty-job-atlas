"""
Job postings scraper for school_id 864 - Centenary University (US)
ATS platform: own website
Careers link: https://www.instagram.com/p/DcMh4Y-oP_M/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Centenary University; nothing here affects any
...
Writes school_job_posts/school_id_864_job_posts.csv (school_id, post_link).
Checkpointed to school_id_864_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 864
SCHOOL_NAME = 'Centenary University'
CAREERS_LINK = 'https://www.instagram.com/p/DcMh4Y-oP_M/'
