"""
Job postings scraper for school_id 930 - SUNY College of Technology at Canton (US)
ATS platform: own website
Careers link: https://canton-accommodate.symplicity.com/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for SUNY College of Technology at Canton; nothing here affects any
...
Writes school_job_posts/school_id_930_job_posts.csv (school_id, post_link).
Checkpointed to school_id_930_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 930
SCHOOL_NAME = 'SUNY College of Technology at Canton'
CAREERS_LINK = 'https://canton-accommodate.symplicity.com/'
