"""
Job postings scraper for school_id 377 - National Louis University (US)
ATS platform: own website
Careers link: https://nl.edu/employment/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for National Louis University; nothing here affects any
...
Writes school_job_posts/school_id_377_job_posts.csv (school_id, post_link).
Checkpointed to school_id_377_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 377
SCHOOL_NAME = 'National Louis University'
CAREERS_LINK = 'https://nl.edu/employment/'
