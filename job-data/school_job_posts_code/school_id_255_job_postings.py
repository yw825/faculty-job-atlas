"""
Job postings scraper for school_id 255 - University of West Florida (US)
ATS platform: own website
Careers link: https://uwf.edu/careers

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of West Florida; nothing here affects any
...
Writes school_job_posts/school_id_255_job_posts.csv (school_id, post_link).
Checkpointed to school_id_255_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 255
SCHOOL_NAME = 'University of West Florida'
CAREERS_LINK = 'https://uwf.edu/careers'
