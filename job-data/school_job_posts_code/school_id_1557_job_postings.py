"""
Job postings scraper for school_id 1557 - Ripon College (US)
ATS platform: own website
Careers link: https://ripon.edu/career-discovery-tour/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Ripon College; nothing here affects any
...
Writes school_job_posts/school_id_1557_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1557_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1557
SCHOOL_NAME = 'Ripon College'
CAREERS_LINK = 'https://ripon.edu/career-discovery-tour/'
ATS_PLATFORM = 'own website'

CHECKPOINT_PATH = os.path.join(HERE, f'school_id_{SCHOOL_ID}_job_postings.checkpoint')


POSTING_PATTERN = 'ripon.edu/<*>'
...
def find_links():
    ...
    (title_role=0 degree=1 furniture=3 len=8842; title_role=0 degree=1 furniture=0 len=10395).

        ripon.edu/<*>

    The generic job-word filter returned 4 link(s) here against 10
