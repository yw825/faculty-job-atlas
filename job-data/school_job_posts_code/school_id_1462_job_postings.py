"""
Job postings scraper for school_id 1462 - Averett University (US)
ATS platform: own website
Careers link: https://www.averett.edu/about-us/employment-opportunities/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Averett University; nothing here affects any
...
Writes school_job_posts/school_id_1462_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1462_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1462
SCHOOL_NAME = 'Averett University'
CAREERS_LINK = 'https://www.averett.edu/about-us/employment-opportunities/'
