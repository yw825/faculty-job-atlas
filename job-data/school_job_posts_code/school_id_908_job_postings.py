"""
Job postings scraper for school_id 908 - Alfred University (US)
ATS platform: own website
Careers link: https://www.alfred.edu/jobs-at-alfred/index.cfm

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Alfred University; nothing here affects any
other school's script.

Link check (ok): 44 posting-shaped links found -- rendered.
...
Writes school_job_posts/school_id_908_job_posts.csv (school_id, post_link).
Checkpointed to school_id_908_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://www.alfred.edu/jobs-at-alfred/index.cfm'
