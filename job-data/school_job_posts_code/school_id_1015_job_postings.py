"""
Job postings scraper for school_id 1015 - Russell Sage College (US)
ATS platform: own website
Careers link: https://sage.interviewexchange.com/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Russell Sage College; nothing here affects any
...
Writes school_job_posts/school_id_1015_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1015_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1015
SCHOOL_NAME = 'Russell Sage College'
CAREERS_LINK = 'https://sage.interviewexchange.com/'
