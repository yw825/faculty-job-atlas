"""
Job postings scraper for school_id 992 - SUNY at Purchase College (US)
ATS platform: PeopleAdmin (detected: peopleadmin)
Careers link: https://jobs.purchase.edu/

SUNY at Purchase College runs on a shared ATS platform -- every school on peopleadmin uses the
...
Writes school_job_posts/school_id_992_job_posts.csv (school_id, post_link).
Checkpointed to school_id_992_job_postings.checkpoint next to this script.
"""
import os
import sys
...
SCHOOL_ID = 992
SCHOOL_NAME = 'SUNY at Purchase College'
CAREERS_LINK = 'https://jobs.purchase.edu/'
