"""
Job postings scraper for school_id 1170 - Cairn University-Langhorne (US)
ATS platform: own website
Careers link: https://cairn.edu/hr/jobs/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Cairn University-Langhorne; nothing here affects any
...
Writes school_job_posts/school_id_1170_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1170_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1170
SCHOOL_NAME = 'Cairn University-Langhorne'
CAREERS_LINK = 'https://cairn.edu/hr/jobs/'
