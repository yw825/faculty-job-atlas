...
def find_links():
    ...
    (title_role=0 degree=0 furniture=2 len=16707; title_role=0 degree=0 furniture=2 len=20812).

        woodbury.edu/admissions/undergraduate-admission/<*>

    The generic job-word filter returned 1 link(s) here against 7
