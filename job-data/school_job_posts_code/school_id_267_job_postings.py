"""
Job postings scraper for school_id 267 - Trinity College of Florida (US)
ATS platform: own website
Careers link: https://www.trinitycollege.edu/gainful-employment/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Trinity College of Florida; nothing here affects any
...
Writes school_job_posts/school_id_267_job_posts.csv (school_id, post_link).
Checkpointed to school_id_267_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 267
SCHOOL_NAME = 'Trinity College of Florida'
CAREERS_LINK = 'https://www.trinitycollege.edu/gainful-employment/'
