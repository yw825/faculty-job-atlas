"""
Job postings scraper for school_id 360 - University of Idaho (US)
ATS platform: PeopleAdmin (detected: peopleadmin)
Careers link: https://uidaho.peopleadmin.com/

University of Idaho runs on a shared ATS platform -- every school on peopleadmin uses the
...
Writes school_job_posts/school_id_360_job_posts.csv (school_id, post_link).
Checkpointed to school_id_360_job_postings.checkpoint next to this script.
"""
import os
import sys
...
CAREERS_LINK = 'https://uidaho.peopleadmin.com/'
