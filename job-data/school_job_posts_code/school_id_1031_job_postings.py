"""
Job postings scraper for school_id 1031 - Mount St. Joseph University (US)
ATS platform: own website
Careers link: https://www.msj.edu/employment-at-the-university/index.html

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Mount St. Joseph University; nothing here affects any
...
Writes school_job_posts/school_id_1031_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1031_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1031
SCHOOL_NAME = 'Mount St. Joseph University'
CAREERS_LINK = 'https://www.msj.edu/employment-at-the-university/index.html'
