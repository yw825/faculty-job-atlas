"""
Job postings scraper for school_id 848 - New England College (US)
ATS platform: PeopleAdmin (detected: peopleadmin)
Careers link: https://nec.peopleadmin.com

New England College runs on a shared ATS platform -- every school on peopleadmin uses the
...
Writes school_job_posts/school_id_848_job_posts.csv (school_id, post_link).
Checkpointed to school_id_848_job_postings.checkpoint next to this script.
"""
import os
import sys
...
SCHOOL_ID = 848
SCHOOL_NAME = 'New England College'
CAREERS_LINK = 'https://nec.peopleadmin.com'
