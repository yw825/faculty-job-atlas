"""
Job postings scraper for school_id 290 - Dalton State College (US)
ATS platform: own website
Careers link: https://www.daltonstate.edu/about/marketing-communications-workforce/career-and-professional-development/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Dalton State College; nothing here affects any
...
Writes school_job_posts/school_id_290_job_posts.csv (school_id, post_link).
Checkpointed to school_id_290_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 290
SCHOOL_NAME = 'Dalton State College'
CAREERS_LINK = 'https://www.daltonstate.edu/about/marketing-communications-workforce/career-and-professional-development/'
