"""
Job postings scraper for school_id 663 - Saginaw Valley State University (US)
ATS platform: own website
Careers link: https://wd503.myworkday.com/svsu/d/home.htmld

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Saginaw Valley State University; nothing here affects any
...
Writes school_job_posts/school_id_663_job_posts.csv (school_id, post_link).
Checkpointed to school_id_663_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 663
SCHOOL_NAME = 'Saginaw Valley State University'
CAREERS_LINK = 'https://wd503.myworkday.com/svsu/d/home.htmld'
