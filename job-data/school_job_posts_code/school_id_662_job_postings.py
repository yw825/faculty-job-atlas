"""
Job postings scraper for school_id 662 - Walsh College (US)
ATS platform: own website
Careers link: https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=8B50A1FFE490890FFF138330679CB02A&fromClientSide=true

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Walsh College; nothing here affects any
...
Writes school_job_posts/school_id_662_job_posts.csv (school_id, post_link).
Checkpointed to school_id_662_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 662
SCHOOL_NAME = 'Walsh College'
CAREERS_LINK = 'https://www.paycomonline.net/v4/ats/web.php/jobs?clientkey=8B50A1FFE490890FFF138330679CB02A&fromClientSide=true'
