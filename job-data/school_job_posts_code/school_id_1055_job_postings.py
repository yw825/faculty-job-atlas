"""
Job postings scraper for school_id 1055 - Ohio State University-Lima Campus (US)
ATS platform: own website
Careers link: https://lima.osu.edu/weserve/weserve-volunteer-opportunities

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Ohio State University-Lima Campus; nothing here affects any
...
Writes school_job_posts/school_id_1055_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1055_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1055
SCHOOL_NAME = 'Ohio State University-Lima Campus'
CAREERS_LINK = 'https://lima.osu.edu/weserve/weserve-volunteer-opportunities'
