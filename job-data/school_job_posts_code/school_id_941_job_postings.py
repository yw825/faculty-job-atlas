"""
Job postings scraper for school_id 941 - SUNY at Fredonia (US)
ATS platform: own website
Careers link: https://www.fredonia.edu/about/offices/human-resources/jobs

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for SUNY at Fredonia; nothing here affects any
other school's script.

Link check (ok): 20 posting-shaped links found -- rendered.
...
Writes school_job_posts/school_id_941_job_posts.csv (school_id, post_link).
Checkpointed to school_id_941_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 941
SCHOOL_NAME = 'SUNY at Fredonia'
CAREERS_LINK = 'https://www.fredonia.edu/about/offices/human-resources/jobs'
