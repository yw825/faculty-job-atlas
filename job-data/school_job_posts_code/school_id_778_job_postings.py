"""
Job postings scraper for school_id 778 - University of North Carolina at Charlotte (US)
ATS platform: own website
Careers link: https://jobs.charlotte.edu/postings/search

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of North Carolina at Charlotte; nothing here affects any
...
Writes school_job_posts/school_id_778_job_posts.csv (school_id, post_link).
Checkpointed to school_id_778_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
