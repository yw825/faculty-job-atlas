"""
Job postings scraper for school_id 1805 - Flinders University (Australia)
ATS platform: Workday (detected: workday)
Careers link: https://flinders.wd3.myworkdayjobs.com/flinders_employment

Flinders University runs on a shared ATS platform -- every school on workday uses the
...
Writes school_job_posts/school_id_1805_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1805_job_postings.checkpoint next to this script.
"""
import os
import sys
