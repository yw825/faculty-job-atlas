"""
Job postings scraper for school_id 1840 - Saint Francis University (Hong Kong)
ATS platform: own website
Careers link: https://www.sfu.edu.hk/en/career/academic-teaching-positions/index.html

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Saint Francis University; nothing here affects any
...
Writes school_job_posts/school_id_1840_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1840_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
