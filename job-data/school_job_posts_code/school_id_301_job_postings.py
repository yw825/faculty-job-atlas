"""
Job postings scraper for school_id 301 - Mercer University (US)
ATS platform: own website
Careers link: https://hr.mercer.edu/prospective-employees/career-opportunities/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Mercer University; nothing here affects any
...
Writes school_job_posts/school_id_301_job_posts.csv (school_id, post_link).
Checkpointed to school_id_301_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 301
SCHOOL_NAME = 'Mercer University'
CAREERS_LINK = 'https://hr.mercer.edu/prospective-employees/career-opportunities/'
