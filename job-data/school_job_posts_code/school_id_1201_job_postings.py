"""
Job postings scraper for school_id 1201 - Point Park University (US)
ATS platform: own website
Careers link: https://www.pointpark.edu/careerready/index

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Point Park University; nothing here affects any
...
Writes school_job_posts/school_id_1201_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1201_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1201
SCHOOL_NAME = 'Point Park University'
CAREERS_LINK = 'https://www.pointpark.edu/careerready/index'
