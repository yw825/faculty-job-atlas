"""
Job postings scraper for school_id 1470 - Hampden-Sydney College (US)
ATS platform: own website
Careers link: https://www.hsc.edu/human-resources/job-openings

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Hampden-Sydney College; nothing here affects any
...
Writes school_job_posts/school_id_1470_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1470_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1470
SCHOOL_NAME = 'Hampden-Sydney College'
CAREERS_LINK = 'https://www.hsc.edu/human-resources/job-openings'
