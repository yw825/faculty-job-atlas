"""
Job postings scraper for school_id 1193 - Temple University (US)
ATS platform: own website
Careers link: https://careers.temple.edu/careers-temple/search-and-apply-jobs

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Temple University; nothing here affects any
...
Writes school_job_posts/school_id_1193_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1193_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1193
SCHOOL_NAME = 'Temple University'
CAREERS_LINK = 'https://careers.temple.edu/careers-temple/search-and-apply-jobs'
