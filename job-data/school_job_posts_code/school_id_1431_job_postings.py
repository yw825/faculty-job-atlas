"""
Job postings scraper for school_id 1431 - Texas Lutheran University (US)
ATS platform: own website
Careers link: https://www.tlu.edu/about-tlu/careers-at-tlu/faculty-positions/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Texas Lutheran University; nothing here affects any
...
Writes school_job_posts/school_id_1431_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1431_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1431
SCHOOL_NAME = 'Texas Lutheran University'
CAREERS_LINK = 'https://www.tlu.edu/about-tlu/careers-at-tlu/faculty-positions/'
ATS_PLATFORM = 'own website'

CHECKPOINT_PATH = os.path.join(HERE, f'school_id_{SCHOOL_ID}_job_postings.checkpoint')


POSTING_PATTERN = 'www.tlu.edu/about-tlu/careers-at-tlu/<*>'
...
def find_links():
    ...
    (title_role=0 degree=0 furniture=7 len=47715; title_role=0 degree=0 furniture=0 len=4371).

        www.tlu.edu/about-tlu/careers-at-tlu/<*>
