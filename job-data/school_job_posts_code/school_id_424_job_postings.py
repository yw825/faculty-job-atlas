"""
Job postings scraper for school_id 424 - University of Saint Francis-Fort Wayne (US)
ATS platform: own website
Careers link: https://www.sf.edu/about/offices-and-departments/careers/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of Saint Francis-Fort Wayne; nothing here affects any
...
Writes school_job_posts/school_id_424_job_posts.csv (school_id, post_link).
Checkpointed to school_id_424_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 424
SCHOOL_NAME = 'University of Saint Francis-Fort Wayne'
CAREERS_LINK = 'https://www.sf.edu/about/offices-and-departments/careers/'
