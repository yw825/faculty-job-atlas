"""
Job postings scraper for school_id 1366 - Saint Edward's University (US)
ATS platform: own website
Careers link: http://stedwards.applicantpro.com/jobs/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Saint Edward's University; nothing here affects any
...
Writes school_job_posts/school_id_1366_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1366_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1366
SCHOOL_NAME = 'Saint Edward\'s University'
CAREERS_LINK = 'http://stedwards.applicantpro.com/jobs/'
