"""
Job postings scraper for school_id 656 - Baker College (US)
ATS platform: own website
Careers link: https://www.baker.edu/about/get-to-know-us/careers/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Baker College; nothing here affects any
...
Writes school_job_posts/school_id_656_job_posts.csv (school_id, post_link).
Checkpointed to school_id_656_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 656
SCHOOL_NAME = 'Baker College'
CAREERS_LINK = 'https://www.baker.edu/about/get-to-know-us/careers/'
