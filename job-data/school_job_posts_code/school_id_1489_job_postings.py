"""
Job postings scraper for school_id 1489 - Mary Baldwin University (US)
ATS platform: own website
Careers link: https://marybaldwin.edu/employment-and-jobs-at-mary-baldwin/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Mary Baldwin University; nothing here affects any
...
Writes school_job_posts/school_id_1489_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1489_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1489
SCHOOL_NAME = 'Mary Baldwin University'
CAREERS_LINK = 'https://marybaldwin.edu/employment-and-jobs-at-mary-baldwin/'
