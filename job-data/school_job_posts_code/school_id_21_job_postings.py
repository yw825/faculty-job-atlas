"""
Job postings scraper for school_id 21 - Amridge University (US)
ATS platform: own website
Careers link: http://www.amridgeuniversity.edu/about/employment/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Amridge University; nothing here affects any
...
Writes school_job_posts/school_id_21_job_posts.csv (school_id, post_link).
Checkpointed to school_id_21_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 21
SCHOOL_NAME = 'Amridge University'
CAREERS_LINK = 'http://www.amridgeuniversity.edu/about/employment/'
