"""
Job postings scraper for school_id 1189 - Holy Family University (US)
ATS platform: own website
Careers link: https://www.holyfamily.edu/about/administrative-services/human-resources/jobs

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Holy Family University; nothing here affects any
...
Writes school_job_posts/school_id_1189_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1189_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1189
SCHOOL_NAME = 'Holy Family University'
CAREERS_LINK = 'https://www.holyfamily.edu/about/administrative-services/human-resources/jobs'
