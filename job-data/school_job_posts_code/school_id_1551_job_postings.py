"""
Job postings scraper for school_id 1551 - Mount Mary University (US)
ATS platform: own website
Careers link: https://mtmary.edu/about/employment.html

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Mount Mary University; nothing here affects any
...
Writes school_job_posts/school_id_1551_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1551_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1551
SCHOOL_NAME = 'Mount Mary University'
CAREERS_LINK = 'https://mtmary.edu/about/employment.html'
