"""
Job postings scraper for school_id 409 - Augustana College (US)
ATS platform: own website
Careers link: https://www.augustana.edu/about-us/offices/hr/employment/opportunities

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Augustana College; nothing here affects any
...
Writes school_job_posts/school_id_409_job_posts.csv (school_id, post_link).
Checkpointed to school_id_409_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 409
SCHOOL_NAME = 'Augustana College'
CAREERS_LINK = 'https://www.augustana.edu/about-us/offices/hr/employment/opportunities'
