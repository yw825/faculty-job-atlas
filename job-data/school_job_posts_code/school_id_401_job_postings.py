"""
Job postings scraper for school_id 401 - Monmouth College (US)
ATS platform: own website
Careers link: https://www.monmouthcollege.edu/offices/hr/employment-opportunities/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Monmouth College; nothing here affects any
...
Writes school_job_posts/school_id_401_job_posts.csv (school_id, post_link).
Checkpointed to school_id_401_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 401
SCHOOL_NAME = 'Monmouth College'
CAREERS_LINK = 'https://www.monmouthcollege.edu/offices/hr/employment-opportunities/'
ATS_PLATFORM = 'own website'

CHECKPOINT_PATH = os.path.join(HERE, f'school_id_{SCHOOL_ID}_job_postings.checkpoint')


POSTING_PATTERN = 'www.monmouthcollege.edu/offices/hr/<*>'
