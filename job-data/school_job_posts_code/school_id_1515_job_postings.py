"""
Job postings scraper for school_id 1515 - Washington State University (US)
ATS platform: own website
Careers link: https://wd5.myworkday.com/wsu/d/task/1422$478.htmld

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Washington State University; nothing here affects any
...
Writes school_job_posts/school_id_1515_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1515_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
