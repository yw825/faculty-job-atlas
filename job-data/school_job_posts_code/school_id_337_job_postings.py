"""
Job postings scraper for school_id 337 - Clarke University (US)
ATS platform: own website
Careers link: https://clarke.applicantpool.com/jobs/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Clarke University; nothing here affects any
...
Writes school_job_posts/school_id_337_job_posts.csv (school_id, post_link).
Checkpointed to school_id_337_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 337
SCHOOL_NAME = 'Clarke University'
CAREERS_LINK = 'https://clarke.applicantpool.com/jobs/'
