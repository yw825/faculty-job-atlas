"""
Job postings scraper for school_id 1340 - Cumberland University (US)
ATS platform: own website
Careers link: https://www.cumberland.edu/about/employment/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Cumberland University; nothing here affects any
...
Writes school_job_posts/school_id_1340_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1340_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://www.cumberland.edu/about/employment/'
