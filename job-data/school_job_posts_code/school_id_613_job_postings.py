"""
Job postings scraper for school_id 613 - University of New England (US)
ATS platform: PeopleAdmin (detected: peopleadmin)
Careers link: https://une.peopleadmin.com/

University of New England runs on a shared ATS platform -- every school on peopleadmin uses the
...
Writes school_job_posts/school_id_613_job_posts.csv (school_id, post_link).
Checkpointed to school_id_613_job_postings.checkpoint next to this script.
"""
import os
import sys
...
CAREERS_LINK = 'https://une.peopleadmin.com/'
