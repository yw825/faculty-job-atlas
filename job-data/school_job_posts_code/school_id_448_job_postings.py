"""
Job postings scraper for school_id 448 - Indiana University-East (US)
ATS platform: own website
Careers link: https://east.iu.edu/red-wolf-central/academic-career/index.html

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Indiana University-East; nothing here affects any
...
Writes school_job_posts/school_id_448_job_posts.csv (school_id, post_link).
Checkpointed to school_id_448_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 448
SCHOOL_NAME = 'Indiana University-East'
CAREERS_LINK = 'https://east.iu.edu/red-wolf-central/academic-career/index.html'
