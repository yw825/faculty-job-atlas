"""
Job postings scraper for school_id 1192 - Saint Joseph's University (US)
ATS platform: Workday (detected: workday)
Careers link: https://sju.wd1.myworkdayjobs.com/sju

Saint Joseph's University runs on a shared ATS platform -- every school on workday uses the
...
Writes school_job_posts/school_id_1192_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1192_job_postings.checkpoint next to this script.
"""
import os
import sys
...
CAREERS_LINK = 'https://sju.wd1.myworkdayjobs.com/sju'
