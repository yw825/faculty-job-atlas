"""
Job postings scraper for school_id 1437 - The University of Texas at Tyler (US)
ATS platform: own website
Careers link: https://www.uttyler.edu/careers/clery-act/index.php

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for The University of Texas at Tyler; nothing here affects any
...
Writes school_job_posts/school_id_1437_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1437_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1437
SCHOOL_NAME = 'The University of Texas at Tyler'
CAREERS_LINK = 'https://www.uttyler.edu/careers/clery-act/index.php'
