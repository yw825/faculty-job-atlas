"""
Job postings scraper for school_id 1246 - Atlantic University (US)
ATS platform: own website
Careers link: https://www.indeed.com/cmp/Atlantic-University-1/jobs

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Atlantic University; nothing here affects any
...
Writes school_job_posts/school_id_1246_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1246_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1246
SCHOOL_NAME = 'Atlantic University'
CAREERS_LINK = 'https://www.indeed.com/cmp/Atlantic-University-1/jobs'
