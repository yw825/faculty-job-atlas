"""
Job postings scraper for school_id 231 - University of Florida (US)
ATS platform: own website
Careers link: https://jobs.ufl.edu/career-growth/professional-development/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of Florida; nothing here affects any
...
Writes school_job_posts/school_id_231_job_posts.csv (school_id, post_link).
Checkpointed to school_id_231_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://jobs.ufl.edu/career-growth/professional-development/'
