"""
Job postings scraper for school_id 98 - California State University-Long Beach (US)
ATS platform: own website
Careers link: https://csucareers.calstate.edu/en-us/filter/?=&leftNavSearchFormQuery=&=&search=&search-keyword=&job-mail-subscribe-privacy=agree&work-type=instructional%20faculty%20-%20temporary%2flecturer&work-type=instructional%20faculty%20%e2%80%93%20tenured%2ftenure-track&location=long%20beach&job-mail-subscribe-privacy=agree

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for California State University-Long Beach; nothing here affects any
...
Writes school_job_posts/school_id_98_job_posts.csv (school_id, post_link).
Checkpointed to school_id_98_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
