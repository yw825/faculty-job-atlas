"""
Job postings scraper for school_id 1798 - University of Queensland (Australia)
ATS platform: Workday (detected: workday)
Careers link: https://uq.wd3.myworkdayjobs.com/uqcareers

University of Queensland runs on a shared ATS platform -- every school on workday uses the
...
Writes school_job_posts/school_id_1798_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1798_job_postings.checkpoint next to this script.
"""
import os
import sys
