"""
Job postings scraper for school_id 973 - The King's College (US)
ATS platform: own website
Careers link: https://www.tkc.edu/?page_id=1006

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for The King's College; nothing here affects any
other school's script.

Link check (review): 2 posting-shaped links found -- rendered wall/challenge page.
...
Writes school_job_posts/school_id_973_job_posts.csv (school_id, post_link).
Checkpointed to school_id_973_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 973
SCHOOL_NAME = 'The King\'s College'
CAREERS_LINK = 'https://www.tkc.edu/?page_id=1006'
