"""
Job postings scraper for school_id 891 - University of New Mexico-Main Campus (US)
ATS platform: own website
Careers link: https://unmjobs.unm.edu/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of New Mexico-Main Campus; nothing here affects any
...
Writes school_job_posts/school_id_891_job_posts.csv (school_id, post_link).
Checkpointed to school_id_891_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 891
SCHOOL_NAME = 'University of New Mexico-Main Campus'
CAREERS_LINK = 'https://unmjobs.unm.edu/'
