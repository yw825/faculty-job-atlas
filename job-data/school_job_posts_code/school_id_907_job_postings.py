"""
Job postings scraper for school_id 907 - University at Albany (US)
ATS platform: own website
Careers link: https://albany.interviewexchange.com/jobsearchfrm.jsp

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University at Albany; nothing here affects any
...
Writes school_job_posts/school_id_907_job_posts.csv (school_id, post_link).
Checkpointed to school_id_907_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 907
SCHOOL_NAME = 'University at Albany'
CAREERS_LINK = 'https://albany.interviewexchange.com/jobsearchfrm.jsp'
