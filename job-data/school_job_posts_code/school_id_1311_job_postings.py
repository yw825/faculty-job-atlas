"""
Job postings scraper for school_id 1311 - Dakota State University (US)
ATS platform: own website
Careers link: https://dsu.edu/careers/benefits.html

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Dakota State University; nothing here affects any
...
Writes school_job_posts/school_id_1311_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1311_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://dsu.edu/careers/benefits.html'
