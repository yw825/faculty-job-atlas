"""
Job postings scraper for school_id 1095 - Bacone College (US)
ATS platform: own website
Careers link: https://www.bacone.edu/job-openings/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Bacone College; nothing here affects any
...
Writes school_job_posts/school_id_1095_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1095_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1095
SCHOOL_NAME = 'Bacone College'
CAREERS_LINK = 'https://www.bacone.edu/job-openings/'
