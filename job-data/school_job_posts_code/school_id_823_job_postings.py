"""
Job postings scraper for school_id 823 - North Dakota State University-Main Campus (US)
ATS platform: own website
Careers link: https://www.ndsu.edu/employment

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for North Dakota State University-Main Campus; nothing here affects any
...
Writes school_job_posts/school_id_823_job_posts.csv (school_id, post_link).
Checkpointed to school_id_823_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 823
SCHOOL_NAME = 'North Dakota State University-Main Campus'
CAREERS_LINK = 'https://www.ndsu.edu/employment'
