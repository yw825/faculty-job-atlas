"""
Job postings scraper for school_id 157 - California State University-Stanislaus (US)
ATS platform: own website
Careers link: https://careers.csustan.edu/st/en-us/filter/?job-mail-subscribe-privacy=agree&search-keyword=&work-type=instructional%20faculty%20-%20temporary%2flecturer&work-type=instructional%20faculty%20%E2%80%93%20tenured%2ftenure-track&work-type=non-instructional%20faculty%20(coach%2fcounselor%2flibrarian)&category=unit%203%20-%20cfa%20-%20california%20faculty%20association

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for California State University-Stanislaus; nothing here affects any
...
Writes school_job_posts/school_id_157_job_posts.csv (school_id, post_link).
Checkpointed to school_id_157_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 157
SCHOOL_NAME = 'California State University-Stanislaus'
CAREERS_LINK = 'https://careers.csustan.edu/st/en-us/filter/?job-mail-subscribe-privacy=agree&search-keyword=&work-type=instructional%20faculty%20-%20temporary%2flecturer&work-type=instructional%20faculty%20%E2%80%93%20tenured%2ftenure-track&work-type=non-instructional%20faculty%20(coach%2fcounselor%2flibrarian)&category=unit%203%20-%20cfa%20-%20california%20faculty%20association'
