"""
Job postings scraper for school_id 527 - Centenary College of Louisiana (US)
ATS platform: own website
Careers link: https://www.centenary.edu/directories/offices-services-directory/human-resources/job-opportunities/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Centenary College of Louisiana; nothing here affects any
...
Writes school_job_posts/school_id_527_job_posts.csv (school_id, post_link).
Checkpointed to school_id_527_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 527
SCHOOL_NAME = 'Centenary College of Louisiana'
CAREERS_LINK = 'https://www.centenary.edu/directories/offices-services-directory/human-resources/job-opportunities/'
ATS_PLATFORM = 'own website'

CHECKPOINT_PATH = os.path.join(HERE, f'school_id_{SCHOOL_ID}_job_postings.checkpoint')


POSTING_PATTERN = 'www.centenary.edu/directories/offices-services-directory/human-resources/<*>'
...
def find_links():
    ...
    (title_role=0 degree=0 furniture=6 len=33339; title_role=0 degree=0 furniture=1 len=20924).

        www.centenary.edu/directories/offices-services-directory/human-resources/<*>

    The generic job-word filter returned 3 link(s) here against 15
