"""
Job postings scraper for school_id 1211 - University of Scranton (US)
ATS platform: own website
Careers link: https://www.follett.com/careerportal/find-career.cfm

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of Scranton; nothing here affects any
...
Writes school_job_posts/school_id_1211_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1211_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1211
SCHOOL_NAME = 'University of Scranton'
CAREERS_LINK = 'https://www.follett.com/careerportal/find-career.cfm'
