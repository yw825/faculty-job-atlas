"""
Job postings scraper for school_id 338 - Loras College (US)
ATS platform: own website
Careers link: https://loras.applicantpool.com/jobs/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Loras College; nothing here affects any
...
Writes school_job_posts/school_id_338_job_posts.csv (school_id, post_link).
Checkpointed to school_id_338_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 338
SCHOOL_NAME = 'Loras College'
CAREERS_LINK = 'https://loras.applicantpool.com/jobs/'
