"""
Job postings scraper for school_id 617 - University of Maine at Fort Kent (US)
ATS platform: own website
Careers link: https://www.maine.edu/careers/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of Maine at Fort Kent; nothing here affects any
...
Writes school_job_posts/school_id_617_job_posts.csv (school_id, post_link).
Checkpointed to school_id_617_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 617
SCHOOL_NAME = 'University of Maine at Fort Kent'
CAREERS_LINK = 'https://www.maine.edu/careers/'
