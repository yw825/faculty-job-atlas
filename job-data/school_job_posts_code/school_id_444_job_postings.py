"""
Job postings scraper for school_id 444 - Saint Mary's College (US)
ATS platform: own website
Careers link: https://www.saintmarys.edu/hr

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Saint Mary's College; nothing here affects any
...
Writes school_job_posts/school_id_444_job_posts.csv (school_id, post_link).
Checkpointed to school_id_444_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 444
SCHOOL_NAME = 'Saint Mary\'s College'
CAREERS_LINK = 'https://www.saintmarys.edu/hr'
