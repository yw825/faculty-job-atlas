"""
Job postings scraper for school_id 899 - New Mexico Institute of Mining and Technology (US)
ATS platform: own website
Careers link: https://www.nmt.edu/hr/employment.php

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for New Mexico Institute of Mining and Technology; nothing here affects any
...
Writes school_job_posts/school_id_899_job_posts.csv (school_id, post_link).
Checkpointed to school_id_899_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 899
SCHOOL_NAME = 'New Mexico Institute of Mining and Technology'
CAREERS_LINK = 'https://www.nmt.edu/hr/employment.php'
