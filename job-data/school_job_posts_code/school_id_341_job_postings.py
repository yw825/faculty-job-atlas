"""
Job postings scraper for school_id 341 - Upper Iowa University (US)
ATS platform: own website
Careers link: https://my.uiu.edu/ICS/Employment_Opportunities.jnz

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Upper Iowa University; nothing here affects any
...
Writes school_job_posts/school_id_341_job_posts.csv (school_id, post_link).
Checkpointed to school_id_341_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 341
SCHOOL_NAME = 'Upper Iowa University'
CAREERS_LINK = 'https://my.uiu.edu/ICS/Employment_Opportunities.jnz'
