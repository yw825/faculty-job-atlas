"""
Job postings scraper for school_id 335 - Drake University (US)
ATS platform: own website
Careers link: https://jobs.drake.edu/jobs/search

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Drake University; nothing here affects any
...
Writes school_job_posts/school_id_335_job_posts.csv (school_id, post_link).
Checkpointed to school_id_335_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 335
SCHOOL_NAME = 'Drake University'
CAREERS_LINK = 'https://jobs.drake.edu/jobs/search'
