"""
Job postings scraper for school_id 458 - Benedictine College (US)
ATS platform: own website
Careers link: https://recruiting.paylocity.com/recruiting/jobs/Details/3764624/Benedictine-College/AssistantAssociate-Professor-of-Psychology

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Benedictine College; nothing here affects any
...
Writes school_job_posts/school_id_458_job_posts.csv (school_id, post_link).
Checkpointed to school_id_458_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
