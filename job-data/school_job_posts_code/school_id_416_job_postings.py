"""
Job postings scraper for school_id 416 - Trine University (US)
ATS platform: own website
Careers link: https://www.trine.edu/human-resources/careers/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Trine University; nothing here affects any
...
Writes school_job_posts/school_id_416_job_posts.csv (school_id, post_link).
Checkpointed to school_id_416_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 416
SCHOOL_NAME = 'Trine University'
CAREERS_LINK = 'https://www.trine.edu/human-resources/careers/'
