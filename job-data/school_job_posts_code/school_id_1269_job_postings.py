"""
Job postings scraper for school_id 1269 - Johnson & Wales University-Providence (US)
ATS platform: own website
Careers link: https://jobs.jwu.edu/en-us/listing/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Johnson & Wales University-Providence; nothing here affects any
...
Writes school_job_posts/school_id_1269_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1269_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1269
SCHOOL_NAME = 'Johnson & Wales University-Providence'
CAREERS_LINK = 'https://jobs.jwu.edu/en-us/listing/'
