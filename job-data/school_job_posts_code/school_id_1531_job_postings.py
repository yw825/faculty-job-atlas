"""
Job postings scraper for school_id 1531 - Beloit College (US)
ATS platform: own website
Careers link: https://www.beloit.edu/offices/human-resources/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Beloit College; nothing here affects any
...
Writes school_job_posts/school_id_1531_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1531_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1531
SCHOOL_NAME = 'Beloit College'
CAREERS_LINK = 'https://www.beloit.edu/offices/human-resources/'
