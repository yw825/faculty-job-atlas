"""
Job postings scraper for school_id 1152 - Mercyhurst University (US)
ATS platform: own website
Careers link: https://www.mercyhurst.edu/human-resources/jobs

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Mercyhurst University; nothing here affects any
...
Writes school_job_posts/school_id_1152_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1152_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1152
SCHOOL_NAME = 'Mercyhurst University'
CAREERS_LINK = 'https://www.mercyhurst.edu/human-resources/jobs'
