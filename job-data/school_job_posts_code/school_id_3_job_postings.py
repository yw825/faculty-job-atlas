"""
Job postings scraper for school_id 3 - University of Alaska Fairbanks (US)
ATS platform: own website
Careers link: https://careers.alaska.edu/jobs/search/faculty-jobs?page=1&cities%5B%5D=Fairbanks&query=

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of Alaska Fairbanks; nothing here affects any
...
Writes school_job_posts/school_id_3_job_posts.csv (school_id, post_link).
Checkpointed to school_id_3_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 3
SCHOOL_NAME = 'University of Alaska Fairbanks'
CAREERS_LINK = 'https://careers.alaska.edu/jobs/search/faculty-jobs?page=1&cities%5B%5D=Fairbanks&query='
