"""
Job postings scraper for school_id 944 - Hobart William Smith Colleges (US)
ATS platform: own website
Careers link: https://www.hws.edu/offices/hr/employment-opportunities/faculty.aspx

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Hobart William Smith Colleges; nothing here affects any
...
Writes school_job_posts/school_id_944_job_posts.csv (school_id, post_link).
Checkpointed to school_id_944_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 944
SCHOOL_NAME = 'Hobart William Smith Colleges'
CAREERS_LINK = 'https://www.hws.edu/offices/hr/employment-opportunities/faculty.aspx'
