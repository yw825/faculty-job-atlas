"""
Job postings scraper for school_id 1747 - Chalmers University of Technology (Sweden)
...
directly to fix or improve results for Chalmers University of Technology; nothing here affects any
...
Writes school_job_posts/school_id_1747_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1747_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
