"""
Job postings scraper for school_id 859 - Caldwell University (US)
ATS platform: own website
Careers link: https://www.caldwell.edu/hr/employment-opportunities/faculty-full-time/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Caldwell University; nothing here affects any
...
Writes school_job_posts/school_id_859_job_posts.csv (school_id, post_link).
Checkpointed to school_id_859_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://www.caldwell.edu/hr/employment-opportunities/faculty-full-time/'
