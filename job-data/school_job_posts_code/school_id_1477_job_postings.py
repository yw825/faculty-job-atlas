"""
Job postings scraper for school_id 1477 - Randolph College (US)
ATS platform: own website
Careers link: https://www.randolphcollege.edu/humanresources/job-openings/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Randolph College; nothing here affects any
...
Writes school_job_posts/school_id_1477_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1477_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1477
SCHOOL_NAME = 'Randolph College'
CAREERS_LINK = 'https://www.randolphcollege.edu/humanresources/job-openings/'
