"""
Job postings scraper for school_id 83 - Scripps College (US)
ATS platform: own website
Careers link: http://www.scrippscollege.edu/hr/faculty

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Scripps College; nothing here affects any
...
Writes school_job_posts/school_id_83_job_posts.csv (school_id, post_link).
Checkpointed to school_id_83_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 83
SCHOOL_NAME = 'Scripps College'
CAREERS_LINK = 'http://www.scrippscollege.edu/hr/faculty'
