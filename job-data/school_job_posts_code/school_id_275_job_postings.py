"""
Job postings scraper for school_id 275 - Emory University (US)
ATS platform: own website
Careers link: http://www.hr.emory.edu/careers/index.html

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Emory University; nothing here affects any
...
Writes school_job_posts/school_id_275_job_posts.csv (school_id, post_link).
Checkpointed to school_id_275_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'http://www.hr.emory.edu/careers/index.html'
