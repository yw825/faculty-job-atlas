"""
Job postings scraper for school_id 1883 - University of Limerick (Ireland)
ATS platform: CoreHR
...
directly to fix or improve results for University of Limerick; nothing here affects any
...
Writes school_job_posts/school_id_1883_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1883_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
