"""
Job postings scraper for school_id 515 - McNeese State University (US)
ATS platform: own website
Careers link: https://www.mcneese.edu/financial-aid/gainful-employment-disclosure-information/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for McNeese State University; nothing here affects any
...
Writes school_job_posts/school_id_515_job_posts.csv (school_id, post_link).
Checkpointed to school_id_515_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 515
SCHOOL_NAME = 'McNeese State University'
CAREERS_LINK = 'https://www.mcneese.edu/financial-aid/gainful-employment-disclosure-information/'
