"""
Job postings scraper for school_id 793 - University of North Carolina at Greensboro (US)
ATS platform: own website
Careers link: https://spartantalent.uncg.edu/postings/search

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of North Carolina at Greensboro; nothing here affects any
other school's script.

Link check (ok): 71 posting-shaped links found.
...
Writes school_job_posts/school_id_793_job_posts.csv (school_id, post_link).
Checkpointed to school_id_793_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://spartantalent.uncg.edu/postings/search'
