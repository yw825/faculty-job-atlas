"""
Job postings scraper for school_id 440 - Ball State University (US)
ATS platform: own website
Careers link: https://wd12.myworkday.com/bsu/d/task/2998$42366.htmld#backheader=true

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Ball State University; nothing here affects any
...
Writes school_job_posts/school_id_440_job_posts.csv (school_id, post_link).
Checkpointed to school_id_440_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
