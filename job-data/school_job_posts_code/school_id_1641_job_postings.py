"""
Job postings scraper for school_id 1641 - McGill University (Canada)
ATS platform: Workday (detected: workday)
Careers link: https://mcgill.wd3.myworkdayjobs.com/mcgill_careers

McGill University runs on a shared ATS platform -- every school on workday uses the
...
Writes school_job_posts/school_id_1641_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1641_job_postings.checkpoint next to this script.
"""
import os
import sys
