"""
Job postings scraper for school_id 1220 - Villanova University (US)
ATS platform: PeopleAdmin (detected: peopleadmin)
Careers link: http://jobs.villanova.edu

Villanova University runs on a shared ATS platform -- every school on peopleadmin uses the
...
Writes school_job_posts/school_id_1220_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1220_job_postings.checkpoint next to this script.
"""
import os
import sys
