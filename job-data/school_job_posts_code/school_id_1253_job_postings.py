"""
Job postings scraper for school_id 1253 - University of Puerto Rico-Mayaguez (US)
ATS platform: own website
Careers link: https://www.eventbrite.com/e/38th-job-fair-tickets-1992770470120

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of Puerto Rico-Mayaguez; nothing here affects any
...
Writes school_job_posts/school_id_1253_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1253_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
