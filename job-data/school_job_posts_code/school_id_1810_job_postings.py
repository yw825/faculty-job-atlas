"""
Job postings scraper for school_id 1810 - Federation University Australia (Australia)
ATS platform: Workday (detected: workday)
Careers link: https://wd105.myworkdaysite.com/recruiting/federation/Federation_Careers

Federation University Australia runs on a shared ATS platform -- every school on workday uses the
...
Writes school_job_posts/school_id_1810_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1810_job_postings.checkpoint next to this script.
"""
import os
import sys
