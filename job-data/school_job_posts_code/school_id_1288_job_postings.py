"""
Job postings scraper for school_id 1288 - Coastal Carolina University (US)
ATS platform: own website
Careers link: https://www.coastal.edu:443/hreo/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Coastal Carolina University; nothing here affects any
...
Writes school_job_posts/school_id_1288_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1288_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1288
SCHOOL_NAME = 'Coastal Carolina University'
CAREERS_LINK = 'https://www.coastal.edu:443/hreo/'
