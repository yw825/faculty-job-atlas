"""
Job postings scraper for school_id 1342 - Maryville College (US)
ATS platform: own website
Careers link: https://www.maryvillecollege.edu/about/inside/human-resources/careers/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Maryville College; nothing here affects any
...
Writes school_job_posts/school_id_1342_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1342_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1342
SCHOOL_NAME = 'Maryville College'
CAREERS_LINK = 'https://www.maryvillecollege.edu/about/inside/human-resources/careers/'
