"""
Job postings scraper for school_id 916 - University of Mount Saint Vincent (US)
ATS platform: own website
Careers link: https://mountsaintvincent.edu/employment-opportunities/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of Mount Saint Vincent; nothing here affects any
...
Writes school_job_posts/school_id_916_job_posts.csv (school_id, post_link).
Checkpointed to school_id_916_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 916
SCHOOL_NAME = 'University of Mount Saint Vincent'
CAREERS_LINK = 'https://mountsaintvincent.edu/employment-opportunities/'
...
def find_links():
    ...
    and school_id_916_job_info.py resolves that fragment back to the
    section's text."""
