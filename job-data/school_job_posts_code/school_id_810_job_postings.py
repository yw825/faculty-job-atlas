"""
Job postings scraper for school_id 810 - North Carolina Wesleyan University (US)
ATS platform: own website
Careers link: https://ncwu.edu/community/careers/current-openings/faculty-teaching-positions/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for North Carolina Wesleyan University; nothing here affects any
...
Writes school_job_posts/school_id_810_job_posts.csv (school_id, post_link).
Checkpointed to school_id_810_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 810
SCHOOL_NAME = 'North Carolina Wesleyan University'
CAREERS_LINK = 'https://ncwu.edu/community/careers/current-openings/faculty-teaching-positions/'
