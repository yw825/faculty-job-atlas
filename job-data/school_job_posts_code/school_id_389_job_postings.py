"""
Job postings scraper for school_id 389 - Elmhurst University (US)
ATS platform: own website
Careers link: https://apply.workable.com/elmhurst-edu/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Elmhurst University; nothing here affects any
...
Writes school_job_posts/school_id_389_job_posts.csv (school_id, post_link).
Checkpointed to school_id_389_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 389
SCHOOL_NAME = 'Elmhurst University'
CAREERS_LINK = 'https://apply.workable.com/elmhurst-edu/'
