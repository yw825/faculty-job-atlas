"""
Job postings scraper for school_id 356 - Wartburg College (US)
ATS platform: own website
Careers link: https://www.wartburg.edu/carson-research-opportunities-focused-my-career-goals/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Wartburg College; nothing here affects any
...
Writes school_job_posts/school_id_356_job_posts.csv (school_id, post_link).
Checkpointed to school_id_356_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 356
SCHOOL_NAME = 'Wartburg College'
CAREERS_LINK = 'https://www.wartburg.edu/carson-research-opportunities-focused-my-career-goals/'
