"""
Job postings scraper for school_id 1155 - Arcadia University (US)
ATS platform: own website
Careers link: https://www.arcadia.edu/about-arcadia/offices-facilities-services/human-resources

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Arcadia University; nothing here affects any
...
Writes school_job_posts/school_id_1155_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1155_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1155
SCHOOL_NAME = 'Arcadia University'
CAREERS_LINK = 'https://www.arcadia.edu/about-arcadia/offices-facilities-services/human-resources'
