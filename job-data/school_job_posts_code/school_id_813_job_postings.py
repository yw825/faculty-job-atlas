"""
Job postings scraper for school_id 813 - Warren Wilson College (US)
ATS platform: own website
Careers link: https://www.warren-wilson.edu/about/employment/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Warren Wilson College; nothing here affects any
...
Writes school_job_posts/school_id_813_job_posts.csv (school_id, post_link).
Checkpointed to school_id_813_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 813
SCHOOL_NAME = 'Warren Wilson College'
CAREERS_LINK = 'https://www.warren-wilson.edu/about/employment/'
ATS_PLATFORM = 'own website'

CHECKPOINT_PATH = os.path.join(HERE, f'school_id_{SCHOOL_ID}_job_postings.checkpoint')


POSTING_PATTERN = 'www.warren-wilson.edu/admission/<*>'
...
def find_links():
    ...
    (title_role=0 degree=0 furniture=3 len=6048; title_role=0 degree=0 furniture=2 len=6988).

        www.warren-wilson.edu/admission/<*>

    The generic job-word filter returned 1 link(s) here against 5
