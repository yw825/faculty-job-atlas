"""
Job postings scraper for school_id 1009 - Stony Brook University (US)
ATS platform: own website
Careers link: https://stonybrook-advocate.symplicity.com/collections/reportit/4a9adc9d6aa24c3cf581ea5daa46cd25

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Stony Brook University; nothing here affects any
...
Writes school_job_posts/school_id_1009_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1009_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
