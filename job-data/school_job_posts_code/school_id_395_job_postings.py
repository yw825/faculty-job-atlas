"""
Job postings scraper for school_id 395 - University of St Francis (US)
ATS platform: own website
Careers link: https://stfrancis.edu/career-success-center/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of St Francis; nothing here affects any
...
Writes school_job_posts/school_id_395_job_posts.csv (school_id, post_link).
Checkpointed to school_id_395_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 395
SCHOOL_NAME = 'University of St Francis'
CAREERS_LINK = 'https://stfrancis.edu/career-success-center/'
