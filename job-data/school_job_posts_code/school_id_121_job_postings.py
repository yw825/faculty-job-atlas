"""
Job postings scraper for school_id 121 - University of California-Riverside (US)
ATS platform: UC Recruit (detected: ucrecruit)
Careers link: https://aprecruit.ucr.edu/apply

University of California-Riverside runs on a shared ATS platform -- every school on ucrecruit uses the
...
Writes school_job_posts/school_id_121_job_posts.csv (school_id, post_link).
Checkpointed to school_id_121_job_postings.checkpoint next to this script.
"""
import os
import sys
...
CAREERS_LINK = 'https://aprecruit.ucr.edu/apply'
