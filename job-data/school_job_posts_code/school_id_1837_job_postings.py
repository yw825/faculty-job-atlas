"""
Job postings scraper for school_id 1837 - Hong Kong Nang Yan College of Higher Education (Hong Kong)
ATS platform: 
Careers link: 

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Hong Kong Nang Yan College of Higher Education; nothing here affects any
...
Writes school_job_posts/school_id_1837_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1837_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
