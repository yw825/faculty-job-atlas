"""
Job postings scraper for school_id 982 - SUNY Oneonta (US)
ATS platform: own website
Careers link: https://oneonta.interviewexchange.com/static/clients/336ONM1/index.jsp

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for SUNY Oneonta; nothing here affects any
...
Writes school_job_posts/school_id_982_job_posts.csv (school_id, post_link).
Checkpointed to school_id_982_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 982
SCHOOL_NAME = 'SUNY Oneonta'
CAREERS_LINK = 'https://oneonta.interviewexchange.com/static/clients/336ONM1/index.jsp'
