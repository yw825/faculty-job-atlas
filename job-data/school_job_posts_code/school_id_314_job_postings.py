"""
Job postings scraper for school_id 314 - Abraham Baldwin Agricultural College (US)
ATS platform: own website
Careers link: https://www.abac.edu/about/administration/human-resources.html

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Abraham Baldwin Agricultural College; nothing here affects any
...
Writes school_job_posts/school_id_314_job_posts.csv (school_id, post_link).
Checkpointed to school_id_314_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://www.abac.edu/about/administration/human-resources.html'
