"""
Job postings scraper for school_id 1093 - Cameron University (US)
ATS platform: own website
Careers link: https://jobs.silkroad.com/Cameron/Careers/jobs/1802

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Cameron University; nothing here affects any
...
Writes school_job_posts/school_id_1093_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1093_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1093
SCHOOL_NAME = 'Cameron University'
CAREERS_LINK = 'https://jobs.silkroad.com/Cameron/Careers/jobs/1802'
