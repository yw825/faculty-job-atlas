"""
Job postings scraper for school_id 442 - Manchester University (US)
ATS platform: own website
Careers link: https://www.manchester.edu/employment-opportunities/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Manchester University; nothing here affects any
...
Writes school_job_posts/school_id_442_job_posts.csv (school_id, post_link).
Checkpointed to school_id_442_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 442
SCHOOL_NAME = 'Manchester University'
CAREERS_LINK = 'https://www.manchester.edu/employment-opportunities/'
