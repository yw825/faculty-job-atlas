"""
Job postings scraper for school_id 687 - Crown College (US)
ATS platform: UKG Ready "TA" career site (detected: ultipro_ta)
Careers link: https://secure5.entertimeonline.com/ta/CBIZ20706.careers?CareersSearch

Crown College runs on a shared ATS platform, so this calls the shared
...
requisitions (24 for Crown, including "Assistant/Associate Professor of
Nursing" and "Faculty In Residence - Worship Ministry"), and
CBIZ20706.careers?ShowJob=<id> renders each one for a human.
...
Writes school_job_posts/school_id_687_job_posts.csv (school_id, post_link).
Checkpointed to school_id_687_job_postings.checkpoint next to this script.
"""
import os
import sys
...
SCHOOL_ID = 687
SCHOOL_NAME = 'Crown College'
CAREERS_LINK = 'https://secure5.entertimeonline.com/ta/CBIZ20706.careers?CareersSearch'
