"""
Job postings scraper for school_id 1790 - University of Sydney (Australia)
ATS platform: Workday (detected: workday)
Careers link: https://usyd.wd105.myworkdayjobs.com/USYD_EXTERNAL_CAREER_SITE/jobs

University of Sydney runs on a shared ATS platform -- every school on workday uses the
...
Writes school_job_posts/school_id_1790_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1790_job_postings.checkpoint next to this script.
"""
import os
import sys
