"""
Job postings scraper for school_id 85 - University of California-Davis (US)
...
University of California-Davis runs on a shared ATS platform -- every school on ucrecruit uses the
...
Writes school_job_posts/school_id_85_job_posts.csv (school_id, post_link).
Checkpointed to school_id_85_job_postings.checkpoint next to this script.
"""
import os
import sys
