"""
Job postings scraper for school_id 1432 - Austin College (US)
ATS platform: own website
Careers link: https://www.austincollege.edu/human-resources/careers

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Austin College; nothing here affects any
...
Writes school_job_posts/school_id_1432_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1432_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1432
SCHOOL_NAME = 'Austin College'
CAREERS_LINK = 'https://www.austincollege.edu/human-resources/careers'
