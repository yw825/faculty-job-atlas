"""
Job postings scraper for school_id 1025 - Bluffton University (US)
ATS platform: own website
Careers link: https://www.bluffton.edu/academiclife/career/index.aspx

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Bluffton University; nothing here affects any
...
Writes school_job_posts/school_id_1025_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1025_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1025
SCHOOL_NAME = 'Bluffton University'
CAREERS_LINK = 'https://www.bluffton.edu/academiclife/career/index.aspx'
