"""
Job postings scraper for school_id 1697 - Aristotle University of Thessaloniki (Greece)
ATS platform: APELLA (Greece) (detected: apella)
Careers link: https://apella.minedu.gov.gr/en/positions

Aristotle University of Thessaloniki runs on a shared ATS platform -- every school on apella uses the
...
Writes school_job_posts/school_id_1697_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1697_job_postings.checkpoint next to this script.
"""
import os
import sys
