"""
Job postings scraper for school_id 805 - Meredith College (US)
ATS platform: own website
Careers link: https://meredith.career-pages.com/jobs/search

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Meredith College; nothing here affects any
...
Writes school_job_posts/school_id_805_job_posts.csv (school_id, post_link).
Checkpointed to school_id_805_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 805
SCHOOL_NAME = 'Meredith College'
CAREERS_LINK = 'https://meredith.career-pages.com/jobs/search'
