"""
Job postings scraper for school_id 1831 - City University of Hong Kong (Hong Kong)
ATS platform: own website
Careers link: https://jobs1.cityu.edu.hk/apply/Default.aspx?jobtype=ACAD

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for City University of Hong Kong; nothing here affects any
...
Writes school_job_posts/school_id_1831_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1831_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
