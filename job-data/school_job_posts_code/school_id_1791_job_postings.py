"""
Job postings scraper for school_id 1791 - University of Technology Sydney (Australia)
...
directly to fix or improve results for University of Technology Sydney; nothing here affects any
...
Writes school_job_posts/school_id_1791_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1791_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
