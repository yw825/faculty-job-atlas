"""
Job postings scraper for school_id 1110 - Pacific University (US)
ATS platform: own website
Careers link: https://www.pacificu.edu/directory/finance-administration/human-resources/jobs-pacific

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Pacific University; nothing here affects any
...
Writes school_job_posts/school_id_1110_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1110_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1110
SCHOOL_NAME = 'Pacific University'
CAREERS_LINK = 'https://www.pacificu.edu/directory/finance-administration/human-resources/jobs-pacific'
