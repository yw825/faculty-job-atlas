"""
Job postings scraper for school_id 1249 - University of Puerto Rico-Humacao (US)
ATS platform: own website
Careers link: https://www.uprh.edu/empleos/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of Puerto Rico-Humacao; nothing here affects any
...
Writes school_job_posts/school_id_1249_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1249_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1249
SCHOOL_NAME = 'University of Puerto Rico-Humacao'
CAREERS_LINK = 'https://www.uprh.edu/empleos/'
