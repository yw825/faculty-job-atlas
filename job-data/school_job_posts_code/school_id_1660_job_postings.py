"""
Job postings scraper for school_id 1660 - Vienna University of Economics and Business (Austria)
ATS platform: own website
Careers link: https://jobs.wu.ac.at/eng

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Vienna University of Economics and Business; nothing here affects any
...
Writes school_job_posts/school_id_1660_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1660_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
