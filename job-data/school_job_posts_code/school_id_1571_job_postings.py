"""
Job postings scraper for school_id 1571 - Davis & Elkins College (US)
ATS platform: own website
Careers link: https://www.dewv.edu/explore/employment/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Davis & Elkins College; nothing here affects any
...
Writes school_job_posts/school_id_1571_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1571_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1571
SCHOOL_NAME = 'Davis & Elkins College'
CAREERS_LINK = 'https://www.dewv.edu/explore/employment/'
