"""
Job postings scraper for school_id 553 - Stonehill College (US)
ATS platform: own website
Careers link: https://jobs.stonehill.edu/hr/sessions/new

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Stonehill College; nothing here affects any
...
Writes school_job_posts/school_id_553_job_posts.csv (school_id, post_link).
Checkpointed to school_id_553_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 553
SCHOOL_NAME = 'Stonehill College'
CAREERS_LINK = 'https://jobs.stonehill.edu/hr/sessions/new'
