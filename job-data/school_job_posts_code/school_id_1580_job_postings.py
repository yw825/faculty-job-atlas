"""
Job postings scraper for school_id 1580 - Shepherd University (US)
ATS platform: PeopleAdmin (detected: peopleadmin)
Careers link: https://jobs-shepherd.peopleadmin.com/

Shepherd University runs on a shared ATS platform -- every school on peopleadmin uses the
...
Writes school_job_posts/school_id_1580_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1580_job_postings.checkpoint next to this script.
"""
import os
import sys
...
SCHOOL_ID = 1580
SCHOOL_NAME = 'Shepherd University'
CAREERS_LINK = 'https://jobs-shepherd.peopleadmin.com/'
