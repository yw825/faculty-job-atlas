"""
Job postings scraper for school_id 184 - Quinnipiac University (US)
ATS platform: own website
Careers link: https://career.qu.edu/en-us/filter/?job-mail-subscribe-privacy=agree&search-keyword=&category=faculty

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Quinnipiac University; nothing here affects any
...
Writes school_job_posts/school_id_184_job_posts.csv (school_id, post_link).
Checkpointed to school_id_184_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://career.qu.edu/en-us/filter/?job-mail-subscribe-privacy=agree&search-keyword=&category=faculty'
