"""
Job postings scraper for school_id 606 - St. Mary's College of Maryland (US)
ATS platform: own website
Careers link: https://apply.interfolio.com/190337

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for St. Mary's College of Maryland; nothing here affects any
...
Writes school_job_posts/school_id_606_job_posts.csv (school_id, post_link).
Checkpointed to school_id_606_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
