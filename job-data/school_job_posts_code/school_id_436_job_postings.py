"""
Job postings scraper for school_id 436 - University of Indianapolis (US)
ATS platform: own website
Careers link: https://hrjobs.uindy.edu

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of Indianapolis; nothing here affects any
...
Writes school_job_posts/school_id_436_job_posts.csv (school_id, post_link).
Checkpointed to school_id_436_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 436
SCHOOL_NAME = 'University of Indianapolis'
CAREERS_LINK = 'https://hrjobs.uindy.edu'
