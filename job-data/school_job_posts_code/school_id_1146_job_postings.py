"""
Job postings scraper for school_id 1146 - Delaware Valley University (US)
ATS platform: own website
Careers link: https://delval.edu/careers-delval

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Delaware Valley University; nothing here affects any
...
Writes school_job_posts/school_id_1146_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1146_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1146
SCHOOL_NAME = 'Delaware Valley University'
CAREERS_LINK = 'https://delval.edu/careers-delval'
