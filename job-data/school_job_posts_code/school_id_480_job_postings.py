"""
Job postings scraper for school_id 480 - Newman University (US)
ATS platform: own website
Careers link: https://newmanu.edu/administration/human-resources/job-openings

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Newman University; nothing here affects any
...
Writes school_job_posts/school_id_480_job_posts.csv (school_id, post_link).
Checkpointed to school_id_480_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 480
SCHOOL_NAME = 'Newman University'
CAREERS_LINK = 'https://newmanu.edu/administration/human-resources/job-openings'
