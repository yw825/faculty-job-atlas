"""
Job postings scraper for school_id 146 - University of California-Santa Barbara (US)
ATS platform: UC Recruit (detected: ucrecruit)
Careers link: http://recruit.ap.ucsb.edu/apply

University of California-Santa Barbara runs on a shared ATS platform -- every school on ucrecruit uses the
...
Writes school_job_posts/school_id_146_job_posts.csv (school_id, post_link).
Checkpointed to school_id_146_job_postings.checkpoint next to this script.
"""
import os
import sys
