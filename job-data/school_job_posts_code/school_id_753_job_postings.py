"""
Job postings scraper for school_id 753 - Millsaps College (US)
ATS platform: own website
Careers link: https://millsaps.edu/work-at-millsaps/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Millsaps College; nothing here affects any
...
Writes school_job_posts/school_id_753_job_posts.csv (school_id, post_link).
Checkpointed to school_id_753_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 753
SCHOOL_NAME = 'Millsaps College'
CAREERS_LINK = 'https://millsaps.edu/work-at-millsaps/'
