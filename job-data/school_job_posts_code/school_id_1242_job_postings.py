"""
Job postings scraper for school_id 1242 - University of Puerto Rico-Carolina (US)
ATS platform: own website
Careers link: https://carolina-upr-csm.symplicity.com/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of Puerto Rico-Carolina; nothing here affects any
...
Writes school_job_posts/school_id_1242_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1242_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1242
SCHOOL_NAME = 'University of Puerto Rico-Carolina'
CAREERS_LINK = 'https://carolina-upr-csm.symplicity.com/'
