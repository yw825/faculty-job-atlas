"""
Job postings scraper for school_id 1078 - The College of Wooster (US)
ATS platform: own website
Careers link: https://wooster.edu/employment/jobs

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for The College of Wooster; nothing here affects any
...
Writes school_job_posts/school_id_1078_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1078_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1078
SCHOOL_NAME = 'The College of Wooster'
CAREERS_LINK = 'https://wooster.edu/employment/jobs'
