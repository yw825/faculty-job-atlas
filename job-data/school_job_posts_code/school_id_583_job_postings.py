"""
Job postings scraper for school_id 583 - Clark University (US)
ATS platform: own website
Careers link: https://clarku.interviewexchange.com/static/clients/569CUM1/index.jsp

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Clark University; nothing here affects any
other school's script.

Link check (ok): 31 posting-shaped links found -- rendered.
...
Writes school_job_posts/school_id_583_job_posts.csv (school_id, post_link).
Checkpointed to school_id_583_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://clarku.interviewexchange.com/static/clients/569CUM1/index.jsp'
