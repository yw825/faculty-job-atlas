"""
Job postings scraper for school_id 736 - Webster University (US)
ATS platform: own website
Careers link: https://recruiting.adp.com/srccar/public/RTI.home?c=1180715&d=ExternalCareerSite

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Webster University; nothing here affects any
...
Writes school_job_posts/school_id_736_job_posts.csv (school_id, post_link).
Checkpointed to school_id_736_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
def find_links():
    ...
    """CUSTOMIZED: careers_link was corrected by hand (ADP board renders a landing page needing interaction).
