"""
Job postings scraper for school_id 529 - Nicholls State University (US)
ATS platform: PeopleAdmin (detected: peopleadmin)
Careers link: https://jobs.nicholls.edu

Nicholls State University runs on a shared ATS platform -- every school on peopleadmin uses the
...
Writes school_job_posts/school_id_529_job_posts.csv (school_id, post_link).
Checkpointed to school_id_529_job_postings.checkpoint next to this script.
"""
import os
import sys
