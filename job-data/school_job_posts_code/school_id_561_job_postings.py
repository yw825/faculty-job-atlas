"""
Job postings scraper for school_id 561 - Lasell University (US)
ATS platform: own website
Careers link: https://www.lasell.edu/discover-lasell/employment/about-human-resources.html#nav

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Lasell University; nothing here affects any
...
Writes school_job_posts/school_id_561_job_posts.csv (school_id, post_link).
Checkpointed to school_id_561_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 561
SCHOOL_NAME = 'Lasell University'
CAREERS_LINK = 'https://www.lasell.edu/discover-lasell/employment/about-human-resources.html#nav'
