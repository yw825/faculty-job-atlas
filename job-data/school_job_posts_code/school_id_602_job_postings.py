"""
Job postings scraper for school_id 602 - Capitol Technology University (US)
ATS platform: own website
Careers link: https://captechu-csm.symplicity.com/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Capitol Technology University; nothing here affects any
...
Writes school_job_posts/school_id_602_job_posts.csv (school_id, post_link).
Checkpointed to school_id_602_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 602
SCHOOL_NAME = 'Capitol Technology University'
CAREERS_LINK = 'https://captechu-csm.symplicity.com/'
