"""
Job postings scraper for school_id 829 - Bellevue University (US)
...
Bellevue University runs on a shared ATS platform -- every school on adp uses the
...
Writes school_job_posts/school_id_829_job_posts.csv (school_id, post_link).
Checkpointed to school_id_829_job_postings.checkpoint next to this script.
"""
import os
import sys
