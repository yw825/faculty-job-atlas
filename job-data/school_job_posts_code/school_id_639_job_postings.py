"""
Job postings scraper for school_id 639 - University of Michigan-Flint (US)
ATS platform: own website
Careers link: https://careers.umich.edu/search-jobs

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of Michigan-Flint; nothing here affects any
other school's script.

Link check (ok): 8 posting-shaped links found -- [shared URL].

NOTE: 3 schools list against this same URL, so this listing carries every one of their postings, not just this school's: University of Michigan-Ann Arbor, University of Michigan-Dearborn.
...
Writes school_job_posts/school_id_639_job_posts.csv (school_id, post_link).
Checkpointed to school_id_639_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 639
SCHOOL_NAME = 'University of Michigan-Flint'
