"""
Job postings scraper for school_id 1424 - St. Mary's University (US)
ATS platform: own website
Careers link: https://www.stmarytx.edu/about/jobs/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for St. Mary's University; nothing here affects any
...
Writes school_job_posts/school_id_1424_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1424_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1424
SCHOOL_NAME = 'St. Mary\'s University'
CAREERS_LINK = 'https://www.stmarytx.edu/about/jobs/'
