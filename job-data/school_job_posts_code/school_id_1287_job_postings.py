"""
Job postings scraper for school_id 1287 - University of South Carolina-Columbia (US)
ATS platform: own website
Careers link: https://www.sc.edu/experience/career-prep/index.php

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of South Carolina-Columbia; nothing here affects any
...
Writes school_job_posts/school_id_1287_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1287_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1287
SCHOOL_NAME = 'University of South Carolina-Columbia'
CAREERS_LINK = 'https://www.sc.edu/experience/career-prep/index.php'
