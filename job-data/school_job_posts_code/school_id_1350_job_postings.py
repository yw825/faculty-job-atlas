"""
Job postings scraper for school_id 1350 - Middle Tennessee State University (US)
ATS platform: own website
Careers link: https://careers.mtsu.edu/en-us/listing/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Middle Tennessee State University; nothing here affects any
...
Writes school_job_posts/school_id_1350_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1350_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://careers.mtsu.edu/en-us/listing/'
