"""
Job postings scraper for school_id 1199 - Duquesne University
ATS platform: Interfolio (detected: interfolio)
Careers link: https://apply.interfolio.com/11181/positions

Duquesne University runs on a shared ATS platform, so this calls the shared
...
Writes school_job_posts/school_id_1199_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1199_job_postings.checkpoint next to this script.
"""
import os
import sys
...
SCHOOL_ID = 1199
SCHOOL_NAME = 'Duquesne University'
CAREERS_LINK = 'https://apply.interfolio.com/11181/positions'
