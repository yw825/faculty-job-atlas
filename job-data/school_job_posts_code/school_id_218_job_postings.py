"""
Job postings scraper for school_id 218 - Webber International University (US)
ATS platform: own website
Careers link: https://www.webber.edu/jobs-at-webber/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Webber International University; nothing here affects any
...
Writes school_job_posts/school_id_218_job_posts.csv (school_id, post_link).
Checkpointed to school_id_218_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 218
SCHOOL_NAME = 'Webber International University'
CAREERS_LINK = 'https://www.webber.edu/jobs-at-webber/'
