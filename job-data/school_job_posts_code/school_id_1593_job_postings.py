"""
Job postings scraper for school_id 1593 - Vancouver Island University (Canada)
ATS platform: own website
Careers link: https://careers.viu.ca/vacancies.html

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Vancouver Island University; nothing here affects any
...
Writes school_job_posts/school_id_1593_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1593_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
