"""
Job postings scraper for school_id 188 - Charter Oak State College (US)
ATS platform: own website
Careers link: https://www.charteroak.edu/aboutus/employment.php

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Charter Oak State College; nothing here affects any
...
Writes school_job_posts/school_id_188_job_posts.csv (school_id, post_link).
Checkpointed to school_id_188_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 188
SCHOOL_NAME = 'Charter Oak State College'
CAREERS_LINK = 'https://www.charteroak.edu/aboutus/employment.php'
