"""
Job postings scraper for school_id 1618 - University of Guelph (Canada)
ATS platform: own website
Careers link: https://careers.uoguelph.ca/go/Faculty%2C-Librarian-and-Veterinarian/8665747/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of Guelph; nothing here affects any
...
Writes school_job_posts/school_id_1618_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1618_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
