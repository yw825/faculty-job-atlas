"""
Job postings scraper for school_id 885 - Thomas Edison State University (US)
ATS platform: own website
Careers link: https://tesu.elluciancrmrecruit.com/Apply/Account/ProspectInquiry?f=a5c390e3-cba0-4376-b596-8fba5466af6e&o=8a362f72-262c-48bc-a36d-c5d6e0f75af6&s=c1a80143-768e-e311-a614-00155d01181f

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Thomas Edison State University; nothing here affects any
...
Writes school_job_posts/school_id_885_job_posts.csv (school_id, post_link).
Checkpointed to school_id_885_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
def find_links():
    ...
    """CUSTOMIZED: careers_link was corrected by hand (was an Ellucian student ADMISSIONS form).
