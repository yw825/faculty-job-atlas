"""
Job postings scraper for school_id 872 - Drew University (US)
ATS platform: own website
Careers link: https://drew.edu/about/human-resources/employment-opportunities/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Drew University; nothing here affects any
other school's script.

Link check (ok): 31 posting-shaped links found.
...
Writes school_job_posts/school_id_872_job_posts.csv (school_id, post_link).
Checkpointed to school_id_872_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 872
SCHOOL_NAME = 'Drew University'
CAREERS_LINK = 'https://drew.edu/about/human-resources/employment-opportunities/'
