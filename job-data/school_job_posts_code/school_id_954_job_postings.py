"""
Job postings scraper for school_id 954 - State University of New York at New Paltz (US)
ATS platform: own website
Careers link: https://www.newpaltz.edu/hr/displayjobs.php?type=Faculty

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for State University of New York at New Paltz; nothing here affects any
other school's script.

Link check (ok): 6 posting-shaped links found -- rendered.
...
Writes school_job_posts/school_id_954_job_posts.csv (school_id, post_link).
Checkpointed to school_id_954_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://www.newpaltz.edu/hr/displayjobs.php?type=Faculty'
ATS_PLATFORM = 'own website'

CHECKPOINT_PATH = os.path.join(HERE, f'school_id_{SCHOOL_ID}_job_postings.checkpoint')


POSTING_PATTERN = 'www.newpaltz.edu/hr/employment-opportunities/<*>'
...
def find_links():
    ...
    (title_role=0 degree=0 furniture=2 len=4865; title_role=0 degree=0 furniture=0 len=3613).

        www.newpaltz.edu/hr/employment-opportunities/<*>

    The generic job-word filter returned 5 link(s) here against 6
