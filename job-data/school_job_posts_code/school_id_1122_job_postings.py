"""
Job postings scraper for school_id 1122 - Corban University (US)
ATS platform: own website
Careers link: https://www.corban.edu/human-resources/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Corban University; nothing here affects any
...
Writes school_job_posts/school_id_1122_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1122_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1122
SCHOOL_NAME = 'Corban University'
CAREERS_LINK = 'https://www.corban.edu/human-resources/'
