"""
Job postings scraper for school_id 1098 - Oklahoma City University (US)
ATS platform: own website
Careers link: https://careers.okcu.edu/jobs/search

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Oklahoma City University; nothing here affects any
...
Writes school_job_posts/school_id_1098_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1098_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1098
SCHOOL_NAME = 'Oklahoma City University'
CAREERS_LINK = 'https://careers.okcu.edu/jobs/search'
