"""
Job postings scraper for school_id 1769 - University of Leeds (United Kingdom)
ATS platform: own website
Careers link: https://jobs.leeds.ac.uk/vacancies.aspx?cat=200

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of Leeds; nothing here affects any
...
Writes school_job_posts/school_id_1769_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1769_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
