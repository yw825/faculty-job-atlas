"""
Job postings scraper for school_id 203 - Gallaudet University (US)
ATS platform: own website
Careers link: https://gallaudet.edu/academic-career-success/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Gallaudet University; nothing here affects any
...
Writes school_job_posts/school_id_203_job_posts.csv (school_id, post_link).
Checkpointed to school_id_203_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 203
SCHOOL_NAME = 'Gallaudet University'
CAREERS_LINK = 'https://gallaudet.edu/academic-career-success/'
