"""
Job postings scraper for school_id 1721 - Erasmus University Rotterdam (Netherlands)
ATS platform: own website
Careers link: https://www.eur.nl/en/working-at-eur/vacancies/overview

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Erasmus University Rotterdam; nothing here affects any
