"""
Job postings scraper for school_id 209 - Trinity Washington University (US)
ATS platform: own website
Careers link: https://www2.trinitydc.edu/hr/employment-openings/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Trinity Washington University; nothing here affects any
...
Writes school_job_posts/school_id_209_job_posts.csv (school_id, post_link).
Checkpointed to school_id_209_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 209
SCHOOL_NAME = 'Trinity Washington University'
CAREERS_LINK = 'https://www2.trinitydc.edu/hr/employment-openings/'
