"""
Job postings scraper for school_id 1297 - Coker University (US)
ATS platform: own website
Careers link: https://www.coker.edu/offices-services/careers/faculty-jobs/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Coker University; nothing here affects any
...
Writes school_job_posts/school_id_1297_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1297_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1297
SCHOOL_NAME = 'Coker University'
CAREERS_LINK = 'https://www.coker.edu/offices-services/careers/faculty-jobs/'
