"""
Job postings scraper for school_id 905 - Excelsior University (US)
ATS platform: own website
Careers link: https://www.excelsior.edu/career-training

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Excelsior University; nothing here affects any
...
Writes school_job_posts/school_id_905_job_posts.csv (school_id, post_link).
Checkpointed to school_id_905_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 905
SCHOOL_NAME = 'Excelsior University'
CAREERS_LINK = 'https://www.excelsior.edu/career-training'
