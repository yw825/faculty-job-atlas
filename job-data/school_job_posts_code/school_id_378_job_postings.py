"""
Job postings scraper for school_id 378 - North Park University (US)
ATS platform: own website
Careers link: https://apply.workable.com/north-park-university/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for North Park University; nothing here affects any
...
Writes school_job_posts/school_id_378_job_posts.csv (school_id, post_link).
Checkpointed to school_id_378_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 378
SCHOOL_NAME = 'North Park University'
CAREERS_LINK = 'https://apply.workable.com/north-park-university/'
