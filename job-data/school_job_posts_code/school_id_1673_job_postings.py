"""
Job postings scraper for school_id 1673 - University of Turku (Finland)
ATS platform: own website
Careers link: https://www.utu.fi/en/university/come-work-with-us/open-vacancies

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of Turku; nothing here affects any
...
Writes school_job_posts/school_id_1673_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1673_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
