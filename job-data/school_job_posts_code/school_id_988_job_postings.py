"""
Job postings scraper for school_id 988 - SUNY College at Potsdam (US)
ATS platform: own website
Careers link: https://employment.potsdam.edu/postings/search

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for SUNY College at Potsdam; nothing here affects any
...
Writes school_job_posts/school_id_988_job_posts.csv (school_id, post_link).
Checkpointed to school_id_988_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 988
SCHOOL_NAME = 'SUNY College at Potsdam'
CAREERS_LINK = 'https://employment.potsdam.edu/postings/search'
