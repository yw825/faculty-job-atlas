"""
Job postings scraper for school_id 1858 - Nanyang Technological University (Singapore)
ATS platform: Workday (detected: workday)
Careers link: https://ntu.wd3.myworkdayjobs.com/Careers

Nanyang Technological University runs on a shared ATS platform -- every school on workday uses the
...
Writes school_job_posts/school_id_1858_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1858_job_postings.checkpoint next to this script.
"""
import os
import sys
