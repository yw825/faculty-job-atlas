"""
Job postings scraper for school_id 734 - University of Missouri-St Louis (US)
ATS platform: own website
Careers link: https://www.umsl.edu/services/hrs/careers/index.html

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of Missouri-St Louis; nothing here affects any
...
Writes school_job_posts/school_id_734_job_posts.csv (school_id, post_link).
Checkpointed to school_id_734_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 734
SCHOOL_NAME = 'University of Missouri-St Louis'
CAREERS_LINK = 'https://www.umsl.edu/services/hrs/careers/index.html'
