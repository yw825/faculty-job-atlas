"""
Job postings scraper for school_id 1838 - Hong Kong Shue Yan University (Hong Kong)
ATS platform: own website
Careers link: https://www.hksyu.edu/en/snippets/external-vacancy

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Hong Kong Shue Yan University; nothing here affects any
...
Writes school_job_posts/school_id_1838_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1838_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
