"""
Job postings scraper for school_id 1480 - Christopher Newport University (US)
ATS platform: PeopleAdmin (detected: peopleadmin)
Careers link: https://jobs.cnu.edu/

Christopher Newport University runs on a shared ATS platform -- every school on peopleadmin uses the
...
Writes school_job_posts/school_id_1480_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1480_job_postings.checkpoint next to this script.
"""
import os
import sys
...
CAREERS_LINK = 'https://jobs.cnu.edu/'
