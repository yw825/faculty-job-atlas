"""
Job postings scraper for school_id 580 - Regis College (US)
ATS platform: own website
Careers link: https://www.regiscollege.edu/about-regis/administrative-offices/department-human-resources/working-regis

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Regis College; nothing here affects any
...
Writes school_job_posts/school_id_580_job_posts.csv (school_id, post_link).
Checkpointed to school_id_580_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 580
SCHOOL_NAME = 'Regis College'
CAREERS_LINK = 'https://www.regiscollege.edu/about-regis/administrative-offices/department-human-resources/working-regis'
