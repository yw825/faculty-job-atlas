"""
Job postings scraper for school_id 1468 - University of Mary Washington (US)
ATS platform: own website
Careers link: https://jobs.umw.edu

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of Mary Washington; nothing here affects any
...
Writes school_job_posts/school_id_1468_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1468_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1468
SCHOOL_NAME = 'University of Mary Washington'
CAREERS_LINK = 'https://jobs.umw.edu'
