"""
Job postings scraper for school_id 703 - Culver-Stockton College (US)
ATS platform: own website
Careers link: https://culver.edu/gps-core/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Culver-Stockton College; nothing here affects any
...
Writes school_job_posts/school_id_703_job_posts.csv (school_id, post_link).
Checkpointed to school_id_703_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 703
SCHOOL_NAME = 'Culver-Stockton College'
CAREERS_LINK = 'https://culver.edu/gps-core/'
