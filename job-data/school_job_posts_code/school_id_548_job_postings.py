"""
Job postings scraper for school_id 548 - Lesley University (US)
ATS platform: own website
Careers link: https://lesley.edu/my-organizations-goals/recruit-talent/priority-job-matching-program

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Lesley University; nothing here affects any
...
Writes school_job_posts/school_id_548_job_posts.csv (school_id, post_link).
Checkpointed to school_id_548_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 548
SCHOOL_NAME = 'Lesley University'
CAREERS_LINK = 'https://lesley.edu/my-organizations-goals/recruit-talent/priority-job-matching-program'
