"""
Job postings scraper for school_id 302 - Middle Georgia State University (US)
ATS platform: own website
Careers link: https://www.mga.edu/human-resources/jobs/index.php

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Middle Georgia State University; nothing here affects any
...
Writes school_job_posts/school_id_302_job_posts.csv (school_id, post_link).
Checkpointed to school_id_302_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 302
SCHOOL_NAME = 'Middle Georgia State University'
CAREERS_LINK = 'https://www.mga.edu/human-resources/jobs/index.php'
