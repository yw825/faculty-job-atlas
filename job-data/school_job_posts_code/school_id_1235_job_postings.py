"""
Job postings scraper for school_id 1235 - American University of Puerto Rico (US)
ATS platform: own website
Careers link: https://aupr.edu/empleo-remunerado/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for American University of Puerto Rico; nothing here affects any
other school's script.

Link check (review): 0 posting-shaped links found -- rendered no job-shaped links found [shared URL].

NOTE: 2 schools list against this same URL, so this listing carries every one of their postings, not just this school's: .
...
Writes school_job_posts/school_id_1235_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1235_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1235
SCHOOL_NAME = 'American University of Puerto Rico'
CAREERS_LINK = 'https://aupr.edu/empleo-remunerado/'
