"""
Job postings scraper for school_id 1212 - Susquehanna University (US)
ATS platform: own website
Careers link: https://www.governmentjobs.com/careers/susqu/faculty?jobType[0]=Faculty&sort=PositionTitle%7CAscending

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Susquehanna University; nothing here affects any
...
Writes school_job_posts/school_id_1212_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1212_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1212
SCHOOL_NAME = 'Susquehanna University'
CAREERS_LINK = 'https://www.governmentjobs.com/careers/susqu/faculty?jobType[0]=Faculty&sort=PositionTitle%7CAscending'
