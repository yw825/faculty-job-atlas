"""
Job postings scraper for school_id 1423 - Our Lady of the Lake University (US)
ATS platform: own website
Careers link: https://ollusa.interviewexchange.com/static/clients/485OLM1/index.jsp

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Our Lady of the Lake University; nothing here affects any
other school's script.

Link check (ok): 46 posting-shaped links found -- rendered.
...
Writes school_job_posts/school_id_1423_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1423_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://ollusa.interviewexchange.com/static/clients/485OLM1/index.jsp'
