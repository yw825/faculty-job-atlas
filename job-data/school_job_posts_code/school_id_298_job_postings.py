"""
Job postings scraper for school_id 298 - LaGrange College (US)
ATS platform: own website
Careers link: https://lagrangecollege.applicantstack.com/x/openings

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for LaGrange College; nothing here affects any
...
Writes school_job_posts/school_id_298_job_posts.csv (school_id, post_link).
Checkpointed to school_id_298_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 298
SCHOOL_NAME = 'LaGrange College'
CAREERS_LINK = 'https://lagrangecollege.applicantstack.com/x/openings'
