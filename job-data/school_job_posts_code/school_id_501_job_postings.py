"""
Job postings scraper for school_id 501 - Murray State University (US)
ATS platform: own website
Careers link: https://www.murraystatejobs.com/postings/search

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Murray State University; nothing here affects any
other school's script.

Link check (ok): 47 posting-shaped links found.
...
Writes school_job_posts/school_id_501_job_posts.csv (school_id, post_link).
Checkpointed to school_id_501_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://www.murraystatejobs.com/postings/search'
