"""
Job postings scraper for school_id 1339 - The University of Tennessee-Knoxville (US)
ATS platform: own website
Careers link: https://hr.utk.edu/faculty-positions/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for The University of Tennessee-Knoxville; nothing here affects any
...
Writes school_job_posts/school_id_1339_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1339_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://hr.utk.edu/faculty-positions/'
