"""
Job postings scraper for school_id 1750 - Stockholm School of Economics (Sweden)
ATS platform: own website
Careers link: https://jobs.hhs.se/job-vacancies

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Stockholm School of Economics; nothing here affects any
...
Writes school_job_posts/school_id_1750_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1750_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
