"""
Job postings scraper for school_id 769 - Belmont Abbey College (US)
ATS platform: own website
Careers link: https://belmontabbeycollege.edu/about-us/employment

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Belmont Abbey College; nothing here affects any
...
Writes school_job_posts/school_id_769_job_posts.csv (school_id, post_link).
Checkpointed to school_id_769_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 769
SCHOOL_NAME = 'Belmont Abbey College'
CAREERS_LINK = 'https://belmontabbeycollege.edu/about-us/employment'
ATS_PLATFORM = 'own website'

CHECKPOINT_PATH = os.path.join(HERE, f'school_id_{SCHOOL_ID}_job_postings.checkpoint')


POSTING_PATTERN = 'belmontabbeycollege.edu/about-us/employment/<*>'
...
def find_links():
    ...
    (title_role=1 degree=0 furniture=3 len=9534; title_role=1 degree=0 furniture=2 len=10349).

        belmontabbeycollege.edu/about-us/employment/<*>

    The generic job-word filter returned 3 link(s) here against 7
