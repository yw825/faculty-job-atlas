"""
Job postings scraper for school_id 762 - The University of Montana-Western (US)
ATS platform: own website
Careers link: https://www.umwestern.edu/section/vacancy-procedure-documents/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for The University of Montana-Western; nothing here affects any
...
Writes school_job_posts/school_id_762_job_posts.csv (school_id, post_link).
Checkpointed to school_id_762_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 762
SCHOOL_NAME = 'The University of Montana-Western'
CAREERS_LINK = 'https://www.umwestern.edu/section/vacancy-procedure-documents/'
