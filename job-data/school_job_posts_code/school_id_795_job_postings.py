"""
Job postings scraper for school_id 795 - Lenoir-Rhyne University (US)
ATS platform: own website
Careers link: https://www.lr.edu/work-at-lr/human-resources

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Lenoir-Rhyne University; nothing here affects any
...
Writes school_job_posts/school_id_795_job_posts.csv (school_id, post_link).
Checkpointed to school_id_795_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 795
SCHOOL_NAME = 'Lenoir-Rhyne University'
CAREERS_LINK = 'https://www.lr.edu/work-at-lr/human-resources'
