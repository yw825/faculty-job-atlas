"""
Job postings scraper for school_id 332 - Mount Mercy University (US)
ATS platform: own website
Careers link: https://www.mtmercy.edu/careers/index.php

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Mount Mercy University; nothing here affects any
...
Writes school_job_posts/school_id_332_job_posts.csv (school_id, post_link).
Checkpointed to school_id_332_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 332
SCHOOL_NAME = 'Mount Mercy University'
CAREERS_LINK = 'https://www.mtmercy.edu/careers/index.php'
