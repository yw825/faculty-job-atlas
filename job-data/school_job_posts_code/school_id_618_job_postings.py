"""
Job postings scraper for school_id 618 - Bates College (US)
ATS platform: own website
Careers link: https://www.bates.edu/career/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Bates College; nothing here affects any
...
Writes school_job_posts/school_id_618_job_posts.csv (school_id, post_link).
Checkpointed to school_id_618_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://www.bates.edu/career/'
ATS_PLATFORM = 'own website'

CHECKPOINT_PATH = os.path.join(HERE, f'school_id_{SCHOOL_ID}_job_postings.checkpoint')


POSTING_PATTERN = 'www.bates.edu/purposeful-work/<*>'
...
def find_links():
    ...
    (title_role=0 degree=0 furniture=2 len=7160; title_role=0 degree=0 furniture=1 len=4290).

        www.bates.edu/purposeful-work/<*>

    The generic job-word filter returned 9 link(s) here against 33
