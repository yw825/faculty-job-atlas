"""
Job postings scraper for school_id 546 - Massachusetts Maritime Academy (US)
ATS platform: own website
Careers link: https://www.maritime.edu/human-resources/employment-opportunities

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Massachusetts Maritime Academy; nothing here affects any
...
Writes school_job_posts/school_id_546_job_posts.csv (school_id, post_link).
Checkpointed to school_id_546_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 546
SCHOOL_NAME = 'Massachusetts Maritime Academy'
CAREERS_LINK = 'https://www.maritime.edu/human-resources/employment-opportunities'
