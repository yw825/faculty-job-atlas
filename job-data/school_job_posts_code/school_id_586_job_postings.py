"""
Job postings scraper for school_id 586 - Worcester State University (US)
ATS platform: own website
Careers link: https://worcester.interviewexchange.com/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Worcester State University; nothing here affects any
other school's script.

Link check (ok): 113 posting-shaped links found -- rendered.
...
Writes school_job_posts/school_id_586_job_posts.csv (school_id, post_link).
Checkpointed to school_id_586_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 586
SCHOOL_NAME = 'Worcester State University'
CAREERS_LINK = 'https://worcester.interviewexchange.com/'
