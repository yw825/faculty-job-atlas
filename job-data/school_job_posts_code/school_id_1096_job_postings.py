"""
Job postings scraper for school_id 1096 - University of Oklahoma-Norman Campus (US)
ATS platform: own website
Careers link: https://jobs.ou.edu/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of Oklahoma-Norman Campus; nothing here affects any
...
Writes school_job_posts/school_id_1096_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1096_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1096
SCHOOL_NAME = 'University of Oklahoma-Norman Campus'
CAREERS_LINK = 'https://jobs.ou.edu/'
