"""
Job postings scraper for school_id 1262 - University of Puerto Rico-Rio Piedras (US)
ATS platform: own website
Careers link: https://recursoshumanos.uprrp.edu/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of Puerto Rico-Rio Piedras; nothing here affects any
...
Writes school_job_posts/school_id_1262_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1262_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1262
SCHOOL_NAME = 'University of Puerto Rico-Rio Piedras'
CAREERS_LINK = 'https://recursoshumanos.uprrp.edu/'
