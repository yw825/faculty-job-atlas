"""
Job postings scraper for school_id 271 - Georgia Southwestern State University (US)
ATS platform: own website
Careers link: https://www.gsw.edu/human-resources/careers

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Georgia Southwestern State University; nothing here affects any
...
Writes school_job_posts/school_id_271_job_posts.csv (school_id, post_link).
Checkpointed to school_id_271_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 271
SCHOOL_NAME = 'Georgia Southwestern State University'
CAREERS_LINK = 'https://www.gsw.edu/human-resources/careers'
