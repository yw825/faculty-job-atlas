"""
Job postings scraper for school_id 1588 - Burman University (Canada)
ATS platform: own website
Careers link: https://www.burmanu.ca/careers

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Burman University; nothing here affects any
...
Writes school_job_posts/school_id_1588_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1588_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
