"""
Job postings scraper for school_id 1060 - Muskingum University (US)
ATS platform: own website
Careers link: https://www.muskingum.edu/human-resources/careers

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Muskingum University; nothing here affects any
...
Writes school_job_posts/school_id_1060_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1060_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1060
SCHOOL_NAME = 'Muskingum University'
CAREERS_LINK = 'https://www.muskingum.edu/human-resources/careers'
ATS_PLATFORM = 'own website'

CHECKPOINT_PATH = os.path.join(HERE, f'school_id_{SCHOOL_ID}_job_postings.checkpoint')


POSTING_PATTERN = 'www.muskingum.edu/human-resources/<*>'
...
def find_links():
    ...
    (title_role=1 degree=0 furniture=3 len=8241; title_role=0 degree=0 furniture=3 len=7608).

        www.muskingum.edu/human-resources/<*>

    The generic job-word filter returned 3 link(s) here against 11
