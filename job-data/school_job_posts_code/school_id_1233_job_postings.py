"""
Job postings scraper for school_id 1233 - University of Puerto Rico-Arecibo (US)
ATS platform: own website
Careers link: https://upra.edu/recursos-humanos/convocatorias/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of Puerto Rico-Arecibo; nothing here affects any
...
Writes school_job_posts/school_id_1233_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1233_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1233
SCHOOL_NAME = 'University of Puerto Rico-Arecibo'
CAREERS_LINK = 'https://upra.edu/recursos-humanos/convocatorias/'
