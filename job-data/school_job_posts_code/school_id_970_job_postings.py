"""
Job postings scraper for school_id 970 - New York University (US)
ATS platform: own website
Careers link: https://www.nyu.edu/about/university-initiatives/nyu-irl.html

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for New York University; nothing here affects any
...
Writes school_job_posts/school_id_970_job_posts.csv (school_id, post_link).
Checkpointed to school_id_970_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://www.nyu.edu/about/university-initiatives/nyu-irl.html'
