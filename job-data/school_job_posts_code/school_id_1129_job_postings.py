"""
Job postings scraper for school_id 1129 - Neumann University (US)
ATS platform: own website
Careers link: https://www.neumann.edu/about/humanresources/employment#Faculty

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Neumann University; nothing here affects any
...
Writes school_job_posts/school_id_1129_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1129_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1129
SCHOOL_NAME = 'Neumann University'
CAREERS_LINK = 'https://www.neumann.edu/about/humanresources/employment#Faculty'
