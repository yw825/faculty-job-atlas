"""
Job postings scraper for school_id 1023 - Ohio University-Main Campus (US)
...
directly to fix or improve results for Ohio University-Main Campus; nothing here affects any
...
Writes school_job_posts/school_id_1023_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1023_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
