"""
Job postings scraper for school_id 979 - New York Institute of Technology (US)
ATS platform: own website
Careers link: https://www.nyit.edu/human_resources/careers

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for New York Institute of Technology; nothing here affects any
...
Writes school_job_posts/school_id_979_job_posts.csv (school_id, post_link).
Checkpointed to school_id_979_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://www.nyit.edu/human_resources/careers'
