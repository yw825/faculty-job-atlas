"""
Job postings scraper for school_id 825 - University of Jamestown (US)
ATS platform: own website
Careers link: https://www.uj.edu/about/job-opportunities/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of Jamestown; nothing here affects any
...
Writes school_job_posts/school_id_825_job_posts.csv (school_id, post_link).
Checkpointed to school_id_825_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 825
SCHOOL_NAME = 'University of Jamestown'
CAREERS_LINK = 'https://www.uj.edu/about/job-opportunities/'
