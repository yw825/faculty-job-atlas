"""
Job postings scraper for school_id 1885 - Munster Technological University (Ireland)
ATS platform: CoreHR
Careers link: https://my.corehr.com/pls/mturecruit/erq_search_version_4.start_search_with_params

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Munster Technological University; nothing here affects any
...
Writes school_job_posts/school_id_1885_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1885_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://my.corehr.com/pls/mturecruit/erq_search_version_4.start_search_with_params'
ATS_PLATFORM = 'CoreHR'
