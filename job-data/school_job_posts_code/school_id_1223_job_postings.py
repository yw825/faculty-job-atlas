"""
Job postings scraper for school_id 1223 - West Chester University of Pennsylvania (US)
ATS platform: own website
Careers link: https://www.wcupa.edu/hr/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for West Chester University of Pennsylvania; nothing here affects any
...
Writes school_job_posts/school_id_1223_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1223_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1223
SCHOOL_NAME = 'West Chester University of Pennsylvania'
CAREERS_LINK = 'https://www.wcupa.edu/hr/'
