"""
Job postings scraper for school_id 1696 - National and Kapodistrian University of Athens (Greece)
ATS platform: APELLA (Greece) (detected: apella)
Careers link: https://apella.minedu.gov.gr/en/positions

National and Kapodistrian University of Athens runs on a shared ATS platform -- every school on apella uses the
...
Writes school_job_posts/school_id_1696_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1696_job_postings.checkpoint next to this script.
"""
import os
import sys
