"""
Job postings scraper for school_id 871 - Felician University (US)
ATS platform: own website
Careers link: https://felician.edu/about-felician-university/careers-at-felician/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Felician University; nothing here affects any
other school's script.

Link check (ok): 65 posting-shaped links found.
...
Writes school_job_posts/school_id_871_job_posts.csv (school_id, post_link).
Checkpointed to school_id_871_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 871
SCHOOL_NAME = 'Felician University'
CAREERS_LINK = 'https://felician.edu/about-felician-university/careers-at-felician/'
