"""
Job postings scraper for school_id 316 - Valdosta State University (US)
ATS platform: own website
Careers link: http://www.valdosta.edu/administration/finance-admin/human-resources/employment-opportunities.php

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Valdosta State University; nothing here affects any
...
Writes school_job_posts/school_id_316_job_posts.csv (school_id, post_link).
Checkpointed to school_id_316_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 316
SCHOOL_NAME = 'Valdosta State University'
CAREERS_LINK = 'http://www.valdosta.edu/administration/finance-admin/human-resources/employment-opportunities.php'
