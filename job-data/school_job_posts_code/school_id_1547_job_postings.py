"""
Job postings scraper for school_id 1547 - Alverno College (US)
ATS platform: own website
Careers link: https://www.alverno.edu/Career-Recruit-a-Grad

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Alverno College; nothing here affects any
...
Writes school_job_posts/school_id_1547_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1547_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1547
SCHOOL_NAME = 'Alverno College'
CAREERS_LINK = 'https://www.alverno.edu/Career-Recruit-a-Grad'
