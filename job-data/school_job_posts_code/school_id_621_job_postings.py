"""
Job postings scraper for school_id 621 - University of Maine at Presque Isle (US)
ATS platform: own website
Careers link: https://www.umpi.edu/human-resources/jobs-at-umpi/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of Maine at Presque Isle; nothing here affects any
...
Writes school_job_posts/school_id_621_job_posts.csv (school_id, post_link).
Checkpointed to school_id_621_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 621
SCHOOL_NAME = 'University of Maine at Presque Isle'
CAREERS_LINK = 'https://www.umpi.edu/human-resources/jobs-at-umpi/'
