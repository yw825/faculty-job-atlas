"""
Job postings scraper for school_id 1008 - Wagner College (US)
ATS platform: own website
Careers link: https://wagner.edu/hr/hr_openings/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Wagner College; nothing here affects any
...
Writes school_job_posts/school_id_1008_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1008_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1008
SCHOOL_NAME = 'Wagner College'
CAREERS_LINK = 'https://wagner.edu/hr/hr_openings/'
