"""
Job postings scraper for school_id 1065 - Ursuline College (US)
ATS platform: own website
Careers link: https://www.ursuline.edu/inside-ursuline/employment/inside-ursuline/employment/job-opportunities

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Ursuline College; nothing here affects any
...
Writes school_job_posts/school_id_1065_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1065_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1065
SCHOOL_NAME = 'Ursuline College'
CAREERS_LINK = 'https://www.ursuline.edu/inside-ursuline/employment/inside-ursuline/employment/job-opportunities'
