"""
Job postings scraper for school_id 1087 - Rogers State University (US)
ATS platform: own website
Careers link: https://my.rsu.edu/ICS/RSU_Jobs/RSU_Employment_Opportunities.jnz

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Rogers State University; nothing here affects any
...
Writes school_job_posts/school_id_1087_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1087_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1087
SCHOOL_NAME = 'Rogers State University'
CAREERS_LINK = 'https://my.rsu.edu/ICS/RSU_Jobs/RSU_Employment_Opportunities.jnz'
