"""
Job postings scraper for school_id 803 - Chowan University (US)
ATS platform: own website
Careers link: https://www.chowan.edu/about/offices/human-resources/workstudyjobs/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Chowan University; nothing here affects any
...
Writes school_job_posts/school_id_803_job_posts.csv (school_id, post_link).
Checkpointed to school_id_803_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 803
SCHOOL_NAME = 'Chowan University'
CAREERS_LINK = 'https://www.chowan.edu/about/offices/human-resources/workstudyjobs/'
