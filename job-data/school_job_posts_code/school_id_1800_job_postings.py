"""
Job postings scraper for school_id 1800 - CQUniversity (Australia)
ATS platform: own website
Careers link: https://careers.cqu.edu.au/go/Academic-&-ELICOS-Jobs/7956910/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for CQUniversity; nothing here affects any
...
Writes school_job_posts/school_id_1800_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1800_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
