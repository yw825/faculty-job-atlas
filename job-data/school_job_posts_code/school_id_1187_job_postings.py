"""
Job postings scraper for school_id 1187 - Chestnut Hill College (US)
ATS platform: own website
Careers link: https://www.chc.edu/careers-at-chc/employment-opportunities/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Chestnut Hill College; nothing here affects any
...
Writes school_job_posts/school_id_1187_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1187_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1187
SCHOOL_NAME = 'Chestnut Hill College'
CAREERS_LINK = 'https://www.chc.edu/careers-at-chc/employment-opportunities/'
