"""
Job postings scraper for school_id 1081 - East Central University (US)
ATS platform: own website
Careers link: https://ecokedu.bamboohr.com/careers

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for East Central University; nothing here affects any
...
Writes school_job_posts/school_id_1081_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1081_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1081
SCHOOL_NAME = 'East Central University'
CAREERS_LINK = 'https://ecokedu.bamboohr.com/careers'
