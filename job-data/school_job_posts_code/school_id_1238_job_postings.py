"""
Job postings scraper for school_id 1238 - University of Puerto Rico-Bayamon (US)
ATS platform: own website
Careers link: https://www.upr.edu/ac/oficinas-adscritas/recursos-humanos/oficina-de-recursos-humanos-convocatorias/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of Puerto Rico-Bayamon; nothing here affects any
...
Writes school_job_posts/school_id_1238_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1238_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1238
SCHOOL_NAME = 'University of Puerto Rico-Bayamon'
CAREERS_LINK = 'https://www.upr.edu/ac/oficinas-adscritas/recursos-humanos/oficina-de-recursos-humanos-convocatorias/'
