"""
Job postings scraper for school_id 888 - Monmouth University (US)
ATS platform: own website
Careers link: https://jobs.monmouth.edu/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Monmouth University; nothing here affects any
...
Writes school_job_posts/school_id_888_job_posts.csv (school_id, post_link).
Checkpointed to school_id_888_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 888
SCHOOL_NAME = 'Monmouth University'
CAREERS_LINK = 'https://jobs.monmouth.edu/'
