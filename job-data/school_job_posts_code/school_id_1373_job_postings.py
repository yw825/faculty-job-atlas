"""
Job postings scraper for school_id 1373 - Texas A & M University-College Station (US)
ATS platform: own website
Careers link: https://faculty.tamu.edu/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Texas A & M University-College Station; nothing here affects any
other school's script.

Link check (ok): 152 posting-shaped links found.
...
Writes school_job_posts/school_id_1373_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1373_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1373
SCHOOL_NAME = 'Texas A & M University-College Station'
CAREERS_LINK = 'https://faculty.tamu.edu/'
