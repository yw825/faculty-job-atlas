"""
Job postings scraper for school_id 1862 - Singapore University of Technology and Design (Singapore)
...
directly to fix or improve results for Singapore University of Technology and Design; nothing here affects any
...
Writes school_job_posts/school_id_1862_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1862_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
