"""
Job postings scraper for school_id 909 - Daemen University (US)
ATS platform: own website
Careers link: https://www.daemen.edu/about/working-daemen/employment-opportunities

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Daemen University; nothing here affects any
...
Writes school_job_posts/school_id_909_job_posts.csv (school_id, post_link).
Checkpointed to school_id_909_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 909
SCHOOL_NAME = 'Daemen University'
CAREERS_LINK = 'https://www.daemen.edu/about/working-daemen/employment-opportunities'
