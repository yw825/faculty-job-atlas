"""
Job postings scraper for school_id 1711 - University of Padua (Italy)
ATS platform: own website
Careers link: https://protocollo.unipd.it/albo/viewer

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of Padua; nothing here affects any
...
Writes school_job_posts/school_id_1711_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1711_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
