"""
Job postings scraper for school_id 109 - Saint Mary's College of California (US)
ATS platform: own website
Careers link: https://www.stmarys-ca.edu/offices-services/academic-affairs/faculty-openings

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Saint Mary's College of California; nothing here affects any
...
Writes school_job_posts/school_id_109_job_posts.csv (school_id, post_link).
Checkpointed to school_id_109_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
