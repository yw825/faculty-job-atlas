"""
Job postings scraper for school_id 150 - University of California-Santa Cruz (US)
ATS platform: UC Recruit (detected: ucrecruit)
Careers link: https://recruit.ucsc.edu/apply

University of California-Santa Cruz runs on a shared ATS platform -- every school on ucrecruit uses the
...
Writes school_job_posts/school_id_150_job_posts.csv (school_id, post_link).
Checkpointed to school_id_150_job_postings.checkpoint next to this script.
"""
import os
import sys
...
CAREERS_LINK = 'https://recruit.ucsc.edu/apply'
