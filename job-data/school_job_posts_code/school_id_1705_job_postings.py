"""
Job postings scraper for school_id 1705 - University College Dublin (Ireland)
ATS platform: CoreHR
...
directly to fix or improve results for University College Dublin; nothing here affects any
...
Writes school_job_posts/school_id_1705_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1705_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
