"""
Job postings scraper for school_id 248 - Polytechnic University of Puerto Rico-Miami (US)
ATS platform: own website
Careers link: https://pupr.edu/hr/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Polytechnic University of Puerto Rico-Miami; nothing here affects any
...
Writes school_job_posts/school_id_248_job_posts.csv (school_id, post_link).
Checkpointed to school_id_248_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 248
SCHOOL_NAME = 'Polytechnic University of Puerto Rico-Miami'
CAREERS_LINK = 'https://pupr.edu/hr/'
