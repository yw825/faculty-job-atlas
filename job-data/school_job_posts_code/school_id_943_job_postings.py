"""
Job postings scraper for school_id 943 - SUNY College at Geneseo (US)
ATS platform: own website
Careers link: https://www.geneseo.edu/provost/applying-for-faculty-positions

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for SUNY College at Geneseo; nothing here affects any
...
Writes school_job_posts/school_id_943_job_posts.csv (school_id, post_link).
Checkpointed to school_id_943_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 943
SCHOOL_NAME = 'SUNY College at Geneseo'
CAREERS_LINK = 'https://www.geneseo.edu/provost/applying-for-faculty-positions'
