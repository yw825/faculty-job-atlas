"""
Job postings scraper for school_id 611 - University of Maine at Augusta (US)
ATS platform: own website
Careers link: https://uma.careers.maine.edu/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of Maine at Augusta; nothing here affects any
...
Writes school_job_posts/school_id_611_job_posts.csv (school_id, post_link).
Checkpointed to school_id_611_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 611
SCHOOL_NAME = 'University of Maine at Augusta'
CAREERS_LINK = 'https://uma.careers.maine.edu/'
