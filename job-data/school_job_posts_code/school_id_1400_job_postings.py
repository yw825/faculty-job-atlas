"""
Job postings scraper for school_id 1400 - University of St Thomas (US)
ATS platform: own website
Careers link: https://stthom.applicantpro.com/jobs/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of St Thomas; nothing here affects any
other school's script.

Link check (ok): 35 posting-shaped links found -- rendered.
...
Writes school_job_posts/school_id_1400_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1400_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1400
SCHOOL_NAME = 'University of St Thomas'
CAREERS_LINK = 'https://stthom.applicantpro.com/jobs/'
