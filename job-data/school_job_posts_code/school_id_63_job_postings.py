"""
Job postings scraper for school_id 63 - Arizona State University Campus Immersion (US)
ATS platform: own website
Careers link: https://facultypositions.asu.edu/#/api/Home/_InterfolioPostings

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Arizona State University Campus Immersion; nothing here affects any
other school's script.

Link check (review): 2 posting-shaped links found -- rendered few job-shaped links.

NOTE: 2 schools list against this same URL, so this listing carries every one of their postings, not just this school's: Arizona State University Digital Immersion.
...
Writes school_job_posts/school_id_63_job_posts.csv (school_id, post_link).
Checkpointed to school_id_63_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
