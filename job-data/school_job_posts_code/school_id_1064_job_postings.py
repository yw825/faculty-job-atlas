"""
Job postings scraper for school_id 1064 - Lake Erie College (US)
ATS platform: own website
Careers link: https://www.lec.edu/career-closet

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Lake Erie College; nothing here affects any
...
Writes school_job_posts/school_id_1064_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1064_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://www.lec.edu/career-closet'
ATS_PLATFORM = 'own website'

CHECKPOINT_PATH = os.path.join(HERE, f'school_id_{SCHOOL_ID}_job_postings.checkpoint')


POSTING_PATTERN = 'www.lec.edu/<*>'
...
def find_links():
    ...
    (title_role=0 degree=0 furniture=3 len=13984; title_role=0 degree=0 furniture=0 len=9714).

        www.lec.edu/<*>

    The generic job-word filter returned 4 link(s) here against 19
