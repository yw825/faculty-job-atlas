"""
Job postings scraper for school_id 241 - Beacon College (US)
ATS platform: own website
Careers link: https://www.beaconcollege.edu/career-opportunities/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Beacon College; nothing here affects any
...
Writes school_job_posts/school_id_241_job_posts.csv (school_id, post_link).
Checkpointed to school_id_241_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 241
SCHOOL_NAME = 'Beacon College'
CAREERS_LINK = 'https://www.beaconcollege.edu/career-opportunities/'
ATS_PLATFORM = 'own website'

CHECKPOINT_PATH = os.path.join(HERE, f'school_id_{SCHOOL_ID}_job_postings.checkpoint')


POSTING_PATTERN = 'www.beaconcollege.edu/college-readiness-programs/<*>'
...
def find_links():
    ...
    (title_role=0 degree=0 furniture=3 len=19449; title_role=0 degree=0 furniture=0 len=12159).

        www.beaconcollege.edu/college-readiness-programs/<*>

    The generic job-word filter returned 4 link(s) here against 9
