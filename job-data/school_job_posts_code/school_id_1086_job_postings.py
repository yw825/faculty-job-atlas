"""
Job postings scraper for school_id 1086 - University of Science and Arts of Oklahoma (US)
ATS platform: own website
Careers link: https://usao.edu/about/human-resources/careers-at-usao.html

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of Science and Arts of Oklahoma; nothing here affects any
...
Writes school_job_posts/school_id_1086_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1086_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1086
SCHOOL_NAME = 'University of Science and Arts of Oklahoma'
CAREERS_LINK = 'https://usao.edu/about/human-resources/careers-at-usao.html'
