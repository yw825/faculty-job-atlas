"""
Job postings scraper for school_id 774 - University of North Carolina at Chapel Hill (US)
ATS platform: PeopleAdmin (detected: peopleadmin)
Careers link: https://unc.peopleadmin.com/postings/search

University of North Carolina at Chapel Hill runs on a shared ATS platform -- every school on peopleadmin uses the
...
Writes school_job_posts/school_id_774_job_posts.csv (school_id, post_link).
Checkpointed to school_id_774_job_postings.checkpoint next to this script.
"""
import os
import sys
...
CAREERS_LINK = 'https://unc.peopleadmin.com/postings/search'
