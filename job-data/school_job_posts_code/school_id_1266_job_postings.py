"""
Job postings scraper for school_id 1266 - University of Rhode Island (US)
ATS platform: own website
Careers link: https://jobs.uri.edu/postings/search

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of Rhode Island; nothing here affects any
other school's script.

Link check (ok): 70 posting-shaped links found.
...
Writes school_job_posts/school_id_1266_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1266_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://jobs.uri.edu/postings/search'
