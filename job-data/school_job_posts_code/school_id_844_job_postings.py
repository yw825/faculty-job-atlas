"""
Job postings scraper for school_id 844 - Wayne State College (US)
ATS platform: own website
Careers link: https://www.wsc.edu/directory/16/employment-opportunities/category/300

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Wayne State College; nothing here affects any
...
Writes school_job_posts/school_id_844_job_posts.csv (school_id, post_link).
Checkpointed to school_id_844_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 844
SCHOOL_NAME = 'Wayne State College'
CAREERS_LINK = 'https://www.wsc.edu/directory/16/employment-opportunities/category/300'
