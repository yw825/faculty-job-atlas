"""
Job postings scraper for school_id 811 - Catawba College (US)
ATS platform: own website
Careers link: https://www.catawba.edu/jobs/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Catawba College; nothing here affects any
...
Writes school_job_posts/school_id_811_job_posts.csv (school_id, post_link).
Checkpointed to school_id_811_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 811
SCHOOL_NAME = 'Catawba College'
CAREERS_LINK = 'https://www.catawba.edu/jobs/'
