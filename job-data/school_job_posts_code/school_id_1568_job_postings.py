"""
Job postings scraper for school_id 1568 - West Virginia Wesleyan College (US)
ATS platform: own website
Careers link: https://www.wvwc.edu/jobs/?faculty

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for West Virginia Wesleyan College; nothing here affects any
...
Writes school_job_posts/school_id_1568_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1568_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1568
SCHOOL_NAME = 'West Virginia Wesleyan College'
CAREERS_LINK = 'https://www.wvwc.edu/jobs/?faculty'
