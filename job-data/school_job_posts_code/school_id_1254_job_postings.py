"""
Job postings scraper for school_id 1254 - Inter American University of Puerto Rico-Ponce (US)
ATS platform: own website
Careers link: https://ponce.inter.edu/recursos-humanos-2/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Inter American University of Puerto Rico-Ponce; nothing here affects any
...
Writes school_job_posts/school_id_1254_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1254_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1254
SCHOOL_NAME = 'Inter American University of Puerto Rico-Ponce'
CAREERS_LINK = 'https://ponce.inter.edu/recursos-humanos-2/'
