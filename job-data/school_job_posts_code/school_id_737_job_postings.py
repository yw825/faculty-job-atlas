"""
Job postings scraper for school_id 737 - Drury University (US)
ATS platform: own website
Careers link: https://www.drury.edu/hr/drury-university-jobs/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Drury University; nothing here affects any
...
Writes school_job_posts/school_id_737_job_posts.csv (school_id, post_link).
Checkpointed to school_id_737_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 737
SCHOOL_NAME = 'Drury University'
CAREERS_LINK = 'https://www.drury.edu/hr/drury-university-jobs/'
