"""
Job postings scraper for school_id 1460 - Southern Virginia University (US)
ATS platform: own website
Careers link: https://svu.edu/about/careers/open-rank-professor-of-biology/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Southern Virginia University; nothing here affects any
...
Writes school_job_posts/school_id_1460_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1460_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1460
SCHOOL_NAME = 'Southern Virginia University'
CAREERS_LINK = 'https://svu.edu/about/careers/open-rank-professor-of-biology/'
