"""
Job postings scraper for school_id 661 - Spring Arbor University (US)
ATS platform: own website
Careers link: https://springarbor.edu/about/offices-and-schools/human-resources/careers.php

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Spring Arbor University; nothing here affects any
...
Writes school_job_posts/school_id_661_job_posts.csv (school_id, post_link).
Checkpointed to school_id_661_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 661
SCHOOL_NAME = 'Spring Arbor University'
CAREERS_LINK = 'https://springarbor.edu/about/offices-and-schools/human-resources/careers.php'
