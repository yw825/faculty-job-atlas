"""
Job postings scraper for school_id 68 - California State Polytechnic University-Humboldt (US)
ATS platform: own website
Careers link: https://careers.humboldt.edu/hm/en-us/filter/?work-type=faculty

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for California State Polytechnic University-Humboldt; nothing here affects any
...
Writes school_job_posts/school_id_68_job_posts.csv (school_id, post_link).
Checkpointed to school_id_68_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 68
SCHOOL_NAME = 'California State Polytechnic University-Humboldt'
CAREERS_LINK = 'https://careers.humboldt.edu/hm/en-us/filter/?work-type=faculty'
