"""
Job postings scraper for school_id 990 - Vassar College (US)
ATS platform: own website
Careers link: https://www.ey.com/en_us/careers/how-to-join-us

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Vassar College; nothing here affects any
...
Writes school_job_posts/school_id_990_job_posts.csv (school_id, post_link).
Checkpointed to school_id_990_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://www.ey.com/en_us/careers/how-to-join-us'
