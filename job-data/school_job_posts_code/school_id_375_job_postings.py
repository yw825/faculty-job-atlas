"""
Job postings scraper for school_id 375 - Illinois Institute of Technology (US)
ATS platform: own website
Careers link: https://www.iit.edu/hr/about/employment-verification

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Illinois Institute of Technology; nothing here affects any
...
Writes school_job_posts/school_id_375_job_posts.csv (school_id, post_link).
Checkpointed to school_id_375_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://www.iit.edu/hr/about/employment-verification'
