"""
Job postings scraper for school_id 923 - Long Island University (US)
ATS platform: own website
Careers link: https://jobs.liu.edu/job_details/4967

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Long Island University; nothing here affects any
...
Writes school_job_posts/school_id_923_job_posts.csv (school_id, post_link).
Checkpointed to school_id_923_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://jobs.liu.edu/job_details/4967'
