"""
Job postings scraper for school_id 1231 - Inter American University of Puerto Rico-Arecibo (US)
ATS platform: own website
Careers link: https://iaupr.elluciancrmrecruit.com/Apply/Account/Create

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Inter American University of Puerto Rico-Arecibo; nothing here affects any
...
Writes school_job_posts/school_id_1231_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1231_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
