"""
Job postings scraper for school_id 461 - Barclay College (US)
ATS platform: own website
Careers link: https://www.barclaycollege.edu/jobs/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Barclay College; nothing here affects any
...
Writes school_job_posts/school_id_461_job_posts.csv (school_id, post_link).
Checkpointed to school_id_461_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 461
SCHOOL_NAME = 'Barclay College'
CAREERS_LINK = 'https://www.barclaycollege.edu/jobs/'
