"""
Job postings scraper for school_id 478 - Washburn University (US)
ATS platform: own website
Careers link: https://careers.washburn.edu/jobs/search

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Washburn University; nothing here affects any
...
Writes school_job_posts/school_id_478_job_posts.csv (school_id, post_link).
Checkpointed to school_id_478_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 478
SCHOOL_NAME = 'Washburn University'
CAREERS_LINK = 'https://careers.washburn.edu/jobs/search'
