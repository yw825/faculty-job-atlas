"""
Job postings scraper for school_id 1111 - Oregon Institute of Technology (US)
ATS platform: own website
Careers link: https://jobs.oit.edu/postings/search

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Oregon Institute of Technology; nothing here affects any
...
Writes school_job_posts/school_id_1111_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1111_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1111
SCHOOL_NAME = 'Oregon Institute of Technology'
CAREERS_LINK = 'https://jobs.oit.edu/postings/search'
