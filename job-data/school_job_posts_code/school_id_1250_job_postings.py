"""
Job postings scraper for school_id 1250 - American University of Puerto Rico (US)
...
Writes school_job_posts/school_id_1250_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1250_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
