"""
Job postings scraper for school_id 1778 - Australian National University (Australia)
...
directly to fix or improve results for Australian National University; nothing here affects any
...
Writes school_job_posts/school_id_1778_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1778_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
