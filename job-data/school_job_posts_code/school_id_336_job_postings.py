"""
Job postings scraper for school_id 336 - Grand View University (US)
ATS platform: own website
Careers link: https://www.grandview.edu/about/directory/careers-at-gv

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Grand View University; nothing here affects any
...
Writes school_job_posts/school_id_336_job_posts.csv (school_id, post_link).
Checkpointed to school_id_336_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 336
SCHOOL_NAME = 'Grand View University'
CAREERS_LINK = 'https://www.grandview.edu/about/directory/careers-at-gv'
