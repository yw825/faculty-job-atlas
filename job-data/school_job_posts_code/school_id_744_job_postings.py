"""
Job postings scraper for school_id 744 - Delta State University (US)
ATS platform: PeopleAdmin (detected: peopleadmin)
Careers link: https://deltastate.peopleadmin.com/

Delta State University runs on a shared ATS platform -- every school on peopleadmin uses the
...
Writes school_job_posts/school_id_744_job_posts.csv (school_id, post_link).
Checkpointed to school_id_744_job_postings.checkpoint next to this script.
"""
import os
import sys
...
SCHOOL_ID = 744
SCHOOL_NAME = 'Delta State University'
CAREERS_LINK = 'https://deltastate.peopleadmin.com/'
