"""
Job postings scraper for school_id 1045 - Wright State University-Main Campus (US)
ATS platform: own website
Careers link: #VALUE!

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Wright State University-Main Campus; nothing here affects any
other school's script.

Link check (broken): 0 posting-shaped links found -- fetch failed [shared URL].

NOTE: 2 schools list against this same URL, so this listing carries every one of their postings, not just this school's: University of Maine at Farmington.
...
Writes school_job_posts/school_id_1045_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1045_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
