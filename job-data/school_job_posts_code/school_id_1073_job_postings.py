"""
Job postings scraper for school_id 1073 - John Carroll University (US)
ATS platform: PeopleAdmin (detected: peopleadmin)
Careers link: https://jcu.peopleadmin.com/

John Carroll University runs on a shared ATS platform -- every school on peopleadmin uses the
...
Writes school_job_posts/school_id_1073_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1073_job_postings.checkpoint next to this script.
"""
import os
import sys
...
SCHOOL_ID = 1073
SCHOOL_NAME = 'John Carroll University'
CAREERS_LINK = 'https://jcu.peopleadmin.com/'
