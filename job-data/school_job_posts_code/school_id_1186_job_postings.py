"""
Job postings scraper for school_id 1186 - Westminster College (US)
ATS platform: own website
Careers link: https://my.westminster.edu/ics/Campus_Life/Campus_Groups/Human_Resources__Employment/Overview.jnz
...
Writes school_job_posts/school_id_1186_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1186_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
def find_links():
    ...
    """CUSTOMIZED: careers_link was corrected by hand (was an authenticated campus-portal (ICS) page).
