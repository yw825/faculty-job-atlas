"""
Job postings scraper for school_id 765 - Carroll College (US)
ATS platform: own website
Careers link: https://www.carroll.edu/about/work-carroll

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Carroll College; nothing here affects any
...
Writes school_job_posts/school_id_765_job_posts.csv (school_id, post_link).
Checkpointed to school_id_765_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://www.carroll.edu/about/work-carroll'
