"""
Job postings scraper for school_id 895 - New Mexico Highlands University (US)
...
directly to fix or improve results for New Mexico Highlands University; nothing here affects any
...
Writes school_job_posts/school_id_895_job_posts.csv (school_id, post_link).
Checkpointed to school_id_895_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
