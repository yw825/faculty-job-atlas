"""
Job postings scraper for school_id 971 - Pace University (US)
ATS platform: own website
Careers link: https://secure6.saashr.com/ta/6000630.careers?CareersSearch

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Pace University; nothing here affects any
...
Writes school_job_posts/school_id_971_job_posts.csv (school_id, post_link).
Checkpointed to school_id_971_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://secure6.saashr.com/ta/6000630.careers?CareersSearch'
