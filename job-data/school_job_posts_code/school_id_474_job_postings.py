"""
Job postings scraper for school_id 474 - Ottawa University-Kansas City (US)
...
directly to fix or improve results for Ottawa University-Kansas City; nothing here affects any
other school's script.

Link check (ok): 10 posting-shaped links found -- rendered [shared URL].

NOTE: 3 schools list against this same URL, so this listing carries every one of their postings, not just this school's: Ottawa University-Ottawa, Ottawa University-Milwaukee.
...
Writes school_job_posts/school_id_474_job_posts.csv (school_id, post_link).
Checkpointed to school_id_474_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 474
SCHOOL_NAME = 'Ottawa University-Kansas City'
