"""
Job postings scraper for school_id 1759 - Middle East Technical University (Turkey)
...
directly to fix or improve results for Middle East Technical University; nothing here affects any
...
Writes school_job_posts/school_id_1759_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1759_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
