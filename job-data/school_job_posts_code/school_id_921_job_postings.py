"""
Job postings scraper for school_id 921 - St. Francis College (US)
ATS platform: own website
Careers link: https://www.sfc.edu/why-sfc/careers-at-sfc

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for St. Francis College; nothing here affects any
...
Writes school_job_posts/school_id_921_job_posts.csv (school_id, post_link).
Checkpointed to school_id_921_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://www.sfc.edu/why-sfc/careers-at-sfc'
