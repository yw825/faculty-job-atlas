"""
Job postings scraper for school_id 494 - Transylvania University (US)
ATS platform: own website
Careers link: https://www.transy.edu/employment-opportunities/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Transylvania University; nothing here affects any
...
Writes school_job_posts/school_id_494_job_posts.csv (school_id, post_link).
Checkpointed to school_id_494_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 494
SCHOOL_NAME = 'Transylvania University'
CAREERS_LINK = 'https://www.transy.edu/employment-opportunities/'
