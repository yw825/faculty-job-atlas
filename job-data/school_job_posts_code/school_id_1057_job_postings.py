"""
Job postings scraper for school_id 1057 - Ohio State University-Marion Campus (US)
ATS platform: own website
Careers link: https://osumarion.osu.edu/engineering/career-opportunities-engineering

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Ohio State University-Marion Campus; nothing here affects any
...
Writes school_job_posts/school_id_1057_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1057_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1057
SCHOOL_NAME = 'Ohio State University-Marion Campus'
CAREERS_LINK = 'https://osumarion.osu.edu/engineering/career-opportunities-engineering'
