"""
Job postings scraper for school_id 615 - Maine Maritime Academy (US)
ATS platform: own website
Careers link: https://mainemaritime.edu/employment-at-mma/faculty-positions/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Maine Maritime Academy; nothing here affects any
...
Writes school_job_posts/school_id_615_job_posts.csv (school_id, post_link).
Checkpointed to school_id_615_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 615
SCHOOL_NAME = 'Maine Maritime Academy'
CAREERS_LINK = 'https://mainemaritime.edu/employment-at-mma/faculty-positions/'
