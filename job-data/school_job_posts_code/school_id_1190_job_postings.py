"""
Job postings scraper for school_id 1190 - La Salle University (US)
ATS platform: PeopleAdmin (detected: peopleadmin)
Careers link: https://lasalle.peopleadmin.com/

La Salle University runs on a shared ATS platform -- every school on peopleadmin uses the
...
Writes school_job_posts/school_id_1190_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1190_job_postings.checkpoint next to this script.
"""
import os
import sys
...
SCHOOL_ID = 1190
SCHOOL_NAME = 'La Salle University'
CAREERS_LINK = 'https://lasalle.peopleadmin.com/'
