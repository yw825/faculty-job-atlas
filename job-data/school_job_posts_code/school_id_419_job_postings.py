"""
Job postings scraper for school_id 419 - Wabash College (US)
ATS platform: own website
Careers link: https://www.wabash.edu/employment

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Wabash College; nothing here affects any
...
Writes school_job_posts/school_id_419_job_posts.csv (school_id, post_link).
Checkpointed to school_id_419_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 419
SCHOOL_NAME = 'Wabash College'
CAREERS_LINK = 'https://www.wabash.edu/employment'
