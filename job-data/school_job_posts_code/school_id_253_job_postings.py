"""
Job postings scraper for school_id 253 - Polytechnic University of Puerto Rico-Orlando (US)
...
Polytechnic University of Puerto Rico-Orlando runs on a shared ATS platform -- every school on adp uses the
...
NOTE: 2 schools list against this same URL, so this listing carries every one of their postings, not just this school's: Universidad Politecnica de Puerto Rico.

Writes school_job_posts/school_id_253_job_posts.csv (school_id, post_link).
Checkpointed to school_id_253_job_postings.checkpoint next to this script.
"""
import os
import sys
...
SCHOOL_ID = 253
SCHOOL_NAME = 'Polytechnic University of Puerto Rico-Orlando'
