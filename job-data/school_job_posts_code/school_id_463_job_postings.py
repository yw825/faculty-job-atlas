"""
Job postings scraper for school_id 463 - Tabor College (US)
ATS platform: own website
Careers link: https://tabor.edu/about/employment/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Tabor College; nothing here affects any
...
Writes school_job_posts/school_id_463_job_posts.csv (school_id, post_link).
Checkpointed to school_id_463_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 463
SCHOOL_NAME = 'Tabor College'
CAREERS_LINK = 'https://tabor.edu/about/employment/'
