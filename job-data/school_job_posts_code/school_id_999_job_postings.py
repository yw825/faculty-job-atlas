"""
Job postings scraper for school_id 999 - St. John Fisher University (US)
ATS platform: own website
Careers link: https://www.sjf.edu/services/human-resources/career-experience/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for St. John Fisher University; nothing here affects any
...
Writes school_job_posts/school_id_999_job_posts.csv (school_id, post_link).
Checkpointed to school_id_999_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 999
SCHOOL_NAME = 'St. John Fisher University'
CAREERS_LINK = 'https://www.sjf.edu/services/human-resources/career-experience/'
