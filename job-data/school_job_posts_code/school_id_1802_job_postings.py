"""
Job postings scraper for school_id 1802 - University of Southern Queensland (Australia)
ATS platform: PageUp/NGA
Careers link: https://usq.nga.net.au/cp/index.cfm?audiencetypecode=ext

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of Southern Queensland; nothing here affects any
...
Writes school_job_posts/school_id_1802_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1802_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
