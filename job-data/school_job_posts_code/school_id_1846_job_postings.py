"""
Job postings scraper for school_id 1846 - The University of Hong Kong (Hong Kong)
ATS platform: own website
Careers link: https://jobs.hku.hk/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for The University of Hong Kong; nothing here affects any
...
Writes school_job_posts/school_id_1846_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1846_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
