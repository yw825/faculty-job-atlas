"""
Job postings scraper for school_id 352 - Dordt University (US)
ATS platform: Oracle Cloud HCM (detected: oracle)
Careers link: https://ibmxjb.fa.ocs.oraclecloud.com/hcmUI/CandidateExperience/en/sites/CX_2/requisitions?lastSelectedFacet=CATEGORIES&selectedCategoriesFacet=300000008610535

Dordt University runs on a shared ATS platform -- every school on oracle uses the
...
Writes school_job_posts/school_id_352_job_posts.csv (school_id, post_link).
Checkpointed to school_id_352_job_postings.checkpoint next to this script.
"""
import os
import sys
