"""
Job postings scraper for school_id 1315 - Augustana University (US)
ATS platform: own website
Careers link: https://www.augie.edu/faculty-positions

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Augustana University; nothing here affects any
...
Writes school_job_posts/school_id_1315_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1315_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1315
SCHOOL_NAME = 'Augustana University'
CAREERS_LINK = 'https://www.augie.edu/faculty-positions'
