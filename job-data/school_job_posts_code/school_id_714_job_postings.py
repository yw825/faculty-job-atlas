"""
Job postings scraper for school_id 714 - Avila University (US)
ATS platform: own website
Careers link: https://www.avila.edu/about/administrative-offices/human-resources/careers/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Avila University; nothing here affects any
...
Writes school_job_posts/school_id_714_job_posts.csv (school_id, post_link).
Checkpointed to school_id_714_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 714
SCHOOL_NAME = 'Avila University'
CAREERS_LINK = 'https://www.avila.edu/about/administrative-offices/human-resources/careers/'
