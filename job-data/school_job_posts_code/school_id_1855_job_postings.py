"""
Job postings scraper for school_id 1855 - Macau Institute of Management (Macau)
ATS platform: own website
Careers link: https://www.mim.edu.mo/?list_102/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Macau Institute of Management; nothing here affects any
...
Writes school_job_posts/school_id_1855_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1855_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
