"""
Job postings scraper for school_id 1475 - Washington and Lee University (US)
ATS platform: own website
Careers link: https://www.wlu.edu/employment-opportunities/faculty-positions

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Washington and Lee University; nothing here affects any
...
Writes school_job_posts/school_id_1475_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1475_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://www.wlu.edu/employment-opportunities/faculty-positions'
