"""
Job postings scraper for school_id 506 - Eastern Kentucky University (US)
ATS platform: own website
Careers link: https://careers.eku.edu/jobs/search

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Eastern Kentucky University; nothing here affects any
other school's script.

Link check (ok): 38 posting-shaped links found -- rendered.
...
Writes school_job_posts/school_id_506_job_posts.csv (school_id, post_link).
Checkpointed to school_id_506_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 506
SCHOOL_NAME = 'Eastern Kentucky University'
CAREERS_LINK = 'https://careers.eku.edu/jobs/search'
