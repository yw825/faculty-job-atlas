"""
Job postings scraper for school_id 1135 - Dickinson College (US)
ATS platform: own website
Careers link: https://jobs.dickinson.edu/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Dickinson College; nothing here affects any
...
CAREERS_LINK = 'https://jobs.dickinson.edu/'
