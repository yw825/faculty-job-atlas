"""
Job postings scraper for school_id 462 - Fort Hays State University (US)
ATS platform: own website
Careers link: https://www.fhsu.edu/humanresourceoffice/positions

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Fort Hays State University; nothing here affects any
...
Writes school_job_posts/school_id_462_job_posts.csv (school_id, post_link).
Checkpointed to school_id_462_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 462
SCHOOL_NAME = 'Fort Hays State University'
CAREERS_LINK = 'https://www.fhsu.edu/humanresourceoffice/positions'
