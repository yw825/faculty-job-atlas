"""
Job postings scraper for school_id 562 - Massachusetts College of Liberal Arts (US)
ATS platform: own website
Careers link: http://mcla.interviewexchange.com/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Massachusetts College of Liberal Arts; nothing here affects any
...
Writes school_job_posts/school_id_562_job_posts.csv (school_id, post_link).
Checkpointed to school_id_562_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 562
SCHOOL_NAME = 'Massachusetts College of Liberal Arts'
CAREERS_LINK = 'http://mcla.interviewexchange.com/'
