"""
Job postings scraper for school_id 1596 - University of British Columbia (Canada)
ATS platform: Workday (detected: workday)
Careers link: https://ubc.wd10.myworkdayjobs.com/ubcfacultyjobs

University of British Columbia runs on a shared ATS platform -- every school on workday uses the
...
Writes school_job_posts/school_id_1596_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1596_job_postings.checkpoint next to this script.
"""
import os
import sys
