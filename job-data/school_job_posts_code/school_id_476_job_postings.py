"""
Job postings scraper for school_id 476 - Kansas Wesleyan University (US)
ATS platform: own website
Careers link: https://www.kwu.edu/about/careers/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Kansas Wesleyan University; nothing here affects any
...
Writes school_job_posts/school_id_476_job_posts.csv (school_id, post_link).
Checkpointed to school_id_476_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 476
SCHOOL_NAME = 'Kansas Wesleyan University'
CAREERS_LINK = 'https://www.kwu.edu/about/careers/'
