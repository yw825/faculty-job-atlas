"""
Job postings scraper for school_id 1367 - The University of Texas at Austin (US)
ATS platform: own website
Careers link: https://faculty.utexas.edu/career

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for The University of Texas at Austin; nothing here affects any
...
Writes school_job_posts/school_id_1367_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1367_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://faculty.utexas.edu/career'
