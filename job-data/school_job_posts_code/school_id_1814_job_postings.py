"""
Job postings scraper for school_id 1814 - RMIT University (Australia)
ATS platform: Workday (detected: workday)
Careers link: https://rmit.wd3.myworkdayjobs.com/RMIT_Careers

RMIT University runs on a shared ATS platform -- every school on workday uses the
...
Writes school_job_posts/school_id_1814_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1814_job_postings.checkpoint next to this script.
"""
import os
import sys
