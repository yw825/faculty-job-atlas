"""
Job postings scraper for school_id 650 - Western Michigan University (US)
ATS platform: own website
Careers link: https://wmich.edu/career/jobfairprep

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Western Michigan University; nothing here affects any
other school's script.

Link check (ok): 38 posting-shaped links found.
...
Writes school_job_posts/school_id_650_job_posts.csv (school_id, post_link).
Checkpointed to school_id_650_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://wmich.edu/career/jobfairprep'
