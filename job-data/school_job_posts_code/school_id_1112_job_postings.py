"""
Job postings scraper for school_id 1112 - Eastern Oregon University (US)
ATS platform: PeopleAdmin (detected: peopleadmin)
Careers link: http://eou.peopleadmin.com

Eastern Oregon University runs on a shared ATS platform -- every school on peopleadmin uses the
...
Writes school_job_posts/school_id_1112_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1112_job_postings.checkpoint next to this script.
"""
import os
import sys
...
SCHOOL_ID = 1112
SCHOOL_NAME = 'Eastern Oregon University'
CAREERS_LINK = 'http://eou.peopleadmin.com'
