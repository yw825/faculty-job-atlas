"""
Job postings scraper for school_id 721 - Missouri Valley College (US)
ATS platform: own website
Careers link: https://www.moval.edu/?post_type=page&p=524

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Missouri Valley College; nothing here affects any
...
Writes school_job_posts/school_id_721_job_posts.csv (school_id, post_link).
Checkpointed to school_id_721_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 721
SCHOOL_NAME = 'Missouri Valley College'
CAREERS_LINK = 'https://www.moval.edu/?post_type=page&p=524'
