"""
Job postings scraper for school_id 307 - Berry College (US)
ATS platform: own website
Careers link: https://www.berry.edu/employment/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Berry College; nothing here affects any
...
Writes school_job_posts/school_id_307_job_posts.csv (school_id, post_link).
Checkpointed to school_id_307_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 307
SCHOOL_NAME = 'Berry College'
CAREERS_LINK = 'https://www.berry.edu/employment/'
