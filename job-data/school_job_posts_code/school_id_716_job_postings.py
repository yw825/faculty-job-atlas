"""
Job postings scraper for school_id 716 - City Vision University (US)
ATS platform: own website
Careers link: https://cityvisionuniversity.applytojob.com

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for City Vision University; nothing here affects any
...
Writes school_job_posts/school_id_716_job_posts.csv (school_id, post_link).
Checkpointed to school_id_716_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 716
SCHOOL_NAME = 'City Vision University'
CAREERS_LINK = 'https://cityvisionuniversity.applytojob.com'
