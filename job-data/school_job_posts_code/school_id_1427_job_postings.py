"""
Job postings scraper for school_id 1427 - The University of Texas at San Antonio (US)
ATS platform: own website
Careers link: https://www.utsa.edu/people-excellence/careers/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for The University of Texas at San Antonio; nothing here affects any
...
Writes school_job_posts/school_id_1427_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1427_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1427
SCHOOL_NAME = 'The University of Texas at San Antonio'
CAREERS_LINK = 'https://www.utsa.edu/people-excellence/careers/'
