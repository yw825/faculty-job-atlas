"""
Job postings scraper for school_id 491 - Georgetown College (US)
ATS platform: own website
Careers link: https://www.georgetowncollege.edu/careers-georgetown-college

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Georgetown College; nothing here affects any
...
Writes school_job_posts/school_id_491_job_posts.csv (school_id, post_link).
Checkpointed to school_id_491_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 491
SCHOOL_NAME = 'Georgetown College'
CAREERS_LINK = 'https://www.georgetowncollege.edu/careers-georgetown-college'
