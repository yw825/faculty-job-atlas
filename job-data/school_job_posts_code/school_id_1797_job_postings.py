"""
Job postings scraper for school_id 1797 - Queensland University of Technology (Australia)
...
directly to fix or improve results for Queensland University of Technology; nothing here affects any
...
Writes school_job_posts/school_id_1797_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1797_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
