"""
Job postings scraper for school_id 595 - University of Maryland-Baltimore County (US)
ATS platform: own website
Careers link: https://facultyjobs.umbc.edu/cwfac/en-us/listing/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of Maryland-Baltimore County; nothing here affects any
...
Writes school_job_posts/school_id_595_job_posts.csv (school_id, post_link).
Checkpointed to school_id_595_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://facultyjobs.umbc.edu/cwfac/en-us/listing/'
