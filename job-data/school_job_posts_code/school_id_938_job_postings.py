"""
Job postings scraper for school_id 938 - Mercy University (US)
ATS platform: own website
Careers link: https://www.mercy.edu/about/human-resources/employment-mercy

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Mercy University; nothing here affects any
...
Writes school_job_posts/school_id_938_job_posts.csv (school_id, post_link).
Checkpointed to school_id_938_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 938
SCHOOL_NAME = 'Mercy University'
CAREERS_LINK = 'https://www.mercy.edu/about/human-resources/employment-mercy'
