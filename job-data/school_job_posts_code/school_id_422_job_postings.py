"""
Job postings scraper for school_id 422 - Indiana Institute of Technology (US)
...
directly to fix or improve results for Indiana Institute of Technology; nothing here affects any
...
Writes school_job_posts/school_id_422_job_posts.csv (school_id, post_link).
Checkpointed to school_id_422_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
