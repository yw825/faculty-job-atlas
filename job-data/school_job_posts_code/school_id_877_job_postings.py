"""
Job postings scraper for school_id 877 - Rutgers University-New Brunswick (US)
ATS platform: own website
Careers link: https://jobs.rutgers.edu/postings/search

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Rutgers University-New Brunswick; nothing here affects any
other school's script.

Link check (ok): 81 posting-shaped links found.

NOTE: 2 schools list against this same URL, so this listing carries every one of their postings, not just this school's: Rutgers University-Camden.
...
Writes school_job_posts/school_id_877_job_posts.csv (school_id, post_link).
Checkpointed to school_id_877_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
