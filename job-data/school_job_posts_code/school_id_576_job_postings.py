"""
Job postings scraper for school_id 576 - Babson College (US)
ATS platform: own website
Careers link: https://entrepreneurship.babson.edu/career-outcomes-mba-class-2025/?share=linkedin

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Babson College; nothing here affects any
...
Writes school_job_posts/school_id_576_job_posts.csv (school_id, post_link).
Checkpointed to school_id_576_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 576
SCHOOL_NAME = 'Babson College'
CAREERS_LINK = 'https://entrepreneurship.babson.edu/career-outcomes-mba-class-2025/?share=linkedin'
