"""
Job postings scraper for school_id 1273 - University of South Carolina Aiken (US)
ATS platform: own website
Careers link: https://www.usca.edu/departments/human-resources/employment/internal-job-postings/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of South Carolina Aiken; nothing here affects any
...
Writes school_job_posts/school_id_1273_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1273_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1273
SCHOOL_NAME = 'University of South Carolina Aiken'
CAREERS_LINK = 'https://www.usca.edu/departments/human-resources/employment/internal-job-postings/'
