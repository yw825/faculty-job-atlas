"""
Job postings scraper for school_id 827 - Minot State University (US)
ATS platform: own website
Careers link: https://www.minotstateu.edu/hr

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Minot State University; nothing here affects any
...
Writes school_job_posts/school_id_827_job_posts.csv (school_id, post_link).
Checkpointed to school_id_827_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 827
SCHOOL_NAME = 'Minot State University'
CAREERS_LINK = 'https://www.minotstateu.edu/hr'
