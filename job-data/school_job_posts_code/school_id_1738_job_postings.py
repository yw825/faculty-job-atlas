"""
Job postings scraper for school_id 1738 - Babeș-Bolyai University (Romania)
...
directly to fix or improve results for Babeș-Bolyai University; nothing here affects any
...
Writes school_job_posts/school_id_1738_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1738_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
