"""
Job postings scraper for school_id 717 - Rockhurst University (US)
ATS platform: own website
Careers link: https://www.rockhurst.edu/about/human-resources/equal-employment-opportunity

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Rockhurst University; nothing here affects any
...
Writes school_job_posts/school_id_717_job_posts.csv (school_id, post_link).
Checkpointed to school_id_717_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 717
SCHOOL_NAME = 'Rockhurst University'
CAREERS_LINK = 'https://www.rockhurst.edu/about/human-resources/equal-employment-opportunity'
