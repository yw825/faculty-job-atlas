"""
Job postings scraper for school_id 1120 - University of Portland (US)
ATS platform: PeopleAdmin (detected: peopleadmin)
Careers link: https://uportland.peopleadmin.com/

University of Portland runs on a shared ATS platform -- every school on peopleadmin uses the
...
Writes school_job_posts/school_id_1120_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1120_job_postings.checkpoint next to this script.
"""
import os
import sys
...
CAREERS_LINK = 'https://uportland.peopleadmin.com/'
