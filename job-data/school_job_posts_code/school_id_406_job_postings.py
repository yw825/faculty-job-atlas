"""
Job postings scraper for school_id 406 - Quincy University (US)
ATS platform: own website
Careers link: https://www.quincy.edu/about/work-at-qu/job-openings/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Quincy University; nothing here affects any
...
Writes school_job_posts/school_id_406_job_posts.csv (school_id, post_link).
Checkpointed to school_id_406_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 406
SCHOOL_NAME = 'Quincy University'
CAREERS_LINK = 'https://www.quincy.edu/about/work-at-qu/job-openings/'
