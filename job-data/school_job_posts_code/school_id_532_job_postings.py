"""
Job postings scraper for school_id 532 - University of Massachusetts-Amherst (US)
ATS platform: own website
Careers link: https://umassamherst.dc4.pageuppeople.com/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of Massachusetts-Amherst; nothing here affects any
...
Writes school_job_posts/school_id_532_job_posts.csv (school_id, post_link).
Checkpointed to school_id_532_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
