"""
Job postings scraper for school_id 929 - Villa Maria College (US)
ATS platform: own website
Careers link: https://www.villa.edu/about-us/employment-opportunities/employment-application/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Villa Maria College; nothing here affects any
...
Writes school_job_posts/school_id_929_job_posts.csv (school_id, post_link).
Checkpointed to school_id_929_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 929
SCHOOL_NAME = 'Villa Maria College'
CAREERS_LINK = 'https://www.villa.edu/about-us/employment-opportunities/employment-application/'
