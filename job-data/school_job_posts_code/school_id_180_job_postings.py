"""
Job postings scraper for school_id 180 - Western Connecticut State University (US)
ATS platform: own website
Careers link: http://wcsu.edu/hr/employment/current-opportunities/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Western Connecticut State University; nothing here affects any
...
Writes school_job_posts/school_id_180_job_posts.csv (school_id, post_link).
Checkpointed to school_id_180_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'http://wcsu.edu/hr/employment/current-opportunities/'
