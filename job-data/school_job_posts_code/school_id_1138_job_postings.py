"""
Job postings scraper for school_id 1138 - Wilson College (US)
...
directly to fix or improve results for Wilson College; nothing here affects any
...
Writes school_job_posts/school_id_1138_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1138_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
