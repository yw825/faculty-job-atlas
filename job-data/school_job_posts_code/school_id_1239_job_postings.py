"""
Job postings scraper for school_id 1239 - Universidad Central de Bayamon (US)
ATS platform: own website
Careers link: https://ucb.edu.pr/oficina-de-recursos-humanos/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Universidad Central de Bayamon; nothing here affects any
...
Writes school_job_posts/school_id_1239_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1239_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1239
SCHOOL_NAME = 'Universidad Central de Bayamon'
CAREERS_LINK = 'https://ucb.edu.pr/oficina-de-recursos-humanos/'
