"""
Job postings scraper for school_id 1770 - Imperial College London (United Kingdom)
ATS platform: own website
Careers link: https://www.imperial.ac.uk/jobs/search-jobs/?

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Imperial College London; nothing here affects any
...
Writes school_job_posts/school_id_1770_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1770_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
