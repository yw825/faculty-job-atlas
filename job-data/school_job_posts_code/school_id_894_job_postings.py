"""
Job postings scraper for school_id 894 - New Mexico State University-Main Campus (US)
ATS platform: own website
Careers link: https://careers.nmsu.edu/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for New Mexico State University-Main Campus; nothing here affects any
other school's script.

Link check (ok): 36 posting-shaped links found -- rendered.
...
Writes school_job_posts/school_id_894_job_posts.csv (school_id, post_link).
Checkpointed to school_id_894_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 894
SCHOOL_NAME = 'New Mexico State University-Main Campus'
CAREERS_LINK = 'https://careers.nmsu.edu/'
