"""
Job postings scraper for school_id 522 - University of Holy Cross (US)
ATS platform: own website
Careers link: https://uhcno.edu/hr/jobs/index.php

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of Holy Cross; nothing here affects any
...
Writes school_job_posts/school_id_522_job_posts.csv (school_id, post_link).
Checkpointed to school_id_522_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 522
SCHOOL_NAME = 'University of Holy Cross'
CAREERS_LINK = 'https://uhcno.edu/hr/jobs/index.php'
