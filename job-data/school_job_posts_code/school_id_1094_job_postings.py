"""
Job postings scraper for school_id 1094 - Randall University (US)
ATS platform: own website
Careers link: https://ru.edu/about-randall/jobs/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Randall University; nothing here affects any
...
Writes school_job_posts/school_id_1094_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1094_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1094
SCHOOL_NAME = 'Randall University'
CAREERS_LINK = 'https://ru.edu/about-randall/jobs/'
