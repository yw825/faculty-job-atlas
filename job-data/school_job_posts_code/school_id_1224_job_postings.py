"""
Job postings scraper for school_id 1224 - King's College (US)
ATS platform: own website
Careers link: https://www.kings.edu/human-resources/careers.html

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for King's College; nothing here affects any
...
Writes school_job_posts/school_id_1224_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1224_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://www.kings.edu/human-resources/careers.html'
...
def find_links():
    ...
    link-based scraper returned 0 row(s) against 8 real openings
    on the page.

    Each section becomes CAREERS_LINK + '#' + a slug of its own heading,
    and school_id_1224_job_info.py resolves that fragment back to the
    section's text."""
