"""
Job postings scraper for school_id 487 - Lindsey Wilson College (US)
ATS platform: own website
Careers link: https://lindsey.elluciancrmrecruit.com/Apply/Account/Create

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Lindsey Wilson College; nothing here affects any
...
Writes school_job_posts/school_id_487_job_posts.csv (school_id, post_link).
Checkpointed to school_id_487_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
