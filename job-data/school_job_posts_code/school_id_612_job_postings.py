"""
Job postings scraper for school_id 612 - Husson University (US)
ATS platform: own website
Careers link: https://www.husson.edu/about/human-resources/index.html

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Husson University; nothing here affects any
...
Writes school_job_posts/school_id_612_job_posts.csv (school_id, post_link).
Checkpointed to school_id_612_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 612
SCHOOL_NAME = 'Husson University'
CAREERS_LINK = 'https://www.husson.edu/about/human-resources/index.html'
