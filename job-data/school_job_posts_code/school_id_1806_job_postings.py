"""
Job postings scraper for school_id 1806 - Torrens University Australia (Australia)
ATS platform: Workday (detected: workday)
Careers link: https://strayer.wd1.myworkdayjobs.com/en-US/ANZ_TUA_External1

Torrens University Australia runs on a shared ATS platform -- every school on workday uses the
...
Writes school_job_posts/school_id_1806_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1806_job_postings.checkpoint next to this script.
"""
import os
import sys
