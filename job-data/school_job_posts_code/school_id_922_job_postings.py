"""
Job postings scraper for school_id 922 - St. Joseph's University-New York (US)
ATS platform: own website
Careers link: https://www.sjny.edu/employment

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for St. Joseph's University-New York; nothing here affects any
...
Writes school_job_posts/school_id_922_job_posts.csv (school_id, post_link).
Checkpointed to school_id_922_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 922
SCHOOL_NAME = 'St. Joseph\'s University-New York'
CAREERS_LINK = 'https://www.sjny.edu/employment'
