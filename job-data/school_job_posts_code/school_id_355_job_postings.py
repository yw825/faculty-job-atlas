"""
Job postings scraper for school_id 355 - Buena Vista University (US)
ATS platform: own website
Careers link: https://www.bvu.edu/en/undergraduate-on-campus/careers--outcomes/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Buena Vista University; nothing here affects any
...
Writes school_job_posts/school_id_355_job_posts.csv (school_id, post_link).
Checkpointed to school_id_355_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 355
SCHOOL_NAME = 'Buena Vista University'
CAREERS_LINK = 'https://www.bvu.edu/en/undergraduate-on-campus/careers--outcomes/'
