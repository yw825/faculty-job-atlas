"""
Job postings scraper for school_id 1237 - Inter American University of Puerto Rico-Bayamon (US)
ATS platform: own website
Careers link: https://www.inter.edu/en/department/bayamon/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Inter American University of Puerto Rico-Bayamon; nothing here affects any
...
Writes school_job_posts/school_id_1237_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1237_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1237
SCHOOL_NAME = 'Inter American University of Puerto Rico-Bayamon'
CAREERS_LINK = 'https://www.inter.edu/en/department/bayamon/'
