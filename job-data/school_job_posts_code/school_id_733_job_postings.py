"""
Job postings scraper for school_id 733 - Saint Louis University (US)
ATS platform: Workday (detected: workday)
Careers link: https://slu.wd5.myworkdayjobs.com/Careers

Saint Louis University runs on a shared ATS platform -- every school on workday uses the
...
Writes school_job_posts/school_id_733_job_posts.csv (school_id, post_link).
Checkpointed to school_id_733_job_postings.checkpoint next to this script.
"""
import os
import sys
...
CAREERS_LINK = 'https://slu.wd5.myworkdayjobs.com/Careers'
