"""
Job postings scraper for school_id 660 - Lawrence Technological University (US)
ATS platform: own website
Careers link: https://ltu.edu/about/human-resources/job-openings/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Lawrence Technological University; nothing here affects any
...
Writes school_job_posts/school_id_660_job_posts.csv (school_id, post_link).
Checkpointed to school_id_660_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 660
SCHOOL_NAME = 'Lawrence Technological University'
CAREERS_LINK = 'https://ltu.edu/about/human-resources/job-openings/'
