"""
Job postings scraper for school_id 705 - Columbia College (US)
ATS platform: own website
Careers link: https://www.ccis.edu/careers/jobs
...
Writes school_job_posts/school_id_705_job_posts.csv (school_id, post_link).
Checkpointed to school_id_705_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://www.ccis.edu/careers/jobs'
