"""
Job postings scraper for school_id 1044 - University of Dayton (US)
ATS platform: own website
Careers link: https://careers.pageuppeople.com/875/cw/en-us/subscribe

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for University of Dayton; nothing here affects any
...
Writes school_job_posts/school_id_1044_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1044_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1044
SCHOOL_NAME = 'University of Dayton'
CAREERS_LINK = 'https://careers.pageuppeople.com/875/cw/en-us/subscribe'
