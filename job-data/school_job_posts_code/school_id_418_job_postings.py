"""
Job postings scraper for school_id 418 - Indiana University-Bloomington (US)
ATS platform: own website
Careers link: https://bloomington.iu.edu/academics/experiential-learning/research-opportunities/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Indiana University-Bloomington; nothing here affects any
...
Writes school_job_posts/school_id_418_job_posts.csv (school_id, post_link).
Checkpointed to school_id_418_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://bloomington.iu.edu/academics/experiential-learning/research-opportunities/'
