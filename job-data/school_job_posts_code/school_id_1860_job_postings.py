"""
Job postings scraper for school_id 1860 - Singapore Institute of Technology (Singapore)
ATS platform: own website
Careers link: https://careers.singaporetech.edu.sg/search/?q=&searchResultView=LIST

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Singapore Institute of Technology; nothing here affects any
...
Writes school_job_posts/school_id_1860_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1860_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
