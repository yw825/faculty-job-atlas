"""
Job postings scraper for school_id 229 - Florida Gulf Coast University (US)
ATS platform: own website
Careers link: https://jobs.fgcu.edu/jobs/search/search-page-faculty

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Florida Gulf Coast University; nothing here affects any
other school's script.

Link check (ok): 21 posting-shaped links found -- rendered.
...
Writes school_job_posts/school_id_229_job_posts.csv (school_id, post_link).
Checkpointed to school_id_229_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://jobs.fgcu.edu/jobs/search/search-page-faculty'
