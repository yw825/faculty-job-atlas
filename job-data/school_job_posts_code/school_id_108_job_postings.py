"""
Job postings scraper for school_id 108 - University of California-Merced (US)
ATS platform: UC Recruit (detected: ucrecruit)
Careers link: https://aprecruit.ucmerced.edu/apply

University of California-Merced runs on a shared ATS platform -- every school on ucrecruit uses the
...
Writes school_job_posts/school_id_108_job_posts.csv (school_id, post_link).
Checkpointed to school_id_108_job_postings.checkpoint next to this script.
"""
import os
import sys
