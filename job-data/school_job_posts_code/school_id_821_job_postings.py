"""
Job postings scraper for school_id 821 - Dickinson State University (US)
ATS platform: own website
Careers link: https://dickinsonstate.edu/about/employment/open-positions/index.html

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Dickinson State University; nothing here affects any
...
Writes school_job_posts/school_id_821_job_posts.csv (school_id, post_link).
Checkpointed to school_id_821_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
CAREERS_LINK = 'https://dickinsonstate.edu/about/employment/open-positions/index.html'
