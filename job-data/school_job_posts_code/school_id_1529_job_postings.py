"""
Job postings scraper for school_id 1529 - Lawrence University (US)
ATS platform: PeopleAdmin (detected: peopleadmin)
Careers link: https://lawrence.peopleadmin.com/

Lawrence University runs on a shared ATS platform -- every school on peopleadmin uses the
...
Writes school_job_posts/school_id_1529_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1529_job_postings.checkpoint next to this script.
"""
import os
import sys
...
SCHOOL_ID = 1529
SCHOOL_NAME = 'Lawrence University'
CAREERS_LINK = 'https://lawrence.peopleadmin.com/'
