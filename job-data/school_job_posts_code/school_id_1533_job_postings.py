"""
Job postings scraper for school_id 1533 - Ottawa University-Milwaukee (US)
...
directly to fix or improve results for Ottawa University-Milwaukee; nothing here affects any
other school's script.

Link check (ok): 10 posting-shaped links found -- rendered [shared URL].

NOTE: 3 schools list against this same URL, so this listing carries every one of their postings, not just this school's: Ottawa University-Ottawa, Ottawa University-Kansas City.
...
Writes school_job_posts/school_id_1533_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1533_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1533
SCHOOL_NAME = 'Ottawa University-Milwaukee'
