"""
Job postings scraper for school_id 1077 - Wilmington College (US)
ATS platform: own website
Careers link: https://www.wilmington.edu/about/employment

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Wilmington College; nothing here affects any
...
Writes school_job_posts/school_id_1077_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1077_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 1077
SCHOOL_NAME = 'Wilmington College'
CAREERS_LINK = 'https://www.wilmington.edu/about/employment'
