"""
Job postings scraper for school_id 1628 - Brock University (Canada)
ATS platform: Workday (detected: workday)
Careers link: https://brocku.wd3.myworkdayjobs.com/brocku_careers

Brock University runs on a shared ATS platform -- every school on workday uses the
...
Writes school_job_posts/school_id_1628_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1628_job_postings.checkpoint next to this script.
"""
import os
import sys
