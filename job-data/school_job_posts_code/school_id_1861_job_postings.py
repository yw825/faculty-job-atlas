"""
Job postings scraper for school_id 1861 - Singapore University of Social Sciences (Singapore)
ATS platform: own website
Careers link: https://careers.suss.edu.sg/go/Academic-Appointments/4634610/

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Singapore University of Social Sciences; nothing here affects any
...
Writes school_job_posts/school_id_1861_job_posts.csv (school_id, post_link).
Checkpointed to school_id_1861_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
