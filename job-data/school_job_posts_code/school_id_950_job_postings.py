"""
Job postings scraper for school_id 950 - Ithaca College (US)
ATS platform: own website
Careers link: https://www.ithaca.edu/center-career-exploration-and-development

No shared ATS platform adapter applies to this school -- find_links() below
is THIS SCHOOL'S OWN scraping logic, owned entirely by this file. Edit it
directly to fix or improve results for Ithaca College; nothing here affects any
other school's script.

Link check (ok): 54 posting-shaped links found.
...
Writes school_job_posts/school_id_950_job_posts.csv (school_id, post_link).
Checkpointed to school_id_950_job_postings.checkpoint next to this script.
"""
import os
import re
import sys
...
SCHOOL_ID = 950
SCHOOL_NAME = 'Ithaca College'
CAREERS_LINK = 'https://www.ithaca.edu/center-career-exploration-and-development'
